...
if __name__ == "__main__":
    ...
    train_txt = r'D:\Code\0-data\1-齿轮检测数据集\青山数据集\VOCdevkit\VOC2012\有缺陷的训练集.txt'  # 输出文件：训练集图片名称
    val_txt = r'D:\Code\0-data\1-齿轮检测数据集\青山数据集\VOCdevkit\VOC2012\有缺陷验证集.txt'  # 输出文件：验证集图片名称
