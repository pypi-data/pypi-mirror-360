...
def main(parser_data):
    ...
    print(f'label_json_path: {label_json_path}')
    ...
    val_dataset = VOCDataSet(VOC_root, "2012", data_transform["val"], "val.txt", json_file=label_json_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--label-json_path', default='/kaggle/input/valcode/classes.json', help='number of classes')
    # 数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default=r'/kaggle/input/voc2012', help='dataset root')

    # 训练好的权重文件
    parser.add_argument('--weights-path',
                        default=r'/kaggle/input/best-model/best_model.pth',
