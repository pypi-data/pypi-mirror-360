...
class LangCache(BaseSDK):
    r"""Redis LangCache Service: API for managing a Redis LangCache"""

    def __init__(
        self,
        server_url: str,
        service_key: Optional[Union[Optional[str], Callable[[], Optional[str]]]] = None,
        ...
        :param service_key: The service_key required for authentication
        ...
        security: Any = None
        if callable(service_key):
            # pylint: disable=unnecessary-lambda-assignment
            security = lambda: models.Security(service_key=service_key())
        else:
            security = models.Security(service_key=service_key)
    ...
    def health(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.HealthCheckReport, http_res)
    ...
    def search(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.CacheEntry], http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorResponseContentData, http_res
            )
    ...
    def cache(
        ...
        *,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.SaveCacheEntryResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorResponseContentData, http_res
            )
    ...
    def delete_entry(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.APISuccessResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorResponseContentData, http_res
            )
