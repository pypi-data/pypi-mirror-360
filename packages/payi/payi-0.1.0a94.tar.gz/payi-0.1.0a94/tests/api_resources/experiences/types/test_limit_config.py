...
class TestLimitConfig:
    ...
    def test_method_create(self, client: Payi) -> None:
        limit_config = client.experiences.types.limit_config.create(
            experience_name="experience_name",
            max=0,
        )
        assert_matches_type(ExperienceType, limit_config, path=["response"])
    ...
    def test_raw_response_create(self, client: Payi) -> None:
        response = client.experiences.types.limit_config.with_raw_response.create(
            experience_name="experience_name",
            max=0,
        )
    ...
    def test_streaming_response_create(self, client: Payi) -> None:
        with client.experiences.types.limit_config.with_streaming_response.create(
            experience_name="experience_name",
            max=0,
        ) as response:
    ...
    def test_path_params_create(self, client: Payi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `experience_name` but received ''"):
            client.experiences.types.limit_config.with_raw_response.create(
                experience_name="",
                max=0,
            )
    ...
    def test_method_delete(self, client: Payi) -> None:
        limit_config = client.experiences.types.limit_config.delete(
            "experience_name",
        )
        assert_matches_type(ExperienceType, limit_config, path=["response"])
    ...
    def test_raw_response_delete(self, client: Payi) -> None:
        response = client.experiences.types.limit_config.with_raw_response.delete(
            "experience_name",
        )
    ...
    def test_streaming_response_delete(self, client: Payi) -> None:
        with client.experiences.types.limit_config.with_streaming_response.delete(
            "experience_name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Payi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `experience_name` but received ''"):
            client.experiences.types.limit_config.with_raw_response.delete(
                "",
            )
...
class TestAsyncLimitConfig:
    ...
    async def test_method_create(self, async_client: AsyncPayi) -> None:
        limit_config = await async_client.experiences.types.limit_config.create(
            experience_name="experience_name",
            max=0,
        )
        assert_matches_type(ExperienceType, limit_config, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncPayi) -> None:
        response = await async_client.experiences.types.limit_config.with_raw_response.create(
            experience_name="experience_name",
            max=0,
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncPayi) -> None:
        async with async_client.experiences.types.limit_config.with_streaming_response.create(
            experience_name="experience_name",
            max=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncPayi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `experience_name` but received ''"):
            await async_client.experiences.types.limit_config.with_raw_response.create(
                experience_name="",
                max=0,
            )
    ...
    async def test_method_delete(self, async_client: AsyncPayi) -> None:
        limit_config = await async_client.experiences.types.limit_config.delete(
            "experience_name",
        )
        assert_matches_type(ExperienceType, limit_config, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncPayi) -> None:
        response = await async_client.experiences.types.limit_config.with_raw_response.delete(
            "experience_name",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncPayi) -> None:
        async with async_client.experiences.types.limit_config.with_streaming_response.delete(
            "experience_name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncPayi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `experience_name` but received ''"):
            await async_client.experiences.types.limit_config.with_raw_response.delete(
                "",
            )
