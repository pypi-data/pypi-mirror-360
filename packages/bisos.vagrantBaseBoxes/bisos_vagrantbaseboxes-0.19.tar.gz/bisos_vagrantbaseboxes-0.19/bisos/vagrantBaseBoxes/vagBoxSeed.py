...
####+BEGIN: b:py3:class/decl :className "VagBox" :superClass "object" :comment "Abstraction of an Apt Package" :classType "basic"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Cls-basic  [[elisp:(outline-show-subtree+toggle)][||]] /VagBox/  superClass=object =Abstraction of an Apt Package=  [[elisp:(org-cycle)][| ]]
#+end_org """
class VagBox(object):
####+END:
    """
...
####+BEGIN: b:py3:class/decl :className "VagBoxSeedInfo" :superClass "object" :comment "Abstraction of the seed Interface" :classType "basic"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Cls-basic  [[elisp:(outline-show-subtree+toggle)][||]] /VagBoxSeedInfo/  superClass=object =Abstraction of the seed Interface=  [[elisp:(org-cycle)][| ]]
#+end_org """
class VagBoxSeedInfo(object):
####+END:
    """
** Abstraction of
"""
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance = super( VagBoxSeedInfo, cls).__new__(cls)
    ...
    @property
    def namedGraphsList(self) -> list[VagBox] | None:
        return self._namedGraphsList

    @namedGraphsList.setter
    def namedGraphsList(self, value: list[VagBox] | None,):
    ...
    def graphByName(self, name: str) -> VagBox | None:
        result: VagBox | None = None
        if self.namedGraphsList is None:
...
####+BEGIN: b:py3:cs:func/typing :funcName "vagBox" :funcType "extTyped" :deco "track"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  F-T-extTyped [[elisp:(outline-show-subtree+toggle)][||]] /vagBox/  deco=track  [[elisp:(org-cycle)][| ]]
#+end_org """
...
** [[elisp:(org-cycle)][| *DocStr | ]
    ...
    pkg = VagBox(name=pkgName, func=func, osVers=osVers)
    return pkg
...
** [[elisp:(org-cycle)][| *DocStr | ]
    #+end_org """
    vagBoxSeedInfo.seedType = seedType
    vagBoxSeedInfo.namedGraphsList  = vagBoxList
    vagBoxSeedInfo.examplesHook  = examplesHook
