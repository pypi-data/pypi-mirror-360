...
from walker.utils import deep_merge_dicts, log2

def enter_repl(state: ReplState):
    cmd_list: list[Command] = [AppId(), Cd(), Check(), Cqlsh(), GetParam(), Help(), Issues(), Ls(), NodeTool(),
                               ReaperForward(), ReaperSchedules(), ReaperRunAbort(), ReaperRunsAbort(), ReaperRuns(), ReaperScheduleActivate(), ReaperScheduleStop(),
                               ReaperScheduleStart(), Reaper(),
                               Report(), Restart(), RollingRestart(), SetParam(), ShowParams(), Status(), Exit()]
