...
if TYPE_CHECKING:
    from penta import Penta, Router  # pragma: no cover
...
class Operation:
    def __init__(
        ...
        *,
        ...
        self.api: Penta = cast("Penta", None)
    ...
    def _create_response_model(self, response_param: Any) -> Optional[Type[Schema]]:
        ...
        return type("PentaResponseSchema", (Schema,), attrs)
...
class PathView:
    ...
    def add_operation(
        ...
        *,
        ...
        view_func._penta_operation = operation  # type: ignore
        return operation
