...
class GulpLearn():
  def __init__(self) -> None:
    ...
    gulp_path = os.popen('which gulp').read().strip()
    os.environ['ASE_GULP_COMMAND'] = f'{gulp_path} < PREFIX.gin > PREFIX.got'
    gulp_lib_path = '/Users/wangjinlong/my_script/sci_research/lmp_use/potential/MD_pot'
    os.environ['GULP_LIB'] = gulp_lib_path
    pass
  ...
  def example(self):
    ...
    calc = ase.calculators.gulp.GULP(
        keywords='conp', shel=['O1', 'O2'], conditions=c)
