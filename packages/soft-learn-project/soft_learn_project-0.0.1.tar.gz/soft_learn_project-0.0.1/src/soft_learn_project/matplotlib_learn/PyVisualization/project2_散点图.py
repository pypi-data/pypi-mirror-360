...
#散点图的四个重要参数
# s 面积(大小)  c 颜色  marker 形状  alpha  透明度
# plt.scatter(yesterday,today,s=10,c='r',marker='<',alpha=0.5)
height = [161,170,182,175,173,165]
weight = [50,58,80,70,69,55]

plt.scatter(height,weight, s=40,c='r',marker='<',alpha=0.5)
plt.show()
...
#股票相关  开盘价和关盘价
open,close = np.loadtxt('000001.csv',delimiter=',',skiprows=1,usecols=(1,4),unpack=True)  # 跳过第一行
change = close - open
yesterday = change[:-1]
today = change[1:]
