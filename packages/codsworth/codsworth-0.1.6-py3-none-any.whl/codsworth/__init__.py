...
def get_resource_path(filename):
    return importlib.resources.files("codsworth").joinpath(filename)
...
class ChatbotAssistant:
    ...
    def save_model(self, model_path, dimensions_path):
        ...
        with dimensions_path.open('w', encoding="utf-8") as f:
...
def main():
    import sys
    print("Starting Codsworth...")
    intents_path = get_resource_path("intents.json")
    dimensions_path = get_resource_path("dimensions.json")
    print(f"intents_path: {intents_path}")
    print(f"dimensions_path: {dimensions_path}")
    ...
    if "--train" in sys.argv:
        ...
        import os
        model_path = os.path.expanduser("~/.codsworth_model.pth")
