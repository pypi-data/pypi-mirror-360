...
class UIEventRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tenant_id", "user_prompt", "conversation_id", "source", "request_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conversation_id": obj.get("conversation_id") if obj.get("conversation_id") is not None else '',
            "source": obj.get("source") if obj.get("source") is not None else '',
            "request_id": obj.get("request_id") if obj.get("request_id") is not None else ''
        })
        return _obj
