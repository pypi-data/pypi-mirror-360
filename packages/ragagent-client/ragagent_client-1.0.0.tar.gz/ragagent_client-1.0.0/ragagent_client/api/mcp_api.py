...
class MCPApi:
    ...
    @validate_call
    def get_mcp_server_spec_mcp_server_spec_get(
        self,
        ...
        _param = self._get_mcp_server_spec_mcp_server_spec_get_serialize(
    ...
    @validate_call
    def get_mcp_server_spec_mcp_server_spec_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_mcp_server_spec_mcp_server_spec_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_mcp_server_spec_mcp_server_spec_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
