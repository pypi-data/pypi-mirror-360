...
class AbandonedSignupData(BaseModel):
    """
    Data structure for abandoned WABA signup flow.
    """ # noqa: E501
    current_step: StrictStr = Field(description="Screen where customer abandoned the flow")
    __properties: ClassVar[List[str]] = ["current_step"]
