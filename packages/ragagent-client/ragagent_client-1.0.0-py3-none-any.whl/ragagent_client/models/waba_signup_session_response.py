...
class WABASignupSessionResponse(BaseModel):
    """
    Response with signup session configuration.
    """ # noqa: E501
    app_id: StrictStr
    configuration_id: StrictStr
    graph_api_version: StrictStr
    feature_type: Optional[StrictStr] = None
    redirect_uri: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["app_id", "configuration_id", "graph_api_version", "feature_type", "redirect_uri"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "graph_api_version": obj.get("graph_api_version"),
