...
{
    let obj = {};
    obj.enable = GUIConf.GUIpanels[MPILabel].JSONObj[MPIOptionsLabel.parascheme[0]] == ParaMPILabel;
...
{
    let obj = {};
    obj.enable = GUIConf.GUIpanels[MPILabel].JSONObj[MPIOptionsLabel.parascheme[0]] == MultiThreadLabel;
    obj.processes = GUIConf.GUIpanels[MPILabel].JSONObj[MPIOptionsLabel.threads[0]];
    return obj;
}
