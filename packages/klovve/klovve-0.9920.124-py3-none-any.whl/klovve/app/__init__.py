...
class BaseApplication(abc.ABC):
    ...
    @abc.abstractmethod
    async def dialog(self, dialog: type["klovve.ui.dialog.BaseDialog"]|klovve.builtin.views.interact._AbstractInteract,
                     dialog_args=None, dialog_kwargs=None, *, view_anchor) -> t.Any:
        pass
...
def create(application: t.Union[BaseApplication, "klovve.builtin.views.window.Window"]) -> "klovve.app.runnable.Runnable":
