...
class TestSummarizeMemory:
    ...
    def test_method_create(self, client: Raindrop) -> None:
        summarize_memory = client.summarize_memory.create(
        ...
        assert_matches_type(SummarizeMemoryCreateResponse, summarize_memory, path=["response"])
    ...
    def test_raw_response_create(self, client: Raindrop) -> None:
        response = client.summarize_memory.with_raw_response.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            memory_ids=["01jxanr45haeswhay4n0q8340y", "01jxanr45haeswhay4n0q8341z"],
            session_id="01jxanr45haeswhay4n0q8340y",
        )
        ...
        summarize_memory = response.parse()
        assert_matches_type(SummarizeMemoryCreateResponse, summarize_memory, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_create(self, client: Raindrop) -> None:
        with client.summarize_memory.with_streaming_response.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            memory_ids=["01jxanr45haeswhay4n0q8340y", "01jxanr45haeswhay4n0q8341z"],
            session_id="01jxanr45haeswhay4n0q8340y",
        ) as response:
...
class TestAsyncSummarizeMemory:
    ...
    async def test_method_create(self, async_client: AsyncRaindrop) -> None:
        summarize_memory = await async_client.summarize_memory.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            memory_ids=["01jxanr45haeswhay4n0q8340y", "01jxanr45haeswhay4n0q8341z"],
            session_id="01jxanr45haeswhay4n0q8340y",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncRaindrop) -> None:
        response = await async_client.summarize_memory.with_raw_response.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            memory_ids=["01jxanr45haeswhay4n0q8340y", "01jxanr45haeswhay4n0q8341z"],
            session_id="01jxanr45haeswhay4n0q8340y",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        summarize_memory = await response.parse()
        assert_matches_type(SummarizeMemoryCreateResponse, summarize_memory, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncRaindrop) -> None:
        async with async_client.summarize_memory.with_streaming_response.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            memory_ids=["01jxanr45haeswhay4n0q8340y", "01jxanr45haeswhay4n0q8341z"],
            session_id="01jxanr45haeswhay4n0q8340y",
        ) as response:
