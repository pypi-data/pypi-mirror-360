...
class TestEndSession:
    ...
    def test_method_create(self, client: Raindrop) -> None:
        end_session = client.end_session.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            session_id="01jxanr45haeswhay4n0q8340y",
        )
        assert_matches_type(EndSessionCreateResponse, end_session, path=["response"])
    ...
    def test_raw_response_create(self, client: Raindrop) -> None:
        response = client.end_session.with_raw_response.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            session_id="01jxanr45haeswhay4n0q8340y",
        )
        ...
        end_session = response.parse()
        assert_matches_type(EndSessionCreateResponse, end_session, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_create(self, client: Raindrop) -> None:
        with client.end_session.with_streaming_response.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            session_id="01jxanr45haeswhay4n0q8340y",
        ) as response:
...
class TestAsyncEndSession:
    ...
    async def test_method_create(self, async_client: AsyncRaindrop) -> None:
        end_session = await async_client.end_session.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            session_id="01jxanr45haeswhay4n0q8340y",
        )
        assert_matches_type(EndSessionCreateResponse, end_session, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncRaindrop) -> None:
        response = await async_client.end_session.with_raw_response.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            session_id="01jxanr45haeswhay4n0q8340y",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        end_session = await response.parse()
        assert_matches_type(EndSessionCreateResponse, end_session, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncRaindrop) -> None:
        async with async_client.end_session.with_streaming_response.create(
            agent_memory_location={"agent_memory": {"name": "memory-name"}},
            session_id="01jxanr45haeswhay4n0q8340y",
        ) as response:
            assert not response.is_closed
