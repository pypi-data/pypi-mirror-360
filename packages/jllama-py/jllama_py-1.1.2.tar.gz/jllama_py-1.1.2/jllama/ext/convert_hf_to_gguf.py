...
class ModelBase:
    ...
    def __init__(self, dir_model: Path, ftype: gguf.LlamaFileType, fname_out: Path, *, is_big_endian: bool = False,
        ...
        self.dir_model_card = dir_model  # overridden in convert_lora_to_gguf.jllama
...
class TextModel(ModelBase):
    ...
    # NOTE: this function is generated by convert_hf_to_gguf_update.jllama
    ...
    def get_vocab_base_pre(self, tokenizer) -> str:
        ...
        # NOTE: if you get an error here, you need to update the convert_hf_to_gguf_update.jllama script
        ...
        if res is None:
            ...
            logger.warning("**          - the model has not been added to convert_hf_to_gguf_update.jllama yet")
            logger.warning("**          - the pre-tokenization config has changed upstream")
            logger.warning(
                "**          Check your model files and convert_hf_to_gguf_update.jllama and update them accordingly.")
...
class LlavaVisionModel(MmprojModel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.hparams["model_type"] == "pixtral":
            # layer_norm_eps is not in config.json, it is hard-coded in modeling_pixtral.jllama
