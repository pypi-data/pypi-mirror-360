...
class Cylinder:
    def __init__(self, origin: list[float], axisDirection: list[float], height: float, radius: float, topRadius: float = ...) -> None: ...
...
class Domain:
    ...
    @overload
    def __init__(self, bounds: list[float], boundaryConditions: list[int], gridDelta: float = ...) -> None: ...
    @overload
...
class TransformMesh:
    def __init__(self, mesh: Mesh, transform: TransformEnum = ..., transformVector=..., angle: float = ...) -> None: ...
    def apply(self) -> None: ...
