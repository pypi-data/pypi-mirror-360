...
from circle.web3.user_controlled_wallets.models.transaction_screening_decision import TransactionScreeningDecision  # noqa: E501
...
class TestTransactionScreeningDecision(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = circle.web3.user_controlled_wallets.models.transaction_screening_decision.TransactionScreeningDecision()  # noqa: E501
        if include_optional :
            return TransactionScreeningDecision(
                ...
                reasons = [
                    circle.web3.user_controlled_wallets.models.risk_signal.RiskSignal(
                        source = 'ADDRESS', 
