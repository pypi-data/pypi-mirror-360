...
class WalletMetadata(BaseModel):
    ...
    def from_json(cls, json_str: str) -> WalletMetadata:
        """Create an instance of WalletMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WalletMetadata:
        """Create an instance of WalletMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WalletMetadata.parse_obj(obj)
