...
class WalletsData(BaseModel):
    ...
    WalletsData
    """
    wallets: conlist(WalletResponseDataWallet) = Field(...)
    ...
    def from_dict(cls, obj: dict) -> WalletsData:
        ...
        _obj = WalletsData.parse_obj({
            "wallets": [WalletResponseDataWallet.from_dict(_item) for _item in obj.get("wallets")] if obj.get("wallets") is not None else None
        })
        return _obj
