...
class SetPinRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetPinRequest:
        """Create an instance of SetPinRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetPinRequest:
        """Create an instance of SetPinRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetPinRequest.parse_obj(obj)

        _obj = SetPinRequest.parse_obj({
