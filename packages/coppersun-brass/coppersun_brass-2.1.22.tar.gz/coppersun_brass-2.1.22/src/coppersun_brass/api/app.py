...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Copper Alloy Brass API starting up")
    ...
    # Shutdown
    logger.info("Copper Alloy Brass API shutting down")
...
def create_app(
    ...
    title: str = "Copper Alloy Brass API",
    version: str = "1.0.0",
