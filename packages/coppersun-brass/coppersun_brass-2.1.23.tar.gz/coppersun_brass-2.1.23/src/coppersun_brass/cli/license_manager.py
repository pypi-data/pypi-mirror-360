...
class LicenseManager:
    ...
    def activate_lemonsqueezy_license(license_key: str, api_key: str = None) -> LicenseInfo:
        ...
        try:
            ...
            expected_store_id = 193336  # Your store ID
            expected_product_id = 556422  # Your product ID
            ...
            if expires_at:
                try:
                    ...
                    pass  # Handle expiry parsing errors gracefully
    ...
    def validate_license(license_key: str) -> LicenseInfo:
        ...
        if not license_key.startswith("BRASS-") and len(license_key) >= 30:
            # Use live API key for LemonSqueezy validation
            api_key = "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..i-kMW1a06zzuGWM-rU4b6e3ArFSDuhBT7CFGmbMGAb7kuucX_JNOjgM4kPhtYM47B5MkLqKNcLdrrO0PJ7_LuP5DjRPasWYrXS4Z3EV8R5tTq93xeyNN12cgpEyCtHaIYeTsbni-Kua1XyikBd3XJ4XNxklOcS6V38se1rhQmQUDi27CbWUcBkOTPA2TrOCo1Tfvh2km9gKMAaYC_SJ28R0LAVFZdbenhO-428SH6n7u73-8sb65-lAwdUtOILcFUK2SyrgE3O2AuK8RYjPw7qO66S61fxgZKYzGs5-ld1C1EZktm1l188Ymvn_fOop536mjdD1aT0lAJdUGTlLhCRF2GINlJEr1vP2mvhnMZj6GD2X_916RG_rmHWPy-bfE_HsHGcmtHdJixdfY2rSgDjfPG_o4FCKI6QgjqoT4m6wiRtowiKZXNz4YWXZIBZOpFzE37sctZz-7FlGywXydT0uAlprUX-fQzeMHJd85EnH-8IZy-a1PIpQIo8hzOtXk"
