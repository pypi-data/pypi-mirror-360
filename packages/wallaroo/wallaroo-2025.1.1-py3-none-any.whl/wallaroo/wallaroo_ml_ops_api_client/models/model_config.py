...
@_attrs_define
class ModelConfig:
    """Wrapper struct to add a realized database ID to an underlying data struct.
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        continuous_batching_config: Union[Dict[str, Any], None, Unset]
        ...
        openai: Union[Dict[str, Any], None, Unset]
