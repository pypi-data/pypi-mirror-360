...
debugLog(f"🔍 Exudyn GUI starting - logging to: {log_file}")
debugLog(f"🔍 Timestamp: {datetime.now().isoformat()}")
...
try:
    ...
    debugLog("⚠️ Jupyter qtconsole not available - using fallback console")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None, SC=None, mbs=None, app_version="", pdfBookmarks=None, pdfPath=None):
        ...
        if self._pdfBookmarks:
            debugLog("✅ PDF documentation bookmarks passed from startup", origin="MainWindow")
        else:
            debugLog("⚠️ No PDF documentation bookmarks provided at startup", origin="MainWindow")
        
        # Set minimum size to prevent too small windows
        #self.setMinimumSize(1200, 800)

        # 1. Load any previously‐saved variables (so self.userVariables is up to date):
        ...
        # 2. (Keep your existing "model‐tracking" code here…)
        ...
        # … after you've started the kernel_client and before rendering …
    ...
    def startRendererRefresh(self):
        ...
        if hasattr(self, 'renderer_timer') and self.renderer_timer is not None:
            if not self.renderer_refresh_active:
                ...
                debugLog("🔄 Started continuous renderer refresh", origin="MainWindow")
        else:
            debugLog("⚠️ Cannot start renderer refresh - timer not initialized", origin="MainWindow")
    ...
    def stopRendererRefresh(self):
        ...
        debugLog("🛑 Stopped continuous renderer refresh", origin="MainWindow")
    ...
    def onRibbonTabChanged(self, index):
        ...
        if "Graphics" in tab_text:
            ...
            self.structureLabel.setText("🖼️ Graphics Structure")  
        else:
            self.graphicsListWidget.hide()
            self.structureTree.show()
            self.structureLabel.setText("🏗️ Model Structure")   
    ...
    def setupGraphicsRibbonTab(self):
        ...
        sketch_group = QGroupBox("✏️ Sketch / Profile")
        ...
        constructors_group = QGroupBox("🧩 Graphics Constructors")
        ...
        edit_group = QGroupBox("✏️ Edit Components")
        ...
        edit_selected_btn = QPushButton("✏️ Edit Selected")
        ...
        accept_group = QGroupBox("✅ Accept/Cancel Graphics")
        ...
        self.acceptGraphicsBtn = QPushButton("✅ Accept Graphics Edit")
        self.cancelGraphicsBtn = QPushButton("❌ Cancel Graphics Edit")
        ...
        layout.addStretch()
        self.ribbonTabs.addTab(graphics_widget, "🎨 Graphics")
    ...
    def setupAnalyseRibbonTab(self):
        ...
        self.ribbonTabs.addTab(analyse_widget, "🧮 Analyse")
    ...
    def setupDataRibbonTab(self):
        ...
        self.ribbonTabs.addTab(data_widget, "📊 Data")
    ...
    def setupModelRibbonTab(self):
        ...
        add_group = QGroupBox("➕ Add Components")
        ...
        # Python Code Group
        python_group = QGroupBox("🐍 Python Editor")
        ...
        snippet_btn = QPushButton("📝 Quick Snippet")
        ...
        self.ribbonTabs.addTab(model_widget, "🔧 Model")
    ...
    def setupSimulationRibbonTab(self):
        ...
        # Simulation Group
        sim_group = QGroupBox("🚀 Simulation & Output")
        ...
        generate_script_btn = QPushButton("📜 Generate Full Script")
        ...
        # Removed deprecated Start Renderer and Stop Renderer buttons - renderer is now integrated
          # 🔧 Add button to toggle between docked and undocked renderer modes
        self.docking_toggle_btn = QPushButton("� Docked")
        ...
        self.ribbonTabs.addTab(sim_widget, "🚀 Simulation")
    ...
    def setupAddLegacyRibbonTab(self):
        ...
        self.ribbonTabs.addTab(add_widget, "➕ Legacy")
    ...
    def setupAddRibbonTab(self):
        ...
        self.ribbonTabs.addTab(add_widget, "➕ Create")
    ...
    def createRibbonLeftPanel(self):
        ...
        self.structureLabel = QLabel("🏗️ Model Structure")
        ...
        def show_selected_doc():
            ...
            if hasattr(self, 'guiModelMapping') and compKey in self.guiModelMapping:
                ...
                if hasattr(self, '_pdfBookmarks') and self._pdfBookmarks is not None:
                    ...
                    debugLog("⚠️ PDF bookmarks not available from global cache, skipping PDF help", origin="MainWindow")
                    pdfBookmarks = None
                    pdfPath = None
                ...
                if pdfBookmarks is not None and pdfPath is not None:
                    ...
                    debugLog("⚠️ PDF bookmarks or path not available, skipping PDF help", origin="MainWindow")
        ...
        variables_group = QGroupBox("📝 User Variables")
        ...
        try:
            if not hasattr(self, 'solution_viewer'):
                ...
                if hasattr(self, 'right_panel_layout'):
                    ...
                    debugLog("⚠️ right_panel_layout not available for renderer widget")
        except Exception as e:
            debugLog(f"❌ Error initializing renderer widget: {e}")
            import traceback
            traceback.print_exc()
    ...
    def createRibbonRightPanel(self):
        ...
        viewer_label = QLabel("🎯 Exudyn OpenGL window")
    ...
    def closeEvent(self, event):
        ...
        debugLog("👋 Exiting Exudyn Model Builder...", origin="MainWindow")
        try:
    ...
    def focusInEvent(self, event):
        """🔄 Restore Focus on Qt MainWindow Re-activation"""
        ...
        try:
            ...
            debugLog(f"⚠️ Could not set focus to renderer: {e}", origin="MainWindow")
        ...
        try:
            ...
            debugLog(f"⚠️ Focus renderer refresh error: {e}", origin="MainWindow")
    ...
    def addItem(self, mode="all"):
        ...
        if result:
            ...
            # 🔧 CRITICAL FIX: Save renderer state AFTER dialog closes (after user moved view)
            # but BEFORE model rebuild
            debugLog("🔄 Saving renderer state after dialog closed, before rebuild...", origin="mainWindow.py")
    ...
    def getAvailableBodies(self):
        ...
        debugLog(f"getAvailableBodies → objects = {list(objects.keys())}")
        debugLog(f"getAvailableBodies → objectCategories = {objectCategories}")
        ...
        debugLog(f"✅ Final availableBodies = {bodies}")
        return bodies
    ...
    def getAvailableItems(self, category):
        ...
        category ∈ { "node", "marker", "object", "sensor", "load", "body" }
        """
        nameByIndex = {}
        typeByIndex = {}
    ...
    def buildSystemAndShowAndRefreshTree(self):
        ...
        # 🔧 Infer actual types and categories for labels
    ...
    def showFullScript(self):
        # 🔍 DEBUG: Log the actual modelSequence structure from GUI
        debugLog(f"🔍 [GUI DEBUG] modelSequence has {len(self.modelSequence)} items")
        for i, item in enumerate(self.modelSequence[:2]):  # Only log first 2 items
            debugLog(f"🔍 [GUI DEBUG] Item {i} keys: {list(item.keys())}")
            debugLog(f"🔍 [GUI DEBUG] Item {i} full structure: {item}")
        ...
        if isinstance(compKey, int):  # top-level created item (both CREATE and legacy)
            ...
            if model_entry and 'data' in model_entry:
                ...
                if 'objectType' in data:
                    try:
                        ...
                        error_msg = f"# ⚠️ Error generating code for {data.get('objectType', 'unknown')}: {str(e)}"
                    ...
                    self.infoBox.setPlainText("# ⚠️ Invalid item: missing objectType.")
            else:
                self.infoBox.setPlainText("# ⚠️ Invalid item: missing data.")
            ...
            if compKey in self.componentToCreate:
                ...
                if 'objectType' in itemData and 'objIndex' in itemData:
                    ...
                    self.infoBox.setPlainText("# ⚠️ Invalid item: missing objectType or objIndex.")
            else:
                self.infoBox.setPlainText(f"# ⚠️ No creation entry found for: {compKey}")
        else:
    ...
    def printCombinedModelInfo(self):
        ...
        debugLog("=== GUI ↔ Model Tree Full Mapping (All Model Data) ===")
        from pprint import pformat
    ...
    def inject_debug_variables(self):
        ...
        debugLog("Injected PrintCombinedModelInfo helper into kernel namespace.",
                 origin="MainWindow")
          # 🚀 Auto-inject QtConsole integration on GUI startup
        try:
...
# 🚀 ExudynGUI QtConsole Integration Auto-Injection
try:
    exec(open(r'{qtconsole_launcher_path}', encoding='utf-8').read())
    print('✅ QtConsole integration auto-loaded on GUI startup!')
except Exception as e:
    print(f'⚠️ QtConsole integration not available: {{e}}')
    print('💡 To find installation path: import exudynGUI, os; print(os.path.join(os.path.dirname(exudynGUI.__file__), "guiConsole", "qtconsole_launcher.py"))')
"""
    ...
    def simulateModel(self):
        """Run simulation with proper 5-step workflow: save state → undock → pause GUI → simulate with restored state → dock."""
        try:
            ...
            # =====================================
            debugLog("💾 STEP 1/5: Saving renderer state before any changes...", origin="MainWindow")
            ...
            try:
                ...
                if hasattr(self, 'solution_viewer') and self.solution_viewer:
                    ...
                    if saved_renderer_state:
                        debugLog("✅ Renderer state saved successfully", origin="MainWindow")
                    else:
                        debugLog("⚠️ Could not save renderer state", origin="MainWindow")
                else:
                    debugLog("⚠️ No solution_viewer available for state saving", origin="MainWindow")
                
                # Save main window geometry to prevent unwanted resizing
                saved_window_geometry = self.saveGeometry()
                debugLog("✅ Main window geometry saved", origin="MainWindow")
                
                debugLog("✅ STEP 1/5 COMPLETE: States saved successfully", origin="MainWindow")
                
            except Exception as e:
                debugLog(f"⚠️ STEP 1/5 FAILED: Error saving states: {e}", origin="MainWindow")

            # =====================================
            # STEP 2: UNDOCK OPENGL WINDOW SECOND (AFTER SAVING STATE)
            # =====================================
            debugLog("🔓 STEP 2/5: Undocking OpenGL window for simulation...", origin="MainWindow")
            ...
            if hasattr(self, 'solution_viewer') and self.solution_viewer:
                try:
                    ...
                    if is_currently_docked:
                        debugLog("🔄 Triggering undocking using SAME method as dock button...", origin="MainWindow")
                        ...
                        if hasattr(self, 'docking_toggle_btn'):
                            ...
                            debugLog("✅ Undocking triggered - now waiting for completion...", origin="MainWindow")                        # ⏰ WAIT FOR UNDOCKING TO ACTUALLY COMPLETE (check for independent window)
                        debugLog("⏰ Waiting for actual undocking to complete (checking for independent window)...", origin="MainWindow")
                        ...
                        while time.time() - start_time < max_wait_time:
                            ...
                            if hasattr(self.solution_viewer, 'checkForIndependentWindow'):
                                if self.solution_viewer.checkForIndependentWindow():
                                    ...
                                    debugLog("✅ Independent Exudyn window detected!", origin="MainWindow")
                                    break
                            ...
                            if (hasattr(self, 'docking_toggle_btn') and 
                                ...
                                if (hasattr(self.solution_viewer, 'renderer_active') and 
                                    ...
                                    undocking_complete = True
                                    debugLog("✅ Renderer active in undocked mode!", origin="MainWindow")
                                    break
                        ...
                        if undocking_complete:
                            ...
                            debugLog(f"⚠️ Renderer active: {getattr(self.solution_viewer, 'renderer_active', 'N/A')}", origin="MainWindow")
                        
                    else:
                        debugLog("✅ STEP 2/5 SKIPPED: OpenGL window already undocked", origin="MainWindow")

                except Exception as e:
                    debugLog(f"⚠️ STEP 2/5 FAILED: Could not undock OpenGL window: {e}", origin="MainWindow")
            else:
                debugLog("⚠️ STEP 2/5 SKIPPED: No solution_viewer available for undocking", origin="MainWindow")            # =====================================
            # STEP 3: PAUSE GUI THIRD (AFTER UNDOCKING)
            # =====================================
            debugLog("🚫 STEP 3/5: Pausing GUI for simulation...", origin="MainWindow")
            self.pauseGUIForSimulation()
            debugLog("✅ STEP 3/5 COMPLETE: GUI paused successfully", origin="MainWindow")

            # =====================================
            # STEP 4: RUN SIMULATION FOURTH (NOW FULLY ISOLATED)
            # =====================================
            debugLog("🚀 STEP 4/5: Starting simulation...", origin="MainWindow")
                        ...
                        if hasattr(self.solution_viewer, 'restartRendererDocked'):
                            ...
                            if success:
                                ...
                                if hasattr(self, 'docking_toggle_btn'):
                                    ...
                                    self.docking_toggle_btn.setText("🔗 Restart Renderer")
                                ...
                                debugLog("⚠️ STEP 5/5 FAILED: OpenGL window re-docking failed", origin="MainWindow")
                        else:
                            debugLog("⚠️ STEP 5/5 FAILED: Renderer does not support docking", origin="MainWindow")
                    else:
                        debugLog("⚠️ STEP 5/5 FAILED: No solution_viewer available for re-docking", origin="MainWindow")
                        
                except Exception as e:
                    debugLog(f"⚠️ STEP 5/5 FAILED: Could not re-dock OpenGL window: {e}", origin="MainWindow")

            else:
                debugLog("✅ STEP 5/5 SKIPPED: Window was originally undocked, leaving undocked", origin="MainWindow")
                # Even if we didn't re-dock, restore window geometry if it was saved
                if saved_window_geometry:
                    debugLog("🔄 Restoring main window geometry (undocked mode)...", origin="MainWindow")
                    self.restoreGeometry(saved_window_geometry)
                    debugLog("✅ Main window geometry restored", origin="MainWindow")

            # Restore the saved view state after re-docking
            if saved_renderer_state:
                debugLog("🔄 Restoring original view state after re-docking...", origin="MainWindow")
                restore_success = self.solution_viewer.restoreRendererState(saved_renderer_state)
                if restore_success:
                    debugLog("✅ Original view state restored after simulation", origin="MainWindow")
                else:
            ...
            debugLog("🎉 ALL STEPS COMPLETE: Simulation workflow finished successfully", origin="MainWindow")
                    ...
                    if hasattr(self, 'solution_viewer') and self.solution_viewer:
                        if hasattr(self.solution_viewer, 'restartRendererDocked'):
                            ...
                            if success and hasattr(self, 'docking_toggle_btn'):
                                self.docking_toggle_btn.setChecked(False)  # False = docked
                                self.docking_toggle_btn.setText("🔗 Docked")
                        debugLog("🔧 Emergency re-dock completed after simulation failure", origin="MainWindow")
                
                # Always try to restore window geometry, even after failure
                if 'saved_window_geometry' in locals() and saved_window_geometry:
                    debugLog("🔄 Emergency restore of main window geometry...", origin="MainWindow")
                    self.restoreGeometry(saved_window_geometry)
                    debugLog("✅ Main window geometry restored after failure", origin="MainWindow")
                    
            except Exception as restore_error:
                debugLog(f"⚠️ Could not restore states after failure: {restore_error}", origin="MainWindow")
    ...
    def clearModel(self):
        ...
        try:
            ...
            if hasattr(self, 'solution_viewer') and self.solution_viewer:
                debugLog("🔄 Restarting renderer with fresh SystemContainer...")
                ...
                if hasattr(self.solution_viewer, 'restartRendererDocked'):
                    success = self.solution_viewer.restartRendererDocked()
                    if success:
                        debugLog("✅ Renderer restarted and docked successfully")
                        # Update docking button to show docked state
                        if hasattr(self, 'docking_toggle_btn'):
                            self.docking_toggle_btn.setChecked(False)  # False = docked
                            self.docking_toggle_btn.setText("🔗 Docked")
                    else:
                        debugLog("⚠️ Renderer restart failed, but model was cleared")
                else:
                    debugLog("⚠️ Renderer restart not available, using setExudynObjects only")
            
            debugLog("🆕 Model cleared and reset successfully")
            debugLog("🔍 Fresh SystemContainer created with new system")
    ...
    def pauseGUIForSimulation(self):
        ...
        """
        try:
            debugLog("🚫 COMPLETE GUI PAUSE: Suspending Qt event loop and Windows communication", origin="MainWindow")
            ...
            if app:
                try:
                    ...
                    debugLog("✅ Event filter installed - blocking GUI events", origin="MainWindow")
                    
                except Exception as e:
                    debugLog(f"⚠️ Could not install event filter: {e}", origin="MainWindow")
            ...
            try:
                ...
                self._simulation_notification = QLabel("🔄 SIMULATION RUNNING\n\nGUI suspended until completion")
                ...
                debugLog(f"⚠️ Could not create notification: {e}", origin="MainWindow")
            
            debugLog("✅ COMPLETE GUI PAUSE: Qt events blocked, Windows communication minimized", origin="MainWindow")
            
        except Exception as e:
            debugLog(f"❌ Failed to pause GUI completely: {e}", origin="MainWindow")            # Fallback: at least disable the main window
            self.setEnabled(False)
    ...
    def resumeGUIAfterSimulation(self):
        ...
        """
        try:
            debugLog("✅ COMPLETE GUI RESUME: Restoring Qt event loop and Windows communication", origin="MainWindow")            
            ...
            if hasattr(self, '_event_filter_installed') and self._event_filter_installed:
                try:
                    ...
                    if app and hasattr(self, '_simulation_event_filter'):
                        ...
                        self._event_filter_installed = False
                        debugLog("✅ Event filter removed - GUI events restored", origin="MainWindow")
                except Exception as e:
                    debugLog(f"⚠️ Could not remove event filter: {e}", origin="MainWindow")
            ...
            if hasattr(self, '_suspended_timers'):
                try:
                    ...
                    debugLog(f"⚠️ Could not restore timers: {e}", origin="MainWindow")
            ...
            if hasattr(self, '_simulation_notification') and self._simulation_notification:
                try:
                    ...
                    debugLog("✅ Simulation notification closed", origin="MainWindow")
                except Exception as e:
                    debugLog(f"⚠️ Could not close notification: {e}", origin="MainWindow")
            
            # 4. RESTORE MAIN WINDOW: Show if it was visible before
            if hasattr(self, '_window_was_visible') and self._window_was_visible:
                self.show()
                debugLog("✅ Main window restored to visible state", origin="MainWindow")
            ...
            debugLog("🔄 COMPLETE GUI RESUME: All systems restored, GUI fully operational", origin="MainWindow")
            
        except Exception as e:
            debugLog(f"❌ Failed to resume GUI completely: {e}", origin="MainWindow")
    ...
    def connectConsoleToKernel(self):
        ...
        if (JUPYTER_AVAILABLE and 
            ...
            try:
                self.console.kernel_manager = self.kernel_manager
                self.console.kernel_client = self.kernel_client
                debugLog("✅ Jupyter console connected to kernel", origin="MainWindow")
            except Exception as e:
                debugLog(f"❌ Failed to connect console to kernel: {e}", origin="MainWindow")
    ...
    def toggleRendererDocking(self):
        ...
        debugLog("🔧 Docking toggle button clicked!")
        try:
            if not hasattr(self, 'solution_viewer') or not self.solution_viewer:
                debugLog("⚠️ No renderer available to toggle docking mode")
                return
            ...
            if self.docking_toggle_btn.isChecked():
                ...
                debugLog("🔄 Restarting renderer in undocked mode...")
                if hasattr(renderer, 'restartRendererUndocked'):
                    success = renderer.restartRendererUndocked()
                    if success:
                        self.docking_toggle_btn.setText("📱 Restart Renderer")
                        debugLog("✅ Renderer restarted in undocked mode (avoids Windows message delivery issues)")
                        ...
                        debugLog("❌ Failed to restart renderer in undocked mode, staying docked")
                else:
                    debugLog("⚠️ Renderer does not support restart methods")
            else:
                # Switch to docked mode using restart
                debugLog("🔄 Restarting renderer in docked mode...")
                if hasattr(renderer, 'restartRendererDocked'):
                    success = renderer.restartRendererDocked()
                    if success:
                        self.docking_toggle_btn.setText("📱 Restart Renderer")
                        debugLog("✅ Renderer restarted in docked mode")
                        # Restore renderer state after docking (delayed)
                        QTimer.singleShot(2000, delayed_restore)
                    else:
                        self.docking_toggle_btn.setText("📱 Restart Renderer")
                        self.docking_toggle_btn.setChecked(True)
                        debugLog("❌ Failed to restart renderer in docked mode, staying undocked")
                else:
                    debugLog("⚠️ Renderer does not support restart methods")
                
        except Exception as e:
            debugLog(f"❌ Error toggling renderer docking: {e}")
