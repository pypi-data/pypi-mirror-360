...
class Industry(BaseModel):
    ...
    Industry
    """ # noqa: E501
    code: StrictStr = Field(description="GICS Industry code.")
    name: StrictStr = Field(description="GICS Industry name.")
    industry_group: IndustryGroup = Field(description="Parent GICS Industry Group.")
