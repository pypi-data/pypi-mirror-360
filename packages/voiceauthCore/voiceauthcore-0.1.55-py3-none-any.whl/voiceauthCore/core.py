...
try:
    yamnet_model = keras.layers.TFSMLayer('models/yamnet', call_endpoint='serving_default')
except Exception as e:
    logging.warning(f"Failed to load YAMNet model: {e}")
    yamnet_model = None

try:
    vggish_model = keras.layers.TFSMLayer("models/vggish", call_endpoint='serving_default')
except Exception as e:
