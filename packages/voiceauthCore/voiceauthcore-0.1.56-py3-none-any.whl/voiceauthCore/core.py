...
try:
    yamnet_model = keras.models.load_model('https://tfhub.dev/google/yamnet/1')
except Exception as e:
    logging.warning(f"Failed to load YAMNet model: {e}")
    yamnet_model = None

try:
    vggish_model = keras.models.load_model('https://www.kaggle.com/models/google/vggish/TensorFlow2/vggish/1')
except Exception as e:
...
try:
    pipe2 = pipeline("audio-classification", model="MIT/ast-finetuned-audioset-10-10-0.4593")
except Exception as e:
    logging.warning(f"Failed to load MIT  model 2: {e}")
    pipe2 = None
