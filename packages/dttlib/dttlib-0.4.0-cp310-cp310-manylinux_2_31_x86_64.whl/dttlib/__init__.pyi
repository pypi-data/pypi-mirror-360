...
class AnalysisResult:
    ...
    class Coherence(AnalysisResult):
        __match_args__ = ("channel_a", "channel_b", "value",)
        channel_a: Channel
        channel_b: Channel
        value: FreqDomainArray
        def __new__(cls, channel_a:Channel, channel_b:Channel, value:FreqDomainArray) -> AnalysisResult.Coherence: ...
    ...
    class TransferFunction(AnalysisResult):
        ...
        channel_b: Channel
        value: FreqDomainArray
        def __new__(cls, channel_a:Channel, channel_b:Channel, value:FreqDomainArray) -> AnalysisResult.TransferFunction: ...
    
    class ASD(AnalysisResult):
        __match_args__ = ("channel", "value",)
        channel: Channel
        value: FreqDomainArray
        def __new__(cls, channel:Channel, value:FreqDomainArray) -> AnalysisResult.ASD: ...
    
    class TimeHistoryReal(AnalysisResult):
        __match_args__ = ("channel", "value",)
        channel: Channel
        value: TimeDomainArray
        def __new__(cls, channel:Channel, value:TimeDomainArray) -> AnalysisResult.TimeHistoryReal: ...
    
    class TimeHistoryComplex(AnalysisResult):
        __match_args__ = ("channel", "value",)
        channel: Channel
        value: TimeDomainArray
        def __new__(cls, channel:Channel, value:TimeDomainArray) -> AnalysisResult.TimeHistoryComplex: ...
    
    class Custom(AnalysisResult):
        r"""
        (source channels, custom pipeline name, value)
        """
        __match_args__ = ("channels", "pipeline_name", "value",)
        channels: builtins.list[Channel]
        pipeline_name: builtins.str
        value: typing.Any
        def __new__(cls, channels:typing.Sequence[Channel], pipeline_name:builtins.str, value:typing.Any) -> AnalysisResult.Custom: ...
    

class Channel:
    name: builtins.str
    data_type: NDSDataType
    channel_type: ChannelType
    rate_hz: builtins.float
    dcu_id: typing.Optional[builtins.int]
    channel_number: typing.Optional[builtins.int]
    calibration: typing.Optional[builtins.int]
    heterodyne_freq_hz: typing.Optional[builtins.float]
    gain: typing.Optional[builtins.float]
    slope: typing.Optional[builtins.float]
    offset: typing.Optional[builtins.float]
    use_active_time: builtins.bool
    units: typing.Optional[builtins.str]
    trend_stat: TrendStat
    trend_type: TrendType
    online: builtins.bool
    testpoint: builtins.bool
    def __new__(cls, name:builtins.str, data_type:NDSDataType, rate_hz:builtins.float) -> Channel: ...
...
class ChannelQuery:
    ...
    to a data source
    """
    def __new__(cls, pattern:typing.Optional[builtins.str]=None, channel_types:typing.Optional[typing.Sequence[ChannelType]]=None, data_types:typing.Optional[typing.Sequence[NDSDataType]]=None, min_sample_rate:typing.Optional[builtins.float]=None, max_sample_rate:typing.Optional[builtins.float]=None, gps_start:typing.Optional[builtins.int]=None, gps_end:typing.Optional[builtins.int]=None) -> ChannelQuery: ...
...
class ChannelSettings:
    ...
    """
    channel: Channel
    raw_decimation_params: DecimationParameters
    heterodyned_decimation_params: DecimationParameters
    do_heterodyne: builtins.bool
    decimation_delays: DecimationDelays
...
class DTT:
    ...
    def no_op(self) -> None:
        ...
        """
    def new_online_scope_view(self, set:ViewSet, span_pip:PipDuration) -> ScopeViewHandle:
        r"""
        Create a new online scope view and return a handle to it.
        Drop all clones of the handle to close the view.
        """
    def new_fixed_scope_view(self, set:ViewSet, start_pip:PipInstant, end_pip:PipInstant) -> ScopeViewHandle:
        r"""
...
class Excitation:
    channel: Channel
    read_back_channel: typing.Optional[Channel]
...
class ExcitationSettings:
    channel: ChannelSettings
    read_back_channel: typing.Optional[ChannelSettings]

class ExcitationSettingsParams:
    active: builtins.bool
    excitation: ExcitationSettings

class FreqDomainArray:
    start_gps_pip: PipInstant
    start_hz: builtins.float
    bucket_width_hz: builtins.float
    overlap: builtins.float
    sequence_index: builtins.int
    sequence_size: builtins.int
    n: builtins.float
    data: typing.Any
...
class MessageJob:
    class SetMessage(MessageJob):
        __match_args__ = ("tag", "msg",)
        tag: builtins.str
        msg: UserMessage
        def __new__(cls, tag:builtins.str, msg:UserMessage) -> MessageJob.SetMessage: ...
...
class NDS2Cache:
    ...
    """
    def __new__(cls, size_bytes:builtins.int, default_file_path:builtins.str) -> NDS2Cache: ...
...
class PipDuration:
    ...
    def from_pips(pips:builtins.int) -> PipDuration:
        ...
        """
    @staticmethod
    def from_seconds_nanoseconds(seconds:builtins.int, nano:builtins.int) -> PipDuration:
        r"""
...
class PipInstant:
    ...
    def to_gpst_seconds(self) -> builtins.float:
        ...
        """
    @staticmethod
    def from_gpst_seconds_nanoseconds(seconds:builtins.int, nano:builtins.int) -> PipInstant:
        r"""
...
class ResponseToUser:
    ...
    class AllMessages(ResponseToUser):
        __match_args__ = ("_0",)
        _0: builtins.dict[builtins.str, UserMessage]
        def __new__(cls, _0:typing.Mapping[builtins.str, UserMessage]) -> ResponseToUser.AllMessages: ...
    ...
    class ScopeViewResult(ResponseToUser):
        __match_args__ = ("id", "result",)
        id: builtins.int
        result: AnalysisResult
        def __new__(cls, id:builtins.int, result:AnalysisResult) -> ResponseToUser.ScopeViewResult: ...
    
    class ChannelQueryResult(ResponseToUser):
        __match_args__ = ("channels",)
        channels: builtins.list[Channel]
        def __new__(cls, channels:typing.Sequence[Channel]) -> ResponseToUser.ChannelQueryResult: ...
...
class ScopeViewHandle:
    ...
    def update(self, span_pip:typing.Optional[PipDuration]=None, start_pip:typing.Optional[PipInstant]=None, end_pip:typing.Optional[PipInstant]=None) -> None:
        r"""
...
class TestParams:
    ...
    # Test Type
    """
    start_time_pip: StartTime
    r"""
    # Start Time
    """
    measurement_time_pip: PipDuration
    r"""
    # time constraints
    ...
    """
    use_measurement_time: builtins.bool
    measurement_cycles: builtins.int
    r"""
    minimum number of cycles
    """
    use_measurement_cycles: builtins.bool
    settling_time_frac: builtins.float
    r"""
    # ramps and settling
    fraction of measurement time needed to "settle" the system
    """
    ramp_down_pip: PipDuration
    r"""
    time to ramp down excitations
    """
    ramp_up_pip: PipDuration
    r"""
    time to ramp up excitations
    """
    calc_power_spectrum: builtins.bool
    r"""
    # sine_options config
    Whether to calculate power spectrum
    Needed for sine response and swept sine
    """
    max_harmonic_order: builtins.int
    r"""
    Maximum harmonic order to calculate
    """
    average_size: builtins.int
    r"""
    # Averaging
    Total number of segments to average
    """
    average_type: AverageType
    measurement_channels: builtins.list[ChannelSettingsParams]
    r"""
    ## channel parameters
    """
    excitations: builtins.list[ExcitationSettingsParams]
    start_hz: builtins.float
    r"""
    # FFT Tools params
    """
    stop_hz: builtins.float
    band_width_hz: builtins.float
    overlap: builtins.float
    r"""
    as a fraction of the length of one segment
    """
    remove_mean: builtins.bool
    r"""
    when true, subtract out the mean
    """
    quiet_time_pip: PipDuration
    r"""
    ...
    """
    remove_decimation_delay: builtins.bool
    r"""
    ...
    """
    custom_pipelines: builtins.list[CustomPipeline]
    r"""
    Custom pipelines
...
class ThumpDuration:
    ...
    def from_thumps(thumps:builtins.int) -> ThumpDuration:
        ...
        """
    @staticmethod
    def from_seconds_nanoseconds(seconds:builtins.int, nano:builtins.int) -> ThumpDuration:
        r"""
        Create a duration given the length as seconds and nanoseconds
        """
...
class ThumpInstant:
    ...
    def to_gpst_seconds(self) -> builtins.float:
        ...
        """
    @staticmethod
    def from_gpst_seconds_nanoseconds(seconds:builtins.int, nano:builtins.int) -> ThumpInstant:
        r"""
        Create an instant given seconds + nanoseconds since the GPS epoch.
        """
    @staticmethod
...
class ViewSet:
    ...
    def from_channels(channels:typing.Sequence[Channel]) -> ViewSet:
        ...
        """
    @staticmethod
    def from_channel_names(channel_names:typing.Sequence[builtins.str], trend:TrendType) -> ViewSet:
        r"""
        convenience function
