...
class LanguageManager:
    ...
    def save_language_file(self, language_code: str, translations: Dict[str, Any], 
        ...
        try:
            ...
            with open(file_path, 'w', encoding='utf-8') as f:
                json.dump(language_data, f, indent=2, ensure_ascii=False, sort_keys=True)
    ...
    def create_language_template(self, language_code: str, language_name: str, 
                               native_name: str, author: str = "AI Prompt Manager") -> Dict[str, Any]:
