...
def generate_interpolation_indicator_map(data, indicator, satellite_info, save_path, satellite_geo_bounds, data_geo_bounds, all_points_outside, water_mask):
    ...
    main_ax.set_aspect(1/np.cos(np.deg2rad(mean_lat)), adjustable='box')
    ...
    lat_range = lat_max - lat_min
    margin = 0.02
    main_ax.set_xlim(lon_min - lon_range*margin, lon_max + lon_range*margin)
    main_ax.set_ylim(lat_min - lat_range*margin, lat_max + lat_range*margin)
