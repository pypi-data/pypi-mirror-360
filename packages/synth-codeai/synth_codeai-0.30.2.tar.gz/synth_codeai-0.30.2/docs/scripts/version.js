...
/**
 * Script to read version from synth_codeai/__version__.py and create version.json
...
// Paths
const versionFilePath = path.resolve(__dirname, '../../synth_codeai/__version__.py');
