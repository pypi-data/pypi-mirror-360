...
from synth_codeai.chat_models.deepseek_chat import ChatDeepseekReasoner
from synth_codeai.console.formatting import cpm
from synth_codeai.logging_config import get_logger
from synth_codeai.model_detection import is_claude_37, is_deepseek_v3
...
def get_model_default_temperature(provider: str, model_name: str) -> float:
    ...
    """
    from synth_codeai.models_params import models_params, DEFAULT_TEMPERATURE
