...
from synth_codeai.llm import initialize_llm, validate_provider_env
from synth_codeai.logging_config import get_logger
from synth_codeai.tool_configs import get_all_tools
from synth_codeai.tool_leaderboard import supported_top_tool_models
...
class FallbackHandler:
    ...
    def attempt_fallback(self):
        ...
        from synth_codeai.database.repositories.trajectory_repository import TrajectoryRepository
        from synth_codeai.database.repositories.human_input_repository import HumanInputRepository
