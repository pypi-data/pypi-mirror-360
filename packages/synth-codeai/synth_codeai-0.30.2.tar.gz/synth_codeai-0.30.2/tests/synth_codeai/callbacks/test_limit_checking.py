...
from synth_codeai.callbacks.default_callback_handler import DefaultCallbackHandler
...
def mock_repositories():
    ...
    with (
        patch("synth_codeai.callbacks.default_callback_handler.get_trajectory_repository") as mock_traj_repo,
        patch("synth_codeai.callbacks.default_callback_handler.get_session_repository") as mock_session_repo,
        patch("synth_codeai.callbacks.default_callback_handler.get_config_repository") as mock_config_repo,
    ):
        # Configure the mocks
...
@patch('sys.exit')
@patch('synth_codeai.callbacks.default_callback_handler.Confirm.ask')
