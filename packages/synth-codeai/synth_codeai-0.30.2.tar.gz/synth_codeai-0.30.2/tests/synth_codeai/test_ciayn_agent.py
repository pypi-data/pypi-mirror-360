...
from synth_codeai.agent_backends.ciayn_agent import CiaynAgent, validate_function_call_pattern
...
class TestFunctionCallValidation:
    ...
    def test_triple_quoted_string_function_calls(self):
        ...
        # Valid test cases
        test_files = sorted(glob.glob("/home/user/workspace/synth-codeai/tests/data/test_case_*.txt"))
        ...
        # Invalid test cases
        invalid_files = sorted(glob.glob("/home/user/workspace/synth-codeai/tests/data/invalid_case_*.txt"))
