...
from synth_codeai.exceptions import FallbackToolExecutionError
...
class TestFallbackHandler(unittest.TestCase):
    ...
    def test_attempt_fallback_resets_counter(self):
        ...
        import synth_codeai.llm as llm
    ...
    def test_load_fallback_tool_models(self):
        import synth_codeai.fallback_handler as fh
    ...
    def test_extract_failed_tool_name(self):
        from synth_codeai.exceptions import FallbackToolExecutionError, ToolExecutionError
    ...
    def test_invoke_fallback(self):
        ...
        with (
            ...
            patch(
                "synth_codeai.fallback_handler.supported_top_tool_models",
                new=[{"provider": "dummy", "model": "dummy_model", "type": "prompt"}],
            ),
            patch("synth_codeai.fallback_handler.validate_provider_env", return_value=True),
            patch("synth_codeai.fallback_handler.initialize_llm") as mock_init_llm,
        ):
        ...
        with (
            ...
            patch("synth_codeai.fallback_handler.validate_provider_env", return_value=False),
            patch("synth_codeai.fallback_handler.initialize_llm") as mock_init_llm,
        ):
    ...
    def test_construct_prompt_msg_list(self):
        ...
        from synth_codeai.fallback_handler import HumanMessage, SystemMessage
    ...
    def test_handle_failure_response(self):
        ...
        from synth_codeai.fallback_handler import SystemMessage
