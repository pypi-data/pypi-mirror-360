...
from synth_codeai.text.processing import process_thinking_content, extract_think_tag # Added import
...
class TestProcessThinkingContent:
    ...
    def test_config_lookup_for_show_thoughts(self):
        ...
        with patch("synth_codeai.database.repositories.config_repository.get_config_repository") as mock_get_config:
            with patch("synth_codeai.text.processing.cpm") as mock_cpm:
                # Setup mocks
                mock_repo = MagicMock()
