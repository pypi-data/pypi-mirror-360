...
from synth_codeai.tools.programmer import (
    parse_aider_flags,
...
def mock_related_files_repository():
    ...
    with patch('synth_codeai.database.repositories.related_files_repository.related_files_repo_var') as mock_repo_var:
        ...
        with patch('synth_codeai.tools.programmer.get_related_files_repository', return_value=mock_repo):
            yield mock_repo
...
def test_aider_config_flag(monkeypatch, mock_config_repository, mock_related_files_repository):
    ...
    monkeypatch.setattr("synth_codeai.tools.programmer.run_interactive_command", mock_run)
