...
from synth_codeai.database.connection import db_var, init_db
from synth_codeai.database.models import BaseModel
...
def mock_logger():
    ...
    with patch("synth_codeai.database.utils.logger") as mock:
        yield mock
...
@patch("synth_codeai.database.utils.initialize_database")
...
@patch("synth_codeai.database.models.BaseModel.delete")
