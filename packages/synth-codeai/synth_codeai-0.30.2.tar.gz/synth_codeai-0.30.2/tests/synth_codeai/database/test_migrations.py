...
def mock_router():
    ...
    with patch("synth_codeai.database.migrations.Router") as mock:
...
class TestMigrationManager:
    ...
    def test_init_router(self, cleanup_db, temp_dir, mock_router):
        ...
        with patch("synth_codeai.database.migrations.Router", return_value=mock_router):
            manager = MigrationManager(db_path=db_path, migrations_dir=migrations_dir)
...
class TestMigrationFunctions:
    ...
    def test_init_migrations(self, cleanup_db, temp_dir):
        ...
        with patch("synth_codeai.database.migrations.MigrationManager") as mock_manager:
    ...
    def test_ensure_migrations_applied(self, cleanup_db, mock_logger):
        ...
        with patch(
            "synth_codeai.database.migrations.init_migrations", return_value=mock_manager
        ):
    ...
    def test_ensure_migrations_applied_error(self, cleanup_db, mock_logger):
        ...
        with patch(
            "synth_codeai.database.migrations.init_migrations",
