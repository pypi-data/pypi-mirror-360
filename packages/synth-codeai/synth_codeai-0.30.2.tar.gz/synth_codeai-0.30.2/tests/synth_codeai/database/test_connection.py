...
these tests may still sometimes create files in the real .synth-codeai directory during execution.
"""
...
def mock_logger():
    ...
    with patch("synth_codeai.database.connection.logger") as mock:
        yield mock
