...
"""
Tests for the Pydantic models in synth_codeai.database.pydantic_models
"""
...
from synth_codeai.database.models import Session
...
class TestSessionModel:
    ...
    def test_from_peewee_model(self):
        ...
        assert session_model.command_line == "synth-codeai run"
    ...
    def test_with_dict_machine_info(self):
        ...
        session_model = SessionModel(
            ...
            updated_at=now,
            start_time=now,
            command_line="synth-codeai --debug",
