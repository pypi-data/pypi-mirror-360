...
from synth_codeai.tools.research import mark_research_complete_no_implementation_required


class TestResearchTools:
    @patch('synth_codeai.tools.research.mark_task_completed')
    @patch('synth_codeai.tools.research.mark_should_exit')
    # @patch('synth_codeai.tools.research.console_panel') # Removed
    @patch('synth_codeai.tools.research.cpm')
    @patch('synth_codeai.tools.research.get_trajectory_repository')
    @patch('synth_codeai.tools.research.get_human_input_repository')
