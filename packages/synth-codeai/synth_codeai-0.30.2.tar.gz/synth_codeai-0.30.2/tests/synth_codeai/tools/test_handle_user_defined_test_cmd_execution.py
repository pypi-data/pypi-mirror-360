...
from synth_codeai.tools.handle_user_defined_test_cmd_execution import (
    TestCommandExecutor,
    TestState,
...
def test_handle_test_failure(test_executor):
    ...
    with patch("synth_codeai.tools.handle_user_defined_test_cmd_execution.console.print"):
...
def test_run_test_command_timeout(test_executor):
    ...
    with (
        ...
        patch(
            "synth_codeai.tools.handle_user_defined_test_cmd_execution.logger.warning"
        ) as mock_logger,
    ):
...
def test_run_test_command_called_process_error(test_executor):
    ...
    with (
        ...
        patch(
            "synth_codeai.tools.handle_user_defined_test_cmd_execution.logger.error"
        ) as mock_logger,
    ):
...
def test_execute_test_command_function():
    ...
    config = {"test_cmd": "test"}
    with patch(
        "synth_codeai.tools.handle_user_defined_test_cmd_execution.TestCommandExecutor"
