...
from synth_codeai.tools.write_file import put_complete_file_contents
...
def mock_trajectory_repository():
    ...
    with patch('synth_codeai.tools.write_file.get_trajectory_repository') as mock_get_repo:
