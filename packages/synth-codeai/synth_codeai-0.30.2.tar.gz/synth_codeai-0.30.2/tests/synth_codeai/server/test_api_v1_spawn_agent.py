...
This module contains tests for the spawn-agent API endpoint in synth_codeai/server/api_v1_spawn_agent.py.
...
from synth_codeai.server.api_v1_sessions import get_repository
from synth_codeai.server.api_v1_spawn_agent import router
from synth_codeai.database.pydantic_models import SessionModel
import datetime
import synth_codeai.server.api_v1_spawn_agent
from synth_codeai.llm import get_model_default_temperature
...
def client(mock_repository, mock_thread, mock_config_repository, monkeypatch):
    ...
    monkeypatch.setattr(
        synth_codeai.server.api_v1_spawn_agent,
        "threading",
...
def test_temperature_handling_in_agent_spawn(client, mock_repository, mock_thread, mock_config_repository, monkeypatch):
    ...
    original_Thread = synth_codeai.server.api_v1_spawn_agent.threading.Thread
    ...
    monkeypatch.setattr(
        synth_codeai.server.api_v1_spawn_agent.threading,
        "Thread",
        spy_Thread
    )
