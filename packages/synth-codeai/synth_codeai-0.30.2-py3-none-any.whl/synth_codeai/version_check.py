"""Version check module for synth.codeai."""

import logging
import requests
from packaging import version

from synth_codeai.__version__ import __version__ as current_version

# URL for the latest version information
VERSION_URL = "https://docs.synth-codeai.ai/version.json"
...
def check_for_newer_version() -> str:
    """
    Check if a newer version of synth.codeai is available.
    ...
    try:
        ...
        if version.parse(latest_version) > version.parse(current_version):
            ...
            return (f"A new version of synth.codeai is available! Consider upgrading to {latest_version} "
