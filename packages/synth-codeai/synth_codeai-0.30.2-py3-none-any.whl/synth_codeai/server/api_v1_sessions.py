...
from synth_codeai.database.repositories.trajectory_repository import TrajectoryRepository, get_trajectory_repository
from synth_codeai.database.pydantic_models import SessionModel, TrajectoryModel
from synth_codeai.utils.agent_thread_manager import stop_agent, is_agent_running
...
async def get_session_trajectories(
    ...
    try:
        ...
        if not trajectories:
            ...
            from synth_codeai.database.models import Trajectory
            try:
