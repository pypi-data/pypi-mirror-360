    ...
    try:
        ...
        if db_path:
            ...
            if not synth_codeai_dir.exists():
                return [create_empty_result(f"No .synth-codeai directory found in {project_dir}")], 1
...
def main():
    ...
    parser.add_argument("--project-dir", help="Directory containing the .synth-codeai folder (defaults to current directory)")
