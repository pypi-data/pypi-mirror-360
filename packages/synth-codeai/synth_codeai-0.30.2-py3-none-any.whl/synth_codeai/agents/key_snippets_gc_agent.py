...
from synth_codeai.console.formatting import console_panel
...
from synth_codeai.prompts.key_snippets_gc_prompts import KEY_SNIPPETS_GC_PROMPT
from synth_codeai.tools.memory import log_work_event
from synth_codeai.agent_context import mark_should_exit
