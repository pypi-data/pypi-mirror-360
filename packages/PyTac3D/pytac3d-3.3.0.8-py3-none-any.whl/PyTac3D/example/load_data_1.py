'''
Example: load_data_1.py

This example demonstrates how to read and visualize locally recorded Tac3D tactile sensor data.

Main contents include:
1. Loading locally recorded data using PyTac3D.DataLoader
2. Estimating the 3D geometry of contact regions with PyTac3D.Analyzer.detectObjects() function
...
本示例主要展示如何读取并可视化本地录制的Tac3D触觉传感器数据
