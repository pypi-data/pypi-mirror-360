        ...
        for line in logs:
            if line.startswith("ADD:"):
                ...
                try:
                    ...
                    pass
xml = XML(r"/run/media/harddisk/Documents/Dictionary/etlex")
x = dictionaryJ(xml)
y = dictionaryJ(xml)
print(x._dictionaryJ__update("cat", "xcvxcv"))
print(x._dictionaryJ__add("asd", "qwe"))
print(x._dictionaryJ__search_exact("cat"))
print(x._dictionaryJ__search_exact("asd"))