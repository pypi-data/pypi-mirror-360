...
class ScanResultImagesInner(BaseModel):
    ...
    spots_low_res: Optional[StrictInt] = Field(default=None, description="Spot count in low resolution range (default 50.0 - 4.5 A)")
    ...
    __properties: ClassVar[List[str]] = ["efficiency", "number", "bkg", "spots", "spots_low_res", "index", "mos", "b", "uc", "xfel_pulseid", "pixel_sum", "max", "sat", "err", "res"]
