...
class DeepSeek(BaseModel):
    def __init__(
        ...
        self.n_routed_experts = self.model.config.n_routed_experts
        self.first_k_dense_replace = self.model.config.first_k_dense_replace
        self.moe_layer_freq = self.model.config.moe_layer_freq
        self.mlp_names = {
    ...
    def get_observer_layers(self):
        ...
        observer_layers_dict = {
            ...
            and (
                k.split(".")[-2] + "." + k.split(".")[-1] in names
                or k.split(".")[-1] in names
            )
        }
