...
class AssistanceTextFrame(betterproto.Message):
    ...
    text: 'str | None' = betterproto.string_field(2, optional=True)
...
class AssistanceImageFrame(betterproto.Message):
    ...
    image: 'bytes | None' = betterproto.bytes_field(2, optional=True)
    is_last_frame: bool = betterproto.bool_field(3)
    timestamp: float = betterproto.float_field(4)
    id: str = betterproto.string_field(5)
    index: int = betterproto.int64_field(6)
...
@dataclass(eq=False, repr=False)
class AssistanceVideoFrame(betterproto.Message):
    meta_field_package_name_ubo_app_dot_store_dot_services_dot_assistant: (
        'str | None'
    ) = betterproto.string_field(1000, optional=True)
    video: 'bytes | None' = betterproto.bytes_field(2, optional=True)
    is_last_frame: bool = betterproto.bool_field(3)
    timestamp: float = betterproto.float_field(4)
    id: str = betterproto.string_field(5)
    index: int = betterproto.int64_field(6)
...
@dataclass(eq=False, repr=False)
class AssistantReportEvent(betterproto.Message):
    meta_field_package_name_ubo_app_dot_store_dot_services_dot_assistant: (
        'str | None'
    ) = betterproto.string_field(1000, optional=True)
    source_id: str = betterproto.string_field(2)
...
class AssistantState(betterproto.Message):
    ...
    selected_llm: 'AssistantLlmName | None' = betterproto.enum_field(3, optional=True)
...
class AcceptableAssistanceFrame(betterproto.Message):
    ...
    assistance_video_frame: 'AssistanceVideoFrame' = betterproto.message_field(
        4, group='acceptable_assistance_frame',
    )
...
@dataclass(eq=False, repr=False)
class DisplayRerenderEvent(betterproto.Message):
    meta_field_package_name_ubo_app_dot_store_dot_services_dot_display: 'str | None' = (
        betterproto.string_field(1000, optional=True)
    )
...
class Action(betterproto.Message):
    ...
    audio_action: 'AudioAction' = betterproto.message_field(7, group='action')
    ...
    camera_action: 'CameraAction' = betterproto.message_field(17, group='action')
    ...
    display_action: 'DisplayAction' = betterproto.message_field(22, group='action')
    ...
    docker_action: 'DockerAction' = betterproto.message_field(25, group='action')
    ...
    docker_image_run_composition_action: 'DockerImageRunCompositionAction' = (
        betterproto.message_field(33, group='action')
    )
    docker_image_run_container_action: 'DockerImageRunContainerAction' = (
        betterproto.message_field(34, group='action')
    )
    ...
    infrared_action: 'InfraredAction' = betterproto.message_field(50, group='action')
    ...
    input_action: 'InputAction' = betterproto.message_field(55, group='action')
    ...
    ip_action: 'IpAction' = betterproto.message_field(60, group='action')
    ...
    keypad_action: 'KeypadAction' = betterproto.message_field(63, group='action')
    ...
    light_dm_action: 'LightDmAction' = betterproto.message_field(66, group='action')
    ...
    light_dm_update_state_action: 'LightDmUpdateStateAction' = (
        betterproto.message_field(68, group='action')
    )
    main_action: 'MainAction' = betterproto.message_field(69, group='action')
    menu_action: 'MenuAction' = betterproto.message_field(70, group='action')
    ...
    power_action: 'PowerAction' = betterproto.message_field(84, group='action')
    power_off_action: 'PowerOffAction' = betterproto.message_field(85, group='action')
    ...
    r_pi_connect_done_downloading_action: 'RPiConnectDoneDownloadingAction' = (
        betterproto.message_field(87, group='action')
    )
    ...
    reboot_action: 'RebootAction' = betterproto.message_field(92, group='action')
    ...
    rgb_ring_action: 'RgbRingAction' = betterproto.message_field(98, group='action')
    ...
    rgb_ring_progress_wheel_step_action: 'RgbRingProgressWheelStepAction' = (
        betterproto.message_field(106, group='action')
    )
    ...
    rgb_ring_waitable_command_action: 'RgbRingWaitableCommandAction' = (
        betterproto.message_field(115, group='action')
    )
    ssh_action: 'SshAction' = betterproto.message_field(116, group='action')
    ssh_clear_enabled_state_action: 'SshClearEnabledStateAction' = (
        betterproto.message_field(117, group='action')
    )
    ssh_update_state_action: 'SshUpdateStateAction' = betterproto.message_field(
        118, group='action',
    )
    sensors_action: 'SensorsAction' = betterproto.message_field(119, group='action')
    ...
    settings_action: 'SettingsAction' = betterproto.message_field(123, group='action')
    ...
    settings_toggle_visual_debug_action: 'SettingsToggleVisualDebugAction' = (
        betterproto.message_field(136, group='action')
    )
    ...
    users_action: 'UsersAction' = betterproto.message_field(155, group='action')
    ...
    vs_code_action: 'VsCodeAction' = betterproto.message_field(160, group='action')
    ...
    wi_fi_action: 'WiFiAction' = betterproto.message_field(165, group='action')
    ...
    wi_fi_set_has_visited_onboarding_action: 'WiFiSetHasVisitedOnboardingAction' = (
        betterproto.message_field(167, group='action')
    )
...
class Event(betterproto.Message):
    ...
    assistant_event: 'AssistantEvent' = betterproto.message_field(2, group='event')
    assistant_report_event: 'AssistantReportEvent' = betterproto.message_field(
        3, group='event',
    )
    audio_event: 'AudioEvent' = betterproto.message_field(4, group='event')
    ...
    camera_event: 'CameraEvent' = betterproto.message_field(11, group='event')
    camera_start_viewfinder_event: 'CameraStartViewfinderEvent' = (
        betterproto.message_field(12, group='event')
    )
    ...
    display_event: 'DisplayEvent' = betterproto.message_field(16, group='event')
    display_render_event: 'DisplayRenderEvent' = betterproto.message_field(
        17, group='event',
    )
    display_rerender_event: 'DisplayRerenderEvent' = betterproto.message_field(
        18, group='event',
    )
    docker_event: 'DockerEvent' = betterproto.message_field(19, group='event')
    ...
    docker_image_fetch_composition_event: 'DockerImageFetchCompositionEvent' = (
        betterproto.message_field(21, group='event')
    )
    ...
    docker_stop_event: 'DockerStopEvent' = betterproto.message_field(34, group='event')
    file_system_copy_event: 'FileSystemCopyEvent' = betterproto.message_field(
        35, group='event',
    )
    file_system_event: 'FileSystemEvent' = betterproto.message_field(36, group='event')
    ...
    infrared_event: 'InfraredEvent' = betterproto.message_field(40, group='event')
    infrared_send_code_event: 'InfraredSendCodeEvent' = betterproto.message_field(
        41, group='event',
    )
    init_event: 'InitEvent' = betterproto.message_field(42, group='event')
    ...
    ip_event: 'IpEvent' = betterproto.message_field(46, group='event')
    main_event: 'MainEvent' = betterproto.message_field(47, group='event')
    ...
    menu_event: 'MenuEvent' = betterproto.message_field(51, group='event')
    menu_go_back_event: 'MenuGoBackEvent' = betterproto.message_field(52, group='event')
    menu_go_home_event: 'MenuGoHomeEvent' = betterproto.message_field(53, group='event')
    menu_scroll_event: 'MenuScrollEvent' = betterproto.message_field(54, group='event')
    ...
    notifications_display_event: 'NotificationsDisplayEvent' = (
        betterproto.message_field(56, group='event')
    )
    ...
    power_event: 'PowerEvent' = betterproto.message_field(59, group='event')
    power_off_event: 'PowerOffEvent' = betterproto.message_field(60, group='event')
    r_pi_connect_event: 'RPiConnectEvent' = betterproto.message_field(61, group='event')
    r_pi_connect_login_event: 'RPiConnectLoginEvent' = betterproto.message_field(
        62, group='event',
    )
    reboot_event: 'RebootEvent' = betterproto.message_field(63, group='event')
    ...
    rgb_ring_event: 'RgbRingEvent' = betterproto.message_field(66, group='event')
    screenshot_event: 'ScreenshotEvent' = betterproto.message_field(67, group='event')
    settings_event: 'SettingsEvent' = betterproto.message_field(68, group='event')
    ...
    settings_start_service_event: 'SettingsStartServiceEvent' = (
        betterproto.message_field(70, group='event')
    )
    settings_stop_service_event: 'SettingsStopServiceEvent' = betterproto.message_field(
        71, group='event',
    )
    snapshot_event: 'SnapshotEvent' = betterproto.message_field(72, group='event')
    ...
    speech_recognition_report_text_event: 'SpeechRecognitionReportTextEvent' = (
        betterproto.message_field(74, group='event')
    )
    ...
    speech_synthesis_synthesize_text_event: 'SpeechSynthesisSynthesizeTextEvent' = (
        betterproto.message_field(76, group='event')
    )
    store_recorded_sequence_event: 'StoreRecordedSequenceEvent' = (
        betterproto.message_field(77, group='event')
    )
    ...
    users_event: 'UsersEvent' = betterproto.message_field(83, group='event')
    users_reset_password_event: 'UsersResetPasswordEvent' = betterproto.message_field(
        84, group='event',
    )
    vs_code_event: 'VsCodeEvent' = betterproto.message_field(85, group='event')
    ...
    web_ui_event: 'WebUiEvent' = betterproto.message_field(88, group='event')
    web_ui_initialize_event: 'WebUiInitializeEvent' = betterproto.message_field(
        89, group='event',
    )
    web_ui_stop_event: 'WebUiStopEvent' = betterproto.message_field(90, group='event')
    wi_fi_event: 'WiFiEvent' = betterproto.message_field(91, group='event')
    wi_fi_input_connection_event: 'WiFiInputConnectionEvent' = (
        betterproto.message_field(92, group='event')
    )
