#ifndef GUARD_33933b99fbea8227fedf6cfb180ea878
#define GUARD_33933b99fbea8227fedf6cfb180ea878
...
namespace UFLLocalFunctions_33933b99fbea8227fedf6cfb180ea878
{

  // UFLLocalFunction
// ----------------

template< class GridPart, class Coeffbndproj, class Coeffddm, class Coeffphidomain, class Coeffsdfprojfull >
  ...
  : public Dune::Fem::BindableGridFunctionWithSpace<GridPart,Dune::Dim<1>>
{
  ...
  typedef std::tuple< Coeffbndproj, Coeffddm, Coeffphidomain, Coeffsdfprojfull > CoefficientTupleType;
  ...
  static constexpr bool gridPartValid = Dune::Fem::checkGridPartValid<GridPartType,Dune::Fem::ConstLocalFunction<Coeffbndproj>>() && Dune::Fem::checkGridPartValid<GridPartType,Dune::Fem::ConstLocalFunction<Coeffddm>>() && Dune::Fem::checkGridPartValid<GridPartType,Dune::Fem::ConstLocalFunction<Coeffphidomain>>() && Dune::Fem::checkGridPartValid<GridPartType,Dune::Fem::ConstLocalFunction<Coeffsdfprojfull>>();
  template< std::size_t i >
  ...
  UFLLocalFunction ( const GridPartType &gridPart, const std::string &name, int order, const Coeffbndproj &coeffbndproj, const Coeffddm &coeffddm, const Coeffphidomain &coeffphidomain, const Coeffsdfprojfull &coeffsdfprojfull, const Dune::Fem::ParameterReader &parameter = Dune::Fem::Parameter::container() )
    : BaseType(gridPart,name,order),
      coefficients_( Dune::Fem::ConstLocalFunction< Coeffbndproj >( coeffbndproj ), Dune::Fem::ConstLocalFunction< Coeffddm >( coeffddm ), Dune::Fem::ConstLocalFunction< Coeffphidomain >( coeffphidomain ), Dune::Fem::ConstLocalFunction< Coeffsdfprojfull >( coeffsdfprojfull ) )
  {}
  ...
  void evaluate ( const Point &x, typename FunctionSpaceType::RangeType &result ) const
  {
    ...
    typename CoefficientFunctionSpaceType< 2 >::RangeType tmp39 = evaluateCoefficient< 2 >( x );
    typename CoefficientFunctionSpaceType< 3 >::RangeType tmp40 = evaluateCoefficient< 3 >( x );
    ...
    typename CoefficientFunctionSpaceType< 2 >::JacobianRangeType tmp53 = jacobianCoefficient< 2 >( x );
  ...
  void jacobian ( const Point &x, typename FunctionSpaceType::JacobianRangeType &result ) const
  {
    ...
    typename CoefficientFunctionSpaceType< 2 >::HessianRangeType tmp60 = hessianCoefficient< 2 >( x );
    const auto tmp61 = ((tmp60[ 0 ])[ 1 ])[ 0 ] * tmp52;
    typename CoefficientFunctionSpaceType< 3 >::JacobianRangeType tmp62 = jacobianCoefficient< 3 >( x );
