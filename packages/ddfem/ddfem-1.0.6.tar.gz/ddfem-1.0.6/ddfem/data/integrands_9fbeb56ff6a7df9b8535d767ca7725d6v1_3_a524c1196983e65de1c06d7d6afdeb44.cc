#ifndef GuardIntegrands_9fbeb56ff6a7df9b8535d767ca7725d6v1_3
#define GuardIntegrands_9fbeb56ff6a7df9b8535d767ca7725d6v1_3
...
namespace Integrands_9fbeb56ff6a7df9b8535d767ca7725d6v1_3
{
  ...
  struct Integrands
  {
    ...
    bool isDirichletIntersection ( const IntersectionType &intersection, DirichletComponentType &dirichletComponent ) const
    {
      ...
      default:
        {
          int domainId;
          auto x = intersection.geometryInInside().center();
          {
              using std::sqrt;
...
PYBIND11_MODULE( integrands_9fbeb56ff6a7df9b8535d767ca7725d6v1_3_a524c1196983e65de1c06d7d6afdeb44, module )
{
  ...
  typedef Integrands_9fbeb56ff6a7df9b8535d767ca7725d6v1_3::Integrands< GridPart > Integrands;
  if constexpr( Integrands::gridPartValid )
  {
      auto cls = Dune::Python::insertClass<Integrands>(module,"Integrands",Dune::Python::GenerateTypeName("Integrands_9fbeb56ff6a7df9b8535d767ca7725d6v1_3::Integrands< GridPart >"), Dune::Python::IncludeFiles({"python/dune/generated/integrands_9fbeb56ff6a7df9b8535d767ca7725d6v1_3_a524c1196983e65de1c06d7d6afdeb44.cc"})).first;
...
#endif // GuardIntegrands_9fbeb56ff6a7df9b8535d767ca7725d6v1_3
