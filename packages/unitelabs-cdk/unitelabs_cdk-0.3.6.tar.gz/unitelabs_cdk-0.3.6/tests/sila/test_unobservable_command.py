...
@pytest.fixture
def handler():
    return UnobservableCommand(identifier="UnobservableCommand", name="Unobservable Command", errors=[DefinedError])


class TestExecute:
    # Execute synchronous function with default parameters.
    async def test_execute_synchronous_default_parameters(self, feature: Feature, handler: UnobservableCommand):
    ...
    async def test_execute_synchronous_custom_parameters(self, feature: Feature, handler: UnobservableCommand):
        # Initialize the unobservable command
        callback = unittest.mock.Mock()
    ...
    async def test_execute_synchronous_returns_none(self, feature: Feature, handler: UnobservableCommand):
        # Initialize the unobservable command
        callback = unittest.mock.Mock()
    ...
    async def test_raises_when_synchronous_raises(self, feature: Feature, handler: UnobservableCommand):
        # Initialize the unobservable command
        def function():
            msg = "Hello, World!"
            raise Exception(msg)
    ...
    async def test_raises_when_synchronous_raises_known_error(self, feature: Feature, handler: UnobservableCommand):
        # Initialize the unobservable command
        def function():
            msg = "Hello, World!"
    ...
    async def test_execute_asynchronous_default_parameters(self, feature: Feature, handler: UnobservableCommand):
        # Initialize the unobservable command
    ...
    async def test_execute_asynchronous_custom_parameters(self, feature: Feature, handler: UnobservableCommand):
        # Initialize the unobservable command
        callback = unittest.mock.AsyncMock()
    ...
    async def test_execute_asynchronous_returns_none(self, feature: Feature, handler: UnobservableCommand):
        # Initialize the unobservable command
        callback = unittest.mock.AsyncMock()
    ...
    async def test_raises_when_asynchronous_raises(self, feature: Feature, handler: UnobservableCommand):
        # Initialize the unobservable command
        async def function():
            msg = "Hello, World!"
            raise Exception(msg)
    ...
    async def test_raises_when_asynchronous_raises_known_error(self, feature: Feature, handler: UnobservableCommand):
        # Initialize the unobservable command
        async def function():
            msg = "Hello, World!"
            raise DefinedError(msg)
