...
from unitelabs.cdk import Connector, compose_app
    ...
    app = Connector(
        {
            "sila_server": {
                ...
                "version": "0.1",
                "description": (
                    "This server aims to implement all features required for the SiLA Interoperability Test Suite"
                ),
...
async def main():
    try:
        app = await compose_app(app_factory)
        await app.start()
