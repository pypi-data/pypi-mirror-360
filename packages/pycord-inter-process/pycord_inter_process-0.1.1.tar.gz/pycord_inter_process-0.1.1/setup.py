...
project_urls = {
    "Issue Tracker": "https://github.com/ParrotXray/pycord-ipc",
    "Source": "https://github.com/ParrotXray/pycord-ipc",
}

_version_regex = r"^__version__ = ['\"]([^'\"]*)['\"]$"

init_file = Path("pycord/ipc/__init__.py")
if init_file.exists():
...
if readme_file.exists():
    ...
    long_description = "A pycord extension for inter-process communication."
...
setuptools.setup(
    ...
    url="https://github.com/ParrotXray/pycord-ipc",
