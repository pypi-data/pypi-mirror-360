...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.25";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2025-07-08T19:09:56.620044";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2025-07-08T19:09:56.620066";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "1bc3e998cb";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2025-07-08T19:09:30Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(1bc3e998cb29a2ccb7635a5c74c875bf0c3b6432 Increment version to 5.0.25)LGVG_RSLD";
  return str;
}
...
ab05c24535110f8be5780a852597152fea7b6689 /VERSION.txt
