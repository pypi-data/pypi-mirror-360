...
class ErrorInternalServerError(object):
    ...
    @property
    def message(self):
        """Gets the message of this ErrorInternalServerError.  # noqa: E501


        :return: The message of this ErrorInternalServerError.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this ErrorInternalServerError.


        :param message: The message of this ErrorInternalServerError.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ErrorInternalServerError, dict):
