  ...
  deploy:
    ...
    - name: Deploy with devops-ai
      ...
      run: |
        ...
        ENV_VARS_STRING="{% for key, value in env_vars.items() %}{{ key }}=${% raw %}{{ key }}{% endraw %}{% if not loop.last %},{% endif %}{% endfor %}"
        {% endif %}
