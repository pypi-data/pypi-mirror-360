...
class AxOptimizer:
    ...
    def run_optimization(
        ...
        best_trial_idx = 0
        trial_times = []
        best_trial_models = None  # Store models from best trial
        ...
        for i in range(self.config.AE_NUM_TRIALS):
            ...
            try:
                ...
                # Determine if this is the best trial so far
                is_best_trial = current_recall > best_recall
                if is_best_trial:
                    best_recall = current_recall
                    best_trial_idx = i
                    best_trial_models = trial_models  # Store the models from best trial
        ...
        # Mark only the final best trial as 'is_best' and clear others
...
class AEModelTuner:
    ...
    def _calculate_final_feature_importance(
        ...
        try:
            # Use models from best trial if available, otherwise retrain
