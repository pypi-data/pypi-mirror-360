...
class ParseCase(ParseBase):
    ...
    def _parse_variables(self):
        ...
        # case_variables优先级高于feature_variables
        self.variables.update(case_variables)
        # 单个参数化用例的variables高于case_variables
        single_variables = self.case_data.get('variables') or {}
        self.traversal_assignments(single_variables)
        self.variables.update(single_variables)
