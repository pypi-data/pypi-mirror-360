...
class NewsletterBlock(StructBlock):
    ...
    titulo = CharBlock(label="Título", default="ASSINE NOSSA NEWSLETTER", required=False)
    texto = RichTextBlock(label="Texto", default="Fique por dentro das novidades e eventos da Semana de Inovação.", required=False)
    imagem = ImageChooserBlock(label="Imagem", required=False)
