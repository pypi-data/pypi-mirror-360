...
class SecurityIssueInsert(BaseModel):
    ...
    vuln_unique_id: Optional[List[str]] = Field(default_factory=list, description="关联的漏洞ID列表")
    component_unique_id: Optional[List[str]] = Field(default_factory=list, description="关联的组件ID列表")
