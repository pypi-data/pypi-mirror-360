...
from nsj_integracao_api_entidades.dto.persona_horariosespeciais import HorariosespeciaiDTO
from nsj_integracao_api_entidades.entity.persona_horariosespeciais import HorariosespeciaiEntity
...
class HorarioDTO(DTOBase):
    ...
    # Atributos de lista
    horariosespeciais: list = DTOListField(
      dto_type=HorariosespeciaiDTO,
      entity_type=HorariosespeciaiEntity,
      related_entity_field='horario',
    )
