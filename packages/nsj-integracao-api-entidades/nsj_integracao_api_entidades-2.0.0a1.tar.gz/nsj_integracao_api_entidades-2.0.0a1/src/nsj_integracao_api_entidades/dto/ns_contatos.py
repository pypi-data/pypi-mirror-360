...
from nsj_integracao_api_entidades.dto.ns_contatosemails import ContatosemailDTO
from nsj_integracao_api_entidades.entity.ns_contatosemails import ContatosemailEntity
...
class ContatoDTO(DTOBase):
    ...
    # Atributos de lista
    contatosemails: list = DTOListField(
      dto_type=ContatosemailDTO,
      entity_type=ContatosemailEntity,
