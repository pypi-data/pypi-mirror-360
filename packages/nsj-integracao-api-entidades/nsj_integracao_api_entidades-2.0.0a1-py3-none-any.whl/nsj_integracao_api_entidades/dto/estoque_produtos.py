...
from nsj_integracao_api_entidades.dto.estoque_produtosconvunidades import ProdutosconvunidadeDTO
from nsj_integracao_api_entidades.entity.estoque_produtosconvunidades import ProdutosconvunidadeEntity

from nsj_integracao_api_entidades.dto.pedidos_produtos_faixas_precos_vigencias import ProdutoFaixaPrecoVigenciaDTO
from nsj_integracao_api_entidades.entity.pedidos_produtos_faixas_precos_vigencias import ProdutoFaixaPrecoVigenciaEntity

from nsj_integracao_api_entidades.dto.pedidos_produtos_faixas_comissoes import ProdutoFaixaComissoDTO
from nsj_integracao_api_entidades.entity.pedidos_produtos_faixas_comissoes import ProdutoFaixaComissoEntity

from nsj_integracao_api_entidades.dto.estoque_itens import ItenDTO
from nsj_integracao_api_entidades.entity.estoque_itens import ItenEntity
...
class ProdutoDTO(DTOBase):
    ...
    classificacaofragilidade: uuid.UUID = DTOField(
      ...
      validator=DTOFieldValidators().validate_uuid,)
    # Atributos de lista
    produtosconvunidades: list = DTOListField(
      dto_type=ProdutosconvunidadeDTO,
      entity_type=ProdutosconvunidadeEntity,
      related_entity_field='produto',
    )
    produtos_faixas_precos_vigencias: list = DTOListField(
      dto_type=ProdutoFaixaPrecoVigenciaDTO,
      entity_type=ProdutoFaixaPrecoVigenciaEntity,
      related_entity_field='produto',
    )
    produtos_faixas_comissoes: list = DTOListField(
      dto_type=ProdutoFaixaComissoDTO,
      entity_type=ProdutoFaixaComissoEntity,
      related_entity_field='produto',
    )
    itens: list = DTOListField(
      dto_type=ItenDTO,
      entity_type=ItenEntity,
      related_entity_field='produto',
    )
