...
from nsj_integracao_api_entidades.dto.persona_dependentestrabalhadores import DependentestrabalhadoreDTO
from nsj_integracao_api_entidades.entity.persona_dependentestrabalhadores import DependentestrabalhadoreEntity
...
class TrabalhadoreDTO(DTOBase):
    ...
    dependentestrabalhadores: list = DTOListField(
      dto_type=DependentestrabalhadoreDTO,
      entity_type=DependentestrabalhadoreEntity,
      related_entity_field='trabalhador',
    )