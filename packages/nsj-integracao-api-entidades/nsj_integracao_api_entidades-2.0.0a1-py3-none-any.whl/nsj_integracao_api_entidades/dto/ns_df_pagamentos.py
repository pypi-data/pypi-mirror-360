...
from nsj_integracao_api_entidades.dto.ns_df_parcelas import DfParcelaDTO
from nsj_integracao_api_entidades.entity.ns_df_parcelas import DfParcelaEntity
...
class DfPagamentoDTO(DTOBase):
    ...
    # Atributos de lista
    df_parcelas: list = DTOListField(
      dto_type=DfParcelaDTO,
      entity_type=DfParcelaEntity,
      related_entity_field='id_pagamento',
    )
