...
from nsj_integracao_api_entidades.dto.ns_df_linhas_impostos import DfLinhaImpostoDTO
from nsj_integracao_api_entidades.entity.ns_df_linhas_impostos import DfLinhaImpostoEntity
...
class DfLinhaDTO(DTOBase):
    ...
    # Atributos de lista
    df_linhas_impostos: list = DTOListField(
      dto_type=DfLinhaImpostoDTO,
      entity_type=DfLinhaImpostoEntity,
      related_entity_field='df_linha',
    )
