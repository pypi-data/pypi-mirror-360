...
class GeminiLLM:
    def __init__(self):
        ...
        if not api_key:
            ...
            print("\n🔧 Quick setup:")
            print("   • Run: bashbuddy setup")
            print("\n🔗 More info: https://github.com/Atharvadethe/BashBuddy")
            print("="*60)
            raise EnvironmentError("GEMINI_API_KEY environment variable not set. Please run 'bashbuddy setup' or follow the instructions above.")
    ...
    def _initialize_model(self):
        ...
        print("5. Run 'bashbuddy setup' to reconfigure")
        print("="*60)
