...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "bb=bashbuddy.main:app",
        ],
    },
    keywords="ai, shell, cli, gemini, assistant, automation",
    project_urls={
        "Bug Reports": "https://github.com/Atharvadethe/bashbuddy/issues",
        "Source": "https://github.com/Atharvadethe/bashbuddy",
        "Documentation": "https://github.com/Atharvadethe/bashbuddy#readme",
    },
) 