...
from sparkfly.api_response import ApiResponse, T as ApiResponseT
import sparkfly.models
from sparkfly import rest
from sparkfly.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.1.10/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sparkfly.models, klass)
