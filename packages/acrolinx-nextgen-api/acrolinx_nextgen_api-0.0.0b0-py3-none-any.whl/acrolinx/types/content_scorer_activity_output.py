...
class ContentScorerActivityOutput(UniversalBaseModel):
    ...
    feedback: typing.Optional[ContentQualityFeedback] = None
    suggestions: typing.Optional[typing.List[ContentSuggestions]] = None
