...
# ✅ Cambia la ruta a la nueva carpeta cloudscrapersafe
with open(os.path.join(os.path.dirname(__file__), 'cloudscrapersafe', '__init__.py')) as fp:
...
setup(
    ...
    packages=[
        'cloudscrapersafe', 
        'cloudscrapersafe.captcha', 
        'cloudscrapersafe.interpreters', 
        'cloudscrapersafe.user_agent'
    ],  
    py_modules=[],
    python_requires='>=3.8',
