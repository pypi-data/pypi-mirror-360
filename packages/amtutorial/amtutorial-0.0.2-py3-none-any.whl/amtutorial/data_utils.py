...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/lib/01_data_utils.qmd.

# %% auto 0
__all__ = ['APP_NAME', 'DATA_DIR', 'MNIST_DIR', 'POKEMON_DIR', 'MODEL_DIR', 'cli_download_pokemon_sprites',
           'cli_process_pokemon_sprites', 'cli_datafy_pokemon_sprites', 'get_cache_dir', 'prepare_bipolar_mnist',
           'load_bipolar_mnist', 'download_pokemon_sprites', 'process_pokemon_sprites', 'binarize_image',
           'floyd_steinberg_dither', 'get_sprite_bbox', 'scale_to_fit', 'datafy_pokemon_sprites',
           'load_bipolar_pokemon_sprites']

# %% ../nbs/lib/01_data_utils.qmd 3
import os
import pathlib
