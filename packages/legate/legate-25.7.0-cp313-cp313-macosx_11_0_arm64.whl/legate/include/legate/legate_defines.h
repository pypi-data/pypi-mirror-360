...
/* #undef LEGATE_USE_NETWORK */

/* #undef LEGATE_USE_OPENMP */

/* #undef LEGATE_USE_CAL */

/* #undef LEGATE_USE_HDF5 */

/* #undef LEGATE_USE_HDF5_VFD_GDS */

/* #undef LEGATE_USE_NCCL */

#define LEGATE_SHARED_LIBRARY_SUFFIX ".dylib"
