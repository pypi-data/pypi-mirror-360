...
class FeeEstimationData(BaseModel):
    """
    FeeEstimationData
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeeEstimationData:
        """Create an instance of FeeEstimationData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeeEstimationData:
        """Create an instance of FeeEstimationData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeeEstimationData.parse_obj(obj)
        ...
        _obj = FeeEstimationData.parse_obj({
