...
class CreateEventMonitorRequest(BaseModel):
    """
    ...
    event_signature: StrictStr = Field(..., alias="eventSignature", description="The specific event to which you want to subscribeven. Please ensure no spaces are included.")
    ...
    __properties = ["blockchain", "contractAddress", "eventSignature", "idempotencyKey"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateEventMonitorRequest:
        """Create an instance of CreateEventMonitorRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateEventMonitorRequest:
        """Create an instance of CreateEventMonitorRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateEventMonitorRequest.parse_obj(obj)
        ...
        _obj = CreateEventMonitorRequest.parse_obj({
