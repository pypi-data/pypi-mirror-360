...
from circle.web3.smart_contract_platform.models.event_logs import EventLogs  # noqa: E501
...
class TestEventLogs(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = circle.web3.smart_contract_platform.models.event_logs.EventLogs()  # noqa: E501
        if include_optional :
            return EventLogs(
                data = circle.web3.smart_contract_platform.models.event_logs_data.EventLogs_data(
