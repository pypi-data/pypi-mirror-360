...
class ImageDataset(Dataset):
    ...
    def image_sizes(self, directory, files, logger): 
        """
        ...
        logger.info(f"Average height: {avg_height:.2f}")
    ...
    def analyze(self, similarity_index=["SSIM","LPIPS"], verbose=False, log_dir=None):
        ...
        self.image_sizes(self.img_dir, self.image_files, self.logger)
