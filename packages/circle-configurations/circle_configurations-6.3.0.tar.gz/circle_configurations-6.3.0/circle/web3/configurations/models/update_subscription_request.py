...
class UpdateSubscriptionRequest(BaseModel):
    ...
    """
    name: StrictStr = Field(..., description="Name of the subscription.")
    enabled: StrictBool = Field(..., description="Whether the subscription is enabled. `true` indicates the subscription is active.")
    __properties = ["name", "enabled"]
