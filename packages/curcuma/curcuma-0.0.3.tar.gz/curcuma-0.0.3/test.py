...
BANNER_TEXT = (
    "Elastic On Azure - Shared Observability - Hub 01"
...
try:
    # # elastic.Space(hub).list()
    # # elastic.Role(hub).list()
    # curcuma.load_plugins()
    # print("test")
    # obs.space.list()
...
except elcebo.CurcumaException as e:
    print(f"Error: {e}")
