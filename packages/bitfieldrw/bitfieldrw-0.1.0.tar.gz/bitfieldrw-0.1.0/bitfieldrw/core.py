...
class BitFieldType:
    ...
    def __class_getitem__(cls, bit_length: int):
...
def bitfield(cls):
    ...
    # Add type hints for dynamically added methods
    if hasattr(cls, "__annotations__"):
        cls.__annotations__["to_bytes"] = 'Callable[[Literal["big", "little"]], bytes]'
        cls.__annotations__["from_bytes"] = (
            'Callable[[bytes, Literal["big", "little"]], object]'
        )
        cls.__annotations__["to_int"] = "Callable[[], int]"
        cls.__annotations__["from_int"] = "Callable[[int], object]"
        cls.__annotations__["get_bit_length"] = "Callable[[], int]"
        cls.__annotations__["get_byte_length"] = "Callable[[], int]"
