...
import sys
import os
from therix.entities.models import Pipeline, PipelineConfiguration, ChatHistory


# Get the path to the directory of env.py
basedir = os.path.abspath(os.path.dirname(__file__))

# Calculate the path to the directory just above `therix`
...
url = URL.create(
    drivername=f"{os.getenv("THERIX_DB_TYPE", "postgresql")}+psycopg2",
    ...
    database=os.getenv("THERIX_DB_NAME"),
