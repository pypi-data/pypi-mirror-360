...
class fc_theta_epsi(Fun):
    def __init__(self, fck: float, aggregates: Aggregates = Aggregates.SILICEOUS, theta: float = 20):
        super().__init__()
        self.__theta = theta
...
class fs_theta_epsi(Fun):
    def __init__(self, fyk: float, Es: float, formed: SteelShapingType = SteelShapingType.HOT_ROLLED,
                 theta: float = 20):
        super().__init__()
        self.__theta = theta
