...
parser.add_argument('--bind', '-b', help=f"bind address and port (default: {DEFAULT_ADDR}:{DEFAULT_PORT})", default=f"{DEFAULT_ADDR}:{DEFAULT_PORT}")
...
def main():
    ...
    if args.version:
        print(f"simple-flask-server {simple_flask_server.__version__}")
        sys.exit()
