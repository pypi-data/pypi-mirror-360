...
class Encounter(BaseResource):
    ...
    hospitalization: Optional[Dict[str, Any]] = Field(
        default=None,
    ...
    def update_status(
        self, new_status: EncounterStatus, timestamp: Optional[datetime] = None
    ) -> None:
        """
    ...
    def get_duration(self, as_of_time: Optional[datetime] = None) -> Optional[float]:
        """
    ...
    def add_diagnosis(
        self, condition_id: str, diagnosis_role: str = "AD", rank: Optional[int] = None
    ) -> None:
        """
