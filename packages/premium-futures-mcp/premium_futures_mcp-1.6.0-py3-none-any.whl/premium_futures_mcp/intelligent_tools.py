...
def get_intelligent_market_tools():
    ...
    return [
        Tool(
            ...
            description="""Get top trading opportunities based on comprehensive 10-factor scoring system:
            ...
            9. Long/Short sentiment (0-4 points)
            10. Basis analysis (0-5 points) - Contango/Backwardation patterns
            
            Total: 0-55 points with direction recommendations (LONG/SHORT/WATCH)
            
            Basis Analysis provides insights into:
            - Extreme contango: Overheated longs → SHORT signals
            - Extreme backwardation: Fear/forced selling → LONG signals
            - Arbitrage opportunities when combined with funding extremes""",
            inputSchema={
                "type": "object",
                "properties": {
                    "limit": {
                    ...
                    "min_score": {
                        "type": "number",
                        "description": "Minimum opportunity score (0-55, default: 27)",
                        "minimum": 0,
                        "maximum": 55,
                        "default": 27
                    },
