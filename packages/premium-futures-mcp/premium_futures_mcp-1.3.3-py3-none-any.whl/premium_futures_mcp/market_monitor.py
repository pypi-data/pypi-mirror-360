...
class MarketMonitor:
    ...
    def __init__(self, testnet: bool = False):
        ...
        self.update_interval = 180  # 3 minutes (reduced for faster crypto market monitoring)
        self.running = False
        ...
        async with self.public_client:
            ...
            while self.running:
                try:
                    ...
                    next_scan_minutes = self.update_interval // 60
                    next_scan_seconds = self.update_interval % 60
                    self.logger.info(f"Next scan in {next_scan_minutes}m {next_scan_seconds}s")
