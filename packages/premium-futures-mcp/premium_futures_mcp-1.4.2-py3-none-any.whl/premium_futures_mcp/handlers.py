        ...
        try:
            if name == "get_market_opportunities":
                ...
                if not opportunities:
                    return {
                        "error": "No market opportunities data available",
                        "suggestion": "Market scanner may be starting up or JSON files not updated yet",
                        "data_source": "json_file_unavailable"
                    }
                ...
                # Data source is always JSON file
                ...
                if not opportunities:
                    return {
                        "error": "No funding extremes data available",
                        "suggestion": "Market scanner may be starting up or JSON files not updated yet",
                        "data_source": "json_file_unavailable"
                    }
                ...
                if not opportunities:
                    return {
                        "error": "No volume leaders data available",
                        "suggestion": "Market scanner may be starting up or JSON files not updated yet",
                        "data_source": "json_file_unavailable"
                    }
                ...
                if not opportunities:
                    return {
                        "error": "No volatility squeeze data available",
                        "suggestion": "Market scanner may be starting up or JSON files not updated yet",
                        "data_source": "json_file_unavailable"
                    }
                ...
                if not opportunities:
                    return {
                        "error": "No whale activity data available",
                        "suggestion": "Market scanner may be starting up or JSON files not updated yet",
                        "data_source": "json_file_unavailable"
                    }
                ...
                if not opportunities:
                    return {
                        "error": "No narrative plays data available",
                        "suggestion": "Market scanner may be starting up or JSON files not updated yet",
                        "data_source": "json_file_unavailable"
                    }
                ...
                if not opportunities:
                    return {
                        "error": "No quick scan data available",
                        "suggestion": "Market scanner may be starting up or JSON files not updated yet",
                        "data_source": "json_file_unavailable"
                    }
