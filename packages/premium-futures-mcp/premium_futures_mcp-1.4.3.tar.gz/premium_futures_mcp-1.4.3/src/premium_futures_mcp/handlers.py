...
class ToolHandler:
    ...
    async def _setup_redis_connection(self):
        ...
        try:
            ...
            redis_urls = [
                "redis://:ilikeMyself1100@localhost:6380",
                "redis://:ilikeMyself1100@premium-redis:6379",  # Docker network (internal port 6379)
        ...
        async with BinanceClient(self.config) as client:
            ...
            # Market Intelligence Tools - Initialize service if needed
                ...
                if not self.market_intelligence:
                    self.market_intelligence = MarketIntelligenceService(None, None)
