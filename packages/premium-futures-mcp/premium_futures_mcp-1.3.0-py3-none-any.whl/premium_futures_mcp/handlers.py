        ...
        try:
            if name == "get_market_opportunities":
                ...
                try:
                    ...
                    self.logger.warning(f"Failed to get cached opportunities: {e}")
                ...
                if not opportunities:
                    from .fallback_data import get_fallback_opportunities
                    opportunities = get_fallback_opportunities()
                    self.logger.info("Using fallback data - Redis may not be available")
                ...
                try:
                    ...
                    if len(opportunities) == len(fallback_data):
                        # Simple check if opportunities came from fallback
                        is_fallback = True
                except Exception:
                    pass
