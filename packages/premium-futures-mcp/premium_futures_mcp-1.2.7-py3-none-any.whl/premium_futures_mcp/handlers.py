        ...
        try:
            if name == "get_market_opportunities":
                ...
                return {
                    ...
                    "processing_mode": "vps_direct_redis",
                ...
                # Get cached opportunities to find the symbol
                opportunities = await self.market_intelligence.get_cached_opportunities()
                ...
                long_squeezes = [opp for opp in funding_extremes if opp['direction'] == 'LONG']
                short_squeezes = [opp for opp in funding_extremes if opp['direction'] == 'SHORT']
                ...
                return {
                    ...
                    "squeeze_analysis": {
                        ...
                        "top_long_squeeze": long_squeezes[0]['symbol'] if long_squeezes else None,
                        "top_short_squeeze": short_squeezes[0]['symbol'] if short_squeezes else None,
                        "trading_signals": {
