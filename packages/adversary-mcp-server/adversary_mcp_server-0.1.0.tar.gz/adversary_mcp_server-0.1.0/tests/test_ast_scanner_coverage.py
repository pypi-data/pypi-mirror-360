...
from adversary_mcp_server.threat_engine import ThreatEngine, Language
...
class TestASTScannerErrorHandling:
    ...
    def test_detect_language_case_insensitive(self):
        ...
        for ext, expected in [('.PY', Language.PYTHON), ('.JS', Language.JAVASCRIPT), ('.TS', Language.TYPESCRIPT)]:
