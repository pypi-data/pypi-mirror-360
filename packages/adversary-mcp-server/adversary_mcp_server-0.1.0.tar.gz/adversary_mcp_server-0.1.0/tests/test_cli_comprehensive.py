...
from adversary_mcp_server.cli import cli, _display_scan_results, _save_results_to_file
...
class TestCLICommandsCoverage:
    ...
    @patch('adversary_mcp_server.cli.CredentialManager')
    @patch('adversary_mcp_server.cli.console')
    def test_configure_command_with_existing_config(self, mock_console, mock_cred_manager):
    ...
    @patch('adversary_mcp_server.cli.console')
    def test_status_command_configured(self, mock_console, mock_threat_engine, mock_cred_manager):
    ...
    @patch('adversary_mcp_server.cli.ThreatEngine')
    @patch('adversary_mcp_server.cli.console')
    def test_status_command_not_configured(self, mock_console, mock_threat_engine, mock_cred_manager):
...
class TestCLIScanCommand:
    ...
    @patch('adversary_mcp_server.cli.console')
    def test_scan_file_basic(self, mock_console, mock_exploit_gen, mock_scanner, mock_threat_engine, mock_cred_manager):
    ...
    @patch('adversary_mcp_server.cli.ExploitGenerator')
    @patch('adversary_mcp_server.cli.console')
    def test_scan_directory_basic(self, mock_console, mock_exploit_gen, mock_scanner, mock_threat_engine, mock_cred_manager):
    ...
    @patch('adversary_mcp_server.cli.ExploitGenerator')
    @patch('adversary_mcp_server.cli.console')
    def test_scan_with_exploits(self, mock_console, mock_exploit_gen, mock_scanner, mock_threat_engine, mock_cred_manager):
    ...
    def test_scan_with_output_file(self, mock_save_results, mock_console, mock_exploit_gen, mock_scanner, mock_threat_engine, mock_cred_manager):
    ...
    @patch('adversary_mcp_server.cli.ASTScanner')
    @patch('adversary_mcp_server.cli.console')
    def test_scan_command_with_mocked_error(self, mock_console, mock_scanner, mock_threat_engine, mock_cred_manager):
