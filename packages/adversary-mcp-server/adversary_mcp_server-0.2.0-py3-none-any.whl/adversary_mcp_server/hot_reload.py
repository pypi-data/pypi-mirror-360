...
class HotReloadService:
    ...
    def __init__(self, threat_engine: ThreatEngine, watch_directories: Optional[List[Path]] = None):
    ...
    def start(self) -> None:
        ...
        print(f"🔄 Hot-reload service started, watching {len(self.watch_directories)} directories")
...
def create_hot_reload_service(threat_engine: ThreatEngine, custom_dirs: Optional[List[Path]] = None) -> HotReloadService:
