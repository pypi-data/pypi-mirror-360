    ...
    def _get_function_name(self, callee: Any) -> Optional[str]:
        ...
        if callee_type == "Identifier":
            ...
            if obj and prop:
                ...
                prop_name = getattr(prop, 'name', None) if getattr(prop, 'type', None) == "Identifier" else None
...
class ASTScanner:
    ...
    def scan_file(self, file_path: Path, language: Optional[LangEnum] = None) -> List[ThreatMatch]:
    ...
    def scan_code(self, source_code: str, file_path: str, language: LangEnum) -> List[ThreatMatch]:
    ...
    def scan_directory(self, directory: Path, recursive: bool = True) -> List[ThreatMatch]:
    ...
    def _apply_rule(self, rule: ThreatRule, context: CodeContext, analysis: Dict[str, Any]) -> List[ThreatMatch]:
    ...
    def _check_condition(self, condition: MatchCondition, context: CodeContext, analysis: Dict[str, Any]) -> List[tuple]:
