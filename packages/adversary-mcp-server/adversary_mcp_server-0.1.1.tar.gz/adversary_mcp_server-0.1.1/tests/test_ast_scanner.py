...
from adversary_mcp_server.ast_scanner import ASTScanner, CodeContext, PythonAnalyzer, JavaScriptAnalyzer
...
def safe_function():
    return "Hello, World!"
        ...
        assert len(threats) == 0 or all(threat.severity.value in ["low", "medium"] for threat in threats)
