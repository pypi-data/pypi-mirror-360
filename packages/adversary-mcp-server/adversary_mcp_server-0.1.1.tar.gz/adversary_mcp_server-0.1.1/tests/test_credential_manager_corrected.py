...
from adversary_mcp_server.credential_manager import (
    SecurityConfig, CredentialManager, CredentialError, CredentialNotFoundError,
    CredentialStorageError, CredentialDecryptionError
)
...
class TestCredentialManagerCorrected:
    ...
    def test_config_with_none_values(self):
        ...
        config = SecurityConfig(
            openai_api_key=None,  # This should work
