...
class Thickness(_message.Message):
    ...
    class TimeDependentPropertiesTable(_message.Message):
        __slots__ = ("rows",)
        ROWS_FIELD_NUMBER: _ClassVar[int]
        rows: _containers.RepeatedCompositeFieldContainer[Thickness.TimeDependentPropertiesTableRow]
        def __init__(self, rows: _Optional[_Iterable[_Union[Thickness.TimeDependentPropertiesTableRow, _Mapping]]] = ...) -> None: ...
    class TimeDependentPropertiesTableRow(_message.Message):
        ...
        value: str
        unit: str
        children: _containers.RepeatedCompositeFieldContainer[Thickness.TimeDependentPropertiesTableRow]
        def __init__(self, key: _Optional[str] = ..., description: _Optional[str] = ..., symbol: _Optional[str] = ..., value: _Optional[str] = ..., unit: _Optional[str] = ..., children: _Optional[_Iterable[_Union[Thickness.TimeDependentPropertiesTableRow, _Mapping]]] = ...) -> None: ...
    NO_FIELD_NUMBER: _ClassVar[int]
