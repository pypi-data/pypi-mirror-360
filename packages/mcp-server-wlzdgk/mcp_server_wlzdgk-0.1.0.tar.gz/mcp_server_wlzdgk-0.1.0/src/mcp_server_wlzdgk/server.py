        ...
        return [
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "required": ["mac","ip","switchId","switchName","portName","vlanName","tmnType"]
                },
            ),
            Tool(
                name=WlzdgkTools.UNBIND_WLZDGK.value,
                description="对指定终端的网络进行阻断",
                inputSchema={
                    "type": "object",
                    "properties": {
                         "mac": {
        ...
        try:
            match name:
                ...
                case WlzdgkTools.BIND_WLZDGK.value:
                    if not all(k in arguments for k in ["mac","ip","switchId","switchName","portName","vlanName","tmnType"]):
                        raise ValueError("Missing required arguments")
                    result = wlzdgk_server.update_bind(arguments["mac"], arguments["ip"], arguments["switchId"], 
                                                                         arguments["switchName"], arguments["portName"], arguments["vlanName"], arguments["tmnType"],)
