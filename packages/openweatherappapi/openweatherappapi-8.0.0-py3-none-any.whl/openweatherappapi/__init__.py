...
class weatherApp:
    ...
    def run(self, api_key):
        ...
        def getweather():
            ...
            try:
                ...
                for i in range(5):
                    ...
                    self.img = Image.open(f"{file}\{self.icon_code}@2x.png")
        ...
        self.image_icon=PhotoImage(file=f"{file}\logo.png")
        root.iconphoto(False,self.image_icon)
        self.round_box=PhotoImage(file=f"{file}\Rounded Rectangle 1.png")
        ...
        self.Search_image = PhotoImage(file=f"{file}\Rounded Rectangle 3.png")

        self.myimage = Label(root, image=self.Search_image, bg="#202731")

        self.myimage.place(x=270, y=122)

        self.weather_image = PhotoImage(file=f"{file}\Layer 7.png")
        ...
        self.Search_icon = PhotoImage(file=f"{file}\Layer 6.png")
        # on click bg
        ...
        #boxes
        self.firstbox = PhotoImage(file=f"{file}\Rounded Rectangle 2.png")

        self.secondbox = PhotoImage(file=f"{file}\Rounded Rectangle 2 copy.png")
        self.secondbox = PhotoImage(file=f"{file}\Rounded Rectangle 2 copy.png")
