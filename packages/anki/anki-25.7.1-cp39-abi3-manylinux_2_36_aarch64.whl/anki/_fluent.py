...
taking to study each card. '''
    ...
    def deck_config_slow_suffix(self, text: str) -> str:
        r''' {$text} (slow) '''
        return self._translate(11, 192, {"text": text})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 223, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 224, {"decks": decks})
...
(compared to {$previousDR}% desired retention) '''
        return self._translate(11, 233, {"factor": factor, "previousDR": previous_dr})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 180)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 181)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP_2 = (11, 182)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 183)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP = (11, 184)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_2 = (11, 185)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_3 = (11, 186)
    DECK_CONFIG_SHARED_PRESET = (11, 187)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 188)
    DECK_CONFIG_SHOW_REMINDER = (11, 189)
    DECK_CONFIG_SIMULATE = (11, 190)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 191)
    DECK_CONFIG_SLOW_SUFFIX = (11, 192)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 193)
    DECK_CONFIG_SMOOTH_GRAPH = (11, 194)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 195)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 196)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 197)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 198)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 199)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 200)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 201)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 202)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 203)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 204)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 205)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 206)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 207)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_ASCENDING = (11, 208)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_DESCENDING = (11, 209)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 210)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 211)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 212)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 213)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 214)
    DECK_CONFIG_SUSPEND_LEECHES = (11, 215)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 216)
    DECK_CONFIG_TIME_TO_OPTIMIZE = (11, 217)
    DECK_CONFIG_TIMER_TITLE = (11, 218)
    DECK_CONFIG_TITLE = (11, 219)
    DECK_CONFIG_TODAY_ONLY = (11, 220)
    DECK_CONFIG_TOO_SHORT_MAXIMUM_INTERVAL = (11, 221)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 222)
    DECK_CONFIG_UPDATING_CARDS = (11, 223)
    DECK_CONFIG_USED_BY_DECKS = (11, 224)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 225)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 226)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP_2 = (11, 227)
    DECK_CONFIG_WEIGHTS = (11, 228)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 229)
    DECK_CONFIG_WEIGHTS_TOOLTIP2 = (11, 230)
    DECK_CONFIG_WHICH_DECK = (11, 231)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 232)
    DECK_CONFIG_WORKLOAD_FACTOR_CHANGE = (11, 233)
    DECK_CONFIG_WORKLOAD_FACTOR_UNCHANGED = (11, 234)
