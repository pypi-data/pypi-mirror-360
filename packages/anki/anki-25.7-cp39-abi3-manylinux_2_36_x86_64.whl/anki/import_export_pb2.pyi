...
class ImportCollectionPackageRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["backup_path", b"backup_path", "col_path", b"col_path", "media_db", b"media_db", "media_folder", b"media_folder"]) -> None: ...
...
class ExportCollectionPackageRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["include_media", b"include_media", "legacy", b"legacy", "out_path", b"out_path"]) -> None: ...
...
class ImportAnkiPackageOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["merge_notetypes", b"merge_notetypes", "update_notes", b"update_notes", "update_notetypes", b"update_notetypes", "with_deck_configs", b"with_deck_configs", "with_scheduling", b"with_scheduling"]) -> None: ...
...
class ImportAnkiPackageRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["options", b"options", "package_path", b"package_path"]) -> None: ...
...
class ImportResponse(google.protobuf.message.Message):
    ...
    class Note(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["fields", b"fields", "id", b"id"]) -> None: ...
    ...
    class Log(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["conflicting", b"conflicting", "dupe_resolution", b"dupe_resolution", "duplicate", b"duplicate", "empty_first_field", b"empty_first_field", "first_field_match", b"first_field_match", "found_notes", b"found_notes", "missing_deck", b"missing_deck", "missing_notetype", b"missing_notetype", "new", b"new", "updated", b"updated"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["changes", b"changes", "log", b"log"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["changes", b"changes", "log", b"log"]) -> None: ...
...
class ExportAnkiPackageRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["limit", b"limit", "options", b"options"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["limit", b"limit", "options", b"options", "out_path", b"out_path"]) -> None: ...
...
class ExportAnkiPackageOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["legacy", b"legacy", "with_deck_configs", b"with_deck_configs", "with_media", b"with_media", "with_scheduling", b"with_scheduling"]) -> None: ...
...
class MediaEntries(google.protobuf.message.Message):
    ...
    class MediaEntry(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["_legacy_zip_filename", b"_legacy_zip_filename", "legacy_zip_filename", b"legacy_zip_filename"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["_legacy_zip_filename", b"_legacy_zip_filename", "legacy_zip_filename", b"legacy_zip_filename", "name", b"name", "sha1", b"sha1", "size", b"size"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["_legacy_zip_filename", b"_legacy_zip_filename"]) -> typing.Literal["legacy_zip_filename"] | None: ...
...
class ImportCsvRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["metadata", b"metadata", "path", b"path"]) -> None: ...
...
class CsvMetadataRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_deck_id", b"_deck_id", "_delimiter", b"_delimiter", "_is_html", b"_is_html", "_notetype_id", b"_notetype_id", "deck_id", b"deck_id", "delimiter", b"delimiter", "is_html", b"is_html", "notetype_id", b"notetype_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_deck_id", b"_deck_id", "_delimiter", b"_delimiter", "_is_html", b"_is_html", "_notetype_id", b"_notetype_id", "deck_id", b"deck_id", "delimiter", b"delimiter", "is_html", b"is_html", "notetype_id", b"notetype_id", "path", b"path"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_deck_id", b"_deck_id"]) -> typing.Literal["deck_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_delimiter", b"_delimiter"]) -> typing.Literal["delimiter"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_is_html", b"_is_html"]) -> typing.Literal["is_html"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_notetype_id", b"_notetype_id"]) -> typing.Literal["notetype_id"] | None: ...
...
class CsvMetadata(google.protobuf.message.Message):
    ...
    class MappedNotetype(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["field_columns", b"field_columns", "id", b"id"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["deck", b"deck", "deck_column", b"deck_column", "deck_id", b"deck_id", "global_notetype", b"global_notetype", "notetype", b"notetype", "notetype_column", b"notetype_column"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["column_labels", b"column_labels", "deck", b"deck", "deck_column", b"deck_column", "deck_id", b"deck_id", "delimiter", b"delimiter", "dupe_resolution", b"dupe_resolution", "force_delimiter", b"force_delimiter", "force_is_html", b"force_is_html", "global_notetype", b"global_notetype", "global_tags", b"global_tags", "guid_column", b"guid_column", "is_html", b"is_html", "match_scope", b"match_scope", "notetype", b"notetype", "notetype_column", b"notetype_column", "preview", b"preview", "tags_column", b"tags_column", "updated_tags", b"updated_tags"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["deck", b"deck"]) -> typing.Literal["deck_id", "deck_column"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["notetype", b"notetype"]) -> typing.Literal["global_notetype", "notetype_column"] | None: ...
...
class ExportCardCsvRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["limit", b"limit", "out_path", b"out_path", "with_html", b"with_html"]) -> None: ...
...
class ExportNoteCsvRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["limit", b"limit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["limit", b"limit", "out_path", b"out_path", "with_deck", b"with_deck", "with_guid", b"with_guid", "with_html", b"with_html", "with_notetype", b"with_notetype", "with_tags", b"with_tags"]) -> None: ...
...
class ExportLimit(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["card_ids", b"card_ids", "deck_id", b"deck_id", "limit", b"limit", "note_ids", b"note_ids", "whole_collection", b"whole_collection"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["card_ids", b"card_ids", "deck_id", b"deck_id", "limit", b"limit", "note_ids", b"note_ids", "whole_collection", b"whole_collection"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["limit", b"limit"]) -> typing.Literal["whole_collection", "deck_id", "note_ids", "card_ids"] | None: ...
