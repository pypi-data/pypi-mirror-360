...
def drift(
    ...
    if choice == "local->aws":
        ...
        close_issue(repo_full_name, token, issue_num, "✅ Local policy updated from AWS. Closing issue.")
        ...
        close_issue(repo_full_name, token, issue_num, "✅ Superset applied. Closing issue.")
