...
def detect_drift(local_doc, aws_doc) -> bool:
    """
    Detect removal drift: AWS has permissions missing from local.
    """
    local_statements = {
...
def drift(
    ...
    if choice == "local->aws":
        ...
        _apply_aws_update_and_close(iam, policy_arn, merged_doc, repo_full_name, token, issue_num, "✅ AWS updated with local changes.")
        ...
        _apply_aws_update_and_close(iam, policy_arn, superset_doc, repo_full_name, token, issue_num, "✅ Superset applied.")
