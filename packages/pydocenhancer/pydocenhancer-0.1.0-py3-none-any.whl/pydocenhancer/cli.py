...
def enhance(module, output, provider, model, api_key):
    """Generate enhanced documentation for a Python module."""
    enhancer = DocEnhancer(provider=provider, model=model, api_key=api_key)
    enhancer.generate_docs(module_path=module, output_dir=output)
