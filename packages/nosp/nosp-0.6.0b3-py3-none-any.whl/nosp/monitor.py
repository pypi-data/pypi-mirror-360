...
PY_MONITOR_ENDPOINT = os.getenv('PY_MONITOR_ENDPOINT') or 'http://127.0.0.1:14000/api/endpoint'
...
class SpiderInfo:
    def __init__(self, name=None, group_name=None, domain=None, url=None, freq=None, metadata=None, user=None,
                 monitor=True,insert_table=None, task_type=0, log=True, show_debug=False, monitor_endpoint=None):
        self.__id = 0
        # 进程ID
        ...
        self.server_location = os.getenv("SERVER_LOCATION")
