...
async function launchApp(browserType, options) {
  var _options$persistentCo, _options$persistentCo2, _options$persistentCo3, _options$persistentCo4, _options$persistentCo5;
  const args = [...((_options$persistentCo = options.persistentContextOptions?.args) !== null && _options$persistentCo !== void 0 ? _options$persistentCo : [])];
  ...
  const context = await browserType.launchPersistentContext((0, _instrumentation.serverSideCallMetadata)(), '', {
    ...
    channel: (_options$persistentCo2 = options.persistentContextOptions?.channel) !== null && _options$persistentCo2 !== void 0 ? _options$persistentCo2 : !options.persistentContextOptions?.executablePath ? (0, _registry.findChromiumChannel)(options.sdkLanguage) : undefined,
    noDefaultViewport: (_options$persistentCo3 = options.persistentContextOptions?.noDefaultViewport) !== null && _options$persistentCo3 !== void 0 ? _options$persistentCo3 : true,
    acceptDownloads: (_options$persistentCo4 = options?.persistentContextOptions?.acceptDownloads) !== null && _options$persistentCo4 !== void 0 ? _options$persistentCo4 : (0, _utils.isUnderTest)() ? 'accept' : 'internal-browser-default',
    colorScheme: (_options$persistentCo5 = options?.persistentContextOptions?.colorScheme) !== null && _options$persistentCo5 !== void 0 ? _options$persistentCo5 : 'no-override',
    args
  });
