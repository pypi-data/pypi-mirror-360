...
class CRPage {
  ...
  constructor(client, targetId, browserContext, opener, bits) {
    ...
    this._mainFrameSession._initialize(bits.hasUIWindow).then(() => this._page.reportAsNew(this._opener?._page, undefined, createdEvent), error => this._page.reportAsNew(this._opener?._page, error, createdEvent));
  }
