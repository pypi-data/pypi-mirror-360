...
class Locator:
    ...
    async def evaluate(
        ...
        *,
        ...
        return await self._with_element(
            lambda h, _: h.evaluate(expression, arg, isolatedContext=isolatedContext),
            timeout,
        )
    ...
    async def is_enabled(self, timeout: float = None) -> bool:
        params = locals_to_params(locals())
        return await self._frame.is_enabled(self._selector, strict=True, **params)
