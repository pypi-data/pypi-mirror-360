  ...
  _onBeforeRequestSent(param) {
    ...
    if (param.intercepts) {
      ...
      if (redirectedFrom) {
        ...
        let params = {};
        if (redirectedFrom._originalRequestRoute?._alreadyContinuedHeaders) params = toBidiRequestHeaders((_redirectedFrom$_orig = redirectedFrom._originalRequestRoute._alreadyContinuedHeaders) !== null && _redirectedFrom$_orig !== void 0 ? _redirectedFrom$_orig : []);
