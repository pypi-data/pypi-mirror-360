...
class BidiConnection {
  ...
  _dispatchMessage(message) {
    ...
    if (object.type === 'event') {
      ...
      let context;
      if ('context' in object.params) context = object.params.context;else if (object.method === 'log.entryAdded' || object.method === 'script.message') context = object.params.source?.context;
      if (context) {
