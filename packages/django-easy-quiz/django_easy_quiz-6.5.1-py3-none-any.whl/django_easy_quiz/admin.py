            ...
            try:
                for question in (
                    ...
                    all_points = [
                        ...
                        question.points_answer_7
                        if question.points_answer_7 is not None
                        else 0,
                        question.points_answer_8
                        if question.points_answer_8 is not None
                        else 0,
                        question.points_answer_9
                        if question.points_answer_9 is not None
                        else 0,
                        question.points_answer_10
                        if question.points_answer_10 is not None
                        else 0,
                    ]
                ...
                if (
                    ...
                    nb_answers += 1
                if (
                    question.answer_7 is not (None or "")
                    and question.points_answer_7 is not None
                ):
                    nb_answers += 1
                if (
                    question.answer_8 is not (None or "")
                    and question.points_answer_8 is not None
                ):
                    nb_answers += 1
                if (
                    question.answer_9 is not (None or "")
                    and question.points_answer_9 is not None
                ):
                    nb_answers += 1
                if (
                    question.answer_10 is not (None or "")
                    and question.points_answer_10 is not None
                ):
                    nb_answers += 1
