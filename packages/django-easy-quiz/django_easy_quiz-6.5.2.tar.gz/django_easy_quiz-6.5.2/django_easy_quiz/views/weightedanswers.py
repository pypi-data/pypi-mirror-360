...
class WeightedAnswersQuizView(FormView):
        ...
        if form.is_valid():
            ...
            for input in form.data:
                ...
                if input.startswith("question_"):
                    ...
                    if 7 in answers_ids:
                        answers.append(question.answer_7)
                        total_points += question.points_answer_7
                    if 8 in answers_ids:
                        answers.append(question.answer_8)
                        total_points += question.points_answer_8
                    if 9 in answers_ids:
                        answers.append(question.answer_9)
                        total_points += question.points_answer_9
                    if 10 in answers_ids:
                        answers.append(question.answer_10)
                        total_points += question.points_answer_10
    ...
    def get(self, request, *args, **kwargs):
        ...
        for question in questions_url:
            ...
            if 7 in answers:
                total_points += question.points_answer_7
                answers_objects.append(question.answer_7)
            if 8 in answers:
                total_points += question.points_answer_8
                answers_objects.append(question.answer_8)
            if 9 in answers:
                total_points += question.points_answer_9
                answers_objects.append(question.answer_9)
            if 10 in answers:
                total_points += question.points_answer_10
                answers_objects.append(question.answer_10)
