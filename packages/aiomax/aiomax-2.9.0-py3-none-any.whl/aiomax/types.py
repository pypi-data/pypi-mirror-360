...
class Callback:
    ...
    async def send(
        ...
        if self.bot is None:
            return
        assert self.message is not None, "Original message not found"
    ...
    async def answer(
        ...
        :param attachments: List of attachments
        """
        assert notification is not None or text is not None or attachments, (
