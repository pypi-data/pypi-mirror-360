...
def blender_tool():
    """
    Decorator for Blender MCP tools.
    
    This decorator provides common functionality for all Blender tools:
    - Error handling and logging
    - Input validation
    - Response formatting
    
    Returns:
        function: Decorated function with added tool functionality
    """
    def decorator(func):
...
__all__ = ['blender_tool', 'tool_wrapper', 'BaseTool']
