...
**Maintained by:** [Dinesh Kumar C](https://github.com/Dinesh210805)
...
[Support this project](https://github.com/sponsors/Dinesh210805)
...
```json
{
  "mcpServers": {
    "blender": {
      "command": "uvx",
      "args": ["--from", "blender-connect-mcp", "blender-mcp"]
    }
  }
}
```
...
```json
{
  "mcpServers": {
    "blender": {
      "command": "cmd",
      "args": ["/c", "uvx", "blender-connect-mcp"]
    }
  }
}
```
...
**Current maintainer:** [Dinesh Kumar C](https://github.com/Dinesh210805)  
**Original creator:** [Siddharth Ahuja](https://github.com/ahujasid)
