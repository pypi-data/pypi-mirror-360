...
def convert(input: list[str], format: Literal['marcxml','picaxml'], output: str, parquet_compression: str, parquet_compression_level, parquet_batch_size=1024*1024*64) -> None:
    if format == 'marcxml':
