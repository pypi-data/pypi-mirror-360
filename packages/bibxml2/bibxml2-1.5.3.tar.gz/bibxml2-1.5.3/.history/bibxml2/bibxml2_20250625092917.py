...
def convert(input: list[str], format: Literal['marcxml','picaxml'], output: str, parquet_compression: str = 'zstd', parquet_compression_level = 22, batch_size=1024*1024*64) -> None:
    if format == 'marcxml':
