...
Compressed files will be read/written if the filename ends with a . TSV format will be used if the output filename contains `.tsv`, otherwise CSV will be used.
