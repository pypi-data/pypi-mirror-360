...
AI Functions are the most powerful feature of AgentUp plugins, allowing your skills to be automatically called by Large Language Models. This guide shows you how to build sophisticated AI-powered plugins that seamlessly integrate with LLM workflows.

## Understanding AI Functions

When a user talks to an AI-enabled AgentUp agent, the LLM can intelligently choose which of your plugin's functions to call based on the conversation context. This enables natural, conversational interfaces to your functionality.
...
This comprehensive guide covers everything you need to build sophisticated AI Functions for AgentUp plugins. With these patterns, you can create powerful, intelligent skills that seamlessly integrate with LLM workflows and provide natural conversational interfaces to any functionality.