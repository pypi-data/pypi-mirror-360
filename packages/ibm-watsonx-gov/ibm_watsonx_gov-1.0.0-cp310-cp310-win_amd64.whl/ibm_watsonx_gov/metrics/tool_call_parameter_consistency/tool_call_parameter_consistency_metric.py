...
TOOL_CALLING_PARAMETER_CONSISTENCY = "tool_call_parameter_consistency"


class ToolCallParameterConsistencyMetric(GenAIMetric):
    """
    Implementation class for ToolCallParameterConsistencyMetric.
    Verify all context-implied parameters are included and their 
    ...
    name: Annotated[Literal["tool_call_parameter_consistency"], Field(title="Metric Name",
                                                                      description="The name of metric.",
                                                                      default=TOOL_CALLING_PARAMETER_CONSISTENCY)]
    ...
    metric_mapping_name: Annotated[Literal["parameter_completeness_consistency"], Field(title="Metric Mapping Name",
                                                                                        description="The mapping name of metric with llmevalkit.",
                                                                                        default="parameter_completeness_consistency")]

    def evaluate(self, data: pd.DataFrame | dict,
                 configuration: GenAIConfiguration | AgenticAIConfiguration,
                 **kwargs) -> AggregateMetricResult:
        """
        Evaluate the data for ToolCallParameterConsistencyMetric
        Args:
    ...
    def _compute_metrics(self, data: pd.DataFrame, configuration: GenAIConfiguration | AgenticAIConfiguration, provider: ToolCallMetricProvider):
        """
        Compute the ToolCallParameterConsistencyMetric metrics for the given data
