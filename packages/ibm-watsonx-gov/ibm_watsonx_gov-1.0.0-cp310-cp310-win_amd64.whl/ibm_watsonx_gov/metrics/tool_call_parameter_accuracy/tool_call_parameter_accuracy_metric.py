...
TOOL_CALLING_PARAMETER_ACCURACY = "tool_call_parameter_accuracy"


class ToolCallParameterAccuracyMetric(GenAIMetric):
    """
    Implementation class for ToolCallParameterAccuracyMetric.
    Final binary check across all semantic criteria. 
    A parameter fails format, grounding, or completeness, 
    ...
    name: Annotated[Literal["tool_call_parameter_accuracy"], Field(title="Metric Name",
                                                                   ...
                                                                   default=TOOL_CALLING_PARAMETER_ACCURACY)]
    ...
    metric_mapping_name: Annotated[Literal["overall_parameter_correctness"], Field(title="Metric Mapping Name",
                                                                                   description="The mapping name of metric with llmevalkit.",
                                                                                   default="overall_parameter_correctness")]
    ...
    def _compute_metrics(self, data: pd.DataFrame, configuration: GenAIConfiguration | AgenticAIConfiguration, provider: ToolCallMetricProvider):
        """
        Compute the ToolCallParameterAccuracyMetric metrics for the given data
