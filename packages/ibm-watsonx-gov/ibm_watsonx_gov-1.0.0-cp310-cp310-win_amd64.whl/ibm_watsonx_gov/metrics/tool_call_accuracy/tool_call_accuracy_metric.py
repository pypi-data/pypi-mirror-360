...
class ToolCallAccuracyMetric(GenAIMetric):
    """
    Implementation class for ToolCallAccuracyMetric.
    Combine ToolCallIntentAccuracy, ToolCallParameterGroundedness, 
    ToolCallParameterConsistency, and ToolCallOrderAccuracy into one score
    ...
    metric_mapping_name: Annotated[Literal["overall_call_correctness"], Field(title="Metric Mapping Name",
                                                                              description="The mapping name of metric with llmevalkit.",
                                                                              default="overall_call_correctness")]
    ...
    def _compute_metrics(self, data: pd.DataFrame, configuration: GenAIConfiguration | AgenticAIConfiguration, provider: ToolCallMetricProvider):
        """
        Compute the ToolCallAccuracyMetric metrics for the given data
