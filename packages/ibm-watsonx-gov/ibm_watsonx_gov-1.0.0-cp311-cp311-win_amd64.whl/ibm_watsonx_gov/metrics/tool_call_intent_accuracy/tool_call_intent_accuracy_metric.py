...
TOOL_CALLING_INTENT_ACCURACY = "tool_call_intent_accuracy"


class ToolCallIntentAccuracyMetric(GenAIMetric):
    """
    Implementation class for ToolCallIntentAccuracyMetric.
    This will assess whether this function call (name + parameters) 
    matches the user request and is the right next step.

    The following methods are supported:
    1. llm_as_judge
    """

    name: Annotated[Literal["tool_call_intent_accuracy"], Field(title="Metric Name",
                                                                description="The name of metric.",
                                                                default=TOOL_CALLING_INTENT_ACCURACY)]
    ...
    metric_mapping_name: Annotated[Literal["function_intent_alignment"], Field(title="Metric Mapping Name",
                                                                               description="The mapping name of metric with llmevalkit.",
                                                                               default="function_intent_alignment")]

    def evaluate(self, data: pd.DataFrame | dict,
                 configuration: GenAIConfiguration | AgenticAIConfiguration,
                 **kwargs) -> AggregateMetricResult:
        """
        Evaluate the data for ToolCallIntentAccuracyMetric
        Args:
    ...
    def _compute_metrics(self, data: pd.DataFrame, configuration: GenAIConfiguration | AgenticAIConfiguration, provider: ToolCallMetricProvider):
        """
        Compute the ToolCallIntentAccuracyMetric metrics for the given data
