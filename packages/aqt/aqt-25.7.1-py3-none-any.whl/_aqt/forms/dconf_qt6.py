...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.dconf = QtWidgets.QComboBox(parent=Dialog)
        ...
        self.confOpts = QtWidgets.QToolButton(parent=Dialog)
        ...
        self.lrnFactor = QtWidgets.QSpinBox(parent=self.tab)
        ...
        self.newPerDay = QtWidgets.QSpinBox(parent=self.tab)
        ...
        self.lrnSteps = QtWidgets.QLineEdit(parent=self.tab)
        ...
        self.newOrder = QtWidgets.QComboBox(parent=self.tab)
        self.newOrder.setObjectName("newOrder")
        self.gridLayout.addWidget(self.newOrder, 1, 1, 1, 2)
        self.bury = QtWidgets.QCheckBox(parent=self.tab)
        self.bury.setObjectName("bury")
        self.gridLayout.addWidget(self.bury, 6, 0, 1, 3, QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        self.easyBonus = QtWidgets.QSpinBox(parent=self.tab_3)
        ...
        self.revPerDay = QtWidgets.QSpinBox(parent=self.tab_3)
        ...
        self.maxIvl = QtWidgets.QSpinBox(parent=self.tab_3)
        ...
        self.buryRev = QtWidgets.QCheckBox(parent=self.tab_3)
        self.buryRev.setObjectName("buryRev")
        self.gridLayout_3.addWidget(self.buryRev, 5, 0, 1, 3, QtCore.Qt.AlignmentFlag.AlignLeft)
        self.hardFactorLabel = QtWidgets.QLabel(parent=self.tab_3)
        self.hardFactorLabel.setObjectName("hardFactorLabel")
        self.gridLayout_3.addWidget(self.hardFactorLabel, 4, 0, 1, 1)
        self.hardFactor = QtWidgets.QSpinBox(parent=self.tab_3)
        ...
        self.lapSteps = QtWidgets.QLineEdit(parent=self.tab_2)
        ...
        self.leechThreshold = QtWidgets.QSpinBox(parent=self.tab_2)
        ...
        self.lapMinInt = QtWidgets.QSpinBox(parent=self.tab_2)
        ...
        self.leechAction = QtWidgets.QComboBox(parent=self.tab_2)
        ...
        self.lapMult = QtWidgets.QSpinBox(parent=self.tab_2)
        ...
        self.maxTaken = QtWidgets.QSpinBox(parent=self.tab_5)
        ...
        self.showTimer = QtWidgets.QCheckBox(parent=self.tab_5)
        self.showTimer.setObjectName("showTimer")
        self.verticalLayout_6.addWidget(self.showTimer, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        self.autoplaySounds = QtWidgets.QCheckBox(parent=self.tab_5)
        self.autoplaySounds.setObjectName("autoplaySounds")
        self.verticalLayout_6.addWidget(self.autoplaySounds, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        self.replayQuestion = QtWidgets.QCheckBox(parent=self.tab_5)
        self.replayQuestion.setChecked(False)
        self.replayQuestion.setObjectName("replayQuestion")
        self.verticalLayout_6.addWidget(self.replayQuestion, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
