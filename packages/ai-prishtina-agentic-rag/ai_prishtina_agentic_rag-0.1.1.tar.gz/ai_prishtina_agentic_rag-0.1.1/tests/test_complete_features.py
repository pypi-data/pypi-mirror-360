...
class TestCodeExecutorTool:
    ...
    async def test_code_executor_initialization(self):
        ...
        tool = CodeExecutorTool(timeout=30, max_output_length=1000)
...
class TestRerankers:
    ...
    async def test_cross_encoder_reranker(self, sample_results):
        ...
        # Use fallback mode (no model) to avoid import issues
    ...
    async def test_colbert_reranker(self, sample_results):
        ...
        # Use fallback mode to avoid import issues
        reranker = ColBERTReranker(model_name=None)
    ...
    async def test_ensemble_reranker(self, sample_results):
        ...
        # Use fallback mode to avoid import issues
        reranker1 = CrossEncoderReranker(model_name=None)
        reranker2 = ColBERTReranker(model_name=None)
