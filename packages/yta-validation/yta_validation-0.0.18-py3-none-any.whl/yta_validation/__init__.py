...
class PythonValidator:
    ...
    def is_numpy_array(
        ...
        """
        return PythonValidator.is_instance(element, 'ndarray')
    ...
    def is_numpy_dtype(
        ...
        'np.int16', etc.).
        """
        return PythonValidator.is_subclass(element, 'np.generic')
    ...
    def is_dependency_installed(
        ...
        """
        Check if the 'dependency' provided is installed
        in this project or if not.
        """
