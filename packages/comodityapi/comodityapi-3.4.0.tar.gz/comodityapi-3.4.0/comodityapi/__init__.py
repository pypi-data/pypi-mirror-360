...
class ComodityAPI:
    ...
    def __init__(self, api_key: str = "", version: str = "1.0"):
    ...
    def get_live_rates(self, symbols: str, updates: str = "1m", quote: str = "USD") -> dict:
        ...
        url = f"https://api.apifreaks.com/{self.version}.0/commodity/rates/latest?{urllib.parse.urlencode(params)}"
    ...
    def get_historical_rates(self, symbols: str, date: str) -> dict:
        ...
        url = f"https://api.apifreaks.com/{self.version}.0/commodity/rates/historical?{urllib.parse.urlencode(params)}"
        return self._make_request(url)
    ...
    def get_fluctuation(self, symbols: str, start_date: str, end_date: str) -> dict:
        ...
        url = f"https://api.apifreaks.com/{self.version}.0/commodity/fluctuation?{urllib.parse.urlencode(params)}"
        return self._make_request(url)
    ...
    def get_time_series(self, symbols: str, start_date: str, end_date: str) -> dict:
        ...
        url = f"https://api.apifreaks.com/{self.version}.0/commodity/time-series?{urllib.parse.urlencode(params)}"
        return self._make_request(url)
    ...
    def get_symbols(self) -> dict:
        url = "https://api.apifreaks.com/{self.version}.0/commodity/symbols"
        return self._make_request(url)
