            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'reboot.memoize.v1.Memoize.Reset') {aborted}"
                        )
                elif (
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'reboot.memoize.v1.Memoize.Start') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'reboot.memoize.v1.Memoize.Store') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'reboot.memoize.v1.Memoize.Fail') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'reboot.memoize.v1.Memoize.Status') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
