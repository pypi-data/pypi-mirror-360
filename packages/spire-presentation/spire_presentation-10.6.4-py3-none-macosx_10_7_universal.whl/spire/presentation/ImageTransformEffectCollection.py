...
#
#        GetDllLibPpt().ImageTransformEffectCollection_CopyTo.argtypes=[c_void_p ,c_void_p,c_int]
#        CallCFunction(GetDllLibPpt().ImageTransformEffectCollection_CopyTo,self.Ptr, intPtrarray,index)
