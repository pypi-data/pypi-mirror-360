...
class ChemResponse(BaseModel):
    ...
    id: Optional[str] = Field(default=None, description="Chemical identifier (typically InChIKey)", validation_alias=AliasChoices("_id", "id"))
    version: Optional[int] = Field(default=None, description="Version number of the data", validation_alias=AliasChoices("_version", "version"))
