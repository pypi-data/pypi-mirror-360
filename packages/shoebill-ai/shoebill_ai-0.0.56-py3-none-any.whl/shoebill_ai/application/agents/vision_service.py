...
class VisionService(BaseVisionService, VisionServiceInterface):
    ...
    def __init__(self, api_url: str, factory: OllamaFactory, api_token: str = None, temperature: float = 0.6,
                 max_tokens: int = 2500, model_name: str = None, timeout: int = None):
        """
        ...
        """
        super().__init__(api_url, api_token, temperature, max_tokens, model_name)
