...
class DeleteVoiceCloneResponse(BaseModel):
    ...
    deleted_id: Optional[StrictStr] = Field(default=None, description="The ID of the voice clone that was deleted")
    __properties: ClassVar[List[str]] = ["success", "message", "deleted_id"]
