...
class CreateApiKeyRequest(BaseModel):
    ...
    CreateApiKeyRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name for the API key")
    permissions: Optional[List[StrictStr]] = Field(default=None, description="List of permissions for the key")
