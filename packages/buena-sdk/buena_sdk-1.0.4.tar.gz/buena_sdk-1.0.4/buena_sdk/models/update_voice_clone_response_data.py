...
class UpdateVoiceCloneResponseData(BaseModel):
    """
    UpdateVoiceCloneResponseData
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Updated name for the voice clone")
    description: Optional[StrictStr] = Field(default=None, description="Updated description of the voice clone")
    is_active: Optional[StrictBool] = Field(default=None, description="Updated active status", alias="isActive")
    updated_at: Optional[datetime] = Field(default=None, description="When the voice clone was last updated", alias="updatedAt")
    __properties: ClassVar[List[str]] = ["name", "description", "isActive", "updatedAt"]
