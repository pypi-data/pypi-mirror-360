...
class VoiceCloneResponseData(BaseModel):
    """
    ...
    sample_count: Optional[StrictInt] = Field(default=None, description="Number of audio samples uploaded for training", alias="sampleCount")
    created_at: Optional[datetime] = Field(default=None, description="When the voice clone was created", alias="createdAt")
    __properties: ClassVar[List[str]] = ["voiceId", "name", "description", "sampleCount", "createdAt"]
