...
class ChatClient:
    def __init__(self, agent_id: str, personal_auth_key: str, personal_auth_secret: str, base_url: str = "https://uat.agentspro.cn"):
        ...
        self.jwt_token = get_jwt_token_api(personal_auth_key, personal_auth_key, base_url) 
    ...
    def invoke(
        ...
        示例:
            ...
            .. code-block:: python
                ...
                app = FastAPI()
                client = ChatClient(agent_id="xxx", personal_auth_key="xxx", personel_auth_secret="xxx")
