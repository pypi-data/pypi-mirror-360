...
class PyModbusClient:
    def __new__(cls, port_name:builtins.str, baudrate:builtins.int, slave_id:builtins.int, is_canfd:typing.Optional[builtins.bool]=False) -> PyModbusClient: ...
...
class StarkFirmwareType(Enum):
    ...
    def __new__(cls, value:builtins.int) -> StarkFirmwareType: ...
...
def init_config(fw_type:StarkFirmwareType, protocol_type:typing.Optional[StarkProtocolType]=StarkProtocolType.Modbus, level:typing.Optional[LogLevel]=LogLevel.Info, max_bytes:typing.Optional[builtins.int]=None) -> None: ...

def list_available_ports() -> typing.Any: ...

def modbus_close(client:PyModbusClient) -> typing.Any: ...
