...
@mcp.tool()
async def scrape(url: str, botrun_flow_lang_url: str = "", user_id: str = "") -> str:
    """
    Scrape a web page to extract its content.

    Args:
        url: The URL to scrape
        botrun_flow_lang_url: Optional URL for the botrun flow lang API
...
async def chat_with_pdf(
    ...
    Args:
        ...
        botrun_flow_lang_url: Optional URL for the botrun flow lang API
        user_id: Optional user ID for file upload
...
async def generate_image(user_input: str, user_id: str = "") -> str:
    ...
    Args:
        ...
        user_id: User ID for rate limit checking
