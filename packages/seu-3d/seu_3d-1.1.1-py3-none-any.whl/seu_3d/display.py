...
class DisplayEmbryo():
    ...
    def tissue_filter(self):
        ...
        x_mask = (coords[:, 0] >= select_xy[0][0]) & (coords[:, 0] <= select_xy[0][1])
        y_mask = (coords[:, 1] >= select_xy[1][0]) & (coords[:, 1] <= select_xy[1][1])
        mask &= x_mask & y_mask
        filter_4 = filter_3[
    ...
    def one_gene_tab(self):
        ...
        def show_gene():
            ...
            points.face_color = cc.cm["kb"](gene_exp_norm)
    ...
    def Moran_tab(self):
        ...
        def show_moran():
            ...
            run_show_moran = widgets.FunctionGui(
                plot_moran,
                call_button="Show top 25 gene exp",
                layout="vertical",
            )
