...
class TestLancedbIngest:
    ...
    def test_method_run(self, client: Quark) -> None:
        lancedb_ingest = client.worker.registry.quark.vector.lancedb_ingest.run(
    ...
    def test_raw_response_run(self, client: Quark) -> None:
        response = client.worker.registry.quark.vector.lancedb_ingest.with_raw_response.run(
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            table_name="table_name",
        )
    ...
    def test_streaming_response_run(self, client: Quark) -> None:
        with client.worker.registry.quark.vector.lancedb_ingest.with_streaming_response.run(
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            table_name="table_name",
        ) as response:
...
class TestAsyncLancedbIngest:
    ...
    async def test_method_run(self, async_client: AsyncQuark) -> None:
        lancedb_ingest = await async_client.worker.registry.quark.vector.lancedb_ingest.run(
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            table_name="table_name",
        )
    ...
    async def test_raw_response_run(self, async_client: AsyncQuark) -> None:
        response = await async_client.worker.registry.quark.vector.lancedb_ingest.with_raw_response.run(
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            table_name="table_name",
        )
    ...
    async def test_streaming_response_run(self, async_client: AsyncQuark) -> None:
        async with async_client.worker.registry.quark.vector.lancedb_ingest.with_streaming_response.run(
            ipc_dataset_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            table_name="table_name",
        ) as response:
