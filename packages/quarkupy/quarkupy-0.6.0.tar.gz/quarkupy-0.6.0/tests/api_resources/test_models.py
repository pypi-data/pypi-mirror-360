...
class TestModels:
    ...
    def test_method_retrieve(self, client: Quark) -> None:
        ...
        assert_matches_type(MlModel, model, path=["response"])
    ...
    def test_method_delete(self, client: Quark) -> None:
        ...
        assert_matches_type(SuccessResponseMessage, model, path=["response"])
    ...
    def test_streaming_response_retrieve_schema(self, client: Quark) -> None:
        with client.models.with_streaming_response.retrieve_schema() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_update_partial(self, client: Quark) -> None:
        model = client.models.update_partial(
    ...
    def test_raw_response_update_partial(self, client: Quark) -> None:
        response = client.models.with_raw_response.update_partial(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            config={},
            model_provider="Native",
            model_type="Local",
    ...
    def test_streaming_response_update_partial(self, client: Quark) -> None:
        with client.models.with_streaming_response.update_partial(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            config={},
            model_provider="Native",
            model_type="Local",
    ...
    def test_path_params_update_partial(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.models.with_raw_response.update_partial(
                id="",
                config={},
                model_provider="Native",
                model_type="Local",
...
class TestAsyncModels:
    ...
    async def test_method_retrieve_schema(self, async_client: AsyncQuark) -> None:
        model = await async_client.models.retrieve_schema()
        assert_matches_type(object, model, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_schema(self, async_client: AsyncQuark) -> None:
        response = await async_client.models.with_raw_response.retrieve_schema()
    ...
    async def test_streaming_response_retrieve_schema(self, async_client: AsyncQuark) -> None:
        async with async_client.models.with_streaming_response.retrieve_schema() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_update_partial(self, async_client: AsyncQuark) -> None:
        model = await async_client.models.update_partial(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            config={},
            model_provider="Native",
            model_type="Local",
    ...
    async def test_raw_response_update_partial(self, async_client: AsyncQuark) -> None:
        response = await async_client.models.with_raw_response.update_partial(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            config={},
            model_provider="Native",
            model_type="Local",
    ...
    async def test_streaming_response_update_partial(self, async_client: AsyncQuark) -> None:
        async with async_client.models.with_streaming_response.update_partial(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            config={},
            model_provider="Native",
            model_type="Local",
    ...
    async def test_path_params_update_partial(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.models.with_raw_response.update_partial(
                id="",
                config={},
                model_provider="Native",
                model_type="Local",
