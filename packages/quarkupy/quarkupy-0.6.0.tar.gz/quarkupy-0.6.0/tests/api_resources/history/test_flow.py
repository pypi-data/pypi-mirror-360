...
class TestFlow:
    ...
    def test_method_retrieve(self, client: Quark) -> None:
        flow = client.history.flow.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(FlowHistoryItem, flow, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve(self, client: Quark) -> None:
        response = client.history.flow.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Quark) -> None:
        with client.history.flow.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.history.flow.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_update(self, client: Quark) -> None:
        flow = client.history.flow.update(
            ...
            edges=[
                {
                    "source": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                    "target": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                    "_id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                }
            ],
            flow_history_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            identity_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    def test_raw_response_update(self, client: Quark) -> None:
        response = client.history.flow.with_raw_response.update(
            created_at=parse_datetime("2019-12-27T18:11:19.117Z"),
            edges=[
                {
                    "source": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    def test_streaming_response_update(self, client: Quark) -> None:
        with client.history.flow.with_streaming_response.update(
            created_at=parse_datetime("2019-12-27T18:11:19.117Z"),
            edges=[
                {
                    "source": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
...
class TestAsyncFlow:
    ...
    async def test_method_retrieve(self, async_client: AsyncQuark) -> None:
        flow = await async_client.history.flow.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(FlowHistoryItem, flow, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncQuark) -> None:
        response = await async_client.history.flow.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncQuark) -> None:
        async with async_client.history.flow.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.history.flow.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_update(self, async_client: AsyncQuark) -> None:
        flow = await async_client.history.flow.update(
            created_at=parse_datetime("2019-12-27T18:11:19.117Z"),
            edges=[
                {
                    "source": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    async def test_raw_response_update(self, async_client: AsyncQuark) -> None:
        response = await async_client.history.flow.with_raw_response.update(
            created_at=parse_datetime("2019-12-27T18:11:19.117Z"),
            edges=[
                {
                    "source": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    async def test_streaming_response_update(self, async_client: AsyncQuark) -> None:
        async with async_client.history.flow.with_streaming_response.update(
            created_at=parse_datetime("2019-12-27T18:11:19.117Z"),
            edges=[
                {
                    "source": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
