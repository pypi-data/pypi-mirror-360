...
from quarkupy import Quark, AsyncQuark, APIResponseValidationError
from quarkupy._types import Omit
from quarkupy._models import BaseModel, FinalRequestOptions
from quarkupy._exceptions import QuarkError, APIStatusError, APITimeoutError, APIResponseValidationError
from quarkupy._base_client import (
    DEFAULT_TIMEOUT,
...
class TestQuark:
    client = Quark(base_url=base_url, api_key=api_key, cookie=cookie, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "quarkupy/_legacy_response.py",
                        "quarkupy/_response.py",
        ...
        with pytest.raises(QuarkError):
            with update_env(
                **{
                ...
                client2 = Quark(base_url=base_url, api_key=None, cookie=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(QUARK_BASE_URL="http://localhost:5000/from/env"):
            client = Quark(api_key=api_key, cookie=cookie, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Quark(base_url=base_url, api_key=api_key, cookie=cookie, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Quark(base_url=base_url, api_key=api_key, cookie=cookie, _strict_response_validation=False)
    ...
    @mock.patch("quarkupy._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Quark) -> None:
        respx_mock.get("/").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.with_streaming_response.retrieve().__enter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("quarkupy._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Quark) -> None:
...
class TestAsyncQuark:
    client = AsyncQuark(base_url=base_url, api_key=api_key, cookie=cookie, _strict_response_validation=True)
        ...
        with pytest.raises(QuarkError):
            with update_env(
                **{
                ...
                client2 = AsyncQuark(base_url=base_url, api_key=None, cookie=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(QUARK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncQuark(api_key=api_key, cookie=cookie, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncQuark(base_url=base_url, api_key=api_key, cookie=cookie, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncQuark(base_url=base_url, api_key=api_key, cookie=cookie, _strict_response_validation=False)
    ...
    @mock.patch("quarkupy._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncQuark) -> None:
        respx_mock.get("/").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            await async_client.with_streaming_response.retrieve().__aenter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("quarkupy._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncQuark) -> None:
        respx_mock.get("/").mock(return_value=httpx.Response(500))
    ...
    def test_get_platform(self) -> None:
        ...
        from quarkupy._utils import asyncify
        from quarkupy._base_client import get_platform
