...
from buildgrid.server.scheduler.assigner import AssignerConfig, PriorityAgeAssignerConfig
...
def load_priority_age_assigner(
    ...
    """
    return PriorityAgeAssignerConfig(count, interval, priority_assignment_percentage, failure_backoff)
