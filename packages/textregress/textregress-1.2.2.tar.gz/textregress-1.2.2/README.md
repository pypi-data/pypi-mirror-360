...
**Note:** Version 1.2.2 includes TF-IDF encoder and fixes all packaging issues. Required for correct import of `TextRegressor` and all submodules.

```bash
pip install textregress==1.2.2
```
