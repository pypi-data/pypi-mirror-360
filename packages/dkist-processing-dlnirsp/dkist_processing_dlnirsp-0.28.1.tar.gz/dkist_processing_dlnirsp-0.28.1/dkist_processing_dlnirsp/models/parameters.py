...
class DlnirspParameters(ParameterBase, ParameterArmIdMixin):
    ...
    def linearization_poly_coeffs(self) -> np.ndarray:
        ...
        Coefficients should be in *increasing* polynomial degree, to be compatible with numpy's more modern
        `polynomial <https://numpy.org/doc/stable/reference/routines.polynomials.html>`_ framework.
        """
