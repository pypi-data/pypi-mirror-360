...
from cmo_gymnasium.utils.registration import make as safety_make
from cmo_gymnasium.vector.async_vector_env import SafetyAsyncVectorEnv
from cmo_gymnasium.vector.sync_vector_env import SafetySyncVectorEnv
...
def make(
    ...
    **kwargs,
    ...
    Example::
        ...
        >>> env = cmo_gymnasium.vector.make('SafetyPointGoal1-v0', num_envs=3)
    ...
    Args:
        ...
        **kwargs: Keywords arguments applied during `cmo_gymnasium.make`
    """
