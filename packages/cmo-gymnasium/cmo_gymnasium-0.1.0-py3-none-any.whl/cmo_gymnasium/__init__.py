...
from cmo_gymnasium import vector, wrappers
from cmo_gymnasium.tasks.safe_multi_agent.tasks.velocity.safe_mujoco_multi import make_ma
from cmo_gymnasium.utils.registration import make, register
from cmo_gymnasium.version import __version__

# import all mo-based environments
import cmo_gymnasium.mo_based_envs.deep_sea_treasure
import cmo_gymnasium.mo_based_envs.four_room  
import cmo_gymnasium.mo_based_envs.mountain_car
import cmo_gymnasium.mo_based_envs.continuous_mountain_car
import cmo_gymnasium.mo_based_envs.frozen_lake
import cmo_gymnasium.mo_based_envs.lunar_lander
import cmo_gymnasium.mo_based_envs.taxi 
...
def __combine_multi(tasks, agents, max_episode_steps):
    ...
    for task_name, task_config in tasks.items():
        ...
        for robot_name in agents:
            ...
            __register_helper(
                env_id=env_id,
                entry_point='cmo_gymnasium.tasks.safe_multi_agent.builder:Builder',
                spec_kwargs={'config': combined_config, 'task_id': env_id},
                max_episode_steps=max_episode_steps,
