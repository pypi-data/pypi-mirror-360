...
from cmo_gymnasium.utils.passive_env_checker import env_step_passive_checker


class PassiveEnvChecker(Wrapper):
    """A wrapper that passively checks the environment's compliance with the Gymnasium API."""
