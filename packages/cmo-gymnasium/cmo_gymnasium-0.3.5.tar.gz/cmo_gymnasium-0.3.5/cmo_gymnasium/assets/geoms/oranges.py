...
from cmo_gymnasium.assets.group import GROUP
from cmo_gymnasium.bases.base_object import Geom
...
class Oranges(Geom):  # pylint: disable=too-many-instance-attributes
    ...
    reward_orange: float = 1.0  # Sparse reward for being inside the goal area
