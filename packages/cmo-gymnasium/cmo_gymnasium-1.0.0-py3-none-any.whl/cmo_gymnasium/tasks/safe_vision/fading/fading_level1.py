...
from cmo_gymnasium.assets.free_geoms import Vases
from cmo_gymnasium.assets.geoms import Hazards
from cmo_gymnasium.tasks.safe_vision.fading.fading_level0 import FadingEasyLevel0
