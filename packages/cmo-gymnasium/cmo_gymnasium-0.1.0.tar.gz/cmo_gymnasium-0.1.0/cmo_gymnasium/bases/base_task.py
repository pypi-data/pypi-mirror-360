...
from cmo_gymnasium.bases.underlying import Underlying
from cmo_gymnasium.utils.common_utils import ResamplingError, camel_to_snake
from cmo_gymnasium.utils.task_utils import theta2vec
...
class BaseTask(Underlying):  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    - :meth:`calculate_cost`: Determine costs depending on the agent and obstacles, actually all
      cost calculation is done in different :meth:`cmo_gymnasium.bases.base_obstacle.BaseObject.cal_cost`
    ...
    def _build_static_geoms_config(self, geoms_config: dict) -> None:
        ...
        base_dir = os.path.dirname(cmo_gymnasium.__file__)
    ...
    def _obs_vision(self) -> np.ndarray:
        ...
        Note:
            ...
            URL: `issue <https://github.com/ernestogomez17/CMO-RL/issues/27>`_
        """
    ...
    def specific_step(self) -> None:
        ...
        It will be called when :meth:`cmo_gymnasium.builder.Builder.step()` is called using env.step().
