...
import cmo_gymnasium.assets.free_geoms as free_geoms
import cmo_gymnasium.assets.geoms as geoms
import cmo_gymnasium.assets.mocaps as mocaps
from cmo_gymnasium import agents
from cmo_gymnasium.assets.color import COLOR
from cmo_gymnasium.assets.free_geoms import FREE_GEOMS_REGISTER
from cmo_gymnasium.assets.geoms import GEOMS_REGISTER
from cmo_gymnasium.assets.mocaps import MOCAPS_REGISTER
from cmo_gymnasium.bases.base_object import FreeGeom, Geom, Mocap
from cmo_gymnasium.utils.common_utils import MujocoException
from cmo_gymnasium.utils.keyboard_viewer import KeyboardViewer
from cmo_gymnasium.utils.random_generator import RandomGenerator
from cmo_gymnasium.world import World
...
class Underlying(abc.ABC):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, config: dict | None = None) -> None:
        ...
        Args:
            config (dict): Configuration dictionary, used to pre-config some attributes
                according to tasks via :meth:`cmo_gymnasium.register`.
        """
    ...
    def _get_viewer(
        ...
        cmo_gymnasium.utils.keyboard_viewer.KeyboardViewer
