...
from cmo_gymnasium import tasks
from cmo_gymnasium.bases.base_task import BaseTask
from cmo_gymnasium.utils.common_utils import ResamplingError, quat2zalign
from cmo_gymnasium.utils.task_utils import get_task_class_name
...
class Builder(gymnasium.Env, gymnasium.utils.EzPickle):
    ...
    def render(self) -> np.ndarray | None:
        """Call underlying :meth:`cmo_gymnasium.bases.underlying.Underlying.render` directly.
