...
# from cmo_gymnasium.wrappers import SafeAutoResetWrapper, SafePassiveEnvChecker, SafeTimeLimit
...
def make(
    ...
    **kwargs: Any,
    ...
    if isinstance(id, EnvSpec):
        ...
        # Print available environments for easier debugging if not found
        if id not in cmo_envs:
            available_envs = sorted(cmo_envs)
            raise AssertionError(
                f'Environment {id} is not registered in cmo-gymnasium.\n'
