...
class ProjectInitializer:
    ...
    def _init_git_repository(self) -> None:
        ...
        try:
            ...
            print(
                "You can manually run 'git init' and 'git add .' to set up version control"
            )
        except FileNotFoundError:
            print(
                "⚠️ Warning: Git not found. Please install Git to enable version control"
            )
    ...
    def _sync_uv_dependencies(self) -> None:
        ...
        try:
            ...
            print(
                "⚠️ Warning: UV not found. Please install UV for dependency management"
            )
