...
class ModelSubCommand(RegistryCommand):  # noqa: D101
    ...
    def download_version(self, args):
        ...
        logger = logging.getLogger("registry.api.models")
        buf: list[str] = []

        def buffer_warning(msg, *a, **kw):
            buf.append(msg)

        # # # WARNING: logger methods are overridden, save and restore to default if needed
        logger.warning = buffer_warning
        logger.info = buffer_warning
