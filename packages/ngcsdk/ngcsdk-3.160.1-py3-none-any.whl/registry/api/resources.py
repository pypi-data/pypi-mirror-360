...
class ResourceAPI:  # noqa: D101
    ...
    def upload_version(
        ...
        if should_create_new_version:
            self._create_version(mrt.org, mrt.team, mrt.name, vcr)
    ...
    def validated_storage_version(self, mrt: ModelRegistryTarget, base_version: Optional[str] = None):
...
class GuestResourceAPI(ResourceAPI):  # noqa: D101
    ...
    def _license_check(self, target, agree_license=False):
        return GuestModelAPI._license_check(**locals())
