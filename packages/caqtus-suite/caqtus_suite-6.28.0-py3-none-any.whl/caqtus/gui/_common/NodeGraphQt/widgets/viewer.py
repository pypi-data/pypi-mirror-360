...
class NodeViewer(QtWidgets.QGraphicsView):
    ...
    def scale(self, sx, sy, pos=None):
        ...
        Args:
            ...
            pos (QtCore.QPointF): mapped position.
        """
        scale = [sx, sx]
    ...
    def wheelEvent(self, event):
        ...
        pos = event.position()
        self._set_viewer_zoom(delta, pos=QtCore.QPoint(int(pos.x()), int(pos.y())))
    ...
    def reset_zoom(self, cent=None):
        ...
        Args:
            cent (QtCore.QPointF): specified center.
        """
        self._scene_range = QtCore.QRectF(
            0, 0, self.size().width(), self.size().height()
        )
