...
from s1_cns_cli.s1graph.common.graph.graph_builder.graph_components.attribute_names import EncryptionValues
from s1_cns_cli.s1graph.common.graph.graph_builder.graph_components.blocks import Block
