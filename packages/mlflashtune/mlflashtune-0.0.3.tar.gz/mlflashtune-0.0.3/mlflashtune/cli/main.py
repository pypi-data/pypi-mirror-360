...
from mlflashtune.core import AEModelTuner
...
def validate_config(config_path: str) -> bool:
    ...
    try:
        ...
        if not hyperparams_path.is_absolute():
            from mlflashtune.core.config import get_project_root
        ...
        print(f"   OMP_NUM_THREADS=1 python -m mlflashtune.cli --config {config_path}")
