...
class GEO:
    def __init__(self, layer_size: list[int], device: str='cpu', init_type: str='he', scale: int=2, hidden_fn: Callable=LeakyReLU, output_fn: Callable=Sigmoid, loss_fn: Callable=MeanSquaredError):
        self.device = device
        ...
        try:
            ...
            raise ValueError('Error: hidden_fn, output_fn, and loss_fn must be valid functions.')
