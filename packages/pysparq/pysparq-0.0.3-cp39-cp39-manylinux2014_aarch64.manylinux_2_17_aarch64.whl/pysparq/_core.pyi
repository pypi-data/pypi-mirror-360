...
def combine_systems(to: SparseState, from: SparseState) -> None:
    ...
def extract_full_state(state: list[System], regs: list[int]) -> numpy.ndarray[numpy.complex128[M, 1]]:
    ...
