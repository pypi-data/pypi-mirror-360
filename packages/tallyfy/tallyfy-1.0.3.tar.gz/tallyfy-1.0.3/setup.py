...
with open(os.path.join(this_directory, 'tallyfy', 'README.md'), encoding='utf-8') as f:
...
setup(
    ...
    url='https://github.com/tallyfy/tallyfy-sdk',
    ...
    project_urls={
        ...
        'Source': 'https://github.com/tallyfy/tallyfy-sdk',
        'Tracker': 'https://github.com/tallyfy/tallyfy-sdk/issues',
    },
