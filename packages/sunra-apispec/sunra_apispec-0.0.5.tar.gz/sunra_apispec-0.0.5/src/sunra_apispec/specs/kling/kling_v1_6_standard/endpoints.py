...
service = BaseAPIService(
    title="Kling v1.6-standard API",
    description="API for Kling v1.6-standard text-to-video generation model - Generate 5s and 10s videos in 720p resolution at 30fps",
    version="1.0.0",
