...
def build(build_type: str = "Release", json_path: str = "build.json"):
    import os, json
...
def clean_all_projects(json_path: str = "build.json"):
    import os, json
...
def main():
    ...
    if args.init:
        ...
        return
    if args.clean:
        clean_all_projects(json_path=args.json)
        return
    if args.build:
        build(build_type=args.build, json_path=args.json)
    else:
        build(build_type="Release", json_path=args.json)
