...
class Ocr2Excel(unittest.TestCase):
    ...
    def test_customsOCR2Excel(self):
        CustomsOCR2Excel(input_path=r'../test_files/Customs/Customs.jpg',
                         output_excel=r'../test_files/Customs/Customs.xlsx',
                         configPath=r'../test_files/poocr-config.toml',
                         id=self.SecretId,
                         key=self.SecretKey)
        self.assertTrue(
            os.path.exists("../test_files/Customs/Customs.xlsx"))
        os.remove('../test_files/Customs/Customs.xlsx')
