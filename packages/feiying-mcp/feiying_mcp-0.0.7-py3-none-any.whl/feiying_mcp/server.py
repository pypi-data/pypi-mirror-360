...
# 导入配置模块
from feiying_mcp.utils.config import config, load_config

# 导入数据库初始化函数
from feiying_mcp.utils.database import init_db

# 导入任务管理器
from feiying_mcp.utils.task_manager import task_manager, start_task_manager, stop_task_manager

# 导入所有工具
from feiying_mcp.tools import all_tools
...
# 创建FastMCP服务器实例
mcp = FastMCP(name="飞影数字人API服务", lifespan=lifespan)
