...
class PinWithModels(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'point': (GeometryPoint,),  # noqa: E501
            'index': (int, none_type,),  # noqa: E501
            'model_ids': ([int],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, name, color, point, index, model_ids, *args, **kwargs):  # noqa: E501
        """PinWithModels - a model defined in OpenAPI
