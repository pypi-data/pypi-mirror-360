...
"""
# I also created environment.py file, which contains the following code:

# def before_scenario(context, scenario):
#     context.driver = webdriver.Firefox()

# so you do not need to create context.driver for me :D



# Make assertions separate, please do not merge them. This is very important.
...
class TestingService:
    ...
    def generate(self, html, feature_scenario, text_line):
        ...
        whole_input = f"System input: {system_input}, \n\nuser_input: {user_input}"
