#!/usr/bin/env python3
"""
Setup script for FinPull - Complete Financial Data Scraper
Enterprise-grade full package with CLI, GUI, and API interfaces
"""
...
setup(
    ...
    python_requires=">=3.7",
    install_requires=[
        "finpull-core>=1.0.16",  # Core functionality
