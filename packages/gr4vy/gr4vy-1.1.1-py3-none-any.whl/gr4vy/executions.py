...
class Executions(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListReportExecutionsResponse(
                result=utils.unmarshal_json_response(models.ReportExecutions, http_res),
                next=next_func,
            )
    ...
    def url(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.ReportExecutionURL, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json_response(errors.Error400Data, http_res)
            raise errors.Error400(response_data, http_res)
        if utils.match_response(http_res, "401", "application/json"):
    ...
    def get(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json_response(models.ReportExecution, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json_response(errors.Error400Data, http_res)
            raise errors.Error400(response_data, http_res)
        if utils.match_response(http_res, "401", "application/json"):
