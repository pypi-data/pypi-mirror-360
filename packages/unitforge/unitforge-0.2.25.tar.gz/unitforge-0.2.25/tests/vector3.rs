...
mod vector3_tests {
    ...
    use unitforge::{Distance, DistanceUnit, Force, ForceDistance, ForceDistanceUnit, ForceUnit, PhysicsQuantity, Stress, StressUnit};
    ...
    #[test]
    fn reproduce() {
        let n = Vector3::new([1.0, 0., 0.]);
        let mag = Stress::new(-1., StressUnit::MPa);
        let a = n * mag;
        println!("{:?}", a);
    }
}