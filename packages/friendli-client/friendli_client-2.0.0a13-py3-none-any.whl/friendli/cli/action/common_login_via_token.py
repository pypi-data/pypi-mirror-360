...
def run(ctx: AppContext, token: str) -> None:
    ...
    # TODO(PC-4369): handle cases where pat is not set in keychain
    ...
    # TODO(PC-4370): avoid project that user has only read only access to

    # Redirect user to docs page explaining default team (and/or context)

    # TODO(PC-4371): warn user about token expiration, nudge user to use other auth method
