...
class AdapterPushStartResultDedicatedModelPushAdapterStartDedicatedModelPushAdapterStartSuccessUploadPlanChatTemplateJinja(
    BaseModel
):
    required: bool
...
class BasePushStartResultDedicatedModelPushBaseStartDedicatedModelPushBaseStartSuccessUploadPlanChatTemplateJinja(
    BaseModel
):
    required: bool
...
class AdapterPushStartResultDedicatedModelPushAdapterStartDedicatedModelPushAdapterStartSuccessUploadPlan(
    ...
    chat_template_jinja: (
        AdapterPushStartResultDedicatedModelPushAdapterStartDedicatedModelPushAdapterStartSuccessUploadPlanChatTemplateJinja
        | None
    ) = Field(alias="chatTemplateJinja", default=None)
    safetensors: list[
...
class AdapterModelCreateInput(BaseModel):
    ...
    chat_template_jinja: FileDescriptorInput | None = Field(
        alias="chatTemplateJinja", default=None
    )
...
class BasePushStartResultDedicatedModelPushBaseStartDedicatedModelPushBaseStartSuccessUploadPlan(
    ...
    chat_template_jinja: (
        BasePushStartResultDedicatedModelPushBaseStartDedicatedModelPushBaseStartSuccessUploadPlanChatTemplateJinja
        | None
    ) = Field(alias="chatTemplateJinja", default=None)
    safetensors: list[
