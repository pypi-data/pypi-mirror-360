...
class DocumentEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "documentId", "messageTitle", "documentDescription", "status", "senderDetail", "signerDetails", "ccDetails", "onBehalfOf", "createdDate", "expiryDate", "enableSigningOrder", "disableEmails", "revokeMessage", "errorMessage", "labels", "isCombinedAudit", "brandId", "documentDownloadOption", "metaData"]
