...
class SenderIdentityEvent(BaseModel):
    """
    SenderIdentityEvent
    """ # noqa: E501
    ...
    approved_date_time: Optional[datetime] = Field(default=None, alias="approvedDateTime")
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "name", "email", "status", "createdDate", "modifiedDate", "approvedDateTime", "brandId", "redirectUrl", "metaData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "approvedDateTime": obj.get("approvedDateTime"),
