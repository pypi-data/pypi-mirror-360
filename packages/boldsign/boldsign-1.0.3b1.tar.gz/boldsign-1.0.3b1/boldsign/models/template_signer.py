...
class TemplateSigner(BaseModel):
    """
    TemplateSigner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["signerName", "signerRole", "signerEmail", "phoneNumber", "enableAccessCode", "enableEmailOTP", "status", "userId", "order", "signerType", "hostEmail", "hostName", "hostUserId", "imposeAuthentication", "allowFieldConfiguration"]
