...
class RewardDataCollatorWithPadding:
    ...
    def __call__(self, features: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        margin = []
        component_names = []
        # print('FEAT', features[0]['component_name'], len(features))
...
def _tokenize(batch: dict[str, list[Any]], tokenizer: "PreTrainedTokenizerBase") -> dict[str, list[Any]]:
    ...
    # print('_tokenize', "component_name" in batch)
...
class RewardTrainer(Trainer):
    ...
    def compute_loss(
        ...
        if self.component_to_idx is not None and "component_name" in inputs:
            component_names = inputs["component_name"]  # expected to be a list of strings, length=batch_size
