...
from .abstract_database_cmd import flatten_json
from abstract_pandas import safe_excel_save

class DatabaseManager:
    def __init__(self, env_path=None, dbName=None, dbType=None, conn_mgr=None):
        self.conn_mgr = conn_mgr or connectionManager(env_path=env_path, dbType=dbType, dbName=dbName)
