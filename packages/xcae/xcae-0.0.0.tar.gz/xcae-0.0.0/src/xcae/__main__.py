...
import veux
import numpy as np
import xara_abaqus as inp
from xara_abaqus.assembly import Assembly

if __name__ == "__main__":

    file_name = sys.argv[2]
    doc = inp.parser.load(file_name, verbose=False)
    ...
    model = inp.create_model(doc, verbose=True, mode="visualize")
