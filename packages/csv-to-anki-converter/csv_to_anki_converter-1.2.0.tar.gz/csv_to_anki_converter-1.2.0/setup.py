...
setup(
    ...
    version="1.2.0",
    author="Willy",
    author_email="willy@example.com",
    description="Convert CSV files to Anki deck packages with ease",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/NurNichtWilly/ankipak",
    project_urls={
        "Bug Reports": "https://github.com/NurNichtWilly/ankipak/issues",
        "Source": "https://github.com/NurNichtWilly/ankipak",
        "Documentation": "https://github.com/NurNichtWilly/ankipak#readme",
    },
