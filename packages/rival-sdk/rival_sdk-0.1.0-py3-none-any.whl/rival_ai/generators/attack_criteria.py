...
# All criteria classes for easy iteration
ALL_TESTCASE_GENERATION_ATTACK_CRITERIA = [
    ...
    SocialContextExploitation,
    MultiTurnAttacks,
    IndirectHarmScenarios,
    EdgeCaseExploitation,
    HallucinationInduction,
    ConsistencyTesting,
    CapabilityMisrepresentation,
    ContextWindowManipulation,
    ConversationStateCorruption,
    ContextInjection,
    MemoryPoisoning,
    LogicalFallacyExploitation,
    CircularReasoningTraps,
    FalsePremiseAcceptance,
    AdversarialAnalogies,
    CharacterRoleConfusion,
    FictionalScenarioExploitation,
    ProfessionalRoleImpersonation,
    IdentityFragmentation,
    EncodingAndObfuscation,
    LanguageSwitching,
    SteganographicPrompts,
    TokenLevelManipulation,
    MoralRelativismExploitation,
    LesserEvilArguments,
    ConsequentialistManipulation,
    TrolleyProblemVariants,
    TimeBasedLogicExploitation,
    SequentialInstructionReordering,
    DelayedActivationPrompts,
    HistoricalContextManipulation,
    FormatStringAttacks,
    StructuredDataManipulation,
    TemplateInjection,
    MetadataExploitation,
    MedicalMisinformation,
    FinancialFraudAssistance,
    LegalAdviceManipulation,
    EducationalContentCorruption,
    CognitiveLoadExploitation,
    AttentionMisdirection,
    PatternMatchingFailures,
    SubliminalInstructionEmbedding,
    CrossModalConfusion,
    InterDomainTransfer,
    ModalitySwitching,
    FormatCrossContamination,
    ComputationalResourceAbuse,
    OutputLengthManipulation,
    ProcessingTimeExploitation,
    MemoryExhaustionAttacks,
    CulturalSensitivityExploitation,
    GenerationalGapExploitation,
    RegionalLawConfusion,
    SocialNormManipulation,
    MultiAgentCoordination,
    HumanAICollaborationExploitation,
    ChainOfCustodyAttacks,
    DistributedHarmScenarios,
    ReinforcementManipulation,
    PreferenceLearningAttacks,
    FewShotLearningExploitation,
    MetaLearningManipulation,
    NoiseInjectionAttacks,
    AdversarialExampleGeneration,
    GradientBasedAttacks,
    BlackBoxOptimization,
    EmergentSkillDiscovery,
    CapabilityEscalation,
    CrossDomainSkillTransfer,
    ImplicitReasoningExploitation,
    ConfidenceCalibrationAttacks,
    EpistemicUncertaintyExploitation,
    AleatoricUncertaintyManipulation,
    UncertaintyCascading,
    TrainingDataReconstruction,
    KnowledgeBoundaryProbing,
    FactualInconsistencyExploitation,
    KnowledgeSourceAttribution,
    BehavioralDriftInduction,
    AdaptationExploitation,
    HabituationAttacks,
    BehavioralAnchoring,
    APIBoundaryViolations,
    IntegrationPointAttacks,
    PluginAndExtensionExploitation,
    InterServiceCommunicationAttacks,
]
