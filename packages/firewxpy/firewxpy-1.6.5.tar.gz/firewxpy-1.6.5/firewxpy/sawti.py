...
def sawti(zone_1_threshold_1=10, zone_1_threshold_2=15, zone_1_threshold_3=21, zone_1_threshold_4=40, zone_2_threshold_1=9, zone_2_threshold_2=13, zone_2_threshold_3=20, zone_2_threshold_4=28, zone_3_threshold_1=10, zone_3_threshold_2=16, zone_3_threshold_3=24, zone_3_threshold_4=36, zone_4_threshold_1=9, zone_4_threshold_2=12, zone_4_threshold_3=15, zone_4_threshold_4=25, zone_1_W_weight=1, zone_1_DD_weight=1, zone_1_FMC_weight=1, zone_2_W_weight=1, zone_2_DD_weight=1, zone_2_FMC_weight=1, zone_3_W_weight=1, zone_3_DD_weight=1, zone_3_FMC_weight=1, zone_4_W_weight=1, zone_4_DD_weight=1, zone_4_FMC_weight=1):
    ...
    # Sets up folders
    if os.path.exists(f"SAWTI Data"):
        pass
    else:
        os.mkdir(f"SAWTI Data")
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                try:
                    urllib.request.urlretrieve('https://sdge.sdsc.edu/data/sdge/sawti/Zone1-LA-Ventura/seaspace_zone1_'+yday.strftime('%m%d%Y')+'_00z.csv', 'seaspace_zone1_'+yday.strftime('%m%d%Y')+'_00z.csv')
                    os.replace('seaspace_zone1_'+yday.strftime('%m%d%Y')+'_00z.csv', f'SAWTI Data/seaspace_zone1_{yday.strftime("%m%d%Y")}_00z.csv')
                    today = False
                except Exception as e:
                    print("Latest Data is over a day old. Aborting...")
                    abort = True
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                try:
                    urllib.request.urlretrieve('https://sdge.sdsc.edu/data/sdge/sawti/Zone2-Orange-InlandEmpire/seaspace_zone2_'+yday.strftime('%m%d%Y')+'_00z.csv', 'seaspace_zone2_'+yday.strftime('%m%d%Y')+'_00z.csv')
                    os.replace('seaspace_zone2_'+yday.strftime('%m%d%Y')+'_00z.csv', f'SAWTI Data/seaspace_zone2_{yday.strftime("%m%d%Y")}_00z.csv')
                    today = False
                except Exception as e:
                    print("Latest Data is over a day old. Aborting...")
                    abort = True
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                try:
                    urllib.request.urlretrieve('https://sdge.sdsc.edu/data/sdge/sawti/Zone3-SanDiego/seaspace_zone3_'+yday.strftime('%m%d%Y')+'_00z.csv', 'seaspace_zone3_'+yday.strftime('%m%d%Y')+'_00z.csv')
                    os.replace('seaspace_zone3_'+yday.strftime('%m%d%Y')+'_00z.csv', f'SAWTI Data/seaspace_zone3_{yday.strftime("%m%d%Y")}_00z.csv')
                    today = False
                except Exception as e:
                    print("Latest Data is over a day old. Aborting...")    
                    abort = True
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                try:
                    urllib.request.urlretrieve('https://sdge.sdsc.edu/data/sdge/sawti/Zone4-SantaBarbara/seaspace_zone4_'+yday.strftime('%m%d%Y')+'_00z.csv', 'seaspace_zone4_'+yday.strftime('%m%d%Y')+'_00z.csv')
                    os.replace('seaspace_zone4_'+yday.strftime('%m%d%Y')+'_00z.csv', f'SAWTI Data/seaspace_zone4_{yday.strftime("%m%d%Y")}_00z.csv')
                    today = False
                except Exception as e:
                    print("Latest Data is over a day old. Aborting...")    
                    abort = True                
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    df1 = pd.read_csv(f'SAWTI Data/seaspace_zone1_{yday.strftime("%m%d%Y")}_00z.csv')
                    df1 = df1.transpose()
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    df2 = pd.read_csv(f'SAWTI Data/seaspace_zone2_{yday.strftime("%m%d%Y")}_00z.csv')
                    df2 = df2.transpose()
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    df3 = pd.read_csv(f'SAWTI Data/seaspace_zone3_{yday.strftime("%m%d%Y")}_00z.csv')
                    df3 = df3.transpose()
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    df4 = pd.read_csv(f'SAWTI Data/seaspace_zone4_{yday.strftime("%m%d%Y")}_00z.csv')
                    df4 = df4.transpose()
