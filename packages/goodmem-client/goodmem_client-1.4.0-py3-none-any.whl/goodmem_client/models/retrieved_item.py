...
class RetrievedItem(BaseModel):
    ...
    """ # noqa: E501
    memory: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Complete memory object (if retrieved)")
    chunk: Optional[ChunkReference] = None
    __properties: ClassVar[List[str]] = ["memory", "chunk"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chunk": ChunkReference.from_dict(obj["chunk"]) if obj.get("chunk") is not None else None
        })
        return _obj
