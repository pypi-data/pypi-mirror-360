...
class RetrieveMemoryEvent(BaseModel):
    ...
    memory_definition: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Memory object to add to client's memories array (converted from protobuf)", alias="memoryDefinition")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if memory_definition (nullable) is None
        # and model_fields_set contains the field
        if self.memory_definition is None and "memory_definition" in self.model_fields_set:
            _dict['memoryDefinition'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memoryDefinition": obj.get("memoryDefinition"),
