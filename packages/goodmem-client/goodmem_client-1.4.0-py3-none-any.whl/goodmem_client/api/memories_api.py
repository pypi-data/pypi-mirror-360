...
class MemoriesApi:
    ...
    def retrieve_memory(
        self,
        message: Annotated[StrictStr, Field(description="Primary query/message for semantic search")],
        space_ids: Annotated[Optional[StrictStr], Field(description="Comma-separated list of space UUIDs to search within")] = None,
        requested_size: Annotated[Optional[StrictInt], Field(description="Maximum number of memories to retrieve")] = None,
        fetch_memory: Annotated[Optional[StrictBool], Field(description="Whether to fetch memory definitions (defaults to true)")] = None,
        fetch_memory_content: Annotated[Optional[StrictBool], Field(description="Whether to fetch original content for memories (defaults to false)")] = None,
        generate_abstract: Annotated[Optional[StrictBool], Field(description="Whether to generate an abstract summary (defaults to true)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param message: Primary query/message for semantic search (required)
        :type message: str
        :param space_ids: Comma-separated list of space UUIDs to search within
        :type space_ids: str
        :param requested_size: Maximum number of memories to retrieve
        :type requested_size: int
        :param fetch_memory: Whether to fetch memory definitions (defaults to true)
        :type fetch_memory: bool
        :param fetch_memory_content: Whether to fetch original content for memories (defaults to false)
        :type fetch_memory_content: bool
        :param generate_abstract: Whether to generate an abstract summary (defaults to true)
        :type generate_abstract: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._retrieve_memory_serialize(
            message=message,
            space_ids=space_ids,
    ...
    def retrieve_memory_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RetrieveMemoryEvent]:
        """Stream semantic memory retrieval
    ...
    def _retrieve_memory_serialize(
        ...
        if generate_abstract is not None:
            ...
            _query_params.append(('generateAbstract', generate_abstract))
