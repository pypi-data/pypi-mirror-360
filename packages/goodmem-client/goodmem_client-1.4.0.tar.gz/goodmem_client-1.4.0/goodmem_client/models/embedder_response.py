...
class EmbedderResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["embedderId", "displayName", "description", "providerType", "endpointUrl", "apiPath", "modelIdentifier", "dimensionality", "maxSequenceLength", "supportedModalities", "labels", "version", "monitoringEndpoint", "ownerId", "createdAt", "updatedAt", "createdById", "updatedById"]
