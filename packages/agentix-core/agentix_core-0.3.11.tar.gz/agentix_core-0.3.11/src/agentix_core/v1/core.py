...
class Core:
    ...
    # Submit Task in Core
    #================================================================================================
    async def submit_task(self, JOB_COOKIE: dict, task_key: str, output: list[dict] | None = None, metadata: str = None) -> bool:
        """
    ...
    # Reject Task in Core
    #================================================================================================
    async def reject_task(self, JOB_COOKIE: dict, task_key: str, rejection_reason: str = "No reason provided", metadata: str = None) -> bool:
        """
