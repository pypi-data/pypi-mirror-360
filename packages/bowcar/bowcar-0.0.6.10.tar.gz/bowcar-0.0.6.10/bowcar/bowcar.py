...
class BowCar:
    ...
    def buzzer_on(self, scale: str = "C0", octave: int = 3, note: int = 4):
        ...
        arduino_loop_code += f"tone(BUZZER_PIN, {tones[octave][idx]}, {self.duration/note*0.95});\n"
        arduino_loop_code += f"delay({self.duration/note*0.05});\n"
        command = f'b{octave}{scale}{note}'
        self.send_command(command)
        time.sleep(self.duration // note)
