...
from bestsms.api.actions.requests._common import Common
from bestsms.api.actions.responses import ActionApiResult
...
class Resubmit(Common):
    ...
    def __str__(self):
        ...
        if self.AuthToken :
            return 'Resubmit(AuthToken='+self.AuthToken+')'
