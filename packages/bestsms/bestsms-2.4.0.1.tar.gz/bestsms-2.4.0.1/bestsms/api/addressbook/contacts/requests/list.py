...
from bestsms.api.addressbook.contacts.requests._common import Common
from bestsms.api.addressbook.contacts.responses.contact_list_api_result import ContactListApiResult
from bestsms.core.dtos.list_request_dto import ListRequestDTO

class ContactList(Common):
    ...
    def BuildAPIURL(self):
        ...
        return f"{self.APIURL}/addressbook/contact/list?recordsPerPage={self.Data.RecordsPerPage}&page={self.Data.Page}"
