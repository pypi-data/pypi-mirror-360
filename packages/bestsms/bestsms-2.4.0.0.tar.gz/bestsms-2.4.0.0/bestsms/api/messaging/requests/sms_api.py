...
from bestsms.api.messaging.dtos.sms_api_request_dto import SMSApiRequestDTO
from bestsms.api.messaging.requests._common import Common
from bestsms.api.messaging.responses import MessageApiResult
...
class SMSApi(Common):
    ...
    """ Private function to POST message to BestSMS REST API """
    ...
    """ Private async function to POST message to BestSMS REST API """
