...
from synapx.nn import Module, functional as F
...
class MSELoss(Loss):
    ...
    def forward(self, y_pred: Tensor, y_true: Tensor) -> Tensor:
        return F.mse_loss(y_pred, y_true, self.reduction)
...
class NLLLoss(Loss):
    ...
    def forward(self, y_pred: Tensor, y_true: Tensor) -> Tensor:
        return F.nll_loss(y_pred, y_true, self.reduction)
...
class BCELoss(Loss):
    ...
    def forward(self, y_pred: Tensor, y_true: Tensor) -> Tensor:
        return F.binary_cross_entropy(y_pred, y_true, self.reduction)
...
class BCEWithLogitsLoss(Loss):
    ...
    def forward(self, y_pred: Tensor, y_true: Tensor) -> Tensor:
        return F.binary_cross_entropy_with_logits(y_pred, y_true, self.reduction)
...
class CrossEntropyLoss(Loss):
    ...
    def forward(self, y_pred: Tensor, y_true: Tensor) -> Tensor:
        return F.cross_entropy(y_pred, y_true, self.reduction)
