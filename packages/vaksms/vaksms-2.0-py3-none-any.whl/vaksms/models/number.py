...
class Number():
    ...
    def get_sms_code(self, *args, **kwargs):
        return self.vaksms_instance.get_sms_code(self, *args, **kwargs)
        
    def wait_sms_code(self, *args, **kwargs):
        return self.vaksms_instance.wait_sms_code(self, *args, **kwargs)
        
    def set_status(self, *args, **kwargs):
        return self.vaksms_instance.set_status(self, *args, **kwargs)
