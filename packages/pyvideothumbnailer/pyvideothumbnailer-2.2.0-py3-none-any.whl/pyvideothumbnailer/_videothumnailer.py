...
class Parameters:
    ...
    DEFAULT_VIDEO_EXTENSIONS = set('.avi',
                                   '.divx',
                                   '.flv',
                                   '.m4v',
                                   '.mkv',
...
class VideoThumbnailer:
    ...
    def __parse_args() -> Namespace:
        ...
        parser.add_argument('--video-file-extensions',
                             type=str,
                             help="""A list of file extensions recognized as video file extensions to be provided as a string.
                                     File extensions have to be separated by commas (','). Each file extension has to be prepended with a dot ('.').""")
    ...
    def __init_parameters(self):
        ...
        if config_file.is_file():
            ...
            if ConfigFile.CONFIG_SECTION_VIDEO in config:
                ...
                if 'video_file_extensions' in video_options:
