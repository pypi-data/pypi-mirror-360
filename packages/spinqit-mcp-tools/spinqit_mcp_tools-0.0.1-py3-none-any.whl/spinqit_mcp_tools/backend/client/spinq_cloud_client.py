...
class SpinQCloudClient():
    ...
    def _task_result_by_id(self, task_id: str):
        taskinfo = {"taskId": task_id}
        return self._session.get(HOST + TASK_URI_PREFIX + "/getTaskResultVisualizationData", params=taskinfo)
    
    def task_result_by_id(self, task_id: str, retry_count:int = RETRY_COUNT):
        return self._retry_request(self._task_result_by_id, retry_count, task_id)
