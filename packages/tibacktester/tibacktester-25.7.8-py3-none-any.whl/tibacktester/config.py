...
class StrategyConfig:
    """Configuration options for :class:`tibacktester.strategy.Strategy`.

    Attributes:
        initial_cash: Starting cash of strategy.
        fee_mode: :class:`tibacktester.common.FeeMode` for calculating brokerage
            ...
            - ``Callable[[FeeInfo], Decimal]``: Fees are calculated using a
                ...
                :class:`tibacktester.common.FeeInfo`.
        ...
        round_fill_price: Whether to round fill prices to the nearest cent.
            Defaults to ``True``.
        position_mode: Position mode for :class:`tibacktester.strategy.Strategy`.
            Supports one of:
        ...
        max_long_positions: Maximum number of long positions that can be held
            at any time in :class:`tibacktester.portfolio.Portfolio`. Unlimited
            when ``None``. Defaults to ``None``.
        max_short_positions: Maximum number of short positions that can be
            held at any time in :class:`tibacktester.portfolio.Portfolio`.
        ...
        exit_cover_fill_price: Fill price for covering an open short position
            ...
            :attr:`tibacktester.common.PriceType.MIDDLE`.
        ...
        return_signals: When ``True``, then bar data, indicator data, and model
            ...
            :class:`tibacktester.strategy.TestResult`. Defaults to ``False``.
