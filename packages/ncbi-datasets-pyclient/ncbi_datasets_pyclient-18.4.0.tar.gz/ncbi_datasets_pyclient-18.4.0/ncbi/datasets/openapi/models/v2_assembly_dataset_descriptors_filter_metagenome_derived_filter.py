...
class V2AssemblyDatasetDescriptorsFilterMetagenomeDerivedFilter(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of V2AssemblyDatasetDescriptorsFilterMetagenomeDerivedFilter from a JSON string"""
