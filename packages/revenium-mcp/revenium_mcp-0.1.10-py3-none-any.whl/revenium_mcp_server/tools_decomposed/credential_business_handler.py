...
from ..business_context.credential_business_context import (
    CredentialBusinessContext, BusinessScenario
)
...
class CredentialBusinessHandler:
    ...
    async def analyze_billing_impact(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        impact_analysis = self.business_context.get_billing_impact_explanation(operation, credential_data)
        
        # Get billing relationship explanations
        relationships = {
            "credential_to_subscription": self.business_context.get_billing_relationship_explanation("credential_to_subscription"),
            "organization_hierarchy": self.business_context.get_billing_relationship_explanation("organization_hierarchy"),
            "subscription_metering": self.business_context.get_billing_relationship_explanation("subscription_metering")
        }
