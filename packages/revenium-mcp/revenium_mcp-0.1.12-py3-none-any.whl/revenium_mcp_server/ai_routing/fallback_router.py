...
from .models import RoutingResult, RoutingMethod, RoutingStatus, ExtractedParameters
...
class FallbackRouter:
    ...
    async def route_query(self, query: str, tool_context: str) -> RoutingResult:
        ...
        if result.status == RoutingStatus.FAILED:
            ...
            logger.debug(f"Rule-based routing result: {tool_name}.{action} (confidence: {overall_confidence:.2f})")
