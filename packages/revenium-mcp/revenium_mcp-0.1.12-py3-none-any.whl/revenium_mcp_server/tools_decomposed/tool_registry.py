...
def _get_tool_registry() -> Dict[str, Type[ToolBase]]:
    ...
    # NOTE: Removed old individual tools that are now consolidated into system_setup and system_diagnostics:
    # - welcome_and_setup (now part of system_setup)
    # - setup_checklist (now part of system_setup)
    # - verify_email_setup (now part of system_setup)
    # - configuration_status (now part of system_diagnostics)
    # - debug_auto_discovery (now part of system_diagnostics)
