...
class CostSummaryFormatter(AnalyticsResponseFormatter):
    ...
    def _format_cost_summary_content(self, data: Dict[str, Any], period: str, aggregation: str) -> str:
...
"""
    ...
    def _format_top_contributors_section(self, section_name: str, contributors: List[Dict[str, Any]], key_field: str) -> str:
        ...
        for contributor in contributors[:3]:  # Top 3
            ...
            name = (contributor.get(key_field) or 
                   contributor.get('name') or 
                   f'Unknown {section_name[:-1]}')  # Remove 's' from section name
