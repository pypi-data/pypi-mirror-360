...
class MCPCapabilityIntegration:
    ...
    async def _generate_tool_schema(self, resource_type: str, capabilities: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _generate_resource_schema(self, resource_type: str, capabilities: Dict[str, Any]) -> Dict[str, Any]:
