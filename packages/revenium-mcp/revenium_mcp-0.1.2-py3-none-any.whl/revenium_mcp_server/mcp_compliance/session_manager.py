...
from .session_operations_helpers import (
    generate_unique_session_id, create_session_info, check_session_limit,
    get_active_sessions, cleanup_expired_sessions, should_perform_cleanup,
    build_session_stats, get_session_from_headers, create_session_headers,
    validate_session_exists, terminate_session_by_id, expire_session_by_id
)
...
class MCPSessionManager:
    ...
    def create_session(
        ...
        try:
            ...
            session = create_session_info(
                session_id, client_info, protocol_version,
    ...
    def create_session_headers(self, session_id: str) -> Dict[str, str]:
        ...
        """
        return {
            self.session_id_header: session_id
        }
