...
from .graph import ResourceGraph, ResourceNode, RelationshipEdge, RelationshipType
...
class ResourceRelationshipEngine:
    ...
    async def add_resource(
        ...
        async with self._lock:
            try:
                ...
                relationships = self.discovery.get_resource_relationships(resource_type, str(resource_id))
    ...
    async def validate_cross_resource_operation(
        self, 
            ...
            for resource_type, pattern_data in patterns.items():
                formatted_patterns[resource_type] = {
                    ...
                    "field_mappings": {
                        ...
                        for field, (target_type, rel_type) in pattern_data.get("field_mappings", {}).items()
                    }
                }
        ...
        try:
            ...
            impact_analysis = {
                ...
                "high_impact_count": len([
                    edge for edge in incoming_edges + outgoing_edges
