...
from .error_handling import (
    MCPError, JSONRPCErrorCode, create_invalid_params_error,
    create_method_not_found_error, create_internal_error
)
...
class MCPLifecycleManager:
    ...
    def __init__(self, server_name: str = "revenium-mcp", server_version: str = "1.0.0"):
    ...
    def _build_server_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "prompts": {
                "listChanged": True  # Support for prompts/list_changed notifications
            },
    ...
    async def handle_initialize_request(
        ...
        try:
            ...
            logger.info(f"MCP initialization from {client_name} v{client_version} using protocol {protocol_version}")
...
Ensure REVENIUM_API_KEY is configured for API access.
    ...
    async def handle_initialized_notification(self, params: Optional[Dict[str, Any]] = None) -> None:
    ...
    async def handle_shutdown(self) -> None:
        ...
        if self.is_initialized:
            client_name = self.client_info.get("name", "Unknown Client") if self.client_info else "Unknown Client"
    ...
    def get_client_capability_support(self, capability: str, sub_capability: Optional[str] = None) -> bool:
