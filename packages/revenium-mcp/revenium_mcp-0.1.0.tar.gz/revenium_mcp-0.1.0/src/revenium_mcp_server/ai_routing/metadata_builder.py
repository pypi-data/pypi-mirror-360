...
class ReveniumMetadataBuilder:
    ...
    def _load_default_config(self) -> MCPMetadataConfig:
        ...
        return MCPMetadataConfig(
            ...
            enable_detailed_tracking=os.getenv("REVENIUM_MCP_DETAILED_TRACKING", "true").lower() == "true",
            include_query_context=os.getenv("REVENIUM_MCP_INCLUDE_CONTEXT", "true").lower() == "true"
        )
