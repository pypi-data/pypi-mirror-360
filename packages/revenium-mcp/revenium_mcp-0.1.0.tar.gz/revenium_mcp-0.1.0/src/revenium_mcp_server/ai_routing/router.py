...
from .models import RoutingResult, RoutingMethod, RoutingStatus
from .parameter_extractor import ParameterExtractor
from .tool_integration import ToolIntegrator, ToolIntegrationError
...
class UniversalQueryRouter:
    ...
    def __init__(self, config: AIRoutingConfig, metrics_collector: Optional[SimpleMetricsCollector] = None):
