...
class UserManager:
    ...
    def __init__(self, client: ReveniumClient) -> None:
        """Initialize user manager with client."""
        self.client = client
    ...
    def _populate_call_count_element_definition(self, resource: Dict[str, Any]) -> None:
        ...
        if 'callCountElementDefinition' in resource:
            ...
            if isinstance(call_count_def, dict):
                ...
                if call_count_def.get('resourceType') == 'undefined' or not call_count_def.get('resourceType'):
                ...
                if call_count_def.get('label') == 'undefined' or not call_count_def.get('label'):
                    ...
                    resource_name = resource.get('name', resource.get('label', resource.get('email', 'Unknown')))
        ...
        if user_id:
            ...
            raise create_structured_missing_parameter_error(
                ...
                examples={
                    ...
                    "valid_formats": ["user_id should be a string identifier", "email should be a valid email address"],
        ...
        if not user_data and name:
            ...
            raise create_structured_missing_parameter_error(
                ...
                examples={
                    ...
                    "example_data": {"email": "user@company.com", "firstName": "John", "lastName": "Doe", "roles": ["ROLE_API_CONSUMER"]},
    ...
    async def update_user(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = await self.update_handler.update_with_merge(
            resource_id=user_id,
            partial_data=user_data,
            config=config,
            action_context="update user"
        )
...
class SubscriberManager:
    ...
    def __init__(self, client: ReveniumClient) -> None:
        """Initialize subscriber manager with client."""
        self.client = client
        ...
        if subscriber_id:
            ...
            raise create_structured_missing_parameter_error(
                ...
                examples={
                    ...
                    "valid_formats": ["subscriber_id should be a string identifier", "email should be a valid email address"],
        ...
        if not subscriber_data:
            raise create_structured_missing_parameter_error(
                ...
                examples={
                    ...
                    "required_fields": ["email", "firstName", "lastName", "organizationIds", "roles"],
                    "example_data": {"email": "subscriber@company.com", "firstName": "John", "lastName": "Doe", "subscriberId": "unique_id_123", "organizationIds": ["org_id_123"], "roles": ["ROLE_API_CONSUMER"]},
                    ...
                    "billing_safety": "🔒 BILLING SAFETY: Subscriber creation establishes billing identity and subscription relationships"
                }
            )
    ...
    async def update_subscriber(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not subscriber_data:
            raise create_structured_missing_parameter_error(
                ...
                examples={
                    "usage": "update(resource_type='subscribers', subscriber_id='sub_123', subscriber_data={'name': 'Updated Name'})",
                    "partial_update": "Only provide the fields you want to update",
                    "updatable_fields": ["firstName", "lastName", "email", "status", "organizationIds"],
        ...
        if "roles" in subscriber_data:
            ...
            logger.info(f"Subscriber {subscriber_id} role update requested: {provided_roles} (backend will validate)")
...
class OrganizationManager:
    ...
    def __init__(self, client: ReveniumClient) -> None:
        """Initialize organization manager with client."""
        self.client = client
        ...
        if 'callCountElementDefinition' in resource:
            ...
            if isinstance(call_count_def, dict):
                ...
                if call_count_def.get('label') == 'undefined' or not call_count_def.get('label'):
                    # Try to create a meaningful label from available data
                    element_id = call_count_def.get('id', 'Unknown')
                    resource_name = resource.get('name', resource.get('label', 'Unknown'))
                    call_count_def['label'] = f"Call Count for {resource_name} ({element_id})"
    ...
    async def create_organization(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not organization_data:
            raise create_structured_missing_parameter_error(
                ...
                examples={
                    ...
                    "example_data": {"name": "Acme Corp", "description": "Technology company", "status": "active"},
        ...
        if "tenantId" not in organization_data:
            organization_data["tenantId"] = self.client.auth_config.tenant_id or self.client.auth_config.team_id
...
class TeamManager:
    ...
    def __init__(self, client: ReveniumClient) -> None:
        """Initialize team manager with client."""
        self.client = client
        ...
        if not team_data:
            raise create_structured_missing_parameter_error(
                ...
                examples={
                    ...
                    "example_data": {"name": "Development Team", "organization_id": "org_123", "description": "Main dev team"},
    ...
    async def update_team(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = await self.update_handler.update_with_merge(
            resource_id=team_id,
            partial_data=team_data,
            config=config,
            action_context="update team"
        )
...
class CustomerValidator:
    ...
    def get_examples(self, resource_type: Optional[str] = None) -> Dict[str, Any]:
        ...
        static_examples = {
            ...
            "subscribers": {
                ...
                "note": "⚠️ REQUIRED: organizationIds and roles fields must be explicitly provided - use resolve_organization_name_to_id() to get organization ID"
            },
            "organizations": {
    ...
    async def validate_configuration(self, resource_type: str, resource_data: Dict[str, Any], dry_run: bool = True) -> Dict[str, Any]:
        ...
        if not self.schema_discovery:
            ...
            raise ToolError(
                ...
                examples={
                    ...
                    "proper_initialization": "Customer management requires schema discovery integration",
        ...
        return self.schema_discovery.validate_customer_configuration(resource_data, resource_type, dry_run)
                    ...
                    "available_roles": [
                        {
                            ...
                            "permissions": ["Full tenant management", "User management", "Resource creation/modification"],
...
class CustomerAnalytics:
    ...
    async def analyze_customers(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if resource_type == "users":
            ...
            analytics = {
                ...
                "activity_rate": (active_resources / total_resources * 100) if total_resources > 0 else 0,
                "sample_size": len(resources),
                "organizations_represented": len(set(r.get('organizationId') for r in resources if r.get('organizationId'))),
                "teams_represented": len(set(r.get('teamId') for r in resources if r.get('teamId')))
            }
            ...
            analytics = {
                ...
                "conversion_rate": (active_resources / total_resources * 100) if total_resources > 0 else 0,
                "trial_rate": (trial_resources / total_resources * 100) if total_resources > 0 else 0,
                "sample_size": len(resources),
                "organizations_represented": len(set(r.get('organizationId') for r in resources if r.get('organizationId')))
            }
            ...
            analytics = {
                ...
                "activity_rate": (active_resources / total_resources * 100) if total_resources > 0 else 0,
                "sample_size": len(resources),
                "hierarchical_organizations": len([r for r in resources if r.get('parentOrganizationId')])
            }
            ...
            raise create_structured_validation_error(
                ...
                examples={
                    ...
                    "analytics_types": ["user_activity", "subscription_metrics", "organization_growth"]
                }
            )
    ...
    async def get_relationships(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        resource_id = (arguments.get("resource_id") or
                      arguments.get("user_id") or
                      arguments.get("subscriber_id") or
                      arguments.get("organization_id") or
...
class CustomerManagement(ToolBase):
    ...
    async def handle_action(
        ...
        try:
            ...
            if action == "list":
                if resource_type == "users":
                    ...
                    raise create_structured_validation_error(
                        ...
                        examples={
                            "valid_resource_types": ["organizations", "subscribers", "users", "teams"],
                            "usage": "list(resource_type='organizations')",
                            "example_calls": ["list(resource_type='organizations')", "list(resource_type='subscribers')"],
                ...
                if resource_type == "users":
                    ...
                    raise create_structured_validation_error(
                        ...
                        examples={
                            "valid_resource_types": ["organizations", "subscribers", "users", "teams"],
                            "usage": "get(resource_type='organizations', organization_id='org_123')",
                            "example_calls": ["get(resource_type='organizations', organization_id='org_123')", "get(resource_type='subscribers', subscriber_id='sub_456')"],
                ...
                if not resource_data:
                    resource_data = (arguments.get("user_data") or arguments.get("subscriber_data") or
                                   arguments.get("organization_data") or arguments.get("team_data") or {})
                
                # PROGRESSIVE COMPLEXITY: Auto-generate missing fields based on mode
                if auto_generate and resource_data:
                    resource_data = self._apply_auto_generation(resource_data, resource_type, arguments)
                
                # Handle dry_run mode for create operations
                if dry_run:
                    return [TextContent(
                        type="text",
                        text=f"🧪 **DRY RUN MODE - Customer Creation**\n\n"
                ...
                if dry_run:
                    resource_data = (arguments.get("user_data") or arguments.get("subscriber_data") or
                                   arguments.get("organization_data") or arguments.get("team_data"))
                    identifier = (arguments.get("user_id") or arguments.get("subscriber_id") or
                                arguments.get("organization_id") or arguments.get("team_id"))
                    return [TextContent(
                        type="text",
                        text=f"🧪 **DRY RUN MODE - Customer Update**\n\n"
                ...
                if resource_type == "users":
                    ...
                    raise create_structured_validation_error(
                        ...
                        examples={
                            ...
                            "example_calls": ["update(resource_type='users', user_id='user_123', user_data={...})", "update(resource_type='organizations', organization_id='org_456', organization_data={...})"],
                ...
                if dry_run:
                    ...
                    return [TextContent(
                        type="text",
                        text=f"🧪 **DRY RUN MODE - Customer Deletion**\n\n"
                ...
                if resource_type == "users":
                    ...
                    raise create_structured_validation_error(
                        ...
                        examples={
                            "valid_resource_types": ["organizations", "subscribers", "users", "teams"],
                            "usage": "delete(resource_type='organizations', organization_id='org_123')",
                            "example_calls": ["delete(resource_type='organizations', organization_id='org_123')", "delete(resource_type='subscribers', subscriber_id='sub_456')"],
            ...
            # Validation and discovery operations
                    ...
                    raise create_structured_missing_parameter_error(
                        ...
                        examples={
                            ...
                            "example_data": {
                                ...
                                "subscribers": {"email": "subscriber@company.com", "firstName": "John", "lastName": "Doe"}
                            },
                ...
                result = await self.validator.validate_configuration(resource_type, resource_data, dry_run)
    ...
    def _format_capabilities_response(self, capabilities: Dict[str, Any]) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
        ...
        if capabilities.get("user_roles"):
            ...
            for role in capabilities.get("user_roles", []):
                if role == "ROLE_TENANT_ADMIN":
                    result_text += f"- `{role}` (returned by API, but not valid or available for customers)\n"
                else:
                    result_text += f"- `{role}`\n"
            result_text += "### Subscribers\n"
            result_text += "- `ROLE_API_CONSUMER` (required field - only role allowed for subscribers)\n"
        ...
        result_text += "3. Use `validate(resource_type='...', ...data={...})` to test configurations\n"
        ...
        if validation_result["valid"]:
            ...
            if errors:
                ...
                raise create_structured_validation_error(
                    ...
                    examples={
                        "common_issues": ["Missing required fields", "Invalid data format", "Type mismatch"],
                        "validation_tips": ["Check field requirements", "Verify data types", "Ensure proper formatting"],
                ...
                raise create_structured_validation_error(
                    ...
                    examples={
                        "common_issues": ["Missing required fields", "Invalid data format", "Unsupported resource type"],
                        "validation_tips": ["Check field types", "Verify required vs optional fields", "Ensure data consistency"],
    ...
    def _format_roles_response(self, roles: Dict[str, Any]) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
        ...
        result_text += '  "lastName": "Doe",\n'
        result_text += '  "organizationIds": ["org_id_123"],\n'
        ...
        result_text += "2. Use `get_examples(resource_type='users')` to see complete user templates\n"
        result_text += "3. Use `validate(resource_type='users', user_data={...})` to test user configurations\n"
        result_text += "4. Use `create(resource_type='users', user_data={...})` to create users with roles\n"
        ...
        return [
            ToolCapability(
                ...
                parameters={
                    ...
                    "get": {"user_id": "str", "subscriber_id": "str", "organization_id": "str", "team_id": "str"},
                    "create": {"user_data": "dict", "subscriber_data": "dict", "organization_data": "dict", "team_data": "dict"},
    ...
    def _apply_auto_generation(self, resource_data: Dict[str, Any], resource_type: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        """Apply auto-generation for progressive complexity support.
    ...
    async def _get_supported_actions(self) -> List[str]:
        ...
        return [
            "list", "get", "create", "update", "delete", "analyze",
            "get_capabilities", "get_examples", "get_roles", "validate",
            "get_agent_summary", "get_relationships", "get_tool_metadata"
        ]
