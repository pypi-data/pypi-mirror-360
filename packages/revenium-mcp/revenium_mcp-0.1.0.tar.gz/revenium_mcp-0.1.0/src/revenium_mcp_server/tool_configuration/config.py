...
class ToolConfig:
    ...
    Attributes:
        profile: Current profile name (starter/business/enterprise)
    ...
    def create_for_testing(
        ...
        **kwargs
        ...
        profile = kwargs.pop('profile', 'enterprise')
    ...
    def _validate_configuration(self) -> None:
        ...
        if self.profile not in PROFILE_DEFINITIONS:
            logger.warning(f"Invalid profile '{self.profile}', using 'enterprise'")
    ...
    def save_config(self) -> None:
        ...
        success = loader.save_json_config(
            self.profile,
