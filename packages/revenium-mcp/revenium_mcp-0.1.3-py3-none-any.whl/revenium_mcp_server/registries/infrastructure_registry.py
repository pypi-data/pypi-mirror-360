...
class InfrastructureRegistry(BaseToolRegistry):
    ...
    registry_description: ClassVar[str] = "System management and monitoring tools with enterprise compliance"
    ...
    def _register_infrastructure_tools(self):
        ...
        self._register_tool("debug_auto_discovery", ConfigurationStatus, {
            "description": "System configuration status and debugging analysis",
            "complexity": "high",
            "parameters": "environment focused"
        })
        
        self._register_tool("performance_dashboard", FastMCPPerformanceDashboard, {
            "description": "FastMCP performance monitoring and system health dashboards",
            "complexity": "medium",
            "parameters": "monitoring scope"
        })
        
        self._register_tool("manage_capabilities", ManageCapabilities, {
            "description": "UCM capability management and configuration",
            "complexity": "medium", 
            "parameters": "capability focused"
        })
        
        self._register_tool("welcome_and_setup", WelcomeSetup, {
    ...
    async def _route_infrastructure_action(self, action: str, arguments: Dict[str, Any]) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
        ...
        elif action in ["performance_dashboard", "fastmcp_performance_dashboard", "prometheus_metrics"]:
            return await self._handle_performance_action(action, arguments)
        
        # Capability management actions
        elif action in ["manage_capabilities", "get_resource_type", "set_capability", "get_capability"]:
            return await self._handle_capability_action(action, arguments)
        
        # Welcome and setup workflow actions
        elif action in ["show_welcome", "setup_checklist", "environment_status", "next_steps", "complete_setup"]:
    ...
    async def _handle_debug_action(self, action: str, arguments: Dict[str, Any]) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
        ...
        return await self._standardized_tool_execution("debug_auto_discovery", action, debug_params.__dict__)
    
    async def _handle_performance_action(self, action: str, arguments: Dict[str, Any]) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
    ...
    async def _handle_capability_action(self, action: str, arguments: Dict[str, Any]) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
    ...
    async def _handle_welcome_action(self, action: str, arguments: Dict[str, Any]) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
    ...
    async def _handle_system_action(self, action: str, arguments: Dict[str, Any]) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
        ...
        # Execute via standardized tool execution
        return await self._standardized_tool_execution("welcome_and_setup", action, health_params.__dict__)
