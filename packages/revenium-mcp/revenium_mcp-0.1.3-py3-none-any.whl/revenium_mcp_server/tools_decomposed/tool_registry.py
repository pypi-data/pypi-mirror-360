...
def _get_tool_registry() -> Dict[str, Type[ToolBase]]:
    ...
    try:
        from .metering_field_validation import MeteringFieldValidationManagement
        registry["manage_metering_field_validation"] = MeteringFieldValidationManagement
    except ImportError:
        pass
    ...
    try:
        ...
        registry["welcome_and_setup"] = WelcomeSetup
    except ImportError:
        pass
    
    try:
        from .setup_checklist import SetupChecklist
        registry["setup_checklist"] = SetupChecklist
    except ImportError:
        pass
    
    try:
        from .email_verification import EmailVerification
        registry["verify_email_setup"] = EmailVerification
    except ImportError:
        pass
    
    try:
        from .configuration_status import ConfigurationStatus
        registry["configuration_status"] = ConfigurationStatus
    except ImportError:
        pass
    
    try:
        from .debug_auto_discovery import DebugAutoDiscovery
        registry["debug_auto_discovery"] = DebugAutoDiscovery
    except ImportError:
        pass
    ...
    try:
        ...
        registry["slack_setup_assistant"] = SlackSetupAssistant
    except ImportError:
        pass
    
    try:
        from .slack_oauth_workflow import SlackOAuthWorkflow
        registry["slack_oauth_workflow"] = SlackOAuthWorkflow
    except ImportError:
        pass
    
    try:
        from .slack_configuration_management import SlackConfigurationManagement
        registry["slack_configuration_management"] = SlackConfigurationManagement
    except ImportError:
        pass
    ...
    try:
        ...
        registry["performance_dashboard"] = PerformanceDashboard
    except ImportError:
        pass
    
    try:
        from .fastmcp_performance_dashboard import FastMCPPerformanceDashboard
        registry["fastmcp_performance_dashboard"] = FastMCPPerformanceDashboard
    except ImportError:
        pass
    
    try:
        from .prometheus_metrics import PrometheusMetrics
        registry["prometheus_metrics"] = PrometheusMetrics
    except ImportError:
        pass
    ...
    try:
        ...
        registry["revenium_log_analysis"] = ReveniumLogAnalysis
    except ImportError:
        pass
    ...
    try:
        ...
        registry["system_monitoring"] = SystemMonitoring
    except ImportError:
        pass
