...
class AgentCostsFormatter(AnalyticsResponseFormatter):
    ...
    def format(self, data: List[Dict[str, Any]], params: Dict[str, Any]) -> str:
        ...
        return self._format_agent_costs_content(data, {"period": period, "aggregation": aggregation})
    
    def _format_agent_costs_content(self, data: List[Dict[str, Any]], params: Dict[str, Any]) -> str:
