...
from .models import Currency, PlanType, BillingPeriod
...
class SmartDefaultsEngine:
    ...
    def get_pagination_defaults(self) -> Dict[str, Any]:
        ...
        return {
            "page": 0,
            "size": self.env_defaults["page_size"],
            "sort": []
        }
    
    def apply_smart_defaults(self, tool_name: str, action: str, user_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def set_onboarding_context(self, onboarding_state: Optional[Dict[str, Any]] = None):
        ...
        if onboarding_state is None:
            try:
                ...
                self._onboarding_context = onboarding_state.__dict__ if hasattr(onboarding_state, '__dict__') else onboarding_state
    ...
    def get_onboarding_enhanced_defaults(self, tool_name: str, action: str, user_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _apply_onboarding_enhancements(self, tool_name: str, action: str, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        elif tool_name in ["welcome_and_setup", "setup_checklist", "verify_email_setup"] and is_first_time:
    ...
    def _enhance_alert_for_onboarding(self, alert_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if enhanced.get("alertType") == "THRESHOLD":
            enhanced["description"] = "🚀 Your First Alert: API Cost Monitor (Created during onboarding)"
    ...
    def _enhance_onboarding_tool_defaults(self, tool_name: str, action: str, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if tool_name == "welcome_and_setup":
            ...
            enhanced["completion_percentage"] = self._calculate_completion_percentage(setup_completion)
