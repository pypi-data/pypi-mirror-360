...
class ConfigurationStore:
    ...
    async def _attempt_discovery(self) -> None:
        ...
        try:
            ...
            logger.info("🔍 Attempting configuration auto-discovery...")
            ...
            logger.info(f"✅ Auto-discovery successful: {len(self._discovered_config.to_dict())} values discovered")
                ...
                if api_key and base_url:
                    ...
                    async with httpx.AsyncClient(timeout=5.0) as client:
                        ...
                        if response.status_code == 200:
                            ...
                            logger.info(f"✅ Manual extraction successful: team_id={team_id}, tenant_id={tenant_id}")
                            return
    ...
    def get_value_with_override(self, env_var_name: str, default: Optional[str] = None) -> Optional[str]:
