...
class EnhancedProductSchemaDiscovery:
    ...
    def get_complete_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "templates": {template.name: self._template_to_dict(template) for template in self.templates},
    ...
    def suggest_template(self, requirements: Dict[str, Any]) -> Dict[str, Any]:
        ...
        has_usage = any(keyword in str(requirements).lower() 
                       for keyword in ["usage", "per", "based on", "metered"])
        has_subscription = any(keyword in str(requirements).lower() 
                             for keyword in ["monthly", "yearly", "subscription", "recurring"])
        has_tiers = any(keyword in str(requirements).lower() 
        ...
        try:
            ...
            if template_info and "template" in template_info:
                return {
                    ...
                    "customization_guidance": self._get_customization_guidance(template_name, requirements)
                }
    ...
    def _build_field_documentation(self) -> List[FieldDocumentation]:
        ...
        return [
            FieldDocumentation(
                ...
                validation_rules=["2-255 characters", "No special characters except spaces, hyphens, underscores"],
            ...
            FieldDocumentation(
                ...
                common_mistakes=["Using deprecated CHARGE type", "Using SUBSCRIPTION without setting period"]
            )
        ]
    ...
    def _build_product_templates(self) -> List[SchemaTemplate]:
        ...
        return [
            ...
            SchemaTemplate(
                ...
                required_customizations=["name", "plan.rating_aggregations[0].name", "plan.tiers[0].unit_amount"],
                optional_customizations=["plan.rating_aggregations[0].aggregation_type", "description", "plan.period"]
            )
        ]
    ...
    def _explain_template_choice(self, requirements: Optional[Dict[str, Any]], template_name: str) -> str:
    ...
    def _get_customization_guidance(self, template_name: str, requirements: Optional[Dict[str, Any]] = None) -> List[str]:
    ...
    def _validate_plan_structure(self, plan_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "tiers" not in plan_data or not plan_data["tiers"]:
            result["errors"].append({
                ...
                "example": {"tiers": [{"name": "Basic Tier", "up_to": None, "unit_amount": "10.00"}]}
            })
    ...
    def _get_domain_specific_guidance(self, domain: str) -> Dict[str, Any]:
        ...
        return domain_guidance.get(domain, {
            "recommended_model": "Start simple and add complexity as needed",
            "pricing_tips": ["Keep pricing transparent", "Align with customer value", "Test different models"]
        })
