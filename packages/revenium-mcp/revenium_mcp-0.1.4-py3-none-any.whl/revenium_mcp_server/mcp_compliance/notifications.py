...
class MCPNotificationManager:
    ...
    async def send_tools_list_changed(self) -> bool:
        ...
        notification = NotificationMessage(
            method=NotificationType.TOOLS_LIST_CHANGED.value
        )
    ...
    async def send_resources_list_changed(self) -> bool:
        ...
        """
        notification = NotificationMessage(
            method=NotificationType.RESOURCES_LIST_CHANGED.value
        )
    ...
    async def send_prompts_list_changed(self) -> bool:
        ...
        """
        notification = NotificationMessage(
            method=NotificationType.PROMPTS_LIST_CHANGED.value
        )
        
        return await self.send_notification(notification)
    
    async def send_resource_updated(self, uri: str, changes: Optional[Dict[str, Any]] = None) -> bool:
        ...
        notification = NotificationMessage(
            method=NotificationType.RESOURCE_UPDATED.value,
            params=params
        )
        
        return await self.send_notification(notification)
    
    async def send_log_message(self, level: str, message: str, logger_name: Optional[str] = None) -> bool:
        ...
        notification = NotificationMessage(
            method=NotificationType.LOG_MESSAGE.value,
            params=params
        )
