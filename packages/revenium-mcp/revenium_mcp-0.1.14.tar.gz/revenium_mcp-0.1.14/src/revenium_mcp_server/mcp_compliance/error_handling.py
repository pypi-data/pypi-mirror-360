...
from .error_formatting_helpers import get_method_suggestions, format_error_content
...
class MCPError(Exception):
    ...
    def to_json_rpc_error(self, request_id: Optional[Union[str, int]] = None) -> Dict[str, Any]:
        ...
        if self.data and (self.data.field or self.data.suggestions or 
                         self.data.examples or self.data.context):
