...
from .models import AIClientConfig, RoutingResult, RoutingMethod, RoutingStatus
...
class AIClient:
    ...
    def __init__(self, config: Optional[AIClientConfig] = None):
        ...
        self.fallback_on_middleware_error = os.getenv("REVENIUM_FALLBACK_ON_ERROR", "true").lower() == "true"
        ...
        logger.info(f"AI Client initialized with model: {self.config.model_name} (using OpenAI SDK with Revenium middleware)")
    ...
    def _load_default_config(self) -> AIClientConfig:
        ...
        return AIClientConfig(
            ...
            max_tokens=int(os.getenv("AI_MAX_TOKENS", "1000")),  # High limit for testing - tune later based on real usage
