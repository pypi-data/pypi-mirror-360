...
class ChartDataFormatter:
    ...
    def __init__(self):
        ...
        self.color_schemes = {
            ...
            ColorScheme.COST_ANALYSIS: [
                "#d62728", "#ff7f0e", "#ffbb78", "#ff9896", "#c5b0d5"
            ],
            ColorScheme.PROFITABILITY: [
                "#2ca02c", "#98df8a", "#1f77b4", "#aec7e8", "#ffbb78"
            ],
            ColorScheme.TREND: [
    ...
    def format_agent_cost_trends_chart(
        self,
        data: List[Dict[str, Any]],
        title: str = "Agent Cost Trends Over Time"
    ) -> ChartData:
    ...
    def format_agent_performance_metrics_chart(
        ...
        try:
            ...
            metadata = {
                ...
                "data_points": len(formatted_data),
                "agents": len(set(item.get("agent") for item in formatted_data)),
                "avg_response_time": sum(item.get("response_time", 0) for item in formatted_data) / len(formatted_data) if formatted_data else 0,
                "avg_throughput": sum(item.get("throughput", 0) for item in formatted_data) / len(formatted_data) if formatted_data else 0
            }
    ...
    def format_task_completion_analysis_chart(
        self,
        data: List[Dict[str, Any]],
        title: str = "Task Completion Analysis"
    ) -> ChartData:
        ...
        try:
            ...
            metadata = {
                ...
                "data_points": len(formatted_data),
                "date_range": self._get_date_range(formatted_data),
                "total_completed_tasks": sum(item.get("completed_tasks", 0) for item in formatted_data),
                "avg_success_rate": sum(item.get("success_rate", 0) for item in formatted_data) / len(formatted_data) if formatted_data else 0
            }
    ...
    def format_transaction_cost_distribution_chart(
        self,
        data: List[Dict[str, Any]],
        title: str = "Transaction Cost Distribution"
    ) -> ChartData:
        ...
        try:
            logger.info(f"Formatting transaction cost distribution chart with {len(data)} data points")
    ...
    def format_provider_task_performance_chart(
        self,
        data: List[Dict[str, Any]],
        title: str = "Provider Task Performance Comparison"
    ) -> ChartData:
        ...
        try:
            ...
            metadata = {
                ...
                "avg_duration": sum(item.get("avg_duration", 0) for item in formatted_data) / len(formatted_data) if formatted_data else 0
            }
    ...
    def format_model_task_efficiency_chart(
        self,
        data: List[Dict[str, Any]],
        title: str = "Model Task Efficiency Analysis"
    ) -> ChartData:
        ...
        try:
            ...
            metadata = {
                ...
                "avg_efficiency": sum(item.get("efficiency_score", 0) for item in formatted_data) / len(formatted_data) if formatted_data else 0,
                "avg_cost_per_task": sum(item.get("cost_per_task", 0) for item in formatted_data) / len(formatted_data) if formatted_data else 0
            }
        ...
        try:
            ...
            for i, item in enumerate(data):
                if not isinstance(item, dict):
                    raise ValueError(f"Data item {i} must be a dictionary, got {type(item).__name__}")
    ...
    def _process_breakdown_data(
        ...
        try:
            ...
            if not isinstance(breakdown_type, str):
                raise ValueError(f"Expected string breakdown_type, got {type(breakdown_type).__name__}")
            ...
            for i, item in enumerate(data):
                ...
                category_name = (item.get(category_field) or
                               item.get("name") or
    ...
    def _process_agent_performance_data(self, data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for i, item in enumerate(data):
                ...
                response_time = item.get("response_time") or item.get("duration") or item.get("latency", 0)
                try:
                    response_time_float = float(response_time)
                except (ValueError, TypeError):
                    logger.warning(f"Invalid response_time value in item {i}: {response_time}, using 0")
                    response_time_float = 0.0

                # Extract throughput
                throughput = item.get("throughput") or item.get("requests_per_minute") or item.get("calls_per_minute", 0)
                try:
                ...
                formatted_item = {
                    ...
                    "efficiency_score": throughput_float / max(response_time_float, 1) if response_time_float > 0 else throughput_float
                }
    ...
    def _process_task_completion_data(self, data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for i, item in enumerate(data):
                ...
                completed_tasks = item.get("completed_tasks") or item.get("tasks_completed") or item.get("count", 0)
                try:
                    completed_tasks_int = int(completed_tasks)
                except (ValueError, TypeError):
                    logger.warning(f"Invalid completed_tasks value in item {i}: {completed_tasks}, using 0")
                ...
                try:
                    ...
                    logger.warning(f"Invalid success_rate value in item {i}: {success_rate}, using 0")
    ...
    def _process_provider_performance_data(self, data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for i, item in enumerate(data):
                ...
                avg_duration = item.get("avg_duration") or item.get("average_duration") or item.get("duration", 0)
                try:
                    avg_duration_float = float(avg_duration)
                except (ValueError, TypeError):
                    logger.warning(f"Invalid avg_duration value in item {i}: {avg_duration}, using 0")
                ...
                formatted_item = {
                    ...
                    "efficiency_ratio": task_count_int / max(avg_duration_float, 1) if avg_duration_float > 0 else task_count_int
                }
        ...
        try:
            ...
            for i, item in enumerate(data):
                ...
                try:
                    ...
                    logger.warning(f"Invalid efficiency_score value in item {i}: {efficiency_score}, using 0")
                ...
                try:
                    ...
                    logger.warning(f"Invalid cost_per_task value in item {i}: {cost_per_task}, using 0")
                    cost_float = 0.0
                ...
                formatted_item = {
                    ...
                    "value_ratio": efficiency_float / max(cost_float * 100, 1) if cost_float > 0 else efficiency_float
                }
    ...
    def format_comparative_analysis_chart(
        ...
        metadata = {
            ...
            "data_points": len(formatted_data),
            "percentage_changes": [pc.__dict__ for pc in comparison_result.percentage_changes] if hasattr(comparison_result, 'percentage_changes') and comparison_result.percentage_changes else [],
    ...
    def format_group_parameter_chart(
        ...
        config = ChartConfig(
            ...
            y_field="value",
            color_scheme=ColorScheme.TREND if chart_type == ChartType.LINE else ColorScheme.BUSINESS
        )
    ...
    def _process_group_parameter_data(
        ...
        for category, values in grouped_data.items():
            ...
            if group == "TOTAL":
                ...
                n = len(sorted_values)
                aggregated_value = sorted_values[n // 2] if n % 2 == 1 else (sorted_values[n // 2 - 1] + sorted_values[n // 2]) / 2
            else:
