...
from .error_handling import (
    MCPError, JSONRPCErrorCode, create_method_not_found_error,
...
class MCPProtocolHandler:
    ...
    def client_supports_capability(self, capability: str, sub_capability: Optional[str] = None) -> bool:
    ...
    def decorator(func):
        async def wrapper(*args, **kwargs):
            try:
                ...
                if not protocol_handler.is_initialized() and func.__name__ not in ["initialize", "ping"]:
                    if method_type == "request":
                        ...
                        logger.warning(f"Notification {func.__name__} received before initialization")
                        return
