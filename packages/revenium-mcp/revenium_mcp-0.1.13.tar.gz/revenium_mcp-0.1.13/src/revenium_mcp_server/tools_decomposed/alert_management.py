            ...
            if not anomaly_data:
                error = create_structured_missing_parameter_error(
                    ...
                    examples={
                        ...
                        "required_fields": ["name", "metricType", "threshold", "alertType", "operatorType"],
                        "example_data": {
                            "name": "Cost Alert",
...
## **🎯 API Design: Two Approaches for Different Needs**
...
### **⚙️ Advanced Configuration: Standard Method**
