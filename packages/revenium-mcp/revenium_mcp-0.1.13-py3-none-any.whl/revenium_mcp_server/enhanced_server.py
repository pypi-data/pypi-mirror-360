...
async def main() -> None:
    ...
    ucm_initialization_failed = False
    ...
    try:
        ...
        ucm_initialization_failed = True
    ...
    if ucm_api_key_missing:
        ...
        async def run_with_api_key_warning():
            ...
            print("\n🚨 CRITICAL: REVENIUM_API_KEY not found - server will not work until this is set.", file=sys.stderr)
            print("   It can be found within the Revenium web console on the API Keys page.\n", file=sys.stderr)
