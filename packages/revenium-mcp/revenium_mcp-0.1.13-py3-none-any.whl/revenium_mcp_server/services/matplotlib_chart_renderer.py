...
class MatplotlibChartRenderer:
    ...
    def __init__(self, config: Optional[ChartRenderConfig] = None, style_template: str = "revenium"):
    ...
    def _render_dual_axis_chart(self, fig: Figure, ax: Axes, chart_data: ChartData) -> None:
        ...
        ax.bar([x + '_revenue' for x in x_values], revenue_values,
        ...
        ax2.bar([x + '_cost' for x in x_values], cost_values,
                color=color2, alpha=0.7, label='Cost')
