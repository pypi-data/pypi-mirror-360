        ...
        for param, value in parameters.items():
            ...
            # Product type validation
                ...
                if not self._validate_product_type(str(value)):
                    errors.append(f"Invalid product type: {value}. Must be one of: api, usage, subscription, metering")

            # Workflow type validation
            elif param == 'workflow_type' and value:
                if not self._validate_workflow_type(str(value)):
                    errors.append(f"Invalid workflow type: {value}. Must be one of: subscription_setup, customer_onboarding, product_creation")
