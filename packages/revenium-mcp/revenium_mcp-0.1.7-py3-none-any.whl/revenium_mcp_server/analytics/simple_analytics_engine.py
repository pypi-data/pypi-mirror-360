...
class AnalyticsProcessor(ABC):
    ...
    def _handle_validation_error_with_logging(self, error: ValidationError, operation_type: str) -> str:
    ...
    @abstractmethod
    async def fetch_data(self, params: Dict[str, Any]) -> Union[List[Dict[str, Any]], Dict[str, Any]]:
        """Fetch data from analyzer."""
        pass
    
    @abstractmethod
    def format_response(self, data: Union[List[Dict[str, Any]], Dict[str, Any]], 
