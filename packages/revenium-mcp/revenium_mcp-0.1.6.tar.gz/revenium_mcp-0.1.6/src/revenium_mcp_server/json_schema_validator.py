...
class JSONSchemaValidator:
    ...
    def _validate_against_schema(self, parameters: Dict[str, Any], schema: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _validate_parameter(self, param_name: str, param_value: Any, param_schema: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _generate_suggestions_for_errors(self, errors: List[Dict[str, Any]], tool_name: str) -> List[str]:
        ...
        for error in errors:
            ...
            if "Missing required parameter" in message:
                ...
                suggestions.append(f"Use get_capabilities action to see all required parameters for {tool_name}")
    ...
    def _build_products_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "action": {
                    "type": "string",
                    "enum": ["list", "get", "create", "update", "delete", "get_capabilities", "get_examples", "validate", "get_agent_summary", "create_simple", "get_templates", "suggest_template", "create_from_description", "create_with_subscription"],
            ...
            "allOf": [
                ...
                {
                    "if": {
                        "properties": {"action": {"const": "create_simple"}}
                    },
                    "then": {
                        "required": ["name"]
                    }
                ...
                {
                    "if": {
                        "properties": {"action": {"const": "create_with_subscription"}}
                    },
                    "then": {
    ...
    def _build_subscriptions_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "action": {
                    "type": "string",
                    "enum": ["list", "get", "create", "update", "cancel", "get_capabilities", "get_examples", "validate", "get_agent_summary", "create_simple", "create_from_text", "get_product_details", "get_credentials", "create_with_credentials"],
    ...
    def _build_sources_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "action": {
                    "type": "string",
                    "enum": ["list", "get", "create", "update", "delete", "get_capabilities", "get_examples", "validate", "get_agent_summary", "create_source", "create_from_text", "get_tool_metadata"],
                ...
                "url": {
                    "type": "string",
                    "description": "Source URL/endpoint"
                },
    ...
    def _build_customers_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "action": {
                    "type": "string",
                    "enum": ["list", "get", "create", "update", "delete", "analyze", "get_agent_summary", "get_capabilities", "get_examples", "validate", "create_simple"],
    ...
    def _build_alerts_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "action": {
                    "type": "string",
                    "enum": ["list", "get", "create", "update", "delete", "clear_all", "get_metrics", "query",
                            "bulk_update", "analytics", "create_from_text", "get_capabilities", "get_examples",
                            "validate", "get_agent_summary", "test_cumulative_usage", "create_budget_alert",
                            "create_simple", "list_metrics", "enable", "disable", "enable_multiple",
                            "disable_multiple", "enable_all", "disable_all", "toggle_status", "get_status",
                            "create_cumulative_usage_alert", "create_threshold_alert"],
                        ...
                        "detection_rules": {
                            ...
                            "items": {
                                ...
                                "properties": {
                                    ...
                                    "metric": {
                                        "type": "string",
                                        "enum": ["total_cost", "cost_per_transaction", "token_count", "input_tokens",
                                                "output_tokens", "requests_per_second", "error_rate"]
                                    },
                                    "operator": {
                                        "type": "string",
                                        "enum": [">=", ">", "<=", "<", "==", "!="]
                                    ...
                                    "time_window": {
                                        "type": "string",
                                        "enum": ["daily", "weekly", "monthly", "quarterly", "1m", "5m", "15m", "30m", "1h", "2h", "4h", "8h", "12h", "1d", "7d", "30d"]
                                    }
                                },
                        ...
                        "filters": {
                            ...
                            "items": {
                                ...
                                "properties": {
                                    "dimension": {
                                        "type": "string",
                                        "enum": ["PRODUCT", "ORGANIZATION", "SUBSCRIBER", "MODEL", "PROVIDER", "TASK_TYPE", "TRACE_ID", "SUBSCRIPTION_ID", "PRODUCT_ID", "AGENT", "SUBSCRIBER_CREDENTIAL_NAME", "SUBSCRIBER_CREDENTIAL"],
                ...
                "query": {
                    "type": "string",
                    "description": "Natural language query for alerts"
                },
                "metric": {
                    "type": "string",
                    "enum": ["TOTAL_COST", "COST_PER_TRANSACTION", "TOKEN_COUNT", "INPUT_TOKEN_COUNT", "OUTPUT_TOKEN_COUNT", "CACHED_TOKEN_COUNT", "TOKENS_PER_SECOND", "REQUESTS_PER_SECOND", "ERROR_RATE", "ERROR_COUNT"],
    ...
    def _build_workflows_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "action": {
                    "type": "string",
                    "enum": ["list", "get", "start", "next_step", "complete_step", "get_capabilities", "get_examples", "validate", "get_agent_summary", "create_simple", "create_from_text"],
                ...
                "workflow_type": {
                    "type": "string",
                    "enum": ["customer_onboarding", "product_launch", "alert_setup", "data_pipeline", "subscription_management"],
                ...
                "step_result": {
                    "type": "object",
                    "description": "Result data from completed step"
                },
                "text": {
                    "type": "string",
                    "minLength": 1,
