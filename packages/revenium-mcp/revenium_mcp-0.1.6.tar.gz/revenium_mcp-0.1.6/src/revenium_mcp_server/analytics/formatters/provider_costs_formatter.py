...
class ProviderCostsFormatter(AnalyticsResponseFormatter):
    ...
    def format(self, data: List[Dict[str, Any]], params: Dict[str, Any]) -> str:
        ...
        return self._format_provider_costs_content(data, {"period": period, "aggregation": aggregation})
    
    def _format_provider_costs_content(self, data: List[Dict[str, Any]], params: Dict[str, Any]) -> str:
    ...
    def _format_provider_costs_header(self, data: List[Dict[str, Any]], params: Dict[str, Any]) -> str:
