...
class SlackPromptingMixin:
    ...
    def should_prompt_for_slack(self, notification_config: Dict[str, Any]) -> bool:
        ...
        disable_prompting = get_config_value("REVENIUM_DISABLE_SLACK_PROMPTING", "false").lower() == "true"
    ...
    async def handle_slack_configuration_selection(self, user_response: Optional[str] = None) -> Tuple[Optional[str], str]:
        ...
        try:
            ...
            selection_message += f"`slack_configuration_management(action='list_configurations')` for more details"
    ...
    async def apply_slack_to_notification_config(self, notification_config: Dict[str, Any], 
        ...
        try:
            ...
            async with ReveniumClient() as client:
                config = await client.get_slack_configuration_by_id(slack_config_id)
    ...
    def format_slack_prompting_result(self, prompt_result: Dict[str, Any], 
                                    user_response: Optional[str] = None,
                                    final_config: Optional[Dict[str, Any]] = None) -> str:
    ...
    def get_slack_prompting_preferences(self) -> Dict[str, Any]:
        ...
        """
        return {
            "prompting_enabled": get_config_value("REVENIUM_DISABLE_SLACK_PROMPTING", "false").lower() != "true",
            "auto_add_default": get_config_value("REVENIUM_AUTO_ADD_SLACK", "false").lower() == "true",
