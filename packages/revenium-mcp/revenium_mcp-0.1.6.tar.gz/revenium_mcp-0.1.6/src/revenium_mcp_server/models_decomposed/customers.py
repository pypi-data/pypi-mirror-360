...
from .base import (
    ...
    validate_email_address, validate_non_empty_string
)
...
class Subscriber(BaseReveniumModel, TimestampMixin, IdentifierMixin, MetadataMixin):
    ...
    subscription_ids: Optional[List[str]] = Field(default_factory=list, description="Associated subscription IDs")
    organization_id: Optional[str] = Field(None, description="Associated organization ID")
...
class Organization(BaseReveniumModel, TimestampMixin, IdentifierMixin, MetadataMixin):
    ...
    parent_organization_id: Optional[str] = Field(None, description="Parent organization ID for hierarchies")
...
class CustomerRelationship(BaseReveniumModel, TimestampMixin):
    ...
    subscription_ids: Optional[List[str]] = Field(default_factory=list, description="Related subscription IDs")
    product_ids: Optional[List[str]] = Field(default_factory=list, description="Related product IDs")
