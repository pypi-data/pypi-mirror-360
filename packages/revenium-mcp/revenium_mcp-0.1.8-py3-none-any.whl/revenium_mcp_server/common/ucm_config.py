...
class UCMConfig:
    ...
    def log_ucm_status(self, tool_name: str, has_ucm_helper: bool, 
                      ucm_call_successful: Optional[bool] = None) -> None:
    ...
    def get_integration_status_text(self, has_ucm_helper: bool, 
                                   ucm_capabilities: Optional[dict] = None) -> str:
        ...
        if has_ucm_helper:
            if ucm_capabilities:
                ...
                return (f"**UCM Integration**: Active (API-verified capabilities)\n"
...
def log_ucm_status(tool_name: str, has_ucm_helper: bool, 
                  ucm_call_successful: Optional[bool] = None) -> None:
...
def get_integration_status_text(has_ucm_helper: bool, 
                               ucm_capabilities: Optional[dict] = None) -> str:
