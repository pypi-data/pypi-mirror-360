...
from .analytics_parameters import AnalyticsParameterValidator, TimePeriod, AggregationType, ChartType
...
class MeteringTransactionBuilder:
    ...
    def sort_by(self, field: str, order: str = "desc") -> 'MeteringTransactionBuilder':
        ...
        if order not in valid_orders:
            self._validation_errors.append(f"Invalid sort order: {order}. Must be one of: {valid_orders}")
    ...
    def build(self) -> MeteringTransactionParams:
        ...
        if self._params.action in ["get_provider_costs", "get_model_costs", "get_customer_costs", "get_cost_summary"]:
    ...
    async def get_analytics_capabilities(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "builder_methods": [
                    "action()", "period()", "aggregation()", "threshold()",
                    "with_details()", "filter_by_provider()", "filter_by_model()",
                    "filter_by_customer()", "with_chart()", "limit_results()",
                    "sort_by()", "with_currency()", "with_timezone()",
                    "enable_anomaly_detection()", "with_baseline_comparison()"
                ],
...
"""
    ...
    def validate_metering_transaction_params(self, params: Dict[str, Any]) -> MeteringTransactionParams:
        """
