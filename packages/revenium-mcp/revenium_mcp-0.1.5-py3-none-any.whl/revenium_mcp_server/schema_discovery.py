...
from .models import (
    PlanType, Currency, BillingPeriod, TrialPeriod, AggregationType, RatingAggregationType,
    SourceType, SubscriptionStatus, UserRole, MetricType
    # REMOVED: SourceStatus - API doesn't support status field for sources
    # REMOVED: UserStatus, SubscriberStatus, OrganizationStatus, TeamStatus, TeamRole - NOT FOUND in actual API
    # REMOVED: OrganizationType - Only CONSUMER type found in actual API, hardcoded instead
)
...
class SchemaDiscoveryEngine:
    ...
    def get_examples(self, resource_type: str = "anomalies", example_type: Optional[str] = None) -> Dict[str, Any]:
    ...
    def validate_configuration(self, resource_type: str, config_data: Dict[str, Any], dry_run: bool = True) -> Dict[str, Any]:
    ...
    def _build_validation_rules(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "alerts": {
                "required": ["query"],
                "optional": ["page", "size", "filters"]
            },
            "products": {
                "required": ["name", "version", "plan"],
                "optional": ["description", "source_ids", "sla_ids", "custom_pricing_rule_ids",
...
class ProductSchemaDiscovery(SchemaDiscoveryEngine):
    ...
    def validate_product_configuration(self, config_data: Dict[str, Any], dry_run: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            error_details = {
                ...
                "error": str(e),
                "suggestion": getattr(e, 'suggestion', 'Please check the field value and try again')
            }
                ...
                "suggestions": [
                    {
                        ...
                        "next_steps": ["Check field values against schema", "Use get_examples for working templates"]
                    }
                ],
                "dry_run": dry_run
            }
    ...
    def _build_product_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "schema": {
                "product_data": {
                    ...
                    "optional": [
                        ...
                        "notification_addresses_on_invoice", "tags", "terms", "coming_soon",
                        "setup_fees", "published", "payment_source"
                    ],
                    "plan_schema": {
                        "required": ["type", "name", "currency"],
                        "optional": ["period", "trial_period", "tiers", "rating_aggregations", "setup_fees"],
                        "tier_schema": {
            ...
            "field_constraints": {
                ...
                "up_to": {"type": "decimal", "min": 0, "note": "Must be greater than starting_from, null for final tier"}
            },
            "business_rules": {
                "tier_structure": [
...
class SourceSchemaDiscovery(SchemaDiscoveryEngine):
    ...
    def validate_source_configuration(self, config_data: Dict[str, Any], dry_run: bool = True) -> Dict[str, Any]:
        ...
        if "status" in config_data:
            ...
            if config_data["status"] not in valid_statuses:
                ...
                validation_result["errors"].append({
                    "field": "status",
                    "error": f"Invalid source status: {config_data['status']}",
...
class SubscriptionSchemaDiscovery(SchemaDiscoveryEngine):
    ...
    def validate_subscription_configuration(self, config_data: Dict[str, Any], dry_run: bool = True, client=None) -> Dict[str, Any]:
        ...
        if client and "product_id" in config_data:
            try:
                ...
                validation_result["warnings"].append(
                    f"Product existence validation unavailable"
                )
...
class CustomerSchemaDiscovery(SchemaDiscoveryEngine):
    ...
    def validate_customer_configuration(self, config_data: Dict[str, Any], resource_type: str = "users", dry_run: bool = True) -> Dict[str, Any]:
    ...
    def _build_customer_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "user_roles": [role.value for role in UserRole],  # CONFIRMED: ROLE_TENANT_ADMIN, ROLE_API_CONSUMER exist
            ...
            "schemas": {
                "users": {
                    "required": ["email"],
                    "optional": [
                        "firstName", "lastName", "full_name", "status", "organization_id",
                        "team_id", "roles", "permissions", "metadata"
                    ],
                    "field_types": {
                ...
                "subscribers": {
                    "required": ["email"],
                    "optional": [
                        "user_id", "name", "status", "subscription_ids", "organization_id",
                        "billing_address", "payment_method", "trial_end_date", "metadata"
                    ],
                    "field_types": {
                        "email": "string (email format)",
                        "user_id": "string (UUID)",
                ...
                "organizations": {
                    "required": ["name"],
                    "optional": [
                        "display_name", "description", "type", "status", "parent_organization_id",
                        "website", "industry", "size", "address", "contact_info", "billing_info",
                        "tags", "metadata"
                    ],
                    "field_types": {
                        "name": "string",
                ...
                "teams": {
                    ...
                    "optional": [
                        "display_name", "description", "status", "parent_team_id", "owner_id",
                        "members", "permissions", "settings", "tags", "metadata"
                    ],
                    "field_types": {
                        "name": "string",
                        "display_name": "string",
        ...
        return [
            ...
            },
            {
                ...
                "template": {
                    ...
                    "type": "CONSUMER",  # CONFIRMED: Only CONSUMER type found in actual API
                    # REMOVED: "status": "active" - NOT FOUND in actual API
            ...
            },
            {
                ...
                "template": {
                    ...
                    "contact_info": {
                        ...
                        "email": "enterprise@globaltech.com",
                        "primary_contact": "Sarah Johnson"
                    },
                    "tags": ["enterprise", "global", "fortune500"],
                    "metadata": {
                        "stock_symbol": "GTECH",
    ...
    def _build_customer_validation_rules(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "organizations": {
                ...
                "field_validation": {
                    "name": {"min_length": 1, "max_length": 255},
                    "type": {"enum": ["CONSUMER"]},  # CONFIRMED: Only CONSUMER type found in actual API
                    # REMOVED: status enum - NOT FOUND in actual API
