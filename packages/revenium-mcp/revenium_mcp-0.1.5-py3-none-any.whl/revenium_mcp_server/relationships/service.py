...
class ResourceRelationshipService:
    ...
    async def _handle_get_resource_relationships(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        if "resource" in relationships:
            ...
            text += f"**Resource**: {resource.get('name', 'N/A')} ({resource.get('status', 'N/A')})\n\n"
    ...
    async def _handle_validate_cross_resource_operation(self, arguments: Dict[str, Any]) -> List[TextContent]:
    ...
    async def _handle_add_resource(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        text = f"✅ **Resource Added Successfully**\n\n"
