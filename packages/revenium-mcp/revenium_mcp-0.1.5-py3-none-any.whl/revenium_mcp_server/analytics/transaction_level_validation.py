        ...
        for required_param in endpoint_config.get("required", []):
            if required_param not in parameters:
                raise create_structured_validation_error(
                    ...
                    value=None,
                    suggestions=[f"Provide {required_param} parameter for {endpoint_name} endpoint"],
        ...
        if "teamId" not in parameters:
            raise create_structured_validation_error(
                ...
                examples={
                    ...
                    "with_aggregation": {"teamId": "team-456", "period": "THIRTY_DAYS", "group": "MEAN"}
                }
            )
    ...
    def _get_endpoint_examples(self, endpoint_name: str) -> Dict[str, Any]:
        ...
        examples = {
            "tokens_per_minute_by_provider": {
                ...
                "with_aggregation": {"teamId": "team-456", "period": "THIRTY_DAYS", "tokenType": "INPUT", "group": "MEAN"},
                "output_tokens": {"teamId": "team-789", "period": "THIRTY_DAYS", "tokenType": "OUTPUT", "group": "MAXIMUM"}
            },
            "cost_metrics_by_agents_over_time": {
                "basic": {"teamId": "team-123", "period": "SEVEN_DAYS"},
                "with_aggregation": {"teamId": "team-456", "period": "THIRTY_DAYS", "group": "MEDIAN"}
            },
            "performance_metrics_by_agents": {
                "basic": {"teamId": "team-123", "period": "SEVEN_DAYS"},
                "with_aggregation": {"teamId": "team-456", "period": "THIRTY_DAYS", "group": "MEAN"}
        ...
        return examples.get(endpoint_name, {
            "basic": {"teamId": "team-123", "period": "SEVEN_DAYS"},
            "with_aggregation": {"teamId": "team-456", "period": "THIRTY_DAYS", "group": "TOTAL"}
        })
