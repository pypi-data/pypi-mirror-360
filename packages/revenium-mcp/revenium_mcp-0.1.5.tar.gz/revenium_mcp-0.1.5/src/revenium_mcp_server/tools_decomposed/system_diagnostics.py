...
class SystemDiagnostics(ToolBase):
    ...
    tool_description: ClassVar[str] = "Unified system diagnostics combining configuration analysis, auto-discovery debugging, and log analysis. Key actions: environment_variables, debug, get_internal_logs, analyze_operations. Use get_capabilities() for complete action list."
    ...
    async def _handle_get_capabilities(self) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
        ...
        capabilities_text = f"""# System Diagnostics - Unified Troubleshooting Tool
...
"""
    ...
    async def _handle_get_examples(self) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
        ...
        examples_text = f"""# System Diagnostics Examples
        ...
        error = create_structured_validation_error(
            ...
            examples={
                ...
                "configuration_actions": [
                    "environment_variables", "auto_discovery",
                    "onboarding_status", "system_health"
                ],
                "debug_actions": ["debug"],
                "log_actions": [
                    "get_internal_logs", "get_integration_logs", "get_recent_logs",
                    "search_logs", "analyze_operations"
                ],
                "example_usage": {
                    "environment_variables": "Detailed environment variable analysis",
                    "debug": "Comprehensive auto-discovery diagnostics",
