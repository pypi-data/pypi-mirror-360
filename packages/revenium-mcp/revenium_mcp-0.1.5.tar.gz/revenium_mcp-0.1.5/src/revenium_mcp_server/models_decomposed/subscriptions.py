...
class SubscriptionMetrics(BaseReveniumModel):
    ...
    # Revenue metrics
    monthly_recurring_revenue: Optional[float] = Field(None, description="Monthly recurring revenue")
    ...
    # Engagement metrics
    average_subscription_duration: Optional[int] = Field(None, description="Average subscription duration in days")
    trial_conversion_rate: Optional[float] = Field(None, description="Trial to paid conversion rate")
