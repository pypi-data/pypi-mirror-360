...
class CapabilityCache:
    ...
    async def get(self, key: str, refresh_callback: Optional[Callable] = None) -> Optional[Dict[str, Any]]:
        ...
        async with self._lock:
            ...
            if (self._warming_enabled and refresh_callback and
                self._should_warm_cache(key) and key not in self._warming_tasks):
