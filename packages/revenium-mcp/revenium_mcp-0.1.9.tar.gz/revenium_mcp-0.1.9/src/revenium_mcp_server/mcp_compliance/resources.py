...
from .error_handling import (
    MCPError, JSONRPCErrorCode, create_resource_not_found_error,
    create_invalid_params_error, create_internal_error
)
from .resource_helpers import get_builtin_resource_definitions, generate_mock_content_by_type
...
from .resource_management_helpers import (
    create_resource_response, check_existing_subscription, remove_subscription,
    notify_subscribers, build_subscription_stats, get_resource_types_list, get_mime_types_list,
    add_subscription_to_list, load_resource_content
)
...
class MCPResourceManager:
    ...
    async def _load_resource_content(self, resource, uri: str):
        ...
        return await load_resource_content(resource, uri, self.content_providers, self._generate_mock_content)
