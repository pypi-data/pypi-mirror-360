...
from .auth import get_auth_config, AuthConfig
...
class ConnectionPoolConfig:
    ...
    def __init__(
        ...
        self.timeout = timeout or float(
            os.getenv("REVENIUM_HTTP_TIMEOUT", "30.0")
        )
...
class ReveniumAPIError(Exception):
    ...
    def __init__(self, message: str, status_code: Optional[int] = None, response_data: Optional[Dict] = None) -> None:
...
class ReveniumClient:
    ...
    def __init__(
        ...
        if self._auth_config_loaded:
            logger.info(f"Initialized Revenium client with base URL: {self.auth_config.base_url} (using shared connection pool)")
        else:
    ...
    def auth_config(self) -> AuthConfig:
        ...
        if not self._auth_config_loaded:
            try:
                ...
                logger.info(f"Loaded auth configuration with base URL: {self._auth_config.base_url}")
    ...
    def _add_team_and_tenant_to_params(self, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
            ...
            try:
                ...
                if response.status_code >= 400:
                    ...
                    try:
                        ...
                        error_text = response.text or f"HTTP {response.status_code} {response.reason_phrase}"
                ...
                if response.content:
                    ...
                    logger.debug(f"Response parsed successfully", operation_id=operation_id, response_size=len(response.content))
                    return result
                else:
                ...
                logger.error("Alert tools error: {}", str(e), operation_id=operation_id, error_code=e.error_code)
                raise
    ...
    async def get(self, endpoint: str, params: Optional[Dict[str, Any]] = None, use_retry: bool = True) -> Dict[str, Any]:
        """Make a GET request to the API."""
        if use_retry:
            return await self._request_with_retry("GET", endpoint, params=params)
        return await self._request("GET", endpoint, params=params)

    async def post(self, endpoint: str, data: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, use_retry: bool = True) -> Dict[str, Any]:
    ...
    async def put(self, endpoint: str, data: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None, use_retry: bool = True) -> Dict[str, Any]:
    ...
    async def delete(self, endpoint: str, params: Optional[Dict[str, Any]] = None, use_retry: bool = True) -> Dict[str, Any]:
    ...
    async def create_product(self, product_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "ownerId" not in mapped_data:
            ...
            if owner_id:
                ...
                logger.warning("ownerId not provided and REVENIUM_OWNER_ID not available from configuration store - API may reject request")
        ...
        debug_info = {
            ...
            "auth_headers": {k: ("***REDACTED***" if k.lower() in ['x-api-key', 'authorization'] else v)
        ...
        try:
            result = await self.post("/profitstream/v2/api/products", data=mapped_data, params=params)
    ...
    async def update_product(self, product_id: str, product_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            result = await self.put(f"/profitstream/v2/api/products/{product_id}", data=mapped_data, params=params)
    ...
    async def get_subscription_by_id(self, subscription_id: str) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.get(f"/profitstream/v2/api/subscriptions/{subscription_id}", params=params)
    ...
    async def create_subscription(self, subscription_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.post("/profitstream/v2/api/subscriptions", data=subscription_data, params=params)
    ...
    async def update_subscription(self, subscription_id: str, subscription_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.put(f"/profitstream/v2/api/subscriptions/{subscription_id}", data=subscription_data, params=params)
    ...
    async def cancel_subscription(self, subscription_id: str) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.delete(f"/profitstream/v2/api/subscriptions/{subscription_id}", params=params)
    ...
    async def update_source(self, source_id: str, source_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.put(f"/profitstream/v2/api/sources/{source_id}", data=source_data, params=params)
    ...
    async def update_user(self, user_id: str, user_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.put(f"/profitstream/v2/api/users/{user_id}", data=user_data, params=params)
    ...
    async def create_subscriber(self, subscriber_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.post("/profitstream/v2/api/subscribers", data=subscriber_data, params=params)

    async def update_subscriber(self, subscriber_id: str, subscriber_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.put(f"/profitstream/v2/api/subscribers/{subscriber_id}", data=subscriber_data, params=params)
    ...
    async def update_credential(self, credential_id: str, credential_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return await self.put(f"/profitstream/v2/api/credentials/{credential_id}", data=credential_data)
    ...
    async def get_organization_by_id(self, organization_id: str) -> Dict[str, Any]:
        ...
        return await self.get(f"/profitstream/v2/api/organizations/{organization_id}", params=params)
    ...
    async def create_organization(self, organization_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_tenant_id_to_params()
        return await self.post("/profitstream/v2/api/organizations", data=organization_data, params=params)

    async def update_organization(self, organization_id: str, organization_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_tenant_id_to_params()
        return await self.put(f"/profitstream/v2/api/organizations/{organization_id}", data=organization_data, params=params)
    ...
    async def delete_organization(self, organization_id: str) -> Dict[str, Any]:
        ...
        """
        params = self._add_tenant_id_to_params()
        return await self.delete(f"/profitstream/v2/api/organizations/{organization_id}", params=params)
    ...
    async def get_organization_tags(self, organization_id: str) -> Dict[str, Any]:
        ...
        """
        params = self._add_tenant_id_to_params()
        return await self.get(f"/profitstream/v2/api/organizations/{organization_id}/tags", params=params)
    ...
    async def update_team(self, team_id: str, team_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_tenant_id_to_params()
        return await self.put(f"/profitstream/v2/api/teams/{team_id}", data=team_data, params=params)
    ...
    async def get_anomaly_by_id(self, anomaly_id: str) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.get(f"/profitstream/v2/api/sources/ai/anomaly/{anomaly_id}", params=params)
    ...
    async def update_anomaly(self, anomaly_id: str, anomaly_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.put(f"/profitstream/v2/api/sources/ai/anomaly/{anomaly_id}", data=anomaly_data, params=params)
    ...
    async def delete_anomaly(self, anomaly_id: str) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.delete(f"/profitstream/v2/api/sources/ai/anomaly/{anomaly_id}", params=params)
    ...
    async def get_anomaly_metrics(self, anomaly_id: str) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.get(f"/profitstream/v2/api/sources/ai/anomaly/{anomaly_id}/metric", params=params)

    # AI Alert API methods
    async def get_alerts(self, page: int = 0, size: int = 20, start: Optional[str] = None, end: Optional[str] = None, **filters) -> Dict[str, Any]:
    ...
    async def update_alert(self, alert_id: str, update_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        params = self._add_team_id_to_params()
        return await self.put(f"/profitstream/v2/api/sources/ai/alert/{alert_id}", data=update_data, params=params)
    ...
    async def search_ai_models(self, query: str, page: int = 0, size: int = 20, **filters) -> Dict[str, Any]:
    ...
    async def get_metering_element_definitions(self, page: int = 0, size: int = 20, **filters) -> Dict[str, Any]:
    ...
    async def create_metering_element_definition(self, element_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            result = await self.post("/profitstream/v2/api/metering-element-definitions", data=element_data)
            logger.info(f"Metering element definition creation successful: {result.get('id', 'Unknown ID')}")
            return result
        except Exception as e:
            logger.error("Metering element definition creation failed: {}", str(e))
            raise

    async def update_metering_element_definition(self, element_id: str, element_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            result = await self.put(f"/profitstream/v2/api/metering-element-definitions/{element_id}", data=element_data)
    ...
    async def delete_metering_element_definition(self, element_id: str) -> Dict[str, Any]:
        ...
        try:
            result = await self.delete(f"/profitstream/v2/api/metering-element-definitions/{element_id}")
