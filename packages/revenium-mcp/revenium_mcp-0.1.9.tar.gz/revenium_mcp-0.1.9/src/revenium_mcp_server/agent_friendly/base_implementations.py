...
from .error_handling import AgentFriendlyError, ValidationError, SchemaError
...
class BaseAgentFriendlyTool(AgentFriendlyTool):
    ...
    async def get_examples(self, example_type: Optional[str] = None) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
    ...
    async def validate(self, data: Dict[str, Any], dry_run: bool = True) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
    ...
    async def create_simple(self, **kwargs) -> List[Union[TextContent, ImageContent, EmbeddedResource]]:
        ...
        return [
            {
                ...
                "parameters": [
                    {"name": "page", "type": "integer", "required": False, "description": "Page number (0-based)"},
