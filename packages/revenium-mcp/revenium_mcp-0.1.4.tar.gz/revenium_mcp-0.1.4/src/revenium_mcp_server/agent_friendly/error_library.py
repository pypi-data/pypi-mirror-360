...
from .unified_error_handler import StandardizedError, ErrorCategory, ErrorSeverity
...
class ErrorLibrary:
    ...
    def missing_action_error(valid_actions: List[str]) -> StandardizedError:
        ...
        return StandardizedError(
            ...
            examples={
                "valid_request": {
                    "action": valid_actions[0] if valid_actions else "list"
                }
            },
            recovery_actions=[
    ...
    def missing_id_error(id_field: str, resource_type: str) -> StandardizedError:
        ...
        return StandardizedError(
            ...
            examples={
                "valid_request": {
                    id_field: f"{resource_type.lower()}_123"
                }
            },
            recovery_actions=[
