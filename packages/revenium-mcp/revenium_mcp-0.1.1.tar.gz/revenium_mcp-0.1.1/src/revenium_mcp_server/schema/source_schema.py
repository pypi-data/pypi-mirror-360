...
class SourceSchemaDiscovery(BaseSchemaDiscovery):
    ...
    def get_examples(self, example_type: Optional[str] = None) -> Dict[str, Any]:
        ...
        return {
            "examples": [
                example for category in all_examples.values() 
    ...
    def _validate_field_lengths(self, config_data: Dict[str, Any], validation_result: Dict[str, Any]) -> None:
    ...
    def _add_type_specific_suggestions(self, source_type: str, validation_result: Dict[str, Any]) -> None:
        """Add type-specific suggestions."""
        suggestions = {
            "API": [
