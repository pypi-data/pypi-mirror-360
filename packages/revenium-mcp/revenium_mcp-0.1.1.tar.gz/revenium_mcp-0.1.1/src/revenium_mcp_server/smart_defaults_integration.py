...
class SmartDefaultsIntegration:
    ...
    def apply_smart_defaults_to_parameters(self, tool_name: str, action: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _log_applied_defaults(self, tool_name: str, action: str, original: Dict[str, Any], enhanced: Dict[str, Any]):
    ...
    def _find_applied_defaults(self, original: Dict[str, Any], enhanced: Dict[str, Any]) -> Dict[str, Any]:
...
class SmartDefaultsReporter:
    ...
    def generate_defaults_guide(self, tool_name: str) -> str:
        ...
        guide += "4. **Customizable**: All defaults can be overridden by providing explicit values\n\n"
