...
class PaginationPerformanceManager:
    ...
    def validate_pagination_params(self, page: int, size: int, 
    ...
    def _log_performance_guidance(self, tool_name: str, size: int, 
                                performance_tier: str, guidance: Dict[str, Any]) -> None:
    ...
    async def monitor_pagination_performance(self, tool_name: str, action: str, 
                                           page: int, size: int, 
                                           execution_func) -> Dict[str, Any]:
        ...
        performance_monitor.record_metric(
            tool_name=tool_name,
            action=f"{action}_paginated",
            execution_time_ms=execution_time_ms,
            execution_path="pagination_monitored",
            success=success,
    ...
    def _log_execution_performance(self, tool_name: str, action: str, 
                                 page: int, size: int, execution_time_ms: float,
...
def validate_pagination_with_performance(page: int, size: int, 
                                        tool_name: str = "unknown") -> Dict[str, Any]:
...
async def monitor_paginated_execution(tool_name: str, action: str, 
                                     page: int, size: int, 
                                     execution_func) -> Dict[str, Any]:
