...
class SlackOAuthWorkflow(ToolBase):
    ...
    tool_description: ClassVar[str] = "Slack OAuth authentication workflow for creating new configurations. Key actions: initiate_oauth, refresh_configurations, check_new_configurations, get_oauth_instructions. Use get_examples() for OAuth workflow templates and get_capabilities() for complete action list."
    ...
    async def _route_oauth_action(self, action: str, client: ReveniumClient, arguments: Dict[str, Any]):
    ...
    def _handle_unknown_oauth_action(self, action: str):
        ...
        raise ToolError(
            ...
            examples={
                "oauth_actions": ["initiate_oauth", "refresh_configurations", "check_new_configurations"],
