...
Defines the tool sets for each profile tier as specified in the
MCP Tool Configuration and Consolidation PRD.

Profile Structure:
- Starter (6 tools): Essential cost monitoring and alerting
- Business (14 tools): Complete business management capabilities  
- Enterprise (15 tools): Full feature set including advanced monitoring
"""
...
def get_profile_tools(profile_name: str) -> Set[str]:
    ...
    Args:
        profile_name: Name of the profile (starter/business/enterprise)
