...
class OnboardingManager:
    ...
    async def initialize(self, mcp_server=None, introspection_engine: Optional[ToolIntrospectionEngine] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if mcp_server and self.conditional_registry:
                tool_registration_results = await self.conditional_registry.register_tools_conditionally(
            ...
            registered_count = sum(1 for registered in initialization_results["tools_registered"].values() if registered)
            logger.info(f"✅ Onboarding system initialized successfully with {registered_count} tools registered")
    ...
    async def _initialize_detection_service(self):
        ...
        try:
            ...
            logger.debug(f"Detection service validated: is_first_time={onboarding_state.is_first_time}")
        except Exception as e:
    ...
    async def get_onboarding_status(self) -> Dict[str, Any]:
        ...
        if not self._initialized:
            return {
                ...
                "message": "Onboarding system not initialized"
            }
        ...
        try:
            ...
            if self.conditional_registry:
                ...
                registration_status = {"registered_tools": [], "last_state_check": "N/A (conditional registry disabled)"}
            ...
            return {
                ...
                "onboarding_state": {
                    ...
                    "recommendations": onboarding_state.recommendations[:3]  # Top 3 recommendations
                },
                "environment_validation": {
                    ...
                    "configuration_method": validation_result.summary.get('configuration_method', 'Unknown')
                },
                "tool_registration": {
    ...
    async def check_setup_completion(self) -> Dict[str, Any]:
        ...
        try:
            ...
            completed_items = sum(1 for completed in setup_completion.values() if completed) if setup_completion else 0
            ...
            return {
                ...
                "next_steps": onboarding_state.recommendations[:3] if completion_percentage < 80 else [
...
async def initialize_onboarding(mcp_server=None, introspection_engine: Optional[ToolIntrospectionEngine] = None) -> Dict[str, Any]:
    """Initialize the onboarding system.
