...
class AnalyticsParameterValidator:
    ...
    def validate_aggregation(aggregation: str) -> AggregationType:
        ...
        try:
            ...
            raise ValueError(f"Invalid aggregation '{aggregation}'. Valid aggregations: {valid_aggregations}")
    ...
    def validate_chart_type(chart_type: str) -> ChartType:
        ...
        try:
            ...
            raise ValueError(f"Invalid chart type '{chart_type}'. Valid chart types: {valid_chart_types}")
