...
class PaliGemmaWithExpertModel(PreTrainedModel):
    ...
    def eager_attention_forward(
        ...
        # edit, before value too big for bfloat16
        big_neg = torch.tensor(-1e4 if att_weights.dtype == torch.float16 else -2.3819763e38, 
                    dtype=att_weights.dtype, device=att_weights.device)  # See gemma/modules.py
