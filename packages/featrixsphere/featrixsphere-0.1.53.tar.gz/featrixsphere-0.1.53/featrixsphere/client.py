...
class FeatrixSphereClient:
    ...
    def predict(self, session_id: str, record: Dict[str, Any], target_column: str = None, max_retries: int = None) -> Dict[str, Any]:
        """
    ...
    def predict_records(self, session_id: str, records: List[Dict[str, Any]], 
                       target_column: str = None, batch_size: int = 250, use_async: bool = None) -> Dict[str, Any]:
        """
    ...
    def predict_df(self, session_id: str, df, target_column: str = None) -> Dict[str, Any]:
        """
        ...
        return self.predict_records(session_id, records, target_column=target_column)
    ...
    def _get_available_predictors(self, session_id: str) -> Dict[str, Dict[str, Any]]:
        ...
        try:
            ...
            for model_type, model_info in models.items():
                if 'single_predictor' in model_type.lower():
                    target_column = model_info.get('target_column')
                    if target_column:
                        predictors[target_column] = model_info
