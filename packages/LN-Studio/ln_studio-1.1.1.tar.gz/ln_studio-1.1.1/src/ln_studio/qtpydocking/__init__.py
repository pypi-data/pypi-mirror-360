...
# adapted from: https://github.com/klauer/qtpydocking/blob/master/qtpydocking/examples/demo.py
# should be replaced with official pyqtads bindings once they run on all platforms
