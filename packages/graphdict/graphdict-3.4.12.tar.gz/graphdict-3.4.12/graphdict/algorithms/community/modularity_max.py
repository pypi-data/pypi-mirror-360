...
from graphdict.algorithms.community.quality import modularity

from graphdict.utils.mapped_queue import MappedQueue
...
def greedy_modularity_communities(G, weight=None, resolution=1):
    ...
    Examples
    --------
    >>> from graphdict.algorithms.community import greedy_modularity_communities
