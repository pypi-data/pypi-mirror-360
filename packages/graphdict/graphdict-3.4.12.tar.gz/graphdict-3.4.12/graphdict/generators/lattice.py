...
from graphdict.classes import set_node_attributes
from graphdict.exception import NetworkXError
from graphdict.relabel import relabel_nodes
from graphdict.utils import flatten, nodes_or_number, pairwise
from graphdict.generators.classic import cycle_graph
from graphdict.generators.classic import empty_graph
from graphdict.generators.classic import path_graph
...
def grid_graph(dim, periodic=False):
    ...
    >>> from graphdict import grid_graph
    ...
    6
    """
    from graphdict.algorithms.operators.product import cartesian_product
...
def triangular_lattice_graph(
    ...
    from graphdict.algorithms.minors import contracted_nodes
