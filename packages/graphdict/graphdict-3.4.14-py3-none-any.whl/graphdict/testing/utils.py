import warnings
from graphdict.utils import nodes_equal, edges_equal, graphs_equal
...
def assert_nodes_equal(nodes1, nodes2):
    warnings.warn(
        (
            ...
            "Use `from graphdict.utils import nodes_equal` and `assert nodes_equal` instead.\n"
        ),
        DeprecationWarning,
    )
...
def assert_edges_equal(edges1, edges2):
    warnings.warn(
        (
            ...
            "Use `from graphdict.utils import edges_equal` and `assert edges_equal` instead.\n"
        ),
        DeprecationWarning,
    )
...
def assert_graphs_equal(graph1, graph2):
    warnings.warn(
        (
            ...
            "Use `from graphdict.utils import graphs_equal` and `assert graphs_equal` instead.\n"
        ),
        DeprecationWarning,
    )
