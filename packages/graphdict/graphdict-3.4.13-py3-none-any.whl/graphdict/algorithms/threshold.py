...
def is_threshold_graph(G):
    ...
    Examples
    --------
    >>> from graphdict.algorithms.threshold import is_threshold_graph
    >>> G = nx.path_graph(3)
...
def make_compact(creation_sequence):
    ...
    Examples
    --------
    >>> from graphdict.algorithms.threshold import make_compact
...
def find_threshold_graph(G, create_using=None):
    ...
    Examples
    --------
    >>> from graphdict.algorithms.threshold import find_threshold_graph
    >>> G = nx.barbell_graph(3, 3)
