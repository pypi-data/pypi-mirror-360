...
from graphdict.utils.decorators import argmap
from graphdict.algorithms.community.community_utils import is_partition
...
def modularity(G, communities, weight="weight", resolution=1):
    ...
    Examples
    --------
    >>> import graphdict.algorithms.community as nx_comm
