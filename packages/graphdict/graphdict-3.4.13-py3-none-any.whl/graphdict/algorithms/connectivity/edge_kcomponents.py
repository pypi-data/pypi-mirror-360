...
from graphdict.utils import arbitrary_element
from graphdict.utils import not_implemented_for
from graphdict.algorithms import bridges
...
def k_edge_components(G, k):
    ...
    --------
    >>> import itertools as it
    >>> from graphdict.utils import pairwise
    >>> paths = [
    ...     (1, 2, 4, 3, 1, 4),
    ...     (5, 6, 7, 8, 5, 7, 8, 6),
    ... ]
...
def bridge_components(G):
    ...
    >>> from graphdict.algorithms.connectivity.edge_kcomponents import bridge_components
...
class EdgeComponentAuxGraph:
    ...
    >>> import itertools as it
    >>> from graphdict.utils import pairwise
    >>> from graphdict.algorithms.connectivity import EdgeComponentAuxGraph
