...
from graphdict import edge_current_flow_betweenness_centrality as edge_current_flow
from graphdict import approximate_current_flow_betweenness_centrality as approximate_cfbc
