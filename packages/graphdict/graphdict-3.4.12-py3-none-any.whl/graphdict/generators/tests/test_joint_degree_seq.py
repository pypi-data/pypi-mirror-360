import time
from graphdict.algorithms.assortativity import degree_mixing_dict
from graphdict.generators import powerlaw_cluster_graph, gnm_random_graph
from graphdict.generators.joint_degree_seq import (
