...
Examples
--------
>>> import graphdict.algorithms.isomorphism as iso
...
>>> from graphdict.algorithms.isomorphism.matchhelpers import close
>>> from graphdict.algorithms.isomorphism import generic_node_match
