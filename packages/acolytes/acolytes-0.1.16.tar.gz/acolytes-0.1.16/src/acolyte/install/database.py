...
class DatabaseInitializer:
    ...
    def init_sqlite(self) -> bool:
        ...
        try:
            ...
            cursor.execute('SELECT COUNT(*) FROM dream_state')
            ...
            # code_graph_metrics: robusto ante filas existentes o corrupción
            cursor.execute('SELECT COUNT(*) FROM code_graph_metrics')
            count = cursor.fetchone()[0]
            if count == 0:
                cursor.execute(
                    """
            ...
            expected_tables = [
                ...
                "code_graph_metrics",
                "code_graph_nodes",
                "sessions",  # Renamed from conversations
                "dream_insights",
                "dream_state",
                "task_sessions",
                "tasks",
                "technical_decisions",
                "runtime_state",  # Runtime configuration storage
                "job_states",  # New table for job tracking
            ]
    ...
    def verify_installation(self) -> Dict[str, Any]:
        ...
        try:
            if self.db_path.exists():
                ...
                status["sqlite"]["ok"] = table_count >= 11  # Expect at least 11 tables
