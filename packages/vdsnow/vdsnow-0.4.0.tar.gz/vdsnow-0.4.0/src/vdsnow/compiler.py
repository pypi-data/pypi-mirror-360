...
def _recursive_parse(
    ...
    if is_manifest:
        ...
        # This is a leaf file. We must generate a state object for it.
        db, schema = (None, None)
...
def _sort_graph(nodes: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        # Return an empty list to halt execution
        return []
...
def compile_plan(
    ...
    for new_node in full_new_state:
        ...
        # For now, we'll stick to the simple check. We can enhance this later.
