...
class _RingModeCoefficientSets:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType
class _RingModeCoefficientSetsEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_RingModeCoefficientSets.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    RING_MODE_COEFFICIENT_SET_00: RingModeCoefficientSets.ValueType = ...  # 0
    RING_MODE_COEFFICIENT_SET_01: RingModeCoefficientSets.ValueType = ...  # 1
    RING_MODE_COEFFICIENT_SET_02: RingModeCoefficientSets.ValueType = ...  # 2
    RING_MODE_COEFFICIENT_SET_03: RingModeCoefficientSets.ValueType = ...  # 3
    RING_MODE_COEFFICIENT_SET_04: RingModeCoefficientSets.ValueType = ...  # 4
    RING_MODE_COEFFICIENT_SET_05: RingModeCoefficientSets.ValueType = ...  # 5
    RING_MODE_COEFFICIENT_SET_06: RingModeCoefficientSets.ValueType = ...  # 6
class RingModeCoefficientSets(_RingModeCoefficientSets, metaclass=_RingModeCoefficientSetsEnumTypeWrapper):
    pass
...
RING_MODE_COEFFICIENT_SET_05: RingModeCoefficientSets.ValueType = ...  # 5
RING_MODE_COEFFICIENT_SET_06: RingModeCoefficientSets.ValueType = ...  # 6
global___RingModeCoefficientSets = RingModeCoefficientSets
...
class MachineSettings(google.protobuf.message.Message):
    ...
    RING_MODE_COEFFICIENT_SET_FIELD_NUMBER: builtins.int
    ...
    ring_mode_coefficient_set: global___RingModeCoefficientSets.ValueType = ...
    def __init__(self,
        *,
        laser_power : builtins.float = ...,
        scan_speed : builtins.float = ...,
