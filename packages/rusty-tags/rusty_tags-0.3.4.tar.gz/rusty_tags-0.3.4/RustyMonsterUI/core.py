...
# %% auto 0
__all__ = ['HEADER_URLS', 'daisy_styles', 'scrollspy_style', 'ThemeRadii', 'ThemeShadows', 'ThemeFont',
           'Theme']
...
class Theme(Enum):
    ...
    def local_headers(self, mode='auto', static_dir='static', icons=True, daisy=True, highlightjs=False, katex=False, apex_charts=False, radii=ThemeRadii.sm, shadows='sm', font='sm'):
