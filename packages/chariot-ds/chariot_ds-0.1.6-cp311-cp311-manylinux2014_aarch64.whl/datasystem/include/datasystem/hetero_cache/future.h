...
#ifndef DATASYSTEM_OBJECT_CACHE_FUTURE_H
#define DATASYSTEM_OBJECT_CACHE_FUTURE_H
...
public:
    ...
    ///
    /// \param[in] subTimeoutMs Timeout interval for invoking.
...
#endif  // DATASYSTEM_OBJECT_CACHE_FUTURE_H