...
"""Chariot datasystem CLI command to generate C++ code template."""
...
class Command(BaseCommand):
    """
    Generate C++ code template for chariot datasystem.
    """

    name = 'generate_cpp_template'
    description = 'generate C++ code template for chariot datasystem'
