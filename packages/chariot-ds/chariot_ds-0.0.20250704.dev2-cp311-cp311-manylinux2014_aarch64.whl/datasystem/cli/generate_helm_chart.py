...
"""Chariot datasystem CLI command to generate Helm chart."""
...
class Command(BaseCommand):
    """
    Generate Helm chart for chariot datasystem deployment.
    """


    name = 'generate_helm_chart'
    description = 'generate Helm chart for chariot datasystem deployment'
