...
"""Chariot datasystem CLI generate_config command."""
...
class Command(BaseCommand):
    """
    Generate chariot datasystem configuration files.
    """

    name = "generate_config"
    description = "generate chariot datasystem cluster and worker configuration files"
    ...
    def run(self, args):
        ...
        """
        try:
            output_dir = os.path.realpath(args.output_path)
