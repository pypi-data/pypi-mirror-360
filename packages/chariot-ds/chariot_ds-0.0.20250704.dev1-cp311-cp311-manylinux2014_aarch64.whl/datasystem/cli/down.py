...
class Command(BaseCommand, ParallelMixin):
    """
    Stop chariot datasystem worker on cluster nodes.
    """

    name = "down"
    description = "stop chariot datasystem worker on cluster nodes"
    ...
    def run(self, args):
        ...
        try:
            ...
            self._config[ClusterConfig.SSH_PRIVATE_KEY] = os.path.abspath(
