...
class Captures(BaseSDK):
    def create(
        ...
        *,
        ...
        amount: OptionalNullable[
            Union[models.CreateCaptureAmount, models.CreateCaptureAmountTypedDict]
        ] = UNSET,
        metadata: OptionalNullable[
            Union[models.CreateCaptureMetadata, models.CreateCaptureMetadataTypedDict]
        ] = UNSET,
        ...
        request = models.CreateCaptureRequest(
            ...
            request_body=models.CreateCaptureRequestBody(
                ...
                amount=utils.get_pydantic_model(
                    amount, OptionalNullable[models.CreateCaptureAmount]
                ),
                metadata=utils.get_pydantic_model(
                    metadata, OptionalNullable[models.CreateCaptureMetadata]
                ),
            ),
        )
    ...
    def list(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ListCapturesResponseBody:
        r"""List captures
