...
class Onboarding(BaseSDK):
        ...
        *,
    ...
    ) -> models.GetOnboardingStatusResponseBody:
        ...
        if utils.match_response(http_res, "200", "application/hal+json"):
            return utils.unmarshal_json_response(
                models.GetOnboardingStatusResponseBody, http_res
            )
        ...
        **⚠️ We no longer recommend implementing this endpoint. Please refer to the Client Links API instead to kick off the onboarding process for your merchants.**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.SubmitOnboardingDataRequestBody]
            )
        request = cast(Optional[models.SubmitOnboardingDataRequestBody], request)
