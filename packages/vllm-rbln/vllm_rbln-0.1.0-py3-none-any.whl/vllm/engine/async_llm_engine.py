...
class AsyncLLMEngine:
    ...
    def _get_executor_cls(
        ...
        elif engine_config.device_config.device_type == "rbln":
            from vllm.executor.rbln_executor import RBLNExecutorAsync
            logger.info("[RBLNExecutorAsync] called from_engine_args rbln")
            executor_class = RBLNExecutorAsync
