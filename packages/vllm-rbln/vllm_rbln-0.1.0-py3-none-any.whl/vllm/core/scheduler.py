...
from vllm.config import CacheConfig, DeviceConfig, LoRAConfig, SchedulerConfig
...
class Scheduler:
    ...
    def __init__(
        ...
        self.is_rbln = device_config.device_type == "rbln"
    ...
    def _schedule_default(self) -> SchedulerOutputs:
        ...
        if len(prefills.seq_groups) == 0:
            run_method = (self._schedule_running_rbln
                          if self.is_rbln else self._schedule_running)
            running_scheduled = run_method(budget,
                                           curr_loras,
                                           enable_chunking=False)
