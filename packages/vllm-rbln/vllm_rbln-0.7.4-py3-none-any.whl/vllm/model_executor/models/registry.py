...
_TEXT_GENERATION_MODELS = {
    ...
    # Temporary patch for RBLN google-t5/t5
    "T5ForConditionalGeneration": ("bart", "BartForConditionalGeneration"),
    "T5WithLMHeadModel": ("bart", "BartForConditionalGeneration"),
}
