...
class RBLNWorker(LoraNotSupportedWorkerBase):
    ...
    def __init__(
        ...
        self.model_runner = RBLNModelRunner(model_config, parallel_config,
    ...
    def execute_model(
        ...
        # RBLN worker only supports single-step output. Wrap the output in a
