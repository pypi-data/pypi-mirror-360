...
class ModelConfig:
    ...
    Args:
        ...
        compiled_model_dir: Absolute path to compiled model directory for 
            RBLN (optimum-rbln). Will be deprecated in future. Please use
            `model` as path to compiled model directory.
    ...
    def __init__(
            ...
            compiled_model_dir: Optional[str] = None,
        ...
        if compiled_model_dir is not None:
            msg = (
                "`--compiled-model-dir` will be removed in a future release. "
                "'Please instead use `--model`")
            logger.warning(DeprecationWarning(msg), stacklevel=2)
...
class DeviceConfig:
    ...
    def __init__(self, device: str = "auto") -> None:
        if device == "auto":
            ...
            elif current_platform.is_rbln():
                self.device_type = "rbln"
        ...
        if self.device_type in ["neuron", "openvino", "rbln"]:
