...
[`SyllableSDKError`](https://github.com/asksyllable/syllable-sdk-python/blob/master/./src/syllable_sdk/models/syllablesdkerror.py) is the base class for all HTTP error responses. It has the following properties:
...
with SyllableSDK(
    ...
    try:
    ...
    except models.SyllableSDKError as e:
        ...
        if isinstance(e, models.HTTPValidationError):
            print(e.data.detail)  # Optional[List[syllable_sdk.ValidationError]]
```

### Error Classes
**Primary errors:**
* [`SyllableSDKError`](https://github.com/asksyllable/syllable-sdk-python/blob/master/./src/syllable_sdk/models/syllablesdkerror.py): The base class for HTTP error responses.
  * [`HTTPValidationError`](https://github.com/asksyllable/syllable-sdk-python/blob/master/./src/syllable_sdk/models/httpvalidationerror.py): Validation Error. Status code `422`. *
...
**Inherit from [`SyllableSDKError`](https://github.com/asksyllable/syllable-sdk-python/blob/master/./src/syllable_sdk/models/syllablesdkerror.py)**:
* [`ResponseValidationError`](https://github.com/asksyllable/syllable-sdk-python/blob/master/./src/syllable_sdk/models/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
