    ...
    def test_05_build_query(self):
        ...
        tests = [
            ...
            (
                ...
                b'SELECT * FROM events INNER JOIN events_json USING(id) WHERE "shadow_reporting" IS TRUE',
            ),
            (
                {"parameters": {"shadow_reporting": True}},
                b'SELECT * FROM events INNER JOIN events_json USING(id) WHERE "shadow_reporting" IS TRUE',
            ...
            (
                ...
                b'SELECT * FROM events INNER JOIN events_json USING(id) WHERE "shadow_reporting" IS FALSE',
            ),
            (
                {"parameters": {"shadow_reporting": False}},
                b'SELECT * FROM events INNER JOIN events_json USING(id) WHERE "shadow_reporting" IS FALSE',
            ...
            (
                ...
                b'SELECT * FROM events INNER JOIN events_json USING(id) WHERE "shadow_reporting_target" IS TRUE',
            ),
            (
                {"parameters": {"shadow_reporting_target": True}},
                b'SELECT * FROM events INNER JOIN events_json USING(id) WHERE "shadow_reporting_target" IS TRUE',
            ...
            (
                ...
                b'SELECT * FROM events INNER JOIN events_json USING(id) WHERE "shadow_reporting_target" IS FALSE',
            ),
            (
                {"parameters": {"shadow_reporting_target": False}},
                b'SELECT * FROM events INNER JOIN events_json USING(id) WHERE "shadow_reporting_target" IS FALSE',
    ...
    def test_06_build_query_aggr(self):
        ...
        tests = [
            ...
            (
                ...
                b'WITH observed_counts AS (SELECT "row_category","col_category",COUNT(*) AS observed FROM events CROSS JOIN LATERAL unnest("protocol") AS "row_category" CROSS JOIN LATERAL unnest("category") AS "col_category" WHERE "detecttime" >= \'2012-11-03T10:00:07\'::timestamp AND "protocol" IS NOT NULL AND "category" IS NOT NULL GROUP BY row_category,col_category),distinct_rows AS (SELECT DISTINCT row_category FROM observed_counts),distinct_cols AS (SELECT DISTINCT col_category FROM observed_counts),all_pairs AS (SELECT dr.row_category,dc.col_category FROM distinct_rows dr CROSS JOIN distinct_cols dc),pivot AS (SELECT ap.row_category,ap.col_category,COALESCE(oc.observed,0) AS observed FROM all_pairs ap LEFT JOIN observed_counts oc ON ap.row_category = oc.row_category AND ap.col_category = oc.col_category),row_totals AS (SELECT row_category,SUM(observed) AS row_total FROM pivot GROUP BY row_category),column_totals AS (SELECT col_category,SUM(observed) AS col_total FROM pivot GROUP BY col_category),total AS (SELECT SUM(observed) AS total FROM pivot),expected AS (SELECT p.row_category,p.col_category,p.observed,(rt.row_total * ct.col_total)::NUMERIC / t.total AS expected,rt.row_total,ct.col_total,t.total FROM pivot p JOIN row_totals rt ON p.row_category = rt.row_category JOIN column_totals ct ON p.col_category = ct.col_category CROSS JOIN total t),residuals AS (SELECT row_category,col_category,observed,expected,CASE WHEN (1 - row_total::NUMERIC / total) > 0 AND (1 - col_total::NUMERIC / total) > 0 THEN (observed - expected) / SQRT(expected * (1 - row_total::NUMERIC / total) * (1 - col_total::NUMERIC / total)) ELSE NULL END AS standardized_residual FROM expected)SELECT row_category,col_category,observed,"standardized_residual" FROM "residuals" AS "res" ORDER BY row_category,col_category',
            ),
            (
                {
                    "parameters": {
                ...
                b'WITH observed_counts AS (SELECT "row_category","col_category",COUNT(*) AS observed FROM events CROSS JOIN LATERAL unnest("node_type") AS "row_category" CROSS JOIN LATERAL unnest("category") AS "col_category" WHERE "detecttime" < \'2012-11-03T10:00:07\'::timestamp AND "node_type" IS NOT NULL AND "category" IS NOT NULL GROUP BY row_category,col_category),distinct_rows AS (SELECT DISTINCT row_category FROM observed_counts),distinct_cols AS (SELECT DISTINCT col_category FROM observed_counts),all_pairs AS (SELECT dr.row_category,dc.col_category FROM distinct_rows dr CROSS JOIN distinct_cols dc),pivot AS (SELECT ap.row_category,ap.col_category,COALESCE(oc.observed,0) AS observed FROM all_pairs ap LEFT JOIN observed_counts oc ON ap.row_category = oc.row_category AND ap.col_category = oc.col_category),row_totals AS (SELECT row_category,SUM(observed) AS row_total FROM pivot GROUP BY row_category),column_totals AS (SELECT col_category,SUM(observed) AS col_total FROM pivot GROUP BY col_category),total AS (SELECT SUM(observed) AS total FROM pivot),expected AS (SELECT p.row_category,p.col_category,p.observed,(rt.row_total * ct.col_total)::NUMERIC / t.total AS expected,rt.row_total,ct.col_total,t.total FROM pivot p JOIN row_totals rt ON p.row_category = rt.row_category JOIN column_totals ct ON p.col_category = ct.col_category CROSS JOIN total t),residuals AS (SELECT row_category,col_category,observed,expected,CASE WHEN (1 - row_total::NUMERIC / total) > 0 AND (1 - col_total::NUMERIC / total) > 0 THEN (observed - expected) / SQRT(expected * (1 - row_total::NUMERIC / total) * (1 - col_total::NUMERIC / total)) ELSE NULL END AS standardized_residual FROM expected)SELECT row_category,col_category,observed,"standardized_residual" FROM "residuals" AS "res" ORDER BY row_category,col_category',
            ),
            (
                {
                    "parameters": {
                ...
                b'WITH observed_counts AS (SELECT "eventseverity" AS "row_category","eventclass" AS "col_category",COUNT(*) AS observed FROM events WHERE "detecttime" >= \'2012-11-03T10:00:07\'::timestamp AND "detecttime" < \'2012-11-03T10:00:07\'::timestamp AND "eventseverity" IS NOT NULL AND "eventclass" IS NOT NULL GROUP BY row_category,col_category),distinct_rows AS (SELECT DISTINCT row_category FROM observed_counts),distinct_cols AS (SELECT DISTINCT col_category FROM observed_counts),all_pairs AS (SELECT dr.row_category,dc.col_category FROM distinct_rows dr CROSS JOIN distinct_cols dc),pivot AS (SELECT ap.row_category,ap.col_category,COALESCE(oc.observed,0) AS observed FROM all_pairs ap LEFT JOIN observed_counts oc ON ap.row_category = oc.row_category AND ap.col_category = oc.col_category),row_totals AS (SELECT row_category,SUM(observed) AS row_total FROM pivot GROUP BY row_category),column_totals AS (SELECT col_category,SUM(observed) AS col_total FROM pivot GROUP BY col_category),total AS (SELECT SUM(observed) AS total FROM pivot),expected AS (SELECT p.row_category,p.col_category,p.observed,(rt.row_total * ct.col_total)::NUMERIC / t.total AS expected,rt.row_total,ct.col_total,t.total FROM pivot p JOIN row_totals rt ON p.row_category = rt.row_category JOIN column_totals ct ON p.col_category = ct.col_category CROSS JOIN total t),residuals AS (SELECT row_category,col_category,observed,expected,CASE WHEN (1 - row_total::NUMERIC / total) > 0 AND (1 - col_total::NUMERIC / total) > 0 THEN (observed - expected) / SQRT(expected * (1 - row_total::NUMERIC / total) * (1 - col_total::NUMERIC / total)) ELSE NULL END AS standardized_residual FROM expected)SELECT row_category,col_category,observed,"standardized_residual" FROM "residuals" AS "res" ORDER BY row_category,col_category',
            ),
            (
                {
                    "parameters": {
                ...
                b'WITH observed_counts AS (SELECT "row_category","col_category",COUNT(*) AS observed FROM events CROSS JOIN LATERAL unnest("target_type") AS "row_category" CROSS JOIN LATERAL unnest("source_type") AS "col_category" WHERE "detecttime" >= \'2012-11-03T10:00:07\'::timestamp AND "detecttime" < \'2012-11-03T10:00:07\'::timestamp AND "target_type" IS NOT NULL AND "source_type" IS NOT NULL GROUP BY row_category,col_category),distinct_rows AS (SELECT DISTINCT row_category FROM observed_counts),distinct_cols AS (SELECT DISTINCT col_category FROM observed_counts),all_pairs AS (SELECT dr.row_category,dc.col_category FROM distinct_rows dr CROSS JOIN distinct_cols dc),pivot AS (SELECT ap.row_category,ap.col_category,COALESCE(oc.observed,0) AS observed FROM all_pairs ap LEFT JOIN observed_counts oc ON ap.row_category = oc.row_category AND ap.col_category = oc.col_category),row_totals AS (SELECT row_category,SUM(observed) AS row_total FROM pivot GROUP BY row_category),column_totals AS (SELECT col_category,SUM(observed) AS col_total FROM pivot GROUP BY col_category),total AS (SELECT SUM(observed) AS total FROM pivot),expected AS (SELECT p.row_category,p.col_category,p.observed,(rt.row_total * ct.col_total)::NUMERIC / t.total AS expected,rt.row_total,ct.col_total,t.total FROM pivot p JOIN row_totals rt ON p.row_category = rt.row_category JOIN column_totals ct ON p.col_category = ct.col_category CROSS JOIN total t),residuals AS (SELECT row_category,col_category,observed,expected,CASE WHEN (1 - row_total::NUMERIC / total) > 0 AND (1 - col_total::NUMERIC / total) > 0 THEN (observed - expected) / SQRT(expected * (1 - row_total::NUMERIC / total) * (1 - col_total::NUMERIC / total)) ELSE NULL END AS standardized_residual FROM expected)SELECT row_category,col_category,observed,"standardized_residual" FROM "residuals" AS "res" ORDER BY row_category,col_category',
            ),
            (
                {
                    "parameters": {
                ...
                b'WITH observed_counts AS (SELECT "row_category","event_class" AS "col_category",COUNT(*) AS observed FROM events CROSS JOIN LATERAL unnest("protocol") AS "row_category" WHERE "detecttime" >= \'2012-11-03T10:00:07\'::timestamp AND "detecttime" < \'2012-11-03T10:00:07\'::timestamp AND "protocol" IS NOT NULL AND "event_class" IS NOT NULL GROUP BY row_category,col_category),distinct_rows AS (SELECT DISTINCT row_category FROM observed_counts),distinct_cols AS (SELECT DISTINCT col_category FROM observed_counts),all_pairs AS (SELECT dr.row_category,dc.col_category FROM distinct_rows dr CROSS JOIN distinct_cols dc),pivot AS (SELECT ap.row_category,ap.col_category,COALESCE(oc.observed,0) AS observed FROM all_pairs ap LEFT JOIN observed_counts oc ON ap.row_category = oc.row_category AND ap.col_category = oc.col_category),row_totals AS (SELECT row_category,SUM(observed) AS row_total FROM pivot GROUP BY row_category),column_totals AS (SELECT col_category,SUM(observed) AS col_total FROM pivot GROUP BY col_category),total AS (SELECT SUM(observed) AS total FROM pivot),expected AS (SELECT p.row_category,p.col_category,p.observed,(rt.row_total * ct.col_total)::NUMERIC / t.total AS expected,rt.row_total,ct.col_total,t.total FROM pivot p JOIN row_totals rt ON p.row_category = rt.row_category JOIN column_totals ct ON p.col_category = ct.col_category CROSS JOIN total t),residuals AS (SELECT row_category,col_category,observed,expected,CASE WHEN (1 - row_total::NUMERIC / total) > 0 AND (1 - col_total::NUMERIC / total) > 0 THEN (observed - expected) / SQRT(expected * (1 - row_total::NUMERIC / total) * (1 - col_total::NUMERIC / total)) ELSE NULL END AS standardized_residual FROM expected)SELECT row_category,col_category,observed,"standardized_residual" FROM "residuals" AS "res" ORDER BY row_category,col_category',
            ),
            (
                {
                    "parameters": {
                ...
                b'WITH observed_counts AS (SELECT "tlp" AS "row_category","tlp" AS "col_category",COUNT(*) AS observed FROM events WHERE "detecttime" >= \'2012-11-03T10:00:07\'::timestamp AND "detecttime" < \'2012-11-03T10:00:07\'::timestamp AND "tlp" IS NOT NULL AND "tlp" IS NOT NULL GROUP BY row_category,col_category),distinct_rows AS (SELECT DISTINCT row_category FROM observed_counts),distinct_cols AS (SELECT DISTINCT col_category FROM observed_counts),all_pairs AS (SELECT dr.row_category,dc.col_category FROM distinct_rows dr CROSS JOIN distinct_cols dc),pivot AS (SELECT ap.row_category,ap.col_category,COALESCE(oc.observed,0) AS observed FROM all_pairs ap LEFT JOIN observed_counts oc ON ap.row_category = oc.row_category AND ap.col_category = oc.col_category),row_totals AS (SELECT row_category,SUM(observed) AS row_total FROM pivot GROUP BY row_category),column_totals AS (SELECT col_category,SUM(observed) AS col_total FROM pivot GROUP BY col_category),total AS (SELECT SUM(observed) AS total FROM pivot),expected AS (SELECT p.row_category,p.col_category,p.observed,(rt.row_total * ct.col_total)::NUMERIC / t.total AS expected,rt.row_total,ct.col_total,t.total FROM pivot p JOIN row_totals rt ON p.row_category = rt.row_category JOIN column_totals ct ON p.col_category = ct.col_category CROSS JOIN total t),residuals AS (SELECT row_category,col_category,observed,expected,CASE WHEN (1 - row_total::NUMERIC / total) > 0 AND (1 - col_total::NUMERIC / total) > 0 THEN (observed - expected) / SQRT(expected * (1 - row_total::NUMERIC / total) * (1 - col_total::NUMERIC / total)) ELSE NULL END AS standardized_residual FROM expected)SELECT row_category,col_category,observed,"standardized_residual" FROM "residuals" AS "res" ORDER BY row_category,col_category',
            ),
            (
                {
                    "parameters": {
                ...
                b'WITH observed_counts AS (SELECT "row_category","col_category",COUNT(*) AS observed FROM events CROSS JOIN LATERAL unnest("protocol") AS "row_category" CROSS JOIN LATERAL unnest("protocol") AS "col_category" WHERE "detecttime" >= \'2012-11-03T10:00:07\'::timestamp AND "detecttime" < \'2012-11-03T10:00:07\'::timestamp AND "protocol" IS NOT NULL AND "protocol" IS NOT NULL GROUP BY row_category,col_category),distinct_rows AS (SELECT DISTINCT row_category FROM observed_counts),distinct_cols AS (SELECT DISTINCT col_category FROM observed_counts),all_pairs AS (SELECT dr.row_category,dc.col_category FROM distinct_rows dr CROSS JOIN distinct_cols dc),pivot AS (SELECT ap.row_category,ap.col_category,COALESCE(oc.observed,0) AS observed FROM all_pairs ap LEFT JOIN observed_counts oc ON ap.row_category = oc.row_category AND ap.col_category = oc.col_category),row_totals AS (SELECT row_category,SUM(observed) AS row_total FROM pivot GROUP BY row_category),column_totals AS (SELECT col_category,SUM(observed) AS col_total FROM pivot GROUP BY col_category),total AS (SELECT SUM(observed) AS total FROM pivot),expected AS (SELECT p.row_category,p.col_category,p.observed,(rt.row_total * ct.col_total)::NUMERIC / t.total AS expected,rt.row_total,ct.col_total,t.total FROM pivot p JOIN row_totals rt ON p.row_category = rt.row_category JOIN column_totals ct ON p.col_category = ct.col_category CROSS JOIN total t),residuals AS (SELECT row_category,col_category,observed,expected,CASE WHEN (1 - row_total::NUMERIC / total) > 0 AND (1 - col_total::NUMERIC / total) > 0 THEN (observed - expected) / SQRT(expected * (1 - row_total::NUMERIC / total) * (1 - col_total::NUMERIC / total)) ELSE NULL END AS standardized_residual FROM expected)SELECT row_category,col_category,observed,"standardized_residual" FROM "residuals" AS "res" ORDER BY row_category,col_category',
            ),
        ]
