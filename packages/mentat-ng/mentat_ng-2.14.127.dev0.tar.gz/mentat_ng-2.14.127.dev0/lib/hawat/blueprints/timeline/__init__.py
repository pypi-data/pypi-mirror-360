...
class AbstractSearchView(PsycopgMixin, CustomSearchView):  # pylint: disable=locally-disabled,abstract-method
    ...
    def _search_events_aggr(self, form_args, qtype, aggr_name, enable_toplist=True):
        ...
        self.response_context["sqlqueries"].append(self.get_db().cursor.lastquery.decode("utf-8"))
    ...
    def custom_search(self, form_args):
        ...
        if form_args.get("aggregations"):
            self.response_context["chart_sections"] = [
                chs for chs in TIMELINE_CHART_SECTIONS if chs.key in form_args["aggregations"]
            ]
        else:
...
class TimelineBlueprint(HawatBlueprint):
    ...
    def register_app(self, app):
        ...
        def _get_upb():
            return URLParamsBuilder({"submit": tr_("Search")})
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("groups", True).add_kwrules_from_form(SimpleTimelineSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("target_groups", True).add_kwrules_from_form(SimpleTimelineSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("categories", True).add_kwrules_from_form(SimpleTimelineSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("classes", True).add_kwrules_from_form(SimpleTimelineSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("target_classes", True).add_kwrules_from_form(SimpleTimelineSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("detectors", True).add_kwrules_from_form(SimpleTimelineSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("detector_types", True).add_kwrules_from_form(SimpleTimelineSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("protocols", True).add_kwrules_from_form(SimpleTimelineSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("severities", True).add_kwrules_from_form(SimpleTimelineSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("target_severities", True).add_kwrules_from_form(SimpleTimelineSearchForm),
