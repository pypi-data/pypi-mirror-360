...
class EventsBlueprint(HawatBlueprint):
    ...
    def register_app(self, app):
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("groups", True).add_kwrules_from_form(SimpleEventSearchForm),
        ...
        app.set_csag(
            ...
            SearchView,
            _get_upb().add_rule("target_groups", True).add_kwrules_from_form(SimpleEventSearchForm),
