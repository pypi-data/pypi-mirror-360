...
mod.add_function('whatsapp_GroupSubject_SetByJID_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('whatsapp_GroupSubject_SetByJID_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
