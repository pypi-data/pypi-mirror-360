...
class DataFrameOP:
    ...
    def to_sample(cls, df:DataFrame, percentage:int=None, randomize:bool|int=True)->DataFrame:
        ...
        percentage: percentage from 0 to 100 of data to be extracted from df e.g.
    ...
    def __resolve_sample_percentage(cls, percentage:int=None)->float:
        ...
        if _sample_percentage is None and dbx_hpexts.dbutils is not None:
            _sample_percentage = dbx_hpexts.dbutils.widgets.get(cls.sample_percentage_key)
