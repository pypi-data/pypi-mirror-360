...
def create_system_message(content: Union[str, List[Union[str, dict]]]) -> SystemMessage:
    """
    创建系统消息实例

    Args:
        content (Union[str, List[Union[str, dict]]]): 消息内容，可以是字符串或包含字符串和字典的列表
...
def create_user_message(content: Union[str, List[Union[str, dict]]]) -> HumanMessage:
    """
    创建用户消息实例
...
def create_assistant_message(
    ...
    Args:
        content (Union[str, List[Union[str, dict]]]): 消息内容，可以是字符串或包含字符串和字典的列表
        tool_calls (List[ToolCall]): 工具调用列表，默认为空
...
def create_tool_message(
    content: Union[str, List[Union[str, dict]]], tool_call_id: str
) -> ToolMessage:
    """
    创建工具消息实例
