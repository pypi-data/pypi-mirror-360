...
def load_pkl_tool(pkl_path: str) -> Union[ToolAbstractClass, None]:
    """
...
__all__ = ["load_str_name_tool", "load_str_tool_list", "load_pkl_tool"]
