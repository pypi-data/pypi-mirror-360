...
scripts = []
for f in glob.glob("ailia_tokenizer/*.py"):
    scripts.append(f)
...
if __name__ == "__main__":
    setup(
        ...
        package_data={"ailia_tokenizer":find_libraries()},
