...
from typing import Any, cast, Dict, List, Optional, Union, Tuple, Literal
...
def evaluate_dax(
    ...
    return DatasetXmlaClient(workspace, dataset, role=role, effective_user_name=effective_user_name) \
...
def list_folders(workspace: Optional[Union[str, UUID]] = None,
                 root_folder: Optional[Union[str, os.PathLike, UUID]] = None,
                 recursive: bool = True,
                 extend_folder_path: bool = False) -> pd.DataFrame:
    """
...
@log
def create_folder(folder: Union[str, os.PathLike], workspace: Optional[Union[str, UUID]] = None,
...
@log
def delete_folder(folder: Union[str, os.PathLike, UUID], workspace: Optional[Union[str, UUID]] = None) -> None:
    """
...
def create_notebook(display_name: str,
                    ...
                    max_attempts: int = 10,
                    workspace: Optional[Union[str, UUID]] = None,
                    folder: Optional[Union[str, os.PathLike, UUID]] = None) -> str:
    """
...
def create_tom_server(dataset: Optional[Union[str, UUID]] = None,
                      readonly: bool = True,
                      workspace: Optional[Union[str, UUID]] = None) -> object:
    """
