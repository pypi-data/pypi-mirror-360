...
class Detection(AnonymizationBase):
    ...
    def from_search_params(
        ...
        if 'limit' in params and params['limit'] == -1:
            ...
            while True:
                params['limit'] = limit
                params['page'] = page
                resp = client.get("/videos/frames/detections", params=params)
    ...
    def from_video_id_and_project_id(
        cls, video_id: str, project_id: str, client: "anonymization.client.BaseClient"
    ) -> List["Detection"]:
