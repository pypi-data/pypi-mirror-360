...
from sthg_ontology_base import BaseModel,OntologyNamespace
import json
import requests
...
SQLALCHEMY_DATABASE_URL = f"mysql+pymysql://dev_user:{encoded_password}@192.168.1.171:9030/ontology_data_source_test"
