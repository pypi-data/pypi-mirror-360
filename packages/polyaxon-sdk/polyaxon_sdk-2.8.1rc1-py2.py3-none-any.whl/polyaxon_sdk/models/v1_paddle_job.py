...
class V1PaddleJob(BaseModel):
    ...
    elastic_policy: Optional[V1PaddleElasticPolic] = Field(None, alias="elasticPolicy")
    master: Optional[V1KFReplica] = None
    worker: Optional[V1KFReplica] = None
    __properties = ["kind", "cleanPodPolicy", "schedulingPolicy", "elasticPolicy", "master", "worker"]
    ...
    def from_dict(cls, obj: dict) -> V1PaddleJob:
        ...
        _obj = V1PaddleJob.parse_obj({
            ...
            "elastic_policy": V1PaddleElasticPolic.from_dict(obj.get("elasticPolicy")) if obj.get("elasticPolicy") is not None else None,
