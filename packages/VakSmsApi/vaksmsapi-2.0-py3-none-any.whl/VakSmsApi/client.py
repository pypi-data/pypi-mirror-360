...
class VakSmsApi:
    ...
    def prolongNumber(self, *args, **kwargs):
        return self.prolong_number(self, *args, **kwargs)
    ...
    def change_status(self, idNum, status: Literal['send', 'end', 'bad']):
        return self.set_status(idNum, status)
