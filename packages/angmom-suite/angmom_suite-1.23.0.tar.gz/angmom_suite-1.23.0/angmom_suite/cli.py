...
def read_args(arg_list=None):
    ...
    barrier.add_argument(
        ...
        type=float,
        nargs=3,
        default=[0.0, 0.0, 25E-6],
        help='Magnetic field applied: this is used to add a field to define the eigenstates, as well as defining the orientation of the quantisation axis'
    )
    ...
    proj = subparsers.add_parser('proj', parents=[model_full_parser])
