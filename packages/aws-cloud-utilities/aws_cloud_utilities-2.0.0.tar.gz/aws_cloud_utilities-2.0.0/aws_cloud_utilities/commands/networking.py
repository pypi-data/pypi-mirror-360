...
@click.option(
    "--output-file",
    help="Output file for AWS IP ranges (supports .json, .yaml, .csv)"
)
@click.option(
    "--filter-service",
...
@click.option(
    "--ipv6",
    is_flag=True,
    help="Include IPv6 ranges in addition to IPv4"
)
@click.option(
    "--show-summary",
    is_flag=True,
    help="Show summary statistics of IP ranges"
)
@click.pass_context
def ip_ranges(
    ctx: click.Context,
...
@click.option(
    "--service",
    help="Show summary for specific service only"
)
@click.option(
    "--region",
    help="Show summary for specific region only"
)
@click.pass_context
