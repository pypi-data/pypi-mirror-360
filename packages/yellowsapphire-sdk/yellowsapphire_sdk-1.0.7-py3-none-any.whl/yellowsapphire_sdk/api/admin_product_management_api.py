...
from yellowsapphire_sdk.models.bulk_create_products200_response import BulkCreateProducts200Response
from yellowsapphire_sdk.models.create_product201_response import CreateProduct201Response
from yellowsapphire_sdk.models.create_product_request import CreateProductRequest
from yellowsapphire_sdk.models.delete_product200_response import DeleteProduct200Response
from yellowsapphire_sdk.models.get_all_products200_response import GetAllProducts200Response
from yellowsapphire_sdk.models.get_product_by_id200_response import GetProductById200Response
from yellowsapphire_sdk.models.update_product200_response import UpdateProduct200Response
from yellowsapphire_sdk.models.update_product_request import UpdateProductRequest
...
class AdminProductManagementApi:
    ...
    def bulk_create_products(
        self,
        file: Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="CSV file with product data (columns: name, SKU, price, category, manufacturer, etc.)")] = None,
    ...
    ) -> BulkCreateProducts200Response:
        """Bulk upload product

        Upload multiple product items via CSV file

        :param file: CSV file with product data (columns: name, SKU, price, category, manufacturer, etc.)
        :type file: bytearray
        ...
        _param = self._bulk_create_products_serialize(
            file=file,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BulkCreateProducts200Response",
    ...
    @validate_call
    def bulk_create_products_with_http_info(
        self,
        file: Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="CSV file with product data (columns: name, SKU, price, category, manufacturer, etc.)")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BulkCreateProducts200Response]:
        """Bulk upload product
    ...
    @validate_call
    def bulk_create_products_without_preload_content(
        self,
        file: Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="CSV file with product data (columns: name, SKU, price, category, manufacturer, etc.)")] = None,
        _request_timeout: Union[
            None,
    ...
    def _bulk_create_products_serialize(
        self,
        file,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/products/bulk',
    ...
    def create_product(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateProduct201Response",
            '400': "CreateProduct400Response",
            '401': "LoginAdmin400Response",
            '500': "LoginAdmin400Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def create_product_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateProduct201Response]:
        """Create new product
    ...
    def delete_product_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteProduct200Response]:
        """Delete product
    ...
    def _delete_product_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/admin/products/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_products(
        ...
        manufacturer: Annotated[Optional[StrictStr], Field(description="Filter by manufacturer")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Search in name, description, SKU, or model")] = None,
        is_available: Annotated[Optional[StrictBool], Field(description="Filter by availability status")] = None,
        low_stock: Annotated[Optional[StrictBool], Field(description="Filter items with low stock")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Retrieve all product with filtering and pagination
        ...
        :param search: Search in name, description, SKU, or model
        :type search: str
        :param is_available: Filter by availability status
        :type is_available: bool
        :param low_stock: Filter items with low stock
        :type low_stock: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_all_products_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAllProducts200Response]:
        """Get all product
    ...
    def get_product_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProductById200Response]:
        """Get product by ID
    ...
    def update_product(
        self,
        id: Annotated[StrictStr, Field(description="Product ID")],
        update_product_request: Annotated[UpdateProductRequest, Field(description="Product fields to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Product ID (required)
        :type id: str
        :param update_product_request: Product fields to update (required)
    ...
    def update_product_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateProduct200Response]:
        """Update product
