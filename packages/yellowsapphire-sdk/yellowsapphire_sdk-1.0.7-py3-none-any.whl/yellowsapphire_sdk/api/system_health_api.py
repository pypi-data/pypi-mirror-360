...
from yellowsapphire_sdk.models.get_health200_response import GetHealth200Response
...
class SystemHealthApi:
    ...
    def get_health(
        ...
        Returns system health status and operational metrics.  **Public Access**: Basic health status available without authentication **Enhanced Data**: Additional performance metrics available with authentication  **Security**: Optional Bearer token authentication for extended metrics **Rate Limiting**: 60 requests/minute for unauthenticated, 120/minute for authenticated 
