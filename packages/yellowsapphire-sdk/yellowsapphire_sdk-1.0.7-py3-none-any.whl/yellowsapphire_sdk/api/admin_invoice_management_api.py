...
from yellowsapphire_sdk.models.generate_invoice201_response import GenerateInvoice201Response
from yellowsapphire_sdk.models.generate_invoice_request import GenerateInvoiceRequest
from yellowsapphire_sdk.models.get_invoice_details200_response import GetInvoiceDetails200Response
from yellowsapphire_sdk.models.get_invoice_templates200_response import GetInvoiceTemplates200Response
from yellowsapphire_sdk.models.list_invoices200_response import ListInvoices200Response
from yellowsapphire_sdk.models.resend_invoice_email200_response import ResendInvoiceEmail200Response
...
class AdminInvoiceManagementApi:
    ...
    def download_invoice(
        self,
        invoice_number: Annotated[str, Field(strict=True, description="Yellow Sapphire invoice number (YS-INV-YYYY-NNNNNN format)")],
        ...
        **Admin Only** - Download the generated PDF invoice file. - Streams PDF file directly to client - Proper content-type headers for PDF viewing/download - File name includes invoice number for identification - No caching headers for security 

        :param invoice_number: Yellow Sapphire invoice number (YS-INV-YYYY-NNNNNN format) (required)
    ...
    def _download_invoice_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/invoices/download/{invoiceNumber}',
    ...
    def generate_invoice(
        self,
        order_id: Annotated[str, Field(strict=True, description="MongoDB ObjectId of the order to generate invoice for")],
        generate_invoice_request: Optional[GenerateInvoiceRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GenerateInvoice201Response:
        """Generate PDF invoice for paid order

        **Admin Only** - Generate PDF invoice for completed orders. - PDF on company letterhead with YS branding - QR code for invoice verification (optional) - Automatic email delivery to customer (optional) - Sequential invoice numbering (YS-INV-YYYY-NNNNNN) - Complete order and customer details  **Requirements:** - Order must exist and belong to customer - Payment status must be 'paid' - Invoice not already generated for this order  **Automation:** - Invoices are auto-generated via MongoDB change streams when payment status becomes 'paid' - This endpoint allows manual generation for special cases 

        :param order_id: MongoDB ObjectId of the order to generate invoice for (required)
        :type order_id: str
        :param generate_invoice_request:
        :type generate_invoice_request: GenerateInvoiceRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._generate_invoice_serialize(
            order_id=order_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "GenerateInvoice201Response",
            '400': "BaseErrorResponse",
            '401': "BaseErrorResponse",
            '403': "BaseErrorResponse",
            '404': "BaseErrorResponse",
            '409': "BaseErrorResponse",
    ...
    @validate_call
    def generate_invoice_with_http_info(
        self,
        order_id: Annotated[str, Field(strict=True, description="MongoDB ObjectId of the order to generate invoice for")],
        generate_invoice_request: Optional[GenerateInvoiceRequest] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GenerateInvoice201Response]:
        """Generate PDF invoice for paid order
    ...
    @validate_call
    def generate_invoice_without_preload_content(
        self,
        order_id: Annotated[str, Field(strict=True, description="MongoDB ObjectId of the order to generate invoice for")],
        generate_invoice_request: Optional[GenerateInvoiceRequest] = None,
        _request_timeout: Union[
    ...
    def _generate_invoice_serialize(
        self,
        order_id,
        ...
        # process the form parameters
        # process the body parameter
        if generate_invoice_request is not None:
            _body_params = generate_invoice_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/invoices/generate/{orderId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_invoice_details(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetInvoiceDetails200Response:
        """Get detailed invoice information

        **ADMIN ONLY** - Retrieve comprehensive details for a specific invoice.  **Returns:** - Complete invoice metadata - Associated order information - Customer details (sanitized) - Line items with product information - Payment and delivery status - Email delivery status 
        ...
        _param = self._get_invoice_details_serialize(
            invoice_number=invoice_number,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetInvoiceDetails200Response",
            '400': "BaseErrorResponse",
            '401': "BaseErrorResponse",
            '403': "BaseErrorResponse",
            '404': "BaseErrorResponse",
    ...
    @validate_call
    def get_invoice_details_with_http_info(
        self,
        invoice_number: Annotated[str, Field(strict=True, description="Yellow Sapphire invoice number (YS-INV-YYYY-NNNNNN format)")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetInvoiceDetails200Response]:
        """Get detailed invoice information
    ...
    @validate_call
    def get_invoice_details_without_preload_content(
        self,
        invoice_number: Annotated[str, Field(strict=True, description="Yellow Sapphire invoice number (YS-INV-YYYY-NNNNNN format)")],
        _request_timeout: Union[
            None,
    ...
    def _get_invoice_details_serialize(
        self,
        invoice_number,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/invoices/{invoiceNumber}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_invoice_templates(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetInvoiceTemplates200Response:
        """Get available invoice templates

        **ADMIN Only** - Retrieve list of available invoice templates for PDF generation. - Returns all registered invoice templates - Includes template metadata (id, name, description) - Provides default template information - Fast response (< 10ms typical)  **Template Types:** - `yellow-sapphire-classic`: Traditional YS branding with orange headers - `ys-modern-professional`: Clean design with gradient headers   - `ys-minimal-clean`: Simple design with minimal colors  **Usage:** Use the `templateId` from this response in invoice generation requests. 
        ...
        _param = self._get_invoice_templates_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetInvoiceTemplates200Response",
            '401': "BaseErrorResponse",
            '403': "BaseErrorResponse",
            '500': "BaseErrorResponse",
        }
    ...
    @validate_call
    def get_invoice_templates_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetInvoiceTemplates200Response]:
        """Get available invoice templates
    ...
    @validate_call
    def get_invoice_templates_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_invoice_templates_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/invoices/templates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_invoices(
        ...
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of invoices per page")] = None,
        payment_status: Annotated[Optional[StrictStr], Field(description="Filter by payment status")] = None,
        customer_email: Annotated[Optional[StrictStr], Field(description="Filter by customer email (partial match, case-insensitive)")] = None,
        invoice_number: Annotated[Optional[StrictStr], Field(description="Filter by invoice number (partial match, case-insensitive)")] = None,
        date_from: Annotated[Optional[date], Field(description="Filter invoices generated from this date (ISO 8601)")] = None,
        date_to: Annotated[Optional[date], Field(description="Filter invoices generated up to this date (ISO 8601)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        **ADMIN ONLY** - Retrieve paginated list of invoices with advanced filtering options.  **Filtering Options:** - Payment status (pending, paid, partially_paid, refunded, failed) - Customer email (partial match, case-insensitive) - Invoice number (partial match, case-insensitive) - Date range (invoice generation date)  **Sorting:** - Default: Most recent invoices first (invoiceGeneratedAt DESC)  **Pagination:** - Default page size: 10 invoices - Maximum page size: 100 invoices - Includes total count and pagination metadata  **Performance:** - Uses database indexes for efficient filtering - Populated customer data (name, email, company) - Excludes sensitive customer information 
        ...
        :param customer_email: Filter by customer email (partial match, case-insensitive)
        :type customer_email: str
        :param invoice_number: Filter by invoice number (partial match, case-insensitive)
        :type invoice_number: str
        :param date_from: Filter invoices generated from this date (ISO 8601)
        :type date_from: date
        :param date_to: Filter invoices generated up to this date (ISO 8601)
        :type date_to: date
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _list_invoices_serialize(
        ...
        if customer_email is not None:
            ...
            _query_params.append(('customerEmail', customer_email))
    ...
    def resend_invoice_email(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ResendInvoiceEmail200Response:
        """Resend invoice email to customer

        **Admin Only** - Resend the invoice email with PDF attachment to the customer. - Sends professional HTML email with PDF attachment - Updates email delivery status in database - Uses YS email template - Includes all order and invoice details  **Requirements:** - Invoice must exist and have generated PDF - Customer email must be valid - PDF file must exist on file system 
        ...
        _param = self._resend_invoice_email_serialize(
            invoice_number=invoice_number,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResendInvoiceEmail200Response",
            '400': "BaseErrorResponse",
            '401': "BaseErrorResponse",
            '403': "BaseErrorResponse",
            '404': "BaseErrorResponse",
    ...
    @validate_call
    def resend_invoice_email_with_http_info(
        self,
        invoice_number: Annotated[str, Field(strict=True, description="Yellow Sapphire invoice number (YS-INV-YYYY-NNNNNN format)")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResendInvoiceEmail200Response]:
        """Resend invoice email to customer
    ...
    @validate_call
    def resend_invoice_email_without_preload_content(
        self,
        invoice_number: Annotated[str, Field(strict=True, description="Yellow Sapphire invoice number (YS-INV-YYYY-NNNNNN format)")],
        _request_timeout: Union[
            None,
    ...
    def _resend_invoice_email_serialize(
        self,
        invoice_number,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/invoices/resend/{invoiceNumber}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
