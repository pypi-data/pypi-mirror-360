...
from yellowsapphire_sdk.models.adjust_product_stock200_response import AdjustProductStock200Response
from yellowsapphire_sdk.models.adjust_product_stock_request import AdjustProductStockRequest
from yellowsapphire_sdk.models.create_product_from_barcode201_response import CreateProductFromBarcode201Response
from yellowsapphire_sdk.models.create_product_from_barcode_request import CreateProductFromBarcodeRequest
from yellowsapphire_sdk.models.lookup_product_by_barcode200_response import LookupProductByBarcode200Response
from yellowsapphire_sdk.models.lookup_product_by_barcode_request import LookupProductByBarcodeRequest
...
class AdminInventoryManagementApi:
    ...
    def adjust_product_stock(
        self,
        id: Annotated[str, Field(strict=True, description="MongoDB ObjectId of the product")],
        adjust_product_stock_request: AdjustProductStockRequest,
        ...
        Perform stock level adjustments with comprehensive audit trail. - ACID-compliant stock adjustments using MongoDB transactions - Comprehensive audit trail with inventory transactions - Support for positive (stock-in) and negative (stock-out) adjustments - Prevention of negative stock levels - Real-time stock validation and conflict detection - Detailed transaction history for compliance  **Use Cases:** - Receiving new inventory shipments - Adjusting for damaged or lost items - Cycle count corrections - Manual stock reconciliation - Shrinkage and write-off adjustments 

        :param id: MongoDB ObjectId of the product (required)
        :type id: str
        :param adjust_product_stock_request: (required)
        :type adjust_product_stock_request: AdjustProductStockRequest
        ...
        _param = self._adjust_product_stock_serialize(
            id=id,
            adjust_product_stock_request=adjust_product_stock_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AdjustProductStock200Response",
            '400': "AdjustProductStock400Response",
            '404': "AdjustProductStock404Response",
            '401': "BaseErrorResponse",
            '500': "AdjustProductStock500Response",
        }
    ...
    @validate_call
    def adjust_product_stock_with_http_info(
        self,
        id: Annotated[str, Field(strict=True, description="MongoDB ObjectId of the product")],
        adjust_product_stock_request: AdjustProductStockRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AdjustProductStock200Response]:
        """Adjust product stock levels
    ...
    @validate_call
    def adjust_product_stock_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True, description="MongoDB ObjectId of the product")],
        adjust_product_stock_request: AdjustProductStockRequest,
        _request_timeout: Union[
    ...
    def _adjust_product_stock_serialize(
        self,
        id,
        adjust_product_stock_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if adjust_product_stock_request is not None:
            _body_params = adjust_product_stock_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/products/stock/adjust',
    ...
    @validate_call
    def create_product_from_barcode(
        self,
        create_product_from_barcode_request: CreateProductFromBarcodeRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> CreateProductFromBarcode201Response:
        """Create product from barcode scan

        Create a new product using barcode lookup data combined with manual input. - Atomic product creation with inventory transaction - Auto-population from barcode lookup with manual overrides - ACID-compliant MongoDB transactions - Comprehensive audit trail and metadata tracking - Automatic SKU generation if not provided - Inventory initialization with stock tracking  **Process:** 1. Validates barcode data and product information 2. Checks for duplicate SKU conflicts 3. Creates product with barcode metadata in atomic transaction 4. Initializes inventory with stock-in transaction 5. Tracks auto-populated vs manually entered fields 6. Returns detailed creation summary with audit information 

        :param create_product_from_barcode_request: (required)
        :type create_product_from_barcode_request: CreateProductFromBarcodeRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_product_from_barcode_serialize(
            create_product_from_barcode_request=create_product_from_barcode_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateProductFromBarcode201Response",
            '400': "CreateProductFromBarcode400Response",
            '401': "BaseErrorResponse",
            '500': "CreateProductFromBarcode500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def create_product_from_barcode_with_http_info(
        self,
        create_product_from_barcode_request: CreateProductFromBarcodeRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateProductFromBarcode201Response]:
        """Create product from barcode scan
    ...
    @validate_call
    def create_product_from_barcode_without_preload_content(
        self,
        create_product_from_barcode_request: CreateProductFromBarcodeRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_product_from_barcode_serialize(
        self,
        create_product_from_barcode_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_product_from_barcode_request is not None:
            _body_params = create_product_from_barcode_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/barcode/create-product',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def lookup_product_by_barcode(
        self,
        lookup_product_by_barcode_request: LookupProductByBarcodeRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> LookupProductByBarcode200Response:
        """Lookup product by barcode

        Try barcode lookup using multiple API sources to retrieve product information. - Integration wih (UPCitemdb, GoUPC, BarcodeLookup, Dell API) - Intelligent data merging and confidence scoring - Caching with 24-hour expiration - Manufacturer-specific API selection - Circuit breaker pattern for resilience - Comprehensive audit trail  **Process:** 1. Validates barcode format (5-20 alphanumeric characters) 2. Checks cache for recent lookups (unless skipCache=true) 3. Queries relevant APIs concurrently with timeouts 4. Merges results using intelligent prioritization 5. Calculates confidence score and data quality metrics 6. Caches successful results and logs comprehensive audit data 

        :param lookup_product_by_barcode_request: (required)
        :type lookup_product_by_barcode_request: LookupProductByBarcodeRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._lookup_product_by_barcode_serialize(
            lookup_product_by_barcode_request=lookup_product_by_barcode_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LookupProductByBarcode200Response",
            '400': "LookupProductByBarcode400Response",
            '401': "BaseErrorResponse",
            '500': "LookupProductByBarcode500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def lookup_product_by_barcode_with_http_info(
        self,
        lookup_product_by_barcode_request: LookupProductByBarcodeRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LookupProductByBarcode200Response]:
        """Lookup product by barcode
    ...
    @validate_call
    def lookup_product_by_barcode_without_preload_content(
        self,
        lookup_product_by_barcode_request: LookupProductByBarcodeRequest,
        _request_timeout: Union[
            None,
    ...
    def _lookup_product_by_barcode_serialize(
        self,
        lookup_product_by_barcode_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if lookup_product_by_barcode_request is not None:
            _body_params = lookup_product_by_barcode_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/barcode/lookup',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
