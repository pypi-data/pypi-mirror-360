...
from yellowsapphire_sdk.models.delete_customer_by_id200_response import DeleteCustomerById200Response
from yellowsapphire_sdk.models.get_all_customers200_response import GetAllCustomers200Response
from yellowsapphire_sdk.models.get_customer_by_id200_response import GetCustomerById200Response
from yellowsapphire_sdk.models.update_customer_profile_by_id200_response import UpdateCustomerProfileById200Response
from yellowsapphire_sdk.models.update_customer_profile_by_id_request import UpdateCustomerProfileByIdRequest
...
class AdminCustomerManagementApi:
    ...
    def delete_customer_by_id(
    ...
    ) -> DeleteCustomerById200Response:
        """Delete customer account

        Remove customer account and associated data
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeleteCustomerById200Response",
    ...
    def delete_customer_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteCustomerById200Response]:
        """Delete customer account
    ...
    def _delete_customer_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/admin/customer/{id}',
    ...
    def get_all_customers(
        ...
        verified: Annotated[Optional[StrictBool], Field(description="Filter by verification status")] = None,
        client_type: Annotated[Optional[StrictStr], Field(description="Filter by client type")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Search in company name, contact name, or email")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type verified: bool
        :param client_type: Filter by client type
        :type client_type: str
        :param search: Search in company name, contact name, or email
        :type search: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAllCustomers200Response",
            '401': "BaseErrorResponse",
            '500': "BaseErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    def get_all_customers_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAllCustomers200Response]:
        """Get all customers
    ...
    def get_customer_by_id(
        ...
        Retrieve specific customer details including order history
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCustomerById200Response",
            '404': "BaseErrorResponse",
            '401': "BaseErrorResponse",
            '500': "BaseErrorResponse",
        }
    ...
    def get_customer_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCustomerById200Response]:
        """Get customer by ID
    ...
    @validate_call
    def update_customer_profile_by_id(
        self,
        id: Annotated[StrictStr, Field(description="Customer ID")],
        update_customer_profile_by_id_request: Annotated[UpdateCustomerProfileByIdRequest, Field(description="Customer details to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> UpdateCustomerProfileById200Response:
        ...
        :param id: Customer ID (required)
        :type id: str
        :param update_customer_profile_by_id_request: Customer details to update (required)
        :type update_customer_profile_by_id_request: UpdateCustomerProfileByIdRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_customer_profile_by_id_serialize(
            id=id,
            update_customer_profile_by_id_request=update_customer_profile_by_id_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdateCustomerProfileById200Response",
            '404': "BaseErrorResponse",
            '400': "BaseErrorResponse",
            '401': "BaseErrorResponse",
            '500': "BaseErrorResponse",
    ...
    @validate_call
    def update_customer_profile_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Customer ID")],
        update_customer_profile_by_id_request: Annotated[UpdateCustomerProfileByIdRequest, Field(description="Customer details to update")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateCustomerProfileById200Response]:
        """Update customer profile
    ...
    @validate_call
    def update_customer_profile_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Customer ID")],
        update_customer_profile_by_id_request: Annotated[UpdateCustomerProfileByIdRequest, Field(description="Customer details to update")],
        _request_timeout: Union[
    ...
    def _update_customer_profile_by_id_serialize(
        self,
        id,
        update_customer_profile_by_id_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_customer_profile_by_id_request is not None:
            _body_params = update_customer_profile_by_id_request
