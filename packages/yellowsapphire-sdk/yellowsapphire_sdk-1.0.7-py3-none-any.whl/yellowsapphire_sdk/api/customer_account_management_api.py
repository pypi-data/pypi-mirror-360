...
from yellowsapphire_sdk.models.customer import Customer
from yellowsapphire_sdk.models.customer_login200_response import CustomerLogin200Response
from yellowsapphire_sdk.models.customer_login_request import CustomerLoginRequest
from yellowsapphire_sdk.models.customer_signup201_response import CustomerSignup201Response
from yellowsapphire_sdk.models.customer_signup_request import CustomerSignupRequest
from yellowsapphire_sdk.models.customer_verify200_response import CustomerVerify200Response
from yellowsapphire_sdk.models.customer_verify_request import CustomerVerifyRequest
from yellowsapphire_sdk.models.edit_customer_profile_request import EditCustomerProfileRequest
from yellowsapphire_sdk.models.login_with_google200_response import LoginWithGoogle200Response
from yellowsapphire_sdk.models.login_with_google_request import LoginWithGoogleRequest
from yellowsapphire_sdk.models.request_otp200_response import RequestOTP200Response
from yellowsapphire_sdk.models.save_firebase_token200_response import SaveFirebaseToken200Response
from yellowsapphire_sdk.models.save_firebase_token_request import SaveFirebaseTokenRequest
...
class CustomerAccountManagementApi:
    ...
    def customer_login(
        self,
        customer_login_request: CustomerLoginRequest,
        ...
        Authenticate existing customer and receive JWT token for API access.  **Authentication Flow:** 1. Customer provides email and password 2. System validates credentials against database 3. Returns JWT token with 24-hour expiration 4. Token includes customer ID, email, and verification status  **Token Usage:** - Include in Authorization header: `Bearer <token>` - Token expires in 24 hours (86400 seconds) - Contains customer profile data and permissions  **Security Features:** - Bcrypt password hashing with salt - Rate limiting: 10 attempts per 15 minutes per IP - Correlation ID tracking for security monitoring - Failed login attempts are logged for security analysis  **Business Logic:** - Unverified accounts can login but have limited access - Account verification required for order placement - Multiple failed attempts may trigger account lockout 

        :param customer_login_request: (required)
        :type customer_login_request: CustomerLoginRequest
        ...
        _param = self._customer_login_serialize(
    ...
    @validate_call
    def customer_login_with_http_info(
        self,
        customer_login_request: CustomerLoginRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomerLogin200Response]:
        """Customer Authentication
    ...
    @validate_call
    def customer_login_without_preload_content(
        self,
        customer_login_request: CustomerLoginRequest,
        _request_timeout: Union[
            None,
    ...
    def _customer_login_serialize(
        ...
        if customer_login_request is not None:
            _body_params = customer_login_request
    ...
    def customer_signup(
        self,
        customer_signup_request: CustomerSignupRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> CustomerSignup201Response:
        """Customer registration

        Register new customer account with validated input.  **Signup Process:** - Account creation happens synchronously  - Welcome email sent asynchronously (non-blocking) - Returns authentication token immediately - Email failures don't affect signup success  **Security:** - Input sanitization for email - Comprehensive field validation - Password strength requirements - Phone number format validation - Protection against SQL injection  **Validation Rules:** - firstName: 1-50 characters, required - lastName: 1-50 characters, required   - email: Valid email format, max 50 characters - phone: SA format - local (0123456789) or international (+27123456789) - password: 6-20 characters 

        :param customer_signup_request: (required)
        :type customer_signup_request: CustomerSignupRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._customer_signup_serialize(
            customer_signup_request=customer_signup_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CustomerSignup201Response",
            '400': "LoginAdmin400Response",
            '409': "CustomerSignup409Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def customer_signup_with_http_info(
        self,
        customer_signup_request: CustomerSignupRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomerSignup201Response]:
        """Customer registration
    ...
    @validate_call
    def customer_signup_without_preload_content(
        self,
        customer_signup_request: CustomerSignupRequest,
        _request_timeout: Union[
            None,
    ...
    def _customer_signup_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if customer_signup_request is not None:
            _body_params = customer_signup_request
    ...
    def customer_verify(
        self,
        customer_verify_request: CustomerVerifyRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> CustomerVerify200Response:
        """Verify customer account

        Verify customer account using OTP

        :param customer_verify_request: (required)
        :type customer_verify_request: CustomerVerifyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._customer_verify_serialize(
            customer_verify_request=customer_verify_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CustomerVerify200Response",
            '400': "CustomerVerify400Response",
            '401': "CompareProducts401Response",
            '500': "CustomerVerify500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def customer_verify_with_http_info(
        self,
        customer_verify_request: CustomerVerifyRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomerVerify200Response]:
        """Verify customer account
    ...
    @validate_call
    def customer_verify_without_preload_content(
        self,
        customer_verify_request: CustomerVerifyRequest,
        _request_timeout: Union[
            None,
    ...
    def _customer_verify_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if customer_verify_request is not None:
            _body_params = customer_verify_request
    ...
    def edit_customer_profile(
        self,
        edit_customer_profile_request: EditCustomerProfileRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param edit_customer_profile_request: (required)
        :type edit_customer_profile_request: EditCustomerProfileRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._edit_customer_profile_serialize(
            edit_customer_profile_request=edit_customer_profile_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Customer",
            '400': "EditCustomerProfile400Response",
            '401': "CompareProducts401Response",
            '500': "EditCustomerProfile500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def edit_customer_profile_with_http_info(
        self,
        edit_customer_profile_request: EditCustomerProfileRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def edit_customer_profile_without_preload_content(
        self,
        edit_customer_profile_request: EditCustomerProfileRequest,
        _request_timeout: Union[
            None,
    ...
    def _edit_customer_profile_serialize(
        self,
        edit_customer_profile_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if edit_customer_profile_request is not None:
            _body_params = edit_customer_profile_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/customer/profile',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_customer_profile(
        ...
        _param = self._get_customer_profile_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "Customer",
            '401': "LoginAdmin400Response",
            '500': "GetCustomerProfile500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _get_customer_profile_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def login_with_google(
        self,
        login_with_google_request: LoginWithGoogleRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> LoginWithGoogle200Response:
        """Google OAuth login

        Authenticate customer using Google OAuth

        :param login_with_google_request: (required)
        :type login_with_google_request: LoginWithGoogleRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._login_with_google_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LoginWithGoogle200Response",
            '400': "LoginWithGoogle400Response",
            '500': "LoginWithGoogle500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def login_with_google_with_http_info(
        self,
        login_with_google_request: LoginWithGoogleRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LoginWithGoogle200Response]:
        """Google OAuth login
    ...
    @validate_call
    def login_with_google_without_preload_content(
        self,
        login_with_google_request: LoginWithGoogleRequest,
        _request_timeout: Union[
            None,
    ...
    def _login_with_google_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if login_with_google_request is not None:
            _body_params = login_with_google_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/customer/googlelogin',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def request_otp(
        ...
        Request a new OTP for account verification. Note: OTP generation is currently disabled.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RequestOTP200Response",
            '400': "RequestOTP400Response",
            '401': "CompareProducts401Response",
            '500': "RequestOTP500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def request_otp_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RequestOTP200Response]:
        """Request OTP
    ...
    def save_firebase_token(
        self,
        save_firebase_token_request: SaveFirebaseTokenRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> SaveFirebaseToken200Response:
        """Save Firebase token

        Save Firebase push notification token for the customer

        :param save_firebase_token_request: (required)
        :type save_firebase_token_request: SaveFirebaseTokenRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._save_firebase_token_serialize(
            save_firebase_token_request=save_firebase_token_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SaveFirebaseToken200Response",
            '400': "SaveFirebaseToken400Response",
            '401': "CompareProducts401Response",
            '404': "SaveFirebaseToken404Response",
            '500': "SaveFirebaseToken500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def save_firebase_token_with_http_info(
        self,
        save_firebase_token_request: SaveFirebaseTokenRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SaveFirebaseToken200Response]:
        """Save Firebase token
    ...
    @validate_call
    def save_firebase_token_without_preload_content(
        self,
        save_firebase_token_request: SaveFirebaseTokenRequest,
        _request_timeout: Union[
            None,
    ...
    def _save_firebase_token_serialize(
        self,
        save_firebase_token_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if save_firebase_token_request is not None:
            _body_params = save_firebase_token_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/customer/firebasetoken',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
