...
conf = yellowsapphire_sdk.Configuration(
    username='the-user',
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("yellowsapphire_sdk")
    ...
    def get_host_settings(self):
        ...
        return [
            ...
            {
                'url': "https://yellowsapphire-backend-826925162454.africa-south1.run.app",
