...
from yellowsapphire_sdk.models.create_admin201_response import CreateAdmin201Response
from yellowsapphire_sdk.models.create_admin_request import CreateAdminRequest
from yellowsapphire_sdk.models.delete_admin_by_id200_response import DeleteAdminById200Response
from yellowsapphire_sdk.models.get_admin_by_id200_response import GetAdminById200Response
from yellowsapphire_sdk.models.get_all_admins200_response import GetAllAdmins200Response
from yellowsapphire_sdk.models.login_admin200_response import LoginAdmin200Response
from yellowsapphire_sdk.models.login_admin_request import LoginAdminRequest
from yellowsapphire_sdk.models.setup_admin201_response import SetupAdmin201Response
from yellowsapphire_sdk.models.setup_admin_request import SetupAdminRequest
from yellowsapphire_sdk.models.update_admin200_response import UpdateAdmin200Response
from yellowsapphire_sdk.models.update_admin_request import UpdateAdminRequest
...
class AdminSystemManagementApi:
    ...
    def create_admin(
        ...
        :param create_admin_request: (required)
        :type create_admin_request: CreateAdminRequest
    ...
    def create_admin_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateAdmin201Response]:
        """Create new admin account
    ...
    def _create_admin_serialize(
        ...
        if create_admin_request is not None:
            _body_params = create_admin_request
    ...
    def delete_admin_by_id(
        self,
        id: Annotated[StrictStr, Field(description="Admin ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> DeleteAdminById200Response:
        """Delete admin account

        Delete an admin account (cannot delete yourself)

        :param id: Admin ID (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_admin_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeleteAdminById200Response",
    ...
    @validate_call
    def delete_admin_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Admin ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteAdminById200Response]:
        """Delete admin account
    ...
    @validate_call
    def delete_admin_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Admin ID")],
        _request_timeout: Union[
            None,
    ...
    def _delete_admin_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_admin_by_id(
        self,
        id: Annotated[str, Field(strict=True, description="Admin MongoDB ObjectId (24-character hex string)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetAdminById200Response:
        """Get admin by ID

        Retrieve specific admin account details by MongoDB ObjectId.  **Implementation:** - Validates MongoDB ObjectId format using class-validator DTOs - Returns admin profile excluding sensitive fields (password, salt) - Includes role, department, and access level information - Requires admin-level authentication 

        :param id: Admin MongoDB ObjectId (24-character hex string) (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_admin_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAdminById200Response",
            '400': "GetAdminById400Response",
            '404': "BaseErrorResponse",
            '401': "BaseErrorResponse",
            '500': "BaseErrorResponse",
        }
    ...
    @validate_call
    def get_admin_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True, description="Admin MongoDB ObjectId (24-character hex string)")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAdminById200Response]:
        """Get admin by ID
    ...
    @validate_call
    def get_admin_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True, description="Admin MongoDB ObjectId (24-character hex string)")],
        _request_timeout: Union[
            None,
    ...
    def _get_admin_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_all_admins(
        ...
        limit: Annotated[Optional[StrictInt], Field(description="Items per page")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetAllAdmins200Response:
        """Get all admin accounts

        Retrieve all admin accounts with pagination
        ...
        _param = self._get_all_admins_serialize(
            page=page,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_all_admins_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="Page number for pagination")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Items per page")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAllAdmins200Response]:
        """Get all admin accounts
    ...
    @validate_call
    def get_all_admins_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="Page number for pagination")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Items per page")] = None,
        _request_timeout: Union[
    ...
    def login_admin(
        ...
        :param login_admin_request: (required)
        :type login_admin_request: LoginAdminRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LoginAdmin200Response",
            '400': "LoginAdmin400Response",
            '401': "LoginAdmin400Response",
            '404': "LoginAdmin400Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def login_admin_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LoginAdmin200Response]:
        """Admin login
    ...
    def _login_admin_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if login_admin_request is not None:
            _body_params = login_admin_request
    ...
    def setup_admin(
        self,
        setup_admin_request: SetupAdminRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> SetupAdmin201Response:
        """Initial admin setup

        Create the first admin account during system setup. Only works when no admins exist.

        :param setup_admin_request: (required)
        :type setup_admin_request: SetupAdminRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._setup_admin_serialize(
            setup_admin_request=setup_admin_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def setup_admin_with_http_info(
        self,
        setup_admin_request: SetupAdminRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SetupAdmin201Response]:
        """Initial admin setup
    ...
    @validate_call
    def setup_admin_without_preload_content(
        self,
        setup_admin_request: SetupAdminRequest,
        _request_timeout: Union[
            None,
    ...
    def _setup_admin_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if setup_admin_request is not None:
            _body_params = setup_admin_request
    ...
    def update_admin(
        ...
        :param id: Admin ID (required)
        :type id: str
        :param update_admin_request: (required)
        :type update_admin_request: UpdateAdminRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def update_admin_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateAdmin200Response]:
        """Update admin account
    ...
    def _update_admin_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_admin_request is not None:
            _body_params = update_admin_request
