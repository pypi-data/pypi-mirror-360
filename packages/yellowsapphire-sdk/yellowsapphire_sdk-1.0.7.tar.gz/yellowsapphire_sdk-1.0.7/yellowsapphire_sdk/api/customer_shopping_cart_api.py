...
from yellowsapphire_sdk.models.add_to_cart200_response import AddToCart200Response
from yellowsapphire_sdk.models.add_to_cart_request import AddToCartRequest
from yellowsapphire_sdk.models.clear_cart200_response import ClearCart200Response
from yellowsapphire_sdk.models.delete_from_cart200_response import DeleteFromCart200Response
from yellowsapphire_sdk.models.get_cart200_response import GetCart200Response
...
class CustomerShoppingCartApi:
    ...
    def add_to_cart(
    ...
    ) -> AddToCart200Response:
        """Add item to cart

        Add product item to customer's shopping cart
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AddToCart200Response",
            '400': "BaseErrorResponse",
            '401': "AuthenticationErrorResponse",
            '404': "AddToCart404Response",
            '500': "AddToCart500Response",
        }
    ...
    def add_to_cart_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddToCart200Response]:
        """Add item to cart
    ...
    def clear_cart(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ClearCart200Response:
        """Clear shopping cart

        Remove all items from customer's shopping cart
        ...
        _param = self._clear_cart_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def clear_cart_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClearCart200Response]:
        """Clear shopping cart
    ...
    @validate_call
    def clear_cart_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def delete_from_cart(
        self,
        item_id: Annotated[StrictStr, Field(description="Cart item ID (product ID)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> DeleteFromCart200Response:
        """Remove item from cart

        Remove specific item from customer's shopping cart

        :param item_id: Cart item ID (product ID) (required)
        :type item_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def delete_from_cart_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteFromCart200Response]:
        """Remove item from cart
    ...
    def _delete_from_cart_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/customer/cart/{itemId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_cart(
        ...
        Retrieve customer's current shopping cart
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCart200Response",
            '400': "GetCart400Response",
            '401': "LoginAdmin400Response",
            '500': "GetCart500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def get_cart_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCart200Response]:
        """Get shopping cart
