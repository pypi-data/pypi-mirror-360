...
from yellowsapphire_sdk.models.get_circuit_breaker_status200_response import GetCircuitBreakerStatus200Response
from yellowsapphire_sdk.models.get_detailed_health200_response import GetDetailedHealth200Response
from yellowsapphire_sdk.models.get_exception_history200_response import GetExceptionHistory200Response
from yellowsapphire_sdk.models.get_system_metrics200_response import GetSystemMetrics200Response
from yellowsapphire_sdk.models.trigger_memory_cleanup200_response import TriggerMemoryCleanup200Response
...
class AdminSystemMonitoringApi:
    ...
    ) -> GetCircuitBreakerStatus200Response:
        """Circuit breaker status

        **ADMIN ONLY** - Circuit breaker health status and metrics for all registered circuits. Shows which services are healthy, in warning state, or critical. 
        ...
        _param = self._get_circuit_breaker_status_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetCircuitBreakerStatus200Response",
    ...
    @validate_call
    def get_circuit_breaker_status_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetCircuitBreakerStatus200Response]:
        """Circuit breaker status
    ...
    @validate_call
    def get_circuit_breaker_status_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_circuit_breaker_status_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/service/circuits',
    ...
    def get_detailed_health(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetDetailedHealth200Response:
        """Detailed system health and monitoring data

        **ADMIN ONLY** - Comprehensive system health information including: - Real-time system metrics (CPU, memory, event loop) - Memory leak detection status and trends - Circuit breaker health for all services - Exception handling metrics and recovery rates - Database performance and connection status  Requires admin authentication. 
        ...
        _param = self._get_detailed_health_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetDetailedHealth200Response",
            '401': "BaseErrorResponse",
    ...
    @validate_call
    def get_detailed_health_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDetailedHealth200Response]:
        """Detailed system health and monitoring data
    ...
    @validate_call
    def get_detailed_health_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_detailed_health_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/service/health-detailed',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_exception_history(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetExceptionHistory200Response:
        """Exception handling history

        **ADMIN ONLY** - Exception handling metrics and recent exception history. Shows recovery rates, exception types, and recent failures. 
        ...
        _param = self._get_exception_history_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetExceptionHistory200Response",
            '401': "BaseErrorResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_exception_history_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetExceptionHistory200Response]:
        """Exception handling history
    ...
    @validate_call
    def get_exception_history_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_exception_history_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/service/exceptions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_system_metrics(
        ...
        **ADMIN ONLY** - Real-time system performance metrics including: - CPU usage and load averages - Memory utilization and garbage collection stats - Event loop performance - Database connection metrics - Circuit breaker status - Exception handling statistics 
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "BaseErrorResponse",
            '500': "GetSystemMetrics500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def trigger_memory_cleanup(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> TriggerMemoryCleanup200Response:
        """Manual memory cleanup

        **ADMIN ONLY** - Manually trigger garbage collection and memory cleanup. Returns memory usage before and after cleanup operation. 
        ...
        _param = self._trigger_memory_cleanup_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TriggerMemoryCleanup200Response",
            '401': "BaseErrorResponse",
            '500': "TriggerMemoryCleanup500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def trigger_memory_cleanup_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TriggerMemoryCleanup200Response]:
        """Manual memory cleanup
    ...
    @validate_call
    def trigger_memory_cleanup_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _trigger_memory_cleanup_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/service/memory/cleanup',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
