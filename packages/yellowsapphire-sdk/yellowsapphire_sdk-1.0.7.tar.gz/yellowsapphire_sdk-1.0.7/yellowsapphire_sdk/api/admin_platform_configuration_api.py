...
from yellowsapphire_sdk.models.create_ad_banner201_response import CreateAdBanner201Response
from yellowsapphire_sdk.models.create_ad_banner_request import CreateAdBannerRequest
from yellowsapphire_sdk.models.create_category201_response import CreateCategory201Response
from yellowsapphire_sdk.models.create_category_request import CreateCategoryRequest
from yellowsapphire_sdk.models.get_all_ad_banners200_response import GetAllAdBanners200Response
from yellowsapphire_sdk.models.update_ad_banner_by_id200_response import UpdateAdBannerById200Response
from yellowsapphire_sdk.models.update_ad_banner_by_id_request import UpdateAdBannerByIdRequest
...
class AdminPlatformConfigurationApi:
    ...
    def create_ad_banner(
        self,
        create_ad_banner_request: CreateAdBannerRequest,
    ...
    ) -> CreateAdBanner201Response:
        """Create advertisement banner

        Create a new advertisement banner for the platform

        :param create_ad_banner_request: (required)
        :type create_ad_banner_request: CreateAdBannerRequest
        ...
        _param = self._create_ad_banner_serialize(
            create_ad_banner_request=create_ad_banner_request,
    ...
    @validate_call
    def create_ad_banner_with_http_info(
        self,
        create_ad_banner_request: CreateAdBannerRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateAdBanner201Response]:
        """Create advertisement banner
    ...
    @validate_call
    def create_ad_banner_without_preload_content(
        self,
        create_ad_banner_request: CreateAdBannerRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_ad_banner_serialize(
        self,
        ...
        if create_ad_banner_request is not None:
            _body_params = create_ad_banner_request
    ...
    def create_category(
        ...
        Create a new product category for the catalog
    ...
    def create_category_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateCategory201Response]:
        """Create product category
    ...
    def _create_category_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/admin/categories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_ad_banners(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetAllAdBanners200Response:
        """Get all advertisement banners

        Retrieve all advertisement banners for admin management
        ...
        _param = self._get_all_ad_banners_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAllAdBanners200Response",
            '401': "BaseErrorResponse",
            '500': "BaseErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_all_ad_banners_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAllAdBanners200Response]:
        """Get all advertisement banners
    ...
    @validate_call
    def get_all_ad_banners_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_ad_banners_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def update_ad_banner_by_id(
        self,
        id: Annotated[StrictStr, Field(description="Banner ID")],
        update_ad_banner_by_id_request: UpdateAdBannerByIdRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> UpdateAdBannerById200Response:
        """Update advertisement banner

        Update an existing advertisement banner by ID

        :param id: Banner ID (required)
        :type id: str
        :param update_ad_banner_by_id_request: (required)
        :type update_ad_banner_by_id_request: UpdateAdBannerByIdRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_ad_banner_by_id_serialize(
            id=id,
            update_ad_banner_by_id_request=update_ad_banner_by_id_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdateAdBannerById200Response",
            '400': "BaseErrorResponse",
    ...
    @validate_call
    def update_ad_banner_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Banner ID")],
        update_ad_banner_by_id_request: UpdateAdBannerByIdRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateAdBannerById200Response]:
        """Update advertisement banner
    ...
    @validate_call
    def update_ad_banner_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Banner ID")],
        update_ad_banner_by_id_request: UpdateAdBannerByIdRequest,
        _request_timeout: Union[
    ...
    def _update_ad_banner_by_id_serialize(
        self,
        id,
        update_ad_banner_by_id_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_ad_banner_by_id_request is not None:
            _body_params = update_ad_banner_by_id_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/admin/banners/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
