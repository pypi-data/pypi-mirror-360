...
from yellowsapphire_sdk.models.compare_products200_response import CompareProducts200Response
from yellowsapphire_sdk.models.compare_products_request import CompareProductsRequest
from yellowsapphire_sdk.models.filter_products200_response import FilterProducts200Response
from yellowsapphire_sdk.models.get_ad_banners200_response import GetAdBanners200Response
from yellowsapphire_sdk.models.get_available_offers200_response import GetAvailableOffers200Response
from yellowsapphire_sdk.models.get_categories200_response import GetCategories200Response
from yellowsapphire_sdk.models.get_featured_products200_response import GetFeaturedProducts200Response
from yellowsapphire_sdk.models.get_product_catalog200_response import GetProductCatalog200Response
from yellowsapphire_sdk.models.get_product_suggestions200_response import GetProductSuggestions200Response
from yellowsapphire_sdk.models.get_shopping_product_by_id200_response import GetShoppingProductById200Response
from yellowsapphire_sdk.models.search_products200_response import SearchProducts200Response
...
class CustomerProductCatalogApi:
    ...
    def compare_products(
        self,
        compare_products_request: CompareProductsRequest,
    ...
    ) -> CompareProducts200Response:
        """Compare multiple products

        Compare specifications and features of multiple products.  **Authentication Required**: User must be logged in to save comparisons.  **Features:** - Side-by-side comparison of product specifications - Highlight differences and similarities - Save comparison for later reference 

        :param compare_products_request: (required)
        :type compare_products_request: CompareProductsRequest
        ...
        _param = self._compare_products_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CompareProducts200Response",
            '400': "CompareProducts400Response",
            '401': "CompareProducts401Response",
        }
    ...
    @validate_call
    def compare_products_with_http_info(
        self,
        compare_products_request: CompareProductsRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CompareProducts200Response]:
        """Compare multiple products
    ...
    @validate_call
    def compare_products_without_preload_content(
        self,
        compare_products_request: CompareProductsRequest,
        _request_timeout: Union[
            None,
    ...
    def _compare_products_serialize(
        self,
        ...
        if compare_products_request is not None:
            _body_params = compare_products_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/shopping/compare',
    ...
    def filter_products(
        self,
        category: Annotated[Optional[StrictStr], Field(description="Product category filter")] = None,
        subcategory: Annotated[Optional[StrictStr], Field(description="Product subcategory filter")] = None,
        manufacturer: Annotated[Optional[StrictStr], Field(description="Manufacturer filter")] = None,
        min_price: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Minimum price filter")] = None,
        max_price: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Maximum price filter")] = None,
        in_stock: Annotated[Optional[StrictBool], Field(description="Filter by stock availability")] = None,
        form_factor: Annotated[Optional[StrictStr], Field(description="Server form factor filter")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> FilterProducts200Response:
        """Filter Products

        Advanced product filtering with multiple criteria.  **Filter Options:** - Category and subcategory filtering - Manufacturer and model filtering - Price range filtering (min/max) - Technical specifications filtering - Availability status filtering  **Features:** - Multiple filters can be combined - Fuzzy matching for text fields - Range validation for numeric fields - Real-time stock availability 

        :param category: Product category filter
        :type category: str
        :param subcategory: Product subcategory filter
        ...
        :param in_stock: Filter by stock availability
        :type in_stock: bool
        :param form_factor: Server form factor filter
        ...
        _param = self._filter_products_serialize(
            category=category,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FilterProducts200Response",
            '400': "FilterProducts400Response",
            '404': "FilterProducts404Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def filter_products_with_http_info(
        self,
        category: Annotated[Optional[StrictStr], Field(description="Product category filter")] = None,
        subcategory: Annotated[Optional[StrictStr], Field(description="Product subcategory filter")] = None,
        manufacturer: Annotated[Optional[StrictStr], Field(description="Manufacturer filter")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FilterProducts200Response]:
        """Filter Products
    ...
    @validate_call
    def filter_products_without_preload_content(
        self,
        category: Annotated[Optional[StrictStr], Field(description="Product category filter")] = None,
        subcategory: Annotated[Optional[StrictStr], Field(description="Product subcategory filter")] = None,
        manufacturer: Annotated[Optional[StrictStr], Field(description="Manufacturer filter")] = None,
    ...
    def _filter_products_serialize(
        self,
        category,
        subcategory,
        manufacturer,
        ...
        if in_stock is not None:
            ...
            _query_params.append(('inStock', in_stock))
            
        if form_factor is not None:
            
            _query_params.append(('formFactor', form_factor))
    ...
    def get_ad_banners(
        self,
        post_code: Annotated[Optional[Annotated[str, Field(strict=True, max_length=50)]], Field(description="Filter banners by postal code")] = None,
        is_active: Annotated[Optional[StrictBool], Field(description="Filter by active status")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Maximum number of banners to return")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetAdBanners200Response:
        """Get advertisement banners

        Retrieve advertisement banners with filtering and pagination capabilities.  **Implementation:** - Returns active banners by default, sorted by display order - Supports filtering by postCode, active status, and limit - Validates input parameters using class-validator DTOs - Returns structured DTO response with banners and total count 

        :param post_code: Filter banners by postal code
        :type post_code: str
        ...
        _param = self._get_ad_banners_serialize(
            post_code=post_code,
            is_active=is_active,
            limit=limit,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAdBanners200Response",
            '400': "GetAdBanners400Response",
            '500': "GetAdBanners500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_ad_banners_with_http_info(
        self,
        post_code: Annotated[Optional[Annotated[str, Field(strict=True, max_length=50)]], Field(description="Filter banners by postal code")] = None,
        is_active: Annotated[Optional[StrictBool], Field(description="Filter by active status")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Maximum number of banners to return")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAdBanners200Response]:
        """Get advertisement banners
    ...
    @validate_call
    def get_ad_banners_without_preload_content(
        self,
        post_code: Annotated[Optional[Annotated[str, Field(strict=True, max_length=50)]], Field(description="Filter banners by postal code")] = None,
        is_active: Annotated[Optional[StrictBool], Field(description="Filter by active status")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Maximum number of banners to return")] = None,
    ...
    def _get_ad_banners_serialize(
        ...
        if post_code is not None:
            ...
            _query_params.append(('postCode', post_code))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/shopping/banners',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_available_offers(
        self,
        post_code: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="4-digit postal code for location-based offers")] = None,
        category: Annotated[Optional[StrictStr], Field(description="Filter offers by product category")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=20, strict=True, ge=1)]], Field(description="Maximum number of offers to return")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetAvailableOffers200Response:
        """Get available special offers and promotions

        Retrieve current special offers and promotional deals.  **Implementation:** - Returns active offers only (isActive: true) - Filters by expiry date validation - PostCode-based offer filtering for targeted promotions - Real-time offer availability checking  **Features:** - Location-based offers - Time-sensitive promotions - Bulk discount offers - Category-specific deals 

        :param post_code: 4-digit postal code for location-based offers
        :type post_code: str
        :param category: Filter offers by product category
        :type category: str
        ...
        _param = self._get_available_offers_serialize(
            post_code=post_code,
            category=category,
            limit=limit,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAvailableOffers200Response",
            '400': "CompareProducts400Response",
            '404': "GetAvailableOffers404Response",
            '500': "GetAvailableOffers500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_available_offers_with_http_info(
        self,
        post_code: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="4-digit postal code for location-based offers")] = None,
        category: Annotated[Optional[StrictStr], Field(description="Filter offers by product category")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=20, strict=True, ge=1)]], Field(description="Maximum number of offers to return")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAvailableOffers200Response]:
        """Get available special offers and promotions
    ...
    @validate_call
    def get_available_offers_without_preload_content(
        self,
        post_code: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="4-digit postal code for location-based offers")] = None,
        category: Annotated[Optional[StrictStr], Field(description="Filter offers by product category")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=20, strict=True, ge=1)]], Field(description="Maximum number of offers to return")] = None,
    ...
    def _get_available_offers_serialize(
        self,
        post_code,
        category,
        limit,
    ...
    def get_categories(
        self,
        category: Annotated[Optional[Annotated[str, Field(strict=True, max_length=50)]], Field(description="Filter by category name (case-insensitive regex)")] = None,
        search: Annotated[Optional[Annotated[str, Field(strict=True, max_length=100)]], Field(description="Search in category name and description")] = None,
        ...
        Retrieve all active product categories with filtering and search capabilities.  **Implementation:** - Returns only active categories by default - Supports optional filtering by category name and search terms - Validates input parameters using class-validator DTOs - Returns structured DTO response with categories and total count 

        :param category: Filter by category name (case-insensitive regex)
        :type category: str
        :param search: Search in category name and description
        :type search: str
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '400': "GetCategories400Response",
            '405': "GetCategories405Response",
            '500': "GetCategories500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _get_categories_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/shopping/categories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_featured_products(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=20, strict=True, ge=1)]], Field(description="Maximum number of products per collection (capped at 20)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetFeaturedProducts200Response:
        """Get featured and recommended products

        Retrieve collections of featured, new arrival, and top-rated products  **Implementation:** - Three separate collections: featured, newArrivals, topRated - Only in-stock products (stock > 0) included - Featured: sorted by rating and review count (descending) - New Arrivals: sorted by creation date (newest first), max 5 - Top Rated: rating >= 4.5 and reviewCount >= 10, max 5 

        :param limit: Maximum number of products per collection (capped at 20)
        :type limit: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_featured_products_serialize(
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetFeaturedProducts200Response",
            '500': "GetFeaturedProducts500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_featured_products_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=20, strict=True, ge=1)]], Field(description="Maximum number of products per collection (capped at 20)")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetFeaturedProducts200Response]:
        """Get featured and recommended products
    ...
    @validate_call
    def get_featured_products_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=20, strict=True, ge=1)]], Field(description="Maximum number of products per collection (capped at 20)")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_featured_products_serialize(
        self,
        limit,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/shopping/featured',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_product_catalog(
        ...
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Number of products per page")] = None,
        category: Annotated[Optional[StrictStr], Field(description="Filter by product category")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetProductCatalog200Response:
        """Get Product Catalog

        Retrieve paginated product catalog with optional filtering.  **Features:** - Pagination support with page/limit parameters - Filter by category, manufacturer, price range - Sort by price, rating, newest - Includes product availability and stock status  **Response includes:** - Product details (name, description, price, images) - Technical specifications - Stock availability - Ratings and reviews - Pagination metadata 
        ...
        _param = self._get_product_catalog_serialize(
            page=page,
            limit=limit,
            category=category,
            sort=sort,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetProductCatalog200Response",
            '400': "GetProductCatalog400Response",
            '500': "GetProductCatalog500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_product_catalog_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number (1-based)")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Number of products per page")] = None,
        category: Annotated[Optional[StrictStr], Field(description="Filter by product category")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProductCatalog200Response]:
        """Get Product Catalog
    ...
    @validate_call
    def get_product_catalog_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number (1-based)")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Number of products per page")] = None,
        category: Annotated[Optional[StrictStr], Field(description="Filter by product category")] = None,
    ...
    def _get_product_catalog_serialize(
        self,
        page,
        limit,
        category,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/shopping/products',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_product_suggestions(
        self,
        q: Annotated[str, Field(min_length=2, strict=True, description="Search query for generating suggestions (minimum 2 characters)")],
        limit: Annotated[Optional[Annotated[int, Field(le=15, strict=True, ge=1)]], Field(description="Maximum number of product suggestions (capped at 15)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetProductSuggestions200Response:
        """Get search suggestions and autocomplete

        Search suggestions system providing autocomplete for product discovery.  **Implementation:** - Three suggestion types: products, categories, brands - Products: ranked by featured status and rating - Categories: max 3 results - Brands: distinct manufacturer values, max 5 results - Minimum 2 characters required - Case-insensitive matching - Only active/available items included 

        :param q: Search query for generating suggestions (minimum 2 characters) (required)
        :type q: str
        :param limit: Maximum number of product suggestions (capped at 15)
        :type limit: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_product_suggestions_serialize(
            q=q,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetProductSuggestions200Response",
            '400': "GetProductSuggestions400Response",
            '500': "GetProductSuggestions500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_product_suggestions_with_http_info(
        self,
        q: Annotated[str, Field(min_length=2, strict=True, description="Search query for generating suggestions (minimum 2 characters)")],
        limit: Annotated[Optional[Annotated[int, Field(le=15, strict=True, ge=1)]], Field(description="Maximum number of product suggestions (capped at 15)")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProductSuggestions200Response]:
        """Get search suggestions and autocomplete
    ...
    @validate_call
    def get_product_suggestions_without_preload_content(
        self,
        q: Annotated[str, Field(min_length=2, strict=True, description="Search query for generating suggestions (minimum 2 characters)")],
        limit: Annotated[Optional[Annotated[int, Field(le=15, strict=True, ge=1)]], Field(description="Maximum number of product suggestions (capped at 15)")] = None,
        _request_timeout: Union[
    ...
    def _get_product_suggestions_serialize(
        self,
        q,
        limit,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/shopping/suggestions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_shopping_product_by_id(
        self,
        id: Annotated[str, Field(strict=True, description="Product MongoDB ObjectId (24-character hex string)")],
        units: Annotated[Optional[Annotated[str, Field(strict=True, max_length=10)]], Field(description="Optional units specification")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetShoppingProductById200Response:
        """Get product details by ID

        Retrieve detailed information for a specific product by MongoDB ObjectId.  **Implementation:** - Validates MongoDB ObjectId format using class-validator DTOs - Returns product details only if available (isAvailable: true) - Maps database fields to standardized DTO response format - Includes comprehensive product information with proper type mapping  **Field Mapping:** - productType: Maps from subcategory field - bestSeller: Derived from isFeatured and other metrics - readyTime: Default value for delivery estimates 

        :param id: Product MongoDB ObjectId (24-character hex string) (required)
        :type id: str
        :param units: Optional units specification
        :type units: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_shopping_product_by_id_serialize(
            id=id,
            units=units,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetShoppingProductById200Response",
            '400': "GetShoppingProductById400Response",
            '404': "GetShoppingProductById404Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_shopping_product_by_id_with_http_info(
        self,
        id: Annotated[str, Field(strict=True, description="Product MongoDB ObjectId (24-character hex string)")],
        units: Annotated[Optional[Annotated[str, Field(strict=True, max_length=10)]], Field(description="Optional units specification")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetShoppingProductById200Response]:
        """Get product details by ID
    ...
    @validate_call
    def get_shopping_product_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True, description="Product MongoDB ObjectId (24-character hex string)")],
        units: Annotated[Optional[Annotated[str, Field(strict=True, max_length=10)]], Field(description="Optional units specification")] = None,
        _request_timeout: Union[
    ...
    def _get_shopping_product_by_id_serialize(
        self,
        id,
        units,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/shopping/products/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def search_products(
        self,
        q: Annotated[Optional[StrictStr], Field(description="Search query for product name, description, SKU, manufacturer, or model")] = None,
        category: Annotated[Optional[StrictStr], Field(description="Filter by product category")] = None,
        brand: Annotated[Optional[StrictStr], Field(description="Filter by product brand/manufacturer")] = None,
        min_price: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Minimum price filter (ZAR)")] = None,
        max_price: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Maximum price filter (ZAR)")] = None,
        in_stock: Annotated[Optional[StrictBool], Field(description="Filter by stock availability only")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Search and filter products by various criteria.  **Implementation:** - Text search across product names, descriptions, SKUs, and manufacturers - Results ranked by featured status and ratings first - Results limited to 10 items per request - Multiple filters can be applied simultaneously  **Filter Behavior:** - Invalid price formats return 400 validation error with detailed messages - Invalid category names return no results with 404 status - All parameters are optional - Price validation includes format checking and range validation - Unicode characters are properly decoded and handled - Duplicate query parameters are concatenated (e.g., q=dell&q=hp becomes \"dell,hp\") 

        :param q: Search query for product name, description, SKU, manufacturer, or model
        :type q: str
        :param category: Filter by product category
        :type category: str
        :param brand: Filter by product brand/manufacturer
        :type brand: str
        :param min_price: Minimum price filter (ZAR)
        :type min_price: float
        :param max_price: Maximum price filter (ZAR)
        :type max_price: float
        :param in_stock: Filter by stock availability only
        :type in_stock: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SearchProducts200Response",
            '404': "NotFoundErrorResponse",
            '400': "ValidationErrorResponse",
            '500': "SearchProducts500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def search_products_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchProducts200Response]:
        """Search Products
