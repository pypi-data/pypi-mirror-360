...
from yellowsapphire_sdk.models.get_all_orders200_response import GetAllOrders200Response
from yellowsapphire_sdk.models.get_order_by_id200_response import GetOrderById200Response
from yellowsapphire_sdk.models.get_order_status_by_id200_response import GetOrderStatusById200Response
from yellowsapphire_sdk.models.update_order_status200_response import UpdateOrderStatus200Response
from yellowsapphire_sdk.models.update_order_status_request import UpdateOrderStatusRequest
...
class AdminOrderFulfillmentApi:
    ...
    def get_all_orders(
        ...
        priority: Annotated[Optional[StrictStr], Field(description="Filter by order priority")] = None,
        assigned_to: Annotated[Optional[StrictStr], Field(description="Filter by assigned admin ID")] = None,
        ...
        Retrieve all product orders with filtering and pagination
        ...
        :type priority: str
        :param assigned_to: Filter by assigned admin ID
    ...
    def get_all_orders_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAllOrders200Response]:
        """Get all orders
    ...
    def get_order_by_id(
        self,
        id: Annotated[StrictStr, Field(description="Order ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_order_status_by_id(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetOrderStatusById200Response:
        """Get order status

        Retrieve current order status and history
        ...
        _param = self._get_order_status_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetOrderStatusById200Response",
            '404': "BaseErrorResponse",
            '401': "BaseErrorResponse",
            '500': "BaseErrorResponse",
        }
    ...
    @validate_call
    def get_order_status_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Order ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetOrderStatusById200Response]:
        """Get order status
    ...
    @validate_call
    def get_order_status_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Order ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_order_status_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/order/{id}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_order_status(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> UpdateOrderStatus200Response:
        """Update order status

        Update order status with fulfillment details
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdateOrderStatus200Response",
            '404': "BaseErrorResponse",
    ...
    def update_order_status_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateOrderStatus200Response]:
        """Update order status
