...
searchTags:
  ...
  - KPN가입
  - 한국결제네트웍스(KPN) 계약방법
datetime: 2024-04-15T06:20:45.253Z
---

<Callout content="" title="한국결제네트웍스(KPN)과 계약을 맺으시기 위한 절차를 순서대로 알려드립니다." />

### **가입신청서 제출**

[포트원 관리자콘솔↗](https://admin.portone.io/) 안에서 한국결제네트웍스(KPN)의 가입신청서를 제출합니다.

- 경로 : [포트원 관리자콘솔↗](https://admin.portone.io/) 회원가입 및 로그인 > 좌측 하단 \[전자결제 신청] 버튼 클릭 > 사업자등록증 업로드 > 원하는 결제수단 & 결제대행사 선택 후 제출
...
### **한국결제네트웍스(KPN) 의 계약 안내**

- 포트원으로 접수해 주신 신청건은 당사에서 1차 검수 후 한국결제네트웍스(KPN) 으로 전달되며,\
  가입 신청서를 제출해 주신 이후 2\~3영업일 내 한국결제네트웍스(KPN) 계약부서로부터 자세한 안내를 받습니다.
...
<Callout icon="" title="한국결제네트웍스(KPN) 채널설정방법 보러가기 ↗" />
