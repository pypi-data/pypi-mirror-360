...
class CdxCreditEvent(InstrumentEvent):
    ...
    payment_date: Optional[datetime] = Field(None, alias="paymentDate", description="The date of the credit event auction settlement.")
    ...
    __properties = ["instrumentEventType", "effectiveDate", "auctionDate", "recoveryRate", "constituentWeight", "constituentReference", "paymentDate"]
