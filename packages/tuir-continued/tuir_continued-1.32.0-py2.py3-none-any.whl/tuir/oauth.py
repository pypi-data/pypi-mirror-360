...
from .objects import codecs_open
...
class OAuthHandler(BaseHTTPRequestHandler):
    ...
    def build_body(self, template_file=INDEX):
        ...
        with codecs_open(template_file, 'r', encoding='utf-8') as fp:
            index_text = fp.read()
            ...
            with self.term.loader('Logging in'):
                try:
                    ...
                    if not autologin:
                        ...
                        welcome_message = 'Welcome {}!'.format(self.reddit.user.name)

            if welcome_message:
                self.term.show_notification(welcome_message)
