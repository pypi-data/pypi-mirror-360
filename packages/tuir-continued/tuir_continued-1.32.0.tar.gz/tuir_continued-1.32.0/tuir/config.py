...
from .objects import KeyMap, codecs_open
...
class Config(object):
    ...
    def load_history(self):
        if os.path.exists(self.history_file):
            with codecs_open(self.history_file, encoding='utf-8') as fp:
    ...
    def save_history(self):
        ...
        with codecs_open(self.history_file, 'w+', encoding='utf-8') as fp:
    ...
    def get_file(cls, filename=None):
        ...
        if os.path.exists(filename):
            with codecs_open(filename, encoding='utf-8') as fp:
                try:
                    read_method = config.read_file
                except AttributeError:
                    # deprecated since 3.2, removed in 3.12
                    read_method = config.readfp  # pylint: disable=E1101
                read_method(fp)
    ...
    def _parse_tuir_file(config):
        ...
        params = {
            ...
            'copy_as_old': partial(config.getboolean, section),
        }
