...
from .objects import curses_session, patch_webbrowser, replace_domain
    ...
    try:
        with curses_session() as stdscr:
            ...
            if config['link']:
                ...
                url = replace_domain(url, 'www.reddit.com', 'old.reddit.com')
        ...
        exit_message = '\n'.join([
            ...
            'https://gitlab.com/Chocimier/tuir/issues\n'])
