...
class AttackRunner:
    ...
    def run_single_strategy(
        self, behavior:BaseHarmfulBehaviour, strategy:AttackStrategy, behavior_number:int, strategy_idx, state: RunState
    ) -> StrategyResult:
        logging.debug(
        ...
        for idx, (behavior_obj, strategy_obj) in enumerate(sampled_params):
            ...
            try:
                strategy_result = self.run_single_strategy(
                    behavior_obj, strategy_obj, plan.behavior_number, idx, state
                )
