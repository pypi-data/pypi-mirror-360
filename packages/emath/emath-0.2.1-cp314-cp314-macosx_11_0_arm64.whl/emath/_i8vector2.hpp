...
#ifndef E_MATH_I8VECTOR2_HPP
#define E_MATH_I8VECTOR2_HPP
...
I8Vector2__richcmp__(I8Vector2 *self, I8Vector2 *other, int op)
{
    ...
    switch(op)
    {
        case Py_LT:
        {
            for (I8Vector2Glm::length_type i = 0; i < 2; i++)
            {
...
static PyObject *
I8Vector2_pointer(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyGetSetDef I8Vector2_PyGetSetDef[] = {
    ...
    {"pointer", (getter)I8Vector2_pointer, 0, 0, 0},
    {0, 0, 0, 0, 0}
};
...
static PyObject *
I8Vector2_min(I8Vector2 *self, PyObject *min)
{
    ...
    I8Vector2 *result = (I8Vector2 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = I8Vector2Glm(vector);
    return (PyObject *)result;
}


static PyObject *
I8Vector2_max(I8Vector2 *self, PyObject *max)
{
...
static PyObject *
I8Vector2_clamp(I8Vector2 *self, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 2)
    {
...
static PyObject *
I8Vector2_get_size(I8Vector2 *cls, void *)
{
    return PyLong_FromSize_t(sizeof(int8_t) * 2);
}


static PyObject *
I8Vector2_get_limits(I8Vector2 *cls, void *)
{
...
static PyObject *
I8Vector2_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(int8_t) * 2;
    Py_buffer view;
...
static PyObject *
I8Vector2_get_array_type(PyTypeObject *cls, void*)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto array_type = module_state->I8Vector2Array_PyTypeObject;
...
static PyObject *
I8Vector2_to_b(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_d(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_f(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_u8(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_i16(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_u16(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_i32(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_u32(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_i(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_u(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_i64(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I8Vector2_to_u64(I8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef I8Vector2_PyMethodDef[] = {
    ...
    {"min", (PyCFunction)I8Vector2_min, METH_O, 0},
    {"max", (PyCFunction)I8Vector2_max, METH_O, 0},
    {"clamp", (PyCFunction)I8Vector2_clamp, METH_FASTCALL, 0},
    {"get_limits", (PyCFunction)I8Vector2_get_limits, METH_NOARGS | METH_STATIC, 0},
    {"get_size", (PyCFunction)I8Vector2_get_size, METH_NOARGS | METH_STATIC, 0},
    {"get_array_type", (PyCFunction)I8Vector2_get_array_type, METH_NOARGS | METH_STATIC, 0},
    {"from_buffer", (PyCFunction)I8Vector2_from_buffer, METH_O | METH_CLASS, 0},

        {"to_b", (PyCFunction)I8Vector2_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)I8Vector2_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)I8Vector2_to_f, METH_NOARGS, 0},

        {"to_u8", (PyCFunction)I8Vector2_to_u8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)I8Vector2_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)I8Vector2_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)I8Vector2_to_i32, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)I8Vector2_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)I8Vector2_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)I8Vector2_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)I8Vector2_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)I8Vector2_to_u64, METH_NOARGS, 0},
...
static PyObject *
I8Vector2Array__sq_getitem__(I8Vector2Array *self, Py_ssize_t index)
{
    ...
    if (!result){ return 0; }
    result->glm = I8Vector2Glm(self->glm[index]);
...
static PyObject *
I8Vector2Array__mp_getitem__(I8Vector2Array *self, PyObject *key)
{
    if (PySlice_Check(key))
    {
        ...
        auto cls = Py_TYPE(self);
        auto *result = (I8Vector2Array *)cls->tp_alloc(cls, 0);
        if (!result){ return 0; }
        if (length == 0)
        {
            result->length = 0;
        ...
        else
        {
            ...
            result->glm = new I8Vector2Glm[length];
            for (I8Vector2Glm::length_type i = 0; i < length; i++)
            {
...
I8Vector2Array_getbufferproc(I8Vector2Array *self, Py_buffer *view, int flags)
{
    if (flags & PyBUF_WRITABLE)
    {
        PyErr_SetString(PyExc_BufferError, "I8Vector2 is read only");
        view->obj = 0;
        return -1;
    }
        ...
        {
            PyErr_SetString(PyExc_BufferError, "I8Vector2 cannot be made Fortran contiguous");
            view->obj = 0;
            return -1;
        }
...
static PyObject *
I8Vector2Array_pointer(I8Vector2Array *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto c_p = module_state->ctypes_c_int8_t_p;
...
static PyObject *
I8Vector2Array_size(I8Vector2Array *self, void *)
{
    return PyLong_FromSize_t(sizeof(int8_t) * 2 * self->length);
}


static PyGetSetDef I8Vector2Array_PyGetSetDef[] = {
    {"pointer", (getter)I8Vector2Array_pointer, 0, 0, 0},
    {"size", (getter)I8Vector2Array_size, 0, 0, 0},
    {0, 0, 0, 0, 0}
};


static PyObject *
I8Vector2Array_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(int8_t);
    Py_buffer view;
    if (PyObject_GetBuffer(buffer, &view, PyBUF_SIMPLE) == -1){ return 0; }
    auto view_length = view.len;
    if (view_length % (sizeof(int8_t) * 2))
    {
        PyBuffer_Release(&view);
        PyErr_Format(PyExc_BufferError, "expected buffer evenly divisible by %zd, got %zd", sizeof(int8_t), view_length);
        return 0;
    }
    auto array_length = view_length / (sizeof(int8_t) * 2);
    ...
    if (array_length > 0)
    {
        result->glm = new I8Vector2Glm[array_length];
...
static PyObject *
I8Vector2Array_get_component_type(PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 0)
    {
    ...
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto component_type = module_state->I8Vector2_PyTypeObject;
    Py_INCREF(component_type);
    return (PyObject *)component_type;
}


static PyMethodDef I8Vector2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)I8Vector2Array_from_buffer, METH_O | METH_CLASS, 0},
    {"get_component_type", (PyCFunction)I8Vector2Array_get_component_type, METH_FASTCALL | METH_CLASS, 0},
    {0, 0, 0, 0}
};
...
static PyType_Slot I8Vector2Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)I8Vector2Array__sq_getitem__},
    {Py_mp_subscript, (void*)I8Vector2Array__mp_getitem__},
    ...
    {Py_tp_getset, (void*)I8Vector2Array_PyGetSetDef},
    {Py_tp_members, (void*)I8Vector2Array_PyMemberDef},
    {Py_tp_methods, (void*)I8Vector2Array_PyMethodDef},
    {0, 0},
};
...
get_I8Vector2_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->I8Vector2_PyTypeObject;
}


static PyTypeObject *
get_I8Vector2Array_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->I8Vector2Array_PyTypeObject;
}


static PyObject *
create_I8Vector2(const int8_t *value)
{
    auto cls = get_I8Vector2_type();
    auto result = (I8Vector2 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = *(I8Vector2Glm *)value;
    return (PyObject *)result;
}


static PyObject *
create_I8Vector2Array(size_t length, const int8_t *value)
{
    auto cls = get_I8Vector2Array_type();
    auto result = (I8Vector2Array *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->length = length;
    if (length > 0)
    {
        ...
        {
            result->glm[i] = ((I8Vector2Glm *)value)[i];
        }
    }
    else
    {
...
get_I8Vector2_value_ptr(const PyObject *self)
{
    ...
    {
        PyErr_Format(PyExc_TypeError, "expected I8Vector2, got %R", self);
        return 0;
    }
    return (int8_t *)&((I8Vector2 *)self)->glm;
}
...
get_I8Vector2Array_value_ptr(const PyObject *self)
{
    if (Py_TYPE(self) != get_I8Vector2Array_type())
    {
        PyErr_Format(
            PyExc_TypeError,
            "expected I8Vector2Array, got %R",
            self
        );
        return 0;
    }
    return (int8_t *)((I8Vector2Array *)self)->glm;
}


static size_t
get_I8Vector2Array_length(const PyObject *self)
{
    if (Py_TYPE(self) != get_I8Vector2Array_type())
    {
        PyErr_Format(
    ...
    return ((I8Vector2Array *)self)->length;
}
