...
#ifndef E_MATH_I32VECTOR3_HPP
#define E_MATH_I32VECTOR3_HPP
...
I32Vector3__richcmp__(I32Vector3 *self, I32Vector3 *other, int op)
{
    ...
    switch(op)
    {
        case Py_LT:
        {
            for (I32Vector3Glm::length_type i = 0; i < 3; i++)
            {
...
I32Vector3_min(I32Vector3 *self, PyObject *min)
{
    ...
    I32Vector3 *result = (I32Vector3 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = I32Vector3Glm(vector);
    return (PyObject *)result;
}
...
static PyObject *
I32Vector3_get_array_type(PyTypeObject *cls, void*)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto array_type = module_state->I32Vector3Array_PyTypeObject;
...
static PyObject *
I32Vector3_to_b(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_d(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_f(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_i8(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_u8(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_i16(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_u16(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_u32(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_i(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_u(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_i64(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector3_to_u64(I32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef I32Vector3_PyMethodDef[] = {
    ...
    {"get_array_type", (PyCFunction)I32Vector3_get_array_type, METH_NOARGS | METH_STATIC, 0},
    {"from_buffer", (PyCFunction)I32Vector3_from_buffer, METH_O | METH_CLASS, 0},

        {"to_b", (PyCFunction)I32Vector3_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)I32Vector3_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)I32Vector3_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)I32Vector3_to_i8, METH_NOARGS, 0},

        {"to_u8", (PyCFunction)I32Vector3_to_u8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)I32Vector3_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)I32Vector3_to_u16, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)I32Vector3_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)I32Vector3_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)I32Vector3_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)I32Vector3_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)I32Vector3_to_u64, METH_NOARGS, 0},
...
I32Vector3Array__sq_getitem__(I32Vector3Array *self, Py_ssize_t index)
{
    ...
    if (!result){ return 0; }
    result->glm = I32Vector3Glm(self->glm[index]);
...
create_I32Vector3(const int32_t *value)
{
    ...
    auto result = (I32Vector3 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = *(I32Vector3Glm *)value;
    return (PyObject *)result;
}
