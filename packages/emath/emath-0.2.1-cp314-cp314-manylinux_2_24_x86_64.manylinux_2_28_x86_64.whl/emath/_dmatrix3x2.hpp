...
#ifndef E_MATH_DMATRIX3X2_HPP
#define E_MATH_DMATRIX3X2_HPP
...
DMatrix3x2_getbufferproc(DMatrix3x2 *self, Py_buffer *view, int flags)
{
    ...
    {
        PyErr_SetString(PyExc_BufferError, "DMatrix3x2 cannot be made Fortran contiguous");
        view->obj = 0;
        return -1;
    }
...
static PyObject *
DMatrix3x2_pointer(DMatrix3x2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyGetSetDef DMatrix3x2_PyGetSetDef[] = {
    {"pointer", (getter)DMatrix3x2_pointer, 0, 0, 0},
    {0, 0, 0, 0, 0}
};
...
static DVector3 *
DMatrix3x2_get_row(DMatrix3x2 *self, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 1)
    {
...
static PyObject *
DMatrix3x2_get_size(DMatrix3x2 *cls, void *)
{
...
static PyObject *
DMatrix3x2_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    ...
    static FMatrix3x2 *
    DMatrix3x2_to_fmatrix(DMatrix3x2 *self, void*)
    {
        auto module_state = get_module_state();
        if (!module_state){ return 0; }
...
static PyObject *
DMatrix3x2_get_array_type(PyTypeObject *cls, void*)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto array_type = module_state->DMatrix3x2Array_PyTypeObject;
...
static PyMethodDef DMatrix3x2_PyMethodDef[] = {
        ...
        {"to_fmatrix", (PyCFunction)DMatrix3x2_to_fmatrix, METH_NOARGS, 0},


    {"get_row", (PyCFunction)DMatrix3x2_get_row, METH_FASTCALL, 0},
    ...
    {"get_size", (PyCFunction)DMatrix3x2_get_size, METH_NOARGS | METH_STATIC, 0},
    {"get_array_type", (PyCFunction)DMatrix3x2_get_array_type, METH_NOARGS | METH_STATIC, 0},
    {"from_buffer", (PyCFunction)DMatrix3x2_from_buffer, METH_O | METH_CLASS, 0},
    {0, 0, 0, 0}
};
...
static PyType_Slot DMatrix3x2_PyType_Slots [] = {
    ...
    {Py_tp_getset, (void*)DMatrix3x2_PyGetSetDef},
...
static PyObject *
DMatrix3x2Array__sq_getitem__(DMatrix3x2Array *self, Py_ssize_t index)
{
...
static PyObject *
DMatrix3x2Array__mp_getitem__(DMatrix3x2Array *self, PyObject *key)
{
    if (PySlice_Check(key))
    {
        ...
        else
        {
            ...
            for (DMatrix3x2Glm::length_type i = 0; i < length; i++)
            {
...
static PyObject *
DMatrix3x2Array_pointer(DMatrix3x2Array *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto c_p = module_state->ctypes_c_double_p;
...
static PyObject *
DMatrix3x2Array_size(DMatrix3x2Array *self, void *)
{
    return PyLong_FromSize_t(sizeof(double) * 6 * self->length);
}


static PyGetSetDef DMatrix3x2Array_PyGetSetDef[] = {
    {"pointer", (getter)DMatrix3x2Array_pointer, 0, 0, 0},
    {"size", (getter)DMatrix3x2Array_size, 0, 0, 0},
    {0, 0, 0, 0, 0}
};


static PyObject *
DMatrix3x2Array_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    ...
    if (array_length > 0)
    {
        result->glm = new DMatrix3x2Glm[array_length];
...
static PyObject *
DMatrix3x2Array_get_component_type(PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 0)
    {
    ...
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto component_type = module_state->DMatrix3x2_PyTypeObject;
    Py_INCREF(component_type);
    return (PyObject *)component_type;
}


static PyMethodDef DMatrix3x2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)DMatrix3x2Array_from_buffer, METH_O | METH_CLASS, 0},
    {"get_component_type", (PyCFunction)DMatrix3x2Array_get_component_type, METH_FASTCALL | METH_CLASS, 0},
    {0, 0, 0, 0}
};
...
static PyType_Slot DMatrix3x2Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)DMatrix3x2Array__sq_getitem__},
    {Py_mp_subscript, (void*)DMatrix3x2Array__mp_getitem__},
    ...
    {Py_tp_getset, (void*)DMatrix3x2Array_PyGetSetDef},
    {Py_tp_members, (void*)DMatrix3x2Array_PyMemberDef},
    {Py_tp_methods, (void*)DMatrix3x2Array_PyMethodDef},
    {0, 0},
};
