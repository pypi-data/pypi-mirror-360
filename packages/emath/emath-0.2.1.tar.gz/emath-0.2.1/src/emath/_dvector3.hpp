...
static PyObject *
DVector3_to_b(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_f(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_i8(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_u8(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_i16(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_u16(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_i32(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_u32(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_i(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_u(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_i64(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
DVector3_to_u64(DVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef DVector3_PyMethodDef[] = {
    ...
    {"from_buffer", (PyCFunction)DVector3_from_buffer, METH_O | METH_CLASS, 0},
        ...
        {"to_b", (PyCFunction)DVector3_to_b, METH_NOARGS, 0},

        {"to_f", (PyCFunction)DVector3_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)DVector3_to_i8, METH_NOARGS, 0},

        {"to_u8", (PyCFunction)DVector3_to_u8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)DVector3_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)DVector3_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)DVector3_to_i32, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)DVector3_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)DVector3_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)DVector3_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)DVector3_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)DVector3_to_u64, METH_NOARGS, 0},
...
DVector3Array__sq_getitem__(DVector3Array *self, Py_ssize_t index)
{
    ...
    if (!result){ return 0; }
    result->glm = DVector3Glm(self->glm[index]);
