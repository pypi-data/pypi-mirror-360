...
#ifndef E_MATH_U8VECTOR4_HPP
#define E_MATH_U8VECTOR4_HPP
...
static PyObject *
U8Vector4_pointer(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyGetSetDef U8Vector4_PyGetSetDef[] = {
    ...
    {"pointer", (getter)U8Vector4_pointer, 0, 0, 0},
    {0, 0, 0, 0, 0}
};
    ...
    static PyObject *
    swizzle_2_U8Vector4(U8Vector4 *self, PyObject *py_attr)
    {
    ...
    static PyObject *
    swizzle_3_U8Vector4(U8Vector4 *self, PyObject *py_attr)
    {
        const char *attr = PyUnicode_AsUTF8(py_attr);
        if (!attr){ return 0; }
    ...
    static PyObject *
    swizzle_4_U8Vector4(U8Vector4 *self, PyObject *py_attr)
    {
        const char *attr = PyUnicode_AsUTF8(py_attr);
        if (!attr){ return 0; }
...
U8Vector4__getattr__(U8Vector4 *self, PyObject *py_attr)
{
    ...
    switch(attr_length)
    {
        ...
        {
            PyErr_Clear();
            return swizzle_2_U8Vector4(self, py_attr);
        }
        case 3:
        {
            PyErr_Clear();
            return swizzle_3_U8Vector4(self, py_attr);
        }
        case 4:
        {
            PyErr_Clear();
            return swizzle_4_U8Vector4(self, py_attr);
        }
    }
    return 0;
}
...
static PyObject *
U8Vector4_min(U8Vector4 *self, PyObject *min)
{
    ...
    U8Vector4 *result = (U8Vector4 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = U8Vector4Glm(vector);
    return (PyObject *)result;
}


static PyObject *
U8Vector4_max(U8Vector4 *self, PyObject *max)
{
...
static PyObject *
U8Vector4_clamp(U8Vector4 *self, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 2)
    {
...
static PyObject *
U8Vector4_get_size(U8Vector4 *cls, void *)
{
    return PyLong_FromSize_t(sizeof(uint8_t) * 4);
}


static PyObject *
U8Vector4_get_limits(U8Vector4 *cls, void *)
{
...
static PyObject *
U8Vector4_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(uint8_t) * 4;
    Py_buffer view;
...
static PyObject *
U8Vector4_to_b(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_d(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_f(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_i8(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_i16(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_u16(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_i32(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_u32(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_i(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_u(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_i64(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector4_to_u64(U8Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef U8Vector4_PyMethodDef[] = {
    ...
    {"max", (PyCFunction)U8Vector4_max, METH_O, 0},
    ...
    {"from_buffer", (PyCFunction)U8Vector4_from_buffer, METH_O | METH_CLASS, 0},
        ...
        {"to_b", (PyCFunction)U8Vector4_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)U8Vector4_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)U8Vector4_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)U8Vector4_to_i8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)U8Vector4_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)U8Vector4_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)U8Vector4_to_i32, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)U8Vector4_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)U8Vector4_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)U8Vector4_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)U8Vector4_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)U8Vector4_to_u64, METH_NOARGS, 0},
...
static PyObject *
U8Vector4Array__new__(PyTypeObject *cls, PyObject *args, PyObject *kwds)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto element_cls = module_state->U8Vector4_PyTypeObject;
    ...
    if (arg_count == 0)
    {
        auto self = (U8Vector4Array *)cls->tp_alloc(cls, 0);
        if (!self){ return 0; }
        self->length = 0;
        self->glm = 0;
        return (PyObject *)self;
    ...
    self->glm = new U8Vector4Glm[arg_count];
...
static void
U8Vector4Array__dealloc__(U8Vector4Array *self)
{
    if (self->weakreflist)
    {
        PyObject_ClearWeakRefs((PyObject *)self);
...
static Py_hash_t
U8Vector4Array__hash__(U8Vector4Array *self)
{
    Py_ssize_t len = self->length * 4;
    Py_uhash_t acc = _HASH_XXPRIME_5;
    for (Py_ssize_t i = 0; i < (Py_ssize_t)self->length; i++)
    {
        for (U8Vector4Glm::length_type j = 0; j < 4; j++)
        {
...
static PyObject *
U8Vector4Array__repr__(U8Vector4Array *self)
{
    return PyUnicode_FromFormat("U8Vector4Array[%zu]", self->length);
}


static Py_ssize_t
U8Vector4Array__len__(U8Vector4Array *self)
{
    return self->length;
}
...
static PyObject *
U8Vector4Array__sq_getitem__(U8Vector4Array *self, Py_ssize_t index)
{
    ...
    U8Vector4 *result = (U8Vector4 *)element_cls->tp_alloc(element_cls, 0);
    if (!result){ return 0; }
    result->glm = U8Vector4Glm(self->glm[index]);
...
static PyObject *
U8Vector4Array__mp_getitem__(U8Vector4Array *self, PyObject *key)
{
    if (PySlice_Check(key))
    {
        ...
        auto cls = Py_TYPE(self);
        auto *result = (U8Vector4Array *)cls->tp_alloc(cls, 0);
        if (!result){ return 0; }
        if (length == 0)
        {
            result->length = 0;
        ...
        else
        {
            ...
            result->glm = new U8Vector4Glm[length];
            for (U8Vector4Glm::length_type i = 0; i < length; i++)
            {
...
static PyObject *
U8Vector4Array__richcmp__(
    U8Vector4Array *self,
    U8Vector4Array *other,
    int op
)
{
    if (Py_TYPE(self) != Py_TYPE(other))
...
static int
U8Vector4Array__bool__(U8Vector4Array *self)
{
...
static int
U8Vector4Array_getbufferproc(U8Vector4Array *self, Py_buffer *view, int flags)
{
    if (flags & PyBUF_WRITABLE)
    {
        PyErr_SetString(PyExc_BufferError, "U8Vector4 is read only");
        view->obj = 0;
        return -1;
    }
        ...
        {
            PyErr_SetString(PyExc_BufferError, "U8Vector4 cannot be made Fortran contiguous");
            view->obj = 0;
            return -1;
        }
    ...
    view->buf = self->glm;
    view->obj = (PyObject *)self;
    view->len = sizeof(uint8_t) * 4 * self->length;
    view->readonly = 1;
    view->itemsize = sizeof(uint8_t);
    view->ndim = 2;
    if (flags & PyBUF_FORMAT)
...
static void
U8Vector4Array_releasebufferproc(U8Vector4Array *self, Py_buffer *view)
{
    delete view->shape;
}


static PyMemberDef U8Vector4Array_PyMemberDef[] = {
    {"__weaklistoffset__", T_PYSSIZET, offsetof(U8Vector4Array, weakreflist), READONLY},
    {0}
};


static PyObject *
U8Vector4Array_pointer(U8Vector4Array *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto c_p = module_state->ctypes_c_uint8_t_p;
...
static PyObject *
U8Vector4Array_size(U8Vector4Array *self, void *)
{
    return PyLong_FromSize_t(sizeof(uint8_t) * 4 * self->length);
}


static PyGetSetDef U8Vector4Array_PyGetSetDef[] = {
    {"pointer", (getter)U8Vector4Array_pointer, 0, 0, 0},
    {"size", (getter)U8Vector4Array_size, 0, 0, 0},
    {0, 0, 0, 0, 0}
};


static PyObject *
U8Vector4Array_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(uint8_t);
    Py_buffer view;
    if (PyObject_GetBuffer(buffer, &view, PyBUF_SIMPLE) == -1){ return 0; }
    auto view_length = view.len;
    if (view_length % (sizeof(uint8_t) * 4))
    {
        PyBuffer_Release(&view);
        PyErr_Format(PyExc_BufferError, "expected buffer evenly divisible by %zd, got %zd", sizeof(uint8_t), view_length);
        return 0;
    }
    auto array_length = view_length / (sizeof(uint8_t) * 4);
    ...
    if (array_length > 0)
    {
        result->glm = new U8Vector4Glm[array_length];
...
static PyObject *
U8Vector4Array_get_component_type(PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 0)
    {
    ...
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto component_type = module_state->U8Vector4_PyTypeObject;
    Py_INCREF(component_type);
    return (PyObject *)component_type;
}


static PyMethodDef U8Vector4Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)U8Vector4Array_from_buffer, METH_O | METH_CLASS, 0},
    {"get_component_type", (PyCFunction)U8Vector4Array_get_component_type, METH_FASTCALL | METH_CLASS, 0},
    {0, 0, 0, 0}
};


static PyType_Slot U8Vector4Array_PyType_Slots [] = {
    {Py_tp_new, (void*)U8Vector4Array__new__},
    {Py_tp_dealloc, (void*)U8Vector4Array__dealloc__},
    {Py_tp_hash, (void*)U8Vector4Array__hash__},
    {Py_tp_repr, (void*)U8Vector4Array__repr__},
    {Py_sq_length, (void*)U8Vector4Array__len__},
    {Py_sq_item, (void*)U8Vector4Array__sq_getitem__},
    {Py_mp_subscript, (void*)U8Vector4Array__mp_getitem__},
    {Py_tp_richcompare, (void*)U8Vector4Array__richcmp__},
    {Py_nb_bool, (void*)U8Vector4Array__bool__},
    {Py_bf_getbuffer, (void*)U8Vector4Array_getbufferproc},
    {Py_bf_releasebuffer, (void*)U8Vector4Array_releasebufferproc},
    {Py_tp_getset, (void*)U8Vector4Array_PyGetSetDef},
    {Py_tp_members, (void*)U8Vector4Array_PyMemberDef},
    {Py_tp_methods, (void*)U8Vector4Array_PyMethodDef},
    {0, 0},
};


static PyType_Spec U8Vector4Array_PyTypeSpec = {
    "emath.U8Vector4Array",
    sizeof(U8Vector4Array),
    0,
    Py_TPFLAGS_DEFAULT,
    U8Vector4Array_PyType_Slots
};


static PyTypeObject *
define_U8Vector4Array_type(PyObject *module)
{
    PyTypeObject *type = (PyTypeObject *)PyType_FromModuleAndSpec(
        module,
        &U8Vector4Array_PyTypeSpec,
        0
    );
    if (!type){ return 0; }
    // Note:
    // Unlike other functions that steal references, PyModule_AddObject() only
    // decrements the reference count of value on success.
    if (PyModule_AddObject(module, "U8Vector4Array", (PyObject *)type) < 0)
    {
        Py_DECREF(type);
        return 0;
    }
...
get_U8Vector4_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->U8Vector4_PyTypeObject;
}


static PyTypeObject *
get_U8Vector4Array_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->U8Vector4Array_PyTypeObject;
}


static PyObject *
create_U8Vector4(const uint8_t *value)
{
    auto cls = get_U8Vector4_type();
    auto result = (U8Vector4 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = *(U8Vector4Glm *)value;
    return (PyObject *)result;
}


static PyObject *
create_U8Vector4Array(size_t length, const uint8_t *value)
{
    auto cls = get_U8Vector4Array_type();
    auto result = (U8Vector4Array *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->length = length;
    if (length > 0)
    {
        ...
        {
            result->glm[i] = ((U8Vector4Glm *)value)[i];
        }
    }
    else
    {
...
get_U8Vector4_value_ptr(const PyObject *self)
{
    ...
    {
        PyErr_Format(PyExc_TypeError, "expected U8Vector4, got %R", self);
        return 0;
    }
    return (uint8_t *)&((U8Vector4 *)self)->glm;
}
...
get_U8Vector4Array_value_ptr(const PyObject *self)
{
    if (Py_TYPE(self) != get_U8Vector4Array_type())
    {
        PyErr_Format(
            PyExc_TypeError,
            "expected U8Vector4Array, got %R",
            self
        );
        return 0;
    }
    return (uint8_t *)((U8Vector4Array *)self)->glm;
}


static size_t
get_U8Vector4Array_length(const PyObject *self)
{
    if (Py_TYPE(self) != get_U8Vector4Array_type())
    {
        PyErr_Format(
    ...
    return ((U8Vector4Array *)self)->length;
}
