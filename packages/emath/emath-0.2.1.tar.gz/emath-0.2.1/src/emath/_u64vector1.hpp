...
U64Vector1_min(U64Vector1 *self, PyObject *min)
{
    ...
    U64Vector1 *result = (U64Vector1 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = U64Vector1Glm(vector);
    return (PyObject *)result;
}
...
static PyObject *
U64Vector1_to_b(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_d(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_f(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_i8(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_u8(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_i16(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_u16(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_i32(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_u32(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_i(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_u(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U64Vector1_to_i64(U64Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef U64Vector1_PyMethodDef[] = {
    ...
    {"from_buffer", (PyCFunction)U64Vector1_from_buffer, METH_O | METH_CLASS, 0},
        ...
        {"to_b", (PyCFunction)U64Vector1_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)U64Vector1_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)U64Vector1_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)U64Vector1_to_i8, METH_NOARGS, 0},

        {"to_u8", (PyCFunction)U64Vector1_to_u8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)U64Vector1_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)U64Vector1_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)U64Vector1_to_i32, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)U64Vector1_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)U64Vector1_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)U64Vector1_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)U64Vector1_to_i64, METH_NOARGS, 0},
...
U64Vector1Array__sq_getitem__(U64Vector1Array *self, Py_ssize_t index)
{
    ...
    if (!result){ return 0; }
    result->glm = U64Vector1Glm(self->glm[index]);
...
create_U64Vector1(const uint64_t *value)
{
    ...
    auto result = (U64Vector1 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = *(U64Vector1Glm *)value;
    return (PyObject *)result;
}
