...
U32Vector3_min(U32Vector3 *self, PyObject *min)
{
    ...
    U32Vector3 *result = (U32Vector3 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = U32Vector3Glm(vector);
    return (PyObject *)result;
}
...
static PyObject *
U32Vector3_to_b(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_d(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_f(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_i8(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_u8(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_i16(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_u16(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_i32(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_i(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_u(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_i64(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U32Vector3_to_u64(U32Vector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef U32Vector3_PyMethodDef[] = {
    ...
    {"from_buffer", (PyCFunction)U32Vector3_from_buffer, METH_O | METH_CLASS, 0},
        ...
        {"to_b", (PyCFunction)U32Vector3_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)U32Vector3_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)U32Vector3_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)U32Vector3_to_i8, METH_NOARGS, 0},

        {"to_u8", (PyCFunction)U32Vector3_to_u8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)U32Vector3_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)U32Vector3_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)U32Vector3_to_i32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)U32Vector3_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)U32Vector3_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)U32Vector3_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)U32Vector3_to_u64, METH_NOARGS, 0},
...
U32Vector3Array__sq_getitem__(U32Vector3Array *self, Py_ssize_t index)
{
    ...
    if (!result){ return 0; }
    result->glm = U32Vector3Glm(self->glm[index]);
...
create_U32Vector3(const uint32_t *value)
{
    ...
    auto result = (U32Vector3 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = *(U32Vector3Glm *)value;
    return (PyObject *)result;
}
