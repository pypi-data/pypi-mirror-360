...
#ifndef E_MATH_U8VECTOR1_HPP
#define E_MATH_U8VECTOR1_HPP
...
U8Vector1__richcmp__(U8Vector1 *self, U8Vector1 *other, int op)
{
    ...
    switch(op)
    {
        case Py_LT:
        {
            for (U8Vector1Glm::length_type i = 0; i < 1; i++)
            {
...
U8Vector1_min(U8Vector1 *self, PyObject *min)
{
    ...
    U8Vector1 *result = (U8Vector1 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = U8Vector1Glm(vector);
    return (PyObject *)result;
}
...
static PyObject *
U8Vector1_get_array_type(PyTypeObject *cls, void*)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto array_type = module_state->U8Vector1Array_PyTypeObject;
...
static PyObject *
U8Vector1_to_b(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_d(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_f(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_i8(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_i16(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_u16(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_i32(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_u32(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_i(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_u(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_i64(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector1_to_u64(U8Vector1 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef U8Vector1_PyMethodDef[] = {
    ...
    {"get_array_type", (PyCFunction)U8Vector1_get_array_type, METH_NOARGS | METH_STATIC, 0},
    {"from_buffer", (PyCFunction)U8Vector1_from_buffer, METH_O | METH_CLASS, 0},

        {"to_b", (PyCFunction)U8Vector1_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)U8Vector1_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)U8Vector1_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)U8Vector1_to_i8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)U8Vector1_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)U8Vector1_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)U8Vector1_to_i32, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)U8Vector1_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)U8Vector1_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)U8Vector1_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)U8Vector1_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)U8Vector1_to_u64, METH_NOARGS, 0},
...
U8Vector1Array__sq_getitem__(U8Vector1Array *self, Py_ssize_t index)
{
    ...
    if (!result){ return 0; }
    result->glm = U8Vector1Glm(self->glm[index]);
...
static PyObject *
U8Vector1Array_get_component_type(PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 0)
    {
    ...
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto component_type = module_state->U8Vector1_PyTypeObject;
...
static PyMethodDef U8Vector1Array_PyMethodDef[] = {
    ...
    {"get_component_type", (PyCFunction)U8Vector1Array_get_component_type, METH_FASTCALL | METH_CLASS, 0},
    {0, 0, 0, 0}
};
