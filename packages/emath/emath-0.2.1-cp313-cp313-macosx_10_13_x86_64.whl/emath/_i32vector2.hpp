...
#ifndef E_MATH_I32VECTOR2_HPP
#define E_MATH_I32VECTOR2_HPP
...
I32Vector2__hash__(I32Vector2 *self)
{
    ...
    for (I32Vector2Glm::length_type i = 0; i < len; i++)
    {
...
I32Vector2__getitem__(I32Vector2 *self, Py_ssize_t index)
{
    ...
    auto c = self->glm[(I32Vector2Glm::length_type)index];
...
I32Vector2__richcmp__(I32Vector2 *self, I32Vector2 *other, int op)
{
    ...
    switch(op)
    {
        case Py_LT:
        {
            for (I32Vector2Glm::length_type i = 0; i < 2; i++)
            {
...
static PyObject *
I32Vector2__add__(PyObject *left, PyObject *right)
{
    ...
    {
        vector = ((I32Vector2 *)left)->glm + ((I32Vector2 *)right)->glm;
    }
    else
    {
        if (Py_TYPE(left) == cls)
        {
            ...
            vector = ((I32Vector2 *)left)->glm + c_right;
        }
        else
        {
            auto c_left = pyobject_to_c_int32_t(left);
            if (PyErr_Occurred()){ PyErr_Clear(); Py_RETURN_NOTIMPLEMENTED; }
            vector = c_left + ((I32Vector2 *)right)->glm;
        }
    }

    I32Vector2 *result = (I32Vector2 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = I32Vector2Glm(
...
static PyObject *
I32Vector2__sub__(PyObject *left, PyObject *right)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto cls = module_state->I32Vector2_PyTypeObject;
...
static PyObject *
I32Vector2__mul__(PyObject *left, PyObject *right)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto cls = module_state->I32Vector2_PyTypeObject;
    ...
    static PyObject *
    I32Vector2__truediv__(PyObject *left, PyObject *right)
    {
        auto module_state = get_module_state();
        if (!module_state){ return 0; }
        auto cls = module_state->I32Vector2_PyTypeObject;
        ...
        if (Py_TYPE(left) == Py_TYPE(right))
        {
                ...
                if (
                        ...
                        ((I32Vector2 *)right)->glm[0] == 0 ||

                        ((I32Vector2 *)right)->glm[1] == 0
...
I32Vector2_getbufferproc(I32Vector2 *self, Py_buffer *view, int flags)
{
    ...
    {
        PyErr_SetString(PyExc_TypeError, "I32Vector2 is read only");
        view->obj = 0;
        return -1;
    }
    view->buf = &self->glm;
...
static PyGetSetDef I32Vector2_PyGetSetDef[] = {
    ...
    {"pointer", (getter)I32Vector2_pointer, 0, 0, 0},
    {0, 0, 0, 0, 0}
};
    ...
    static PyObject *
    swizzle_2_I32Vector2(I32Vector2 *self, PyObject *py_attr)
    {
    ...
    static PyObject *
    swizzle_3_I32Vector2(I32Vector2 *self, PyObject *py_attr)
    {
        const char *attr = PyUnicode_AsUTF8(py_attr);
        if (!attr){ return 0; }
    ...
    static PyObject *
    swizzle_4_I32Vector2(I32Vector2 *self, PyObject *py_attr)
    {
        const char *attr = PyUnicode_AsUTF8(py_attr);
        if (!attr){ return 0; }
...
I32Vector2__getattr__(I32Vector2 *self, PyObject *py_attr)
{
    ...
    switch(attr_length)
    {
        ...
        {
            PyErr_Clear();
            return swizzle_2_I32Vector2(self, py_attr);
        }
        case 3:
        {
            PyErr_Clear();
            return swizzle_3_I32Vector2(self, py_attr);
        }
        case 4:
        {
            PyErr_Clear();
            return swizzle_4_I32Vector2(self, py_attr);
        }
    }
    return 0;
}
...
static PyObject *
I32Vector2_min(I32Vector2 *self, PyObject *min)
{
    ...
    I32Vector2 *result = (I32Vector2 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = I32Vector2Glm(vector);
    return (PyObject *)result;
}


static PyObject *
I32Vector2_max(I32Vector2 *self, PyObject *max)
{
...
static PyObject *
I32Vector2_clamp(I32Vector2 *self, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 2)
    {
...
static PyObject *
I32Vector2_get_size(I32Vector2 *cls, void *)
{
    return PyLong_FromSize_t(sizeof(int32_t) * 2);
}


static PyObject *
I32Vector2_get_limits(I32Vector2 *cls, void *)
{
...
static PyObject *
I32Vector2_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(int32_t) * 2;
    Py_buffer view;
...
static PyObject *
I32Vector2_to_b(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_d(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_f(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_i8(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_u8(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_i16(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_u16(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_u32(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_i(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_u(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_i64(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I32Vector2_to_u64(I32Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef I32Vector2_PyMethodDef[] = {
    ...
    {"max", (PyCFunction)I32Vector2_max, METH_O, 0},
    ...
    {"from_buffer", (PyCFunction)I32Vector2_from_buffer, METH_O | METH_CLASS, 0},
        ...
        {"to_b", (PyCFunction)I32Vector2_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)I32Vector2_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)I32Vector2_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)I32Vector2_to_i8, METH_NOARGS, 0},

        {"to_u8", (PyCFunction)I32Vector2_to_u8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)I32Vector2_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)I32Vector2_to_u16, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)I32Vector2_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)I32Vector2_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)I32Vector2_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)I32Vector2_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)I32Vector2_to_u64, METH_NOARGS, 0},
...
static PyObject *
I32Vector2Array__new__(PyTypeObject *cls, PyObject *args, PyObject *kwds)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    ...
    if (arg_count == 0)
    {
        auto self = (I32Vector2Array *)cls->tp_alloc(cls, 0);
        if (!self){ return 0; }
        self->length = 0;
        self->glm = 0;
        return (PyObject *)self;
    ...
    self->glm = new I32Vector2Glm[arg_count];
...
static void
I32Vector2Array__dealloc__(I32Vector2Array *self)
{
    if (self->weakreflist)
    {
        PyObject_ClearWeakRefs((PyObject *)self);
...
static Py_hash_t
I32Vector2Array__hash__(I32Vector2Array *self)
{
    Py_ssize_t len = self->length * 2;
    Py_uhash_t acc = _HASH_XXPRIME_5;
    for (Py_ssize_t i = 0; i < (Py_ssize_t)self->length; i++)
    {
        for (I32Vector2Glm::length_type j = 0; j < 2; j++)
        {
...
static PyObject *
I32Vector2Array__repr__(I32Vector2Array *self)
{
    return PyUnicode_FromFormat("I32Vector2Array[%zu]", self->length);
}


static Py_ssize_t
I32Vector2Array__len__(I32Vector2Array *self)
{
    return self->length;
}
...
static PyObject *
I32Vector2Array__sq_getitem__(I32Vector2Array *self, Py_ssize_t index)
{
    ...
    I32Vector2 *result = (I32Vector2 *)element_cls->tp_alloc(element_cls, 0);
    if (!result){ return 0; }
    result->glm = I32Vector2Glm(self->glm[index]);
...
static PyObject *
I32Vector2Array__mp_getitem__(I32Vector2Array *self, PyObject *key)
{
    if (PySlice_Check(key))
    {
        ...
        else
        {
            ...
            for (I32Vector2Glm::length_type i = 0; i < length; i++)
            {
...
static PyObject *
I32Vector2Array__richcmp__(
    I32Vector2Array *self,
    I32Vector2Array *other,
    int op
)
{
    if (Py_TYPE(self) != Py_TYPE(other))
...
static int
I32Vector2Array__bool__(I32Vector2Array *self)
{
...
static int
I32Vector2Array_getbufferproc(I32Vector2Array *self, Py_buffer *view, int flags)
{
    if (flags & PyBUF_WRITABLE)
    {
        PyErr_SetString(PyExc_BufferError, "I32Vector2 is read only");
        view->obj = 0;
        return -1;
    }
        ...
        {
            PyErr_SetString(PyExc_BufferError, "I32Vector2 cannot be made Fortran contiguous");
            view->obj = 0;
            return -1;
        }
    ...
    view->buf = self->glm;
    view->obj = (PyObject *)self;
    view->len = sizeof(int32_t) * 2 * self->length;
    view->readonly = 1;
    view->itemsize = sizeof(int32_t);
    view->ndim = 2;
    if (flags & PyBUF_FORMAT)
...
static void
I32Vector2Array_releasebufferproc(I32Vector2Array *self, Py_buffer *view)
{
    delete view->shape;
}


static PyMemberDef I32Vector2Array_PyMemberDef[] = {
    {"__weaklistoffset__", T_PYSSIZET, offsetof(I32Vector2Array, weakreflist), READONLY},
    {0}
};
...
static PyObject *
I32Vector2Array_size(I32Vector2Array *self, void *)
{
    return PyLong_FromSize_t(sizeof(int32_t) * 2 * self->length);
}
...
I32Vector2Array_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    ...
    if (array_length > 0)
    {
        result->glm = new I32Vector2Glm[array_length];
...
static PyObject *
I32Vector2Array_get_component_type(PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 0)
    {
    ...
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto component_type = module_state->I32Vector2_PyTypeObject;
...
static PyType_Slot I32Vector2Array_PyType_Slots [] = {
    {Py_tp_new, (void*)I32Vector2Array__new__},
    {Py_tp_dealloc, (void*)I32Vector2Array__dealloc__},
    {Py_tp_hash, (void*)I32Vector2Array__hash__},
    {Py_tp_repr, (void*)I32Vector2Array__repr__},
    {Py_sq_length, (void*)I32Vector2Array__len__},
    {Py_sq_item, (void*)I32Vector2Array__sq_getitem__},
    {Py_mp_subscript, (void*)I32Vector2Array__mp_getitem__},
    {Py_tp_richcompare, (void*)I32Vector2Array__richcmp__},
    {Py_nb_bool, (void*)I32Vector2Array__bool__},
    {Py_bf_getbuffer, (void*)I32Vector2Array_getbufferproc},
    {Py_bf_releasebuffer, (void*)I32Vector2Array_releasebufferproc},
    {Py_tp_getset, (void*)I32Vector2Array_PyGetSetDef},
    {Py_tp_members, (void*)I32Vector2Array_PyMemberDef},
    {Py_tp_methods, (void*)I32Vector2Array_PyMethodDef},
    {0, 0},
};


static PyType_Spec I32Vector2Array_PyTypeSpec = {
    "emath.I32Vector2Array",
    sizeof(I32Vector2Array),
    0,
    Py_TPFLAGS_DEFAULT,
    I32Vector2Array_PyType_Slots
};


static PyTypeObject *
define_I32Vector2Array_type(PyObject *module)
{
    PyTypeObject *type = (PyTypeObject *)PyType_FromModuleAndSpec(
        module,
        &I32Vector2Array_PyTypeSpec,
        0
    );
    if (!type){ return 0; }
    // Note:
    // Unlike other functions that steal references, PyModule_AddObject() only
    // decrements the reference count of value on success.
    if (PyModule_AddObject(module, "I32Vector2Array", (PyObject *)type) < 0)
    {
        Py_DECREF(type);
        return 0;
    }
...
static PyObject *
create_I32Vector2(const int32_t *value)
{
    auto cls = get_I32Vector2_type();
    auto result = (I32Vector2 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = *(I32Vector2Glm *)value;
    return (PyObject *)result;
}


static PyObject *
create_I32Vector2Array(size_t length, const int32_t *value)
{
...
get_I32Vector2_value_ptr(const PyObject *self)
{
...
static const int32_t *
get_I32Vector2Array_value_ptr(const PyObject *self)
{
...
static size_t
get_I32Vector2Array_length(const PyObject *self)
{
    if (Py_TYPE(self) != get_I32Vector2Array_type())
    {
        PyErr_Format(
