...
#ifndef E_MATH_UVECTOR3_HPP
#define E_MATH_UVECTOR3_HPP
...
UVector3__richcmp__(UVector3 *self, UVector3 *other, int op)
{
    ...
    switch(op)
    {
        case Py_LT:
        {
            for (UVector3Glm::length_type i = 0; i < 3; i++)
            {
...
static PyObject *
UVector3_pointer(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyGetSetDef UVector3_PyGetSetDef[] = {
    ...
    {"pointer", (getter)UVector3_pointer, 0, 0, 0},
    {0, 0, 0, 0, 0}
};
...
static PyObject *
UVector3_min(UVector3 *self, PyObject *min)
{
    ...
    UVector3 *result = (UVector3 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = UVector3Glm(vector);
    return (PyObject *)result;
}


static PyObject *
UVector3_max(UVector3 *self, PyObject *max)
{
...
static PyObject *
UVector3_clamp(UVector3 *self, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 2)
    {
...
static PyObject *
UVector3_get_size(UVector3 *cls, void *)
{
    return PyLong_FromSize_t(sizeof(unsigned int) * 3);
}


static PyObject *
UVector3_get_limits(UVector3 *cls, void *)
{
...
static PyObject *
UVector3_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(unsigned int) * 3;
    Py_buffer view;
...
static PyObject *
UVector3_get_array_type(PyTypeObject *cls, void*)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto array_type = module_state->UVector3Array_PyTypeObject;
...
static PyObject *
UVector3_to_b(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_d(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_f(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_i8(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_u8(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_i16(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_u16(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_i32(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_u32(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_i(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_i64(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
UVector3_to_u64(UVector3 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef UVector3_PyMethodDef[] = {
    ...
    {"min", (PyCFunction)UVector3_min, METH_O, 0},
    {"max", (PyCFunction)UVector3_max, METH_O, 0},
    {"clamp", (PyCFunction)UVector3_clamp, METH_FASTCALL, 0},
    {"get_limits", (PyCFunction)UVector3_get_limits, METH_NOARGS | METH_STATIC, 0},
    {"get_size", (PyCFunction)UVector3_get_size, METH_NOARGS | METH_STATIC, 0},
    {"get_array_type", (PyCFunction)UVector3_get_array_type, METH_NOARGS | METH_STATIC, 0},
    {"from_buffer", (PyCFunction)UVector3_from_buffer, METH_O | METH_CLASS, 0},

        {"to_b", (PyCFunction)UVector3_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)UVector3_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)UVector3_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)UVector3_to_i8, METH_NOARGS, 0},

        {"to_u8", (PyCFunction)UVector3_to_u8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)UVector3_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)UVector3_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)UVector3_to_i32, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)UVector3_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)UVector3_to_i, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)UVector3_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)UVector3_to_u64, METH_NOARGS, 0},
...
static PyObject *
UVector3Array__new__(PyTypeObject *cls, PyObject *args, PyObject *kwds)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto element_cls = module_state->UVector3_PyTypeObject;
    ...
    if (arg_count == 0)
    {
        auto self = (UVector3Array *)cls->tp_alloc(cls, 0);
        if (!self){ return 0; }
        self->length = 0;
        self->glm = 0;
        return (PyObject *)self;
    ...
    self->glm = new UVector3Glm[arg_count];
...
static void
UVector3Array__dealloc__(UVector3Array *self)
{
    if (self->weakreflist)
    {
        PyObject_ClearWeakRefs((PyObject *)self);
...
static Py_hash_t
UVector3Array__hash__(UVector3Array *self)
{
    Py_ssize_t len = self->length * 3;
    Py_uhash_t acc = _HASH_XXPRIME_5;
    for (Py_ssize_t i = 0; i < (Py_ssize_t)self->length; i++)
    {
        for (UVector3Glm::length_type j = 0; j < 3; j++)
        {
...
static PyObject *
UVector3Array__repr__(UVector3Array *self)
{
    return PyUnicode_FromFormat("UVector3Array[%zu]", self->length);
}


static Py_ssize_t
UVector3Array__len__(UVector3Array *self)
{
    return self->length;
}
...
static PyObject *
UVector3Array__sq_getitem__(UVector3Array *self, Py_ssize_t index)
{
    ...
    UVector3 *result = (UVector3 *)element_cls->tp_alloc(element_cls, 0);
    if (!result){ return 0; }
    result->glm = UVector3Glm(self->glm[index]);
...
static PyObject *
UVector3Array__mp_getitem__(UVector3Array *self, PyObject *key)
{
    if (PySlice_Check(key))
    {
        ...
        auto cls = Py_TYPE(self);
        auto *result = (UVector3Array *)cls->tp_alloc(cls, 0);
        if (!result){ return 0; }
        if (length == 0)
        {
            result->length = 0;
        ...
        else
        {
            ...
            result->glm = new UVector3Glm[length];
            for (UVector3Glm::length_type i = 0; i < length; i++)
            {
...
static int
UVector3Array__bool__(UVector3Array *self)
{
...
static int
UVector3Array_getbufferproc(UVector3Array *self, Py_buffer *view, int flags)
{
    if (flags & PyBUF_WRITABLE)
    {
        PyErr_SetString(PyExc_BufferError, "UVector3 is read only");
        view->obj = 0;
        return -1;
    }
        ...
        {
            PyErr_SetString(PyExc_BufferError, "UVector3 cannot be made Fortran contiguous");
            view->obj = 0;
            return -1;
        }
    ...
    view->buf = self->glm;
    view->obj = (PyObject *)self;
    view->len = sizeof(unsigned int) * 3 * self->length;
    view->readonly = 1;
    view->itemsize = sizeof(unsigned int);
    view->ndim = 2;
    if (flags & PyBUF_FORMAT)
...
static void
UVector3Array_releasebufferproc(UVector3Array *self, Py_buffer *view)
{
    delete view->shape;
}


static PyMemberDef UVector3Array_PyMemberDef[] = {
    {"__weaklistoffset__", T_PYSSIZET, offsetof(UVector3Array, weakreflist), READONLY},
    {0}
};


static PyObject *
UVector3Array_pointer(UVector3Array *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto c_p = module_state->ctypes_c_unsigned_int_p;
...
static PyObject *
UVector3Array_size(UVector3Array *self, void *)
{
    return PyLong_FromSize_t(sizeof(unsigned int) * 3 * self->length);
}


static PyGetSetDef UVector3Array_PyGetSetDef[] = {
    {"pointer", (getter)UVector3Array_pointer, 0, 0, 0},
    {"size", (getter)UVector3Array_size, 0, 0, 0},
    {0, 0, 0, 0, 0}
};


static PyObject *
UVector3Array_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(unsigned int);
    Py_buffer view;
    if (PyObject_GetBuffer(buffer, &view, PyBUF_SIMPLE) == -1){ return 0; }
    auto view_length = view.len;
    if (view_length % (sizeof(unsigned int) * 3))
    {
        PyBuffer_Release(&view);
        PyErr_Format(PyExc_BufferError, "expected buffer evenly divisible by %zd, got %zd", sizeof(unsigned int), view_length);
        return 0;
    }
    auto array_length = view_length / (sizeof(unsigned int) * 3);
    ...
    if (array_length > 0)
    {
        result->glm = new UVector3Glm[array_length];
...
static PyObject *
UVector3Array_get_component_type(PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 0)
    {
    ...
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto component_type = module_state->UVector3_PyTypeObject;
    Py_INCREF(component_type);
    return (PyObject *)component_type;
}


static PyMethodDef UVector3Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)UVector3Array_from_buffer, METH_O | METH_CLASS, 0},
    {"get_component_type", (PyCFunction)UVector3Array_get_component_type, METH_FASTCALL | METH_CLASS, 0},
    {0, 0, 0, 0}
};


static PyType_Slot UVector3Array_PyType_Slots [] = {
    {Py_tp_new, (void*)UVector3Array__new__},
    {Py_tp_dealloc, (void*)UVector3Array__dealloc__},
    {Py_tp_hash, (void*)UVector3Array__hash__},
    {Py_tp_repr, (void*)UVector3Array__repr__},
    {Py_sq_length, (void*)UVector3Array__len__},
    {Py_sq_item, (void*)UVector3Array__sq_getitem__},
    {Py_mp_subscript, (void*)UVector3Array__mp_getitem__},
    {Py_tp_richcompare, (void*)UVector3Array__richcmp__},
    {Py_nb_bool, (void*)UVector3Array__bool__},
    {Py_bf_getbuffer, (void*)UVector3Array_getbufferproc},
    {Py_bf_releasebuffer, (void*)UVector3Array_releasebufferproc},
    {Py_tp_getset, (void*)UVector3Array_PyGetSetDef},
    {Py_tp_members, (void*)UVector3Array_PyMemberDef},
    {Py_tp_methods, (void*)UVector3Array_PyMethodDef},
    {0, 0},
};


static PyType_Spec UVector3Array_PyTypeSpec = {
    "emath.UVector3Array",
    sizeof(UVector3Array),
    0,
    Py_TPFLAGS_DEFAULT,
    UVector3Array_PyType_Slots
};


static PyTypeObject *
define_UVector3Array_type(PyObject *module)
{
    PyTypeObject *type = (PyTypeObject *)PyType_FromModuleAndSpec(
        module,
        &UVector3Array_PyTypeSpec,
        0
    );
    if (!type){ return 0; }
    // Note:
    // Unlike other functions that steal references, PyModule_AddObject() only
    // decrements the reference count of value on success.
    if (PyModule_AddObject(module, "UVector3Array", (PyObject *)type) < 0)
    {
        Py_DECREF(type);
        return 0;
    }
...
get_UVector3_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->UVector3_PyTypeObject;
}


static PyTypeObject *
get_UVector3Array_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->UVector3Array_PyTypeObject;
}


static PyObject *
create_UVector3(const unsigned int *value)
{
    auto cls = get_UVector3_type();
    auto result = (UVector3 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = *(UVector3Glm *)value;
    return (PyObject *)result;
}


static PyObject *
create_UVector3Array(size_t length, const unsigned int *value)
{
    auto cls = get_UVector3Array_type();
    auto result = (UVector3Array *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->length = length;
    if (length > 0)
    {
        ...
        {
            result->glm[i] = ((UVector3Glm *)value)[i];
        }
    }
    else
    {
...
get_UVector3_value_ptr(const PyObject *self)
{
    if (Py_TYPE(self) != get_UVector3_type())
    {
        PyErr_Format(PyExc_TypeError, "expected UVector3, got %R", self);
        return 0;
    }
    return (unsigned int *)&((UVector3 *)self)->glm;
}


static const unsigned int *
get_UVector3Array_value_ptr(const PyObject *self)
{
    if (Py_TYPE(self) != get_UVector3Array_type())
    {
        PyErr_Format(
            PyExc_TypeError,
            "expected UVector3Array, got %R",
            self
        );
        return 0;
    }
    return (unsigned int *)((UVector3Array *)self)->glm;
}


static size_t
get_UVector3Array_length(const PyObject *self)
{
    if (Py_TYPE(self) != get_UVector3Array_type())
    {
        PyErr_Format(
    ...
    return ((UVector3Array *)self)->length;
}
