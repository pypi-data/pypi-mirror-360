...
#ifndef E_MATH_I16VECTOR4_HPP
#define E_MATH_I16VECTOR4_HPP
...
I16Vector4__richcmp__(I16Vector4 *self, I16Vector4 *other, int op)
{
    ...
    switch(op)
    {
        case Py_LT:
        {
            for (I16Vector4Glm::length_type i = 0; i < 4; i++)
            {
...
static PyObject *
I16Vector4_pointer(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyGetSetDef I16Vector4_PyGetSetDef[] = {
    ...
    {"pointer", (getter)I16Vector4_pointer, 0, 0, 0},
    {0, 0, 0, 0, 0}
};
...
static PyObject *
I16Vector4_min(I16Vector4 *self, PyObject *min)
{
    ...
    I16Vector4 *result = (I16Vector4 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = I16Vector4Glm(vector);
    return (PyObject *)result;
}


static PyObject *
I16Vector4_max(I16Vector4 *self, PyObject *max)
{
...
static PyObject *
I16Vector4_clamp(I16Vector4 *self, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 2)
    {
...
static PyObject *
I16Vector4_get_size(I16Vector4 *cls, void *)
{
    return PyLong_FromSize_t(sizeof(int16_t) * 4);
}


static PyObject *
I16Vector4_get_limits(I16Vector4 *cls, void *)
{
...
static PyObject *
I16Vector4_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(int16_t) * 4;
    Py_buffer view;
...
static PyObject *
I16Vector4_get_array_type(PyTypeObject *cls, void*)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto array_type = module_state->I16Vector4Array_PyTypeObject;
...
static PyObject *
I16Vector4_to_b(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_d(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_f(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_i8(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_u8(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_u16(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_i32(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_u32(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_i(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_u(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_i64(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I16Vector4_to_u64(I16Vector4 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef I16Vector4_PyMethodDef[] = {
    ...
    {"min", (PyCFunction)I16Vector4_min, METH_O, 0},
    {"max", (PyCFunction)I16Vector4_max, METH_O, 0},
    {"clamp", (PyCFunction)I16Vector4_clamp, METH_FASTCALL, 0},
    {"get_limits", (PyCFunction)I16Vector4_get_limits, METH_NOARGS | METH_STATIC, 0},
    {"get_size", (PyCFunction)I16Vector4_get_size, METH_NOARGS | METH_STATIC, 0},
    {"get_array_type", (PyCFunction)I16Vector4_get_array_type, METH_NOARGS | METH_STATIC, 0},
    {"from_buffer", (PyCFunction)I16Vector4_from_buffer, METH_O | METH_CLASS, 0},

        {"to_b", (PyCFunction)I16Vector4_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)I16Vector4_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)I16Vector4_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)I16Vector4_to_i8, METH_NOARGS, 0},

        {"to_u8", (PyCFunction)I16Vector4_to_u8, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)I16Vector4_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)I16Vector4_to_i32, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)I16Vector4_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)I16Vector4_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)I16Vector4_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)I16Vector4_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)I16Vector4_to_u64, METH_NOARGS, 0},
...
static PyObject *
I16Vector4Array__new__(PyTypeObject *cls, PyObject *args, PyObject *kwds)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto element_cls = module_state->I16Vector4_PyTypeObject;
    ...
    if (arg_count == 0)
    {
        auto self = (I16Vector4Array *)cls->tp_alloc(cls, 0);
        if (!self){ return 0; }
        self->length = 0;
        self->glm = 0;
        return (PyObject *)self;
    ...
    self->glm = new I16Vector4Glm[arg_count];
...
static void
I16Vector4Array__dealloc__(I16Vector4Array *self)
{
    if (self->weakreflist)
    {
        PyObject_ClearWeakRefs((PyObject *)self);
...
static Py_hash_t
I16Vector4Array__hash__(I16Vector4Array *self)
{
    Py_ssize_t len = self->length * 4;
    Py_uhash_t acc = _HASH_XXPRIME_5;
    for (Py_ssize_t i = 0; i < (Py_ssize_t)self->length; i++)
    {
        for (I16Vector4Glm::length_type j = 0; j < 4; j++)
        {
...
static PyObject *
I16Vector4Array__repr__(I16Vector4Array *self)
{
    return PyUnicode_FromFormat("I16Vector4Array[%zu]", self->length);
}


static Py_ssize_t
I16Vector4Array__len__(I16Vector4Array *self)
{
    return self->length;
}
...
static PyObject *
I16Vector4Array__sq_getitem__(I16Vector4Array *self, Py_ssize_t index)
{
    ...
    I16Vector4 *result = (I16Vector4 *)element_cls->tp_alloc(element_cls, 0);
    if (!result){ return 0; }
    result->glm = I16Vector4Glm(self->glm[index]);
...
static PyObject *
I16Vector4Array__mp_getitem__(I16Vector4Array *self, PyObject *key)
{
    if (PySlice_Check(key))
    {
        ...
        else
        {
            ...
            result->glm = new I16Vector4Glm[length];
            for (I16Vector4Glm::length_type i = 0; i < length; i++)
            {
...
static PyObject *
I16Vector4Array__richcmp__(
    I16Vector4Array *self,
    I16Vector4Array *other,
    int op
)
{
    if (Py_TYPE(self) != Py_TYPE(other))
...
static int
I16Vector4Array__bool__(I16Vector4Array *self)
{
...
static int
I16Vector4Array_getbufferproc(I16Vector4Array *self, Py_buffer *view, int flags)
{
    if (flags & PyBUF_WRITABLE)
    {
        PyErr_SetString(PyExc_BufferError, "I16Vector4 is read only");
        view->obj = 0;
        return -1;
    }
        ...
        {
            PyErr_SetString(PyExc_BufferError, "I16Vector4 cannot be made Fortran contiguous");
            view->obj = 0;
            return -1;
        }
    ...
    view->buf = self->glm;
    view->obj = (PyObject *)self;
    view->len = sizeof(int16_t) * 4 * self->length;
    view->readonly = 1;
    view->itemsize = sizeof(int16_t);
    view->ndim = 2;
    if (flags & PyBUF_FORMAT)
...
static void
I16Vector4Array_releasebufferproc(I16Vector4Array *self, Py_buffer *view)
{
    delete view->shape;
}


static PyMemberDef I16Vector4Array_PyMemberDef[] = {
    {"__weaklistoffset__", T_PYSSIZET, offsetof(I16Vector4Array, weakreflist), READONLY},
    {0}
};


static PyObject *
I16Vector4Array_pointer(I16Vector4Array *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto c_p = module_state->ctypes_c_int16_t_p;
...
static PyObject *
I16Vector4Array_size(I16Vector4Array *self, void *)
{
    return PyLong_FromSize_t(sizeof(int16_t) * 4 * self->length);
}


static PyGetSetDef I16Vector4Array_PyGetSetDef[] = {
    {"pointer", (getter)I16Vector4Array_pointer, 0, 0, 0},
    {"size", (getter)I16Vector4Array_size, 0, 0, 0},
    {0, 0, 0, 0, 0}
};


static PyObject *
I16Vector4Array_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(int16_t);
    Py_buffer view;
    if (PyObject_GetBuffer(buffer, &view, PyBUF_SIMPLE) == -1){ return 0; }
    auto view_length = view.len;
    if (view_length % (sizeof(int16_t) * 4))
    {
        PyBuffer_Release(&view);
        PyErr_Format(PyExc_BufferError, "expected buffer evenly divisible by %zd, got %zd", sizeof(int16_t), view_length);
        return 0;
    }
    auto array_length = view_length / (sizeof(int16_t) * 4);
    ...
    if (array_length > 0)
    {
        result->glm = new I16Vector4Glm[array_length];
...
static PyObject *
I16Vector4Array_get_component_type(PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 0)
    {
    ...
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto component_type = module_state->I16Vector4_PyTypeObject;
    Py_INCREF(component_type);
    return (PyObject *)component_type;
}


static PyMethodDef I16Vector4Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)I16Vector4Array_from_buffer, METH_O | METH_CLASS, 0},
    {"get_component_type", (PyCFunction)I16Vector4Array_get_component_type, METH_FASTCALL | METH_CLASS, 0},
    {0, 0, 0, 0}
};


static PyType_Slot I16Vector4Array_PyType_Slots [] = {
    {Py_tp_new, (void*)I16Vector4Array__new__},
    {Py_tp_dealloc, (void*)I16Vector4Array__dealloc__},
    {Py_tp_hash, (void*)I16Vector4Array__hash__},
    {Py_tp_repr, (void*)I16Vector4Array__repr__},
    {Py_sq_length, (void*)I16Vector4Array__len__},
    {Py_sq_item, (void*)I16Vector4Array__sq_getitem__},
    {Py_mp_subscript, (void*)I16Vector4Array__mp_getitem__},
    {Py_tp_richcompare, (void*)I16Vector4Array__richcmp__},
    {Py_nb_bool, (void*)I16Vector4Array__bool__},
    {Py_bf_getbuffer, (void*)I16Vector4Array_getbufferproc},
    {Py_bf_releasebuffer, (void*)I16Vector4Array_releasebufferproc},
    {Py_tp_getset, (void*)I16Vector4Array_PyGetSetDef},
    {Py_tp_members, (void*)I16Vector4Array_PyMemberDef},
    {Py_tp_methods, (void*)I16Vector4Array_PyMethodDef},
    {0, 0},
};


static PyType_Spec I16Vector4Array_PyTypeSpec = {
    "emath.I16Vector4Array",
    sizeof(I16Vector4Array),
    0,
    Py_TPFLAGS_DEFAULT,
    I16Vector4Array_PyType_Slots
};


static PyTypeObject *
define_I16Vector4Array_type(PyObject *module)
{
    PyTypeObject *type = (PyTypeObject *)PyType_FromModuleAndSpec(
        module,
        &I16Vector4Array_PyTypeSpec,
        0
    );
    if (!type){ return 0; }
    // Note:
    // Unlike other functions that steal references, PyModule_AddObject() only
    // decrements the reference count of value on success.
    if (PyModule_AddObject(module, "I16Vector4Array", (PyObject *)type) < 0)
    {
        Py_DECREF(type);
        return 0;
    }
...
get_I16Vector4_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->I16Vector4_PyTypeObject;
}


static PyTypeObject *
get_I16Vector4Array_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->I16Vector4Array_PyTypeObject;
}
...
create_I16Vector4(const int16_t *value)
{
    ...
    auto result = (I16Vector4 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = *(I16Vector4Glm *)value;
    return (PyObject *)result;
}
...
create_I16Vector4Array(size_t length, const int16_t *value)
{
    ...
    if (length > 0)
    {
        ...
        {
            result->glm[i] = ((I16Vector4Glm *)value)[i];
        }
    }
    else
    {
...
get_I16Vector4_value_ptr(const PyObject *self)
{
    ...
    {
        PyErr_Format(PyExc_TypeError, "expected I16Vector4, got %R", self);
        return 0;
    }
    return (int16_t *)&((I16Vector4 *)self)->glm;
}
...
get_I16Vector4Array_value_ptr(const PyObject *self)
{
    if (Py_TYPE(self) != get_I16Vector4Array_type())
    {
        PyErr_Format(
            PyExc_TypeError,
            "expected I16Vector4Array, got %R",
            self
        );
        return 0;
    }
    return (int16_t *)((I16Vector4Array *)self)->glm;
}
...
get_I16Vector4Array_length(const PyObject *self)
{
    ...
    return ((I16Vector4Array *)self)->length;
}
