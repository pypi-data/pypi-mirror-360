...
#ifndef E_MATH_I64VECTOR2_HPP
#define E_MATH_I64VECTOR2_HPP
...
static PyObject *
I64Vector2_pointer(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyGetSetDef I64Vector2_PyGetSetDef[] = {
    ...
    {"pointer", (getter)I64Vector2_pointer, 0, 0, 0},
    {0, 0, 0, 0, 0}
};
...
static PyObject *
I64Vector2_min(I64Vector2 *self, PyObject *min)
{
...
static PyObject *
I64Vector2_max(I64Vector2 *self, PyObject *max)
{
...
static PyObject *
I64Vector2_clamp(I64Vector2 *self, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 2)
    {
...
static PyObject *
I64Vector2_get_size(I64Vector2 *cls, void *)
{
    return PyLong_FromSize_t(sizeof(int64_t) * 2);
}


static PyObject *
I64Vector2_get_limits(I64Vector2 *cls, void *)
{
...
static PyObject *
I64Vector2_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(int64_t) * 2;
    Py_buffer view;
...
static PyObject *
I64Vector2_get_array_type(PyTypeObject *cls, void*)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto array_type = module_state->I64Vector2Array_PyTypeObject;
...
static PyObject *
I64Vector2_to_d(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_f(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_i8(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_u8(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_i16(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_u16(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_i32(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_u32(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_i(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_u(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
I64Vector2_to_u64(I64Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef I64Vector2_PyMethodDef[] = {
    ...
    {"min", (PyCFunction)I64Vector2_min, METH_O, 0},
    {"max", (PyCFunction)I64Vector2_max, METH_O, 0},
    {"clamp", (PyCFunction)I64Vector2_clamp, METH_FASTCALL, 0},
    {"get_limits", (PyCFunction)I64Vector2_get_limits, METH_NOARGS | METH_STATIC, 0},
    {"get_size", (PyCFunction)I64Vector2_get_size, METH_NOARGS | METH_STATIC, 0},
    {"get_array_type", (PyCFunction)I64Vector2_get_array_type, METH_NOARGS | METH_STATIC, 0},
    {"from_buffer", (PyCFunction)I64Vector2_from_buffer, METH_O | METH_CLASS, 0},

        {"to_b", (PyCFunction)I64Vector2_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)I64Vector2_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)I64Vector2_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)I64Vector2_to_i8, METH_NOARGS, 0},

        {"to_u8", (PyCFunction)I64Vector2_to_u8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)I64Vector2_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)I64Vector2_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)I64Vector2_to_i32, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)I64Vector2_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)I64Vector2_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)I64Vector2_to_u, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)I64Vector2_to_u64, METH_NOARGS, 0},
...
static PyObject *
I64Vector2Array__new__(PyTypeObject *cls, PyObject *args, PyObject *kwds)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto element_cls = module_state->I64Vector2_PyTypeObject;
    ...
    if (arg_count == 0)
    {
        auto self = (I64Vector2Array *)cls->tp_alloc(cls, 0);
        if (!self){ return 0; }
        self->length = 0;
        self->glm = 0;
        return (PyObject *)self;
    ...
    self->glm = new I64Vector2Glm[arg_count];
...
static void
I64Vector2Array__dealloc__(I64Vector2Array *self)
{
    if (self->weakreflist)
    {
        PyObject_ClearWeakRefs((PyObject *)self);
...
static Py_hash_t
I64Vector2Array__hash__(I64Vector2Array *self)
{
    Py_ssize_t len = self->length * 2;
    Py_uhash_t acc = _HASH_XXPRIME_5;
    for (Py_ssize_t i = 0; i < (Py_ssize_t)self->length; i++)
    {
        for (I64Vector2Glm::length_type j = 0; j < 2; j++)
        {
...
static PyObject *
I64Vector2Array__repr__(I64Vector2Array *self)
{
    return PyUnicode_FromFormat("I64Vector2Array[%zu]", self->length);
}


static Py_ssize_t
I64Vector2Array__len__(I64Vector2Array *self)
{
    return self->length;
}
...
static PyObject *
I64Vector2Array__sq_getitem__(I64Vector2Array *self, Py_ssize_t index)
{
...
static PyObject *
I64Vector2Array__mp_getitem__(I64Vector2Array *self, PyObject *key)
{
    if (PySlice_Check(key))
    {
        ...
        auto cls = Py_TYPE(self);
        auto *result = (I64Vector2Array *)cls->tp_alloc(cls, 0);
        if (!result){ return 0; }
        if (length == 0)
        {
            result->length = 0;
        ...
        else
        {
            ...
            result->glm = new I64Vector2Glm[length];
            for (I64Vector2Glm::length_type i = 0; i < length; i++)
            {
...
static PyObject *
I64Vector2Array__richcmp__(
    I64Vector2Array *self,
    I64Vector2Array *other,
    int op
)
{
    if (Py_TYPE(self) != Py_TYPE(other))
...
static int
I64Vector2Array__bool__(I64Vector2Array *self)
{
...
static int
I64Vector2Array_getbufferproc(I64Vector2Array *self, Py_buffer *view, int flags)
{
    if (flags & PyBUF_WRITABLE)
    {
        PyErr_SetString(PyExc_BufferError, "I64Vector2 is read only");
        view->obj = 0;
        return -1;
    }
        ...
        {
            PyErr_SetString(PyExc_BufferError, "I64Vector2 cannot be made Fortran contiguous");
            view->obj = 0;
            return -1;
        }
    ...
    view->buf = self->glm;
    view->obj = (PyObject *)self;
    view->len = sizeof(int64_t) * 2 * self->length;
    view->readonly = 1;
    view->itemsize = sizeof(int64_t);
    view->ndim = 2;
    if (flags & PyBUF_FORMAT)
...
static void
I64Vector2Array_releasebufferproc(I64Vector2Array *self, Py_buffer *view)
{
    delete view->shape;
}


static PyMemberDef I64Vector2Array_PyMemberDef[] = {
    {"__weaklistoffset__", T_PYSSIZET, offsetof(I64Vector2Array, weakreflist), READONLY},
    {0}
};


static PyObject *
I64Vector2Array_pointer(I64Vector2Array *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto c_p = module_state->ctypes_c_int64_t_p;
...
static PyObject *
I64Vector2Array_size(I64Vector2Array *self, void *)
{
    return PyLong_FromSize_t(sizeof(int64_t) * 2 * self->length);
}


static PyGetSetDef I64Vector2Array_PyGetSetDef[] = {
    {"pointer", (getter)I64Vector2Array_pointer, 0, 0, 0},
    {"size", (getter)I64Vector2Array_size, 0, 0, 0},
    {0, 0, 0, 0, 0}
};


static PyObject *
I64Vector2Array_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(int64_t);
    Py_buffer view;
    if (PyObject_GetBuffer(buffer, &view, PyBUF_SIMPLE) == -1){ return 0; }
    auto view_length = view.len;
    if (view_length % (sizeof(int64_t) * 2))
    {
        PyBuffer_Release(&view);
        PyErr_Format(PyExc_BufferError, "expected buffer evenly divisible by %zd, got %zd", sizeof(int64_t), view_length);
        return 0;
    }
    auto array_length = view_length / (sizeof(int64_t) * 2);
    ...
    if (array_length > 0)
    {
        result->glm = new I64Vector2Glm[array_length];
...
I64Vector2Array_get_component_type(PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto component_type = module_state->I64Vector2_PyTypeObject;
...
static PyType_Slot I64Vector2Array_PyType_Slots [] = {
    {Py_tp_new, (void*)I64Vector2Array__new__},
    {Py_tp_dealloc, (void*)I64Vector2Array__dealloc__},
    {Py_tp_hash, (void*)I64Vector2Array__hash__},
    {Py_tp_repr, (void*)I64Vector2Array__repr__},
    {Py_sq_length, (void*)I64Vector2Array__len__},
    {Py_sq_item, (void*)I64Vector2Array__sq_getitem__},
    {Py_mp_subscript, (void*)I64Vector2Array__mp_getitem__},
    {Py_tp_richcompare, (void*)I64Vector2Array__richcmp__},
    {Py_nb_bool, (void*)I64Vector2Array__bool__},
    {Py_bf_getbuffer, (void*)I64Vector2Array_getbufferproc},
    {Py_bf_releasebuffer, (void*)I64Vector2Array_releasebufferproc},
    {Py_tp_getset, (void*)I64Vector2Array_PyGetSetDef},
    {Py_tp_members, (void*)I64Vector2Array_PyMemberDef},
    {Py_tp_methods, (void*)I64Vector2Array_PyMethodDef},
    {0, 0},
};


static PyType_Spec I64Vector2Array_PyTypeSpec = {
    "emath.I64Vector2Array",
    sizeof(I64Vector2Array),
    0,
    Py_TPFLAGS_DEFAULT,
    I64Vector2Array_PyType_Slots
};


static PyTypeObject *
define_I64Vector2Array_type(PyObject *module)
{
    PyTypeObject *type = (PyTypeObject *)PyType_FromModuleAndSpec(
        module,
        &I64Vector2Array_PyTypeSpec,
        0
    );
    if (!type){ return 0; }
    // Note:
    // Unlike other functions that steal references, PyModule_AddObject() only
    // decrements the reference count of value on success.
    if (PyModule_AddObject(module, "I64Vector2Array", (PyObject *)type) < 0)
    {
        Py_DECREF(type);
        return 0;
    }
...
get_I64Vector2_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->I64Vector2_PyTypeObject;
}


static PyTypeObject *
get_I64Vector2Array_type()
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    return module_state->I64Vector2Array_PyTypeObject;
}


static PyObject *
create_I64Vector2(const int64_t *value)
{
...
static PyObject *
create_I64Vector2Array(size_t length, const int64_t *value)
{
    auto cls = get_I64Vector2Array_type();
    auto result = (I64Vector2Array *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->length = length;
    if (length > 0)
    {
        ...
        {
            result->glm[i] = ((I64Vector2Glm *)value)[i];
        }
    }
    else
    {
...
get_I64Vector2_value_ptr(const PyObject *self)
{
    if (Py_TYPE(self) != get_I64Vector2_type())
    {
...
static const int64_t *
get_I64Vector2Array_value_ptr(const PyObject *self)
{
    if (Py_TYPE(self) != get_I64Vector2Array_type())
    {
        PyErr_Format(
            PyExc_TypeError,
            "expected I64Vector2Array, got %R",
            self
        );
        return 0;
    }
    return (int64_t *)((I64Vector2Array *)self)->glm;
}


static size_t
get_I64Vector2Array_length(const PyObject *self)
{
    if (Py_TYPE(self) != get_I64Vector2Array_type())
    {
        PyErr_Format(
    ...
    return ((I64Vector2Array *)self)->length;
}
