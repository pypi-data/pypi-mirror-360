...
#ifndef E_MATH_U8VECTOR2_HPP
#define E_MATH_U8VECTOR2_HPP
...
U8Vector2__richcmp__(U8Vector2 *self, U8Vector2 *other, int op)
{
    ...
    switch(op)
    {
        case Py_LT:
        {
            for (U8Vector2Glm::length_type i = 0; i < 2; i++)
            {
...
static PyObject *
U8Vector2_min(U8Vector2 *self, PyObject *min)
{
    ...
    U8Vector2 *result = (U8Vector2 *)cls->tp_alloc(cls, 0);
    if (!result){ return 0; }
    result->glm = U8Vector2Glm(vector);
    return (PyObject *)result;
}


static PyObject *
U8Vector2_max(U8Vector2 *self, PyObject *max)
{
...
static PyObject *
U8Vector2_clamp(U8Vector2 *self, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 2)
    {
...
static PyObject *
U8Vector2_get_size(U8Vector2 *cls, void *)
{
    return PyLong_FromSize_t(sizeof(uint8_t) * 2);
}


static PyObject *
U8Vector2_get_limits(U8Vector2 *cls, void *)
{
...
static PyObject *
U8Vector2_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(uint8_t) * 2;
    Py_buffer view;
...
static PyObject *
U8Vector2_get_array_type(PyTypeObject *cls, void*)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto array_type = module_state->U8Vector2Array_PyTypeObject;
...
static PyObject *
U8Vector2_to_b(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_d(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_f(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_i8(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_i16(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_u16(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_i32(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_u32(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_i(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_u(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_i64(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyObject *
U8Vector2_to_u64(U8Vector2 *self, void *)
{
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
...
static PyMethodDef U8Vector2_PyMethodDef[] = {
    ...
    {"min", (PyCFunction)U8Vector2_min, METH_O, 0},
    {"max", (PyCFunction)U8Vector2_max, METH_O, 0},
    {"clamp", (PyCFunction)U8Vector2_clamp, METH_FASTCALL, 0},
    {"get_limits", (PyCFunction)U8Vector2_get_limits, METH_NOARGS | METH_STATIC, 0},
    {"get_size", (PyCFunction)U8Vector2_get_size, METH_NOARGS | METH_STATIC, 0},
    {"get_array_type", (PyCFunction)U8Vector2_get_array_type, METH_NOARGS | METH_STATIC, 0},
    {"from_buffer", (PyCFunction)U8Vector2_from_buffer, METH_O | METH_CLASS, 0},

        {"to_b", (PyCFunction)U8Vector2_to_b, METH_NOARGS, 0},

        {"to_d", (PyCFunction)U8Vector2_to_d, METH_NOARGS, 0},

        {"to_f", (PyCFunction)U8Vector2_to_f, METH_NOARGS, 0},

        {"to_i8", (PyCFunction)U8Vector2_to_i8, METH_NOARGS, 0},

        {"to_i16", (PyCFunction)U8Vector2_to_i16, METH_NOARGS, 0},

        {"to_u16", (PyCFunction)U8Vector2_to_u16, METH_NOARGS, 0},

        {"to_i32", (PyCFunction)U8Vector2_to_i32, METH_NOARGS, 0},

        {"to_u32", (PyCFunction)U8Vector2_to_u32, METH_NOARGS, 0},

        {"to_i", (PyCFunction)U8Vector2_to_i, METH_NOARGS, 0},

        {"to_u", (PyCFunction)U8Vector2_to_u, METH_NOARGS, 0},

        {"to_i64", (PyCFunction)U8Vector2_to_i64, METH_NOARGS, 0},

        {"to_u64", (PyCFunction)U8Vector2_to_u64, METH_NOARGS, 0},
...
static PyObject *
U8Vector2Array__sq_getitem__(U8Vector2Array *self, Py_ssize_t index)
{
    ...
    if (!result){ return 0; }
    result->glm = U8Vector2Glm(self->glm[index]);
...
static PyObject *
U8Vector2Array__mp_getitem__(U8Vector2Array *self, PyObject *key)
{
    if (PySlice_Check(key))
    {
        ...
        else
        {
            ...
            for (U8Vector2Glm::length_type i = 0; i < length; i++)
            {
...
U8Vector2Array_getbufferproc(U8Vector2Array *self, Py_buffer *view, int flags)
{
    if (flags & PyBUF_WRITABLE)
    {
        PyErr_SetString(PyExc_BufferError, "U8Vector2 is read only");
        view->obj = 0;
        return -1;
    }
        ...
        {
            PyErr_SetString(PyExc_BufferError, "U8Vector2 cannot be made Fortran contiguous");
            view->obj = 0;
            return -1;
        }
...
static PyObject *
U8Vector2Array_size(U8Vector2Array *self, void *)
{
    return PyLong_FromSize_t(sizeof(uint8_t) * 2 * self->length);
}


static PyGetSetDef U8Vector2Array_PyGetSetDef[] = {
    {"pointer", (getter)U8Vector2Array_pointer, 0, 0, 0},
    {"size", (getter)U8Vector2Array_size, 0, 0, 0},
    {0, 0, 0, 0, 0}
};


static PyObject *
U8Vector2Array_from_buffer(PyTypeObject *cls, PyObject *buffer)
{
    static Py_ssize_t expected_size = sizeof(uint8_t);
    Py_buffer view;
    if (PyObject_GetBuffer(buffer, &view, PyBUF_SIMPLE) == -1){ return 0; }
    auto view_length = view.len;
    if (view_length % (sizeof(uint8_t) * 2))
    {
        PyBuffer_Release(&view);
        PyErr_Format(PyExc_BufferError, "expected buffer evenly divisible by %zd, got %zd", sizeof(uint8_t), view_length);
        return 0;
    }
    auto array_length = view_length / (sizeof(uint8_t) * 2);
    ...
    if (array_length > 0)
    {
        result->glm = new U8Vector2Glm[array_length];
...
static PyObject *
U8Vector2Array_get_component_type(PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs)
{
    if (nargs != 0)
    {
    ...
    auto module_state = get_module_state();
    if (!module_state){ return 0; }
    auto component_type = module_state->U8Vector2_PyTypeObject;
    Py_INCREF(component_type);
    return (PyObject *)component_type;
}


static PyMethodDef U8Vector2Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction)U8Vector2Array_from_buffer, METH_O | METH_CLASS, 0},
    {"get_component_type", (PyCFunction)U8Vector2Array_get_component_type, METH_FASTCALL | METH_CLASS, 0},
    {0, 0, 0, 0}
};
...
static PyType_Slot U8Vector2Array_PyType_Slots [] = {
    ...
    {Py_sq_item, (void*)U8Vector2Array__sq_getitem__},
    {Py_mp_subscript, (void*)U8Vector2Array__mp_getitem__},
    ...
    {Py_tp_methods, (void*)U8Vector2Array_PyMethodDef},
    {0, 0},
};
