...
class DescribeSideResource:
    ...
    def test_equal_json_with_different_ordering(self):
        ...
        assert transaction_type.compare_json_structures(json1, json2)
    ...
    def test_not_equal_json(self):
        ...
        assert not transaction_type.compare_json_structures(json1, json2)
    ...
    def test_different_json_structure(self):
        json1 = {"movements": [{"movementTypes": "StockMovement", "side": "Side1", "direction": 1}]}
