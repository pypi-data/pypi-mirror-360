...
IAddressBooks_VERSION = "5.3.2760"
...
class IAddressBooks(BaseEndpoint):
    ...
    def findCertsByEmail(self, email):
        postUri = "/_findCertsByEmail"
        __data__ = None
        __encoded__ = None
        ...
        from netbluemind.addressbook.api.CertInfo import CertInfo
        from netbluemind.addressbook.api.CertInfo import __CertInfoSerDer__
        return self.handleResult__(serder.ListSerDer(__CertInfoSerDer__()), response)

    def findUidsByEmail(self, email):
        postUri = "/_findUidsByEmail"
        __data__ = None
        __encoded__ = None
        __data__ = serder.STRING.encode(email)
