...
class GetCohortResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCohortResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCohortResponse:
        """Create an instance of GetCohortResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCohortResponse.parse_obj(obj)

        _obj = GetCohortResponse.parse_obj(
            {
