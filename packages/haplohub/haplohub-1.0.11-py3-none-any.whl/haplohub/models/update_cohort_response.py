...
class UpdateCohortResponse(BaseModel):
    ...
    result: CohortDetailSchema = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateCohortResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateCohortResponse:
        """Create an instance of UpdateCohortResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateCohortResponse.parse_obj(obj)

        _obj = UpdateCohortResponse.parse_obj(
            {
                "status": obj.get("status"),
                "result": CohortDetailSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
