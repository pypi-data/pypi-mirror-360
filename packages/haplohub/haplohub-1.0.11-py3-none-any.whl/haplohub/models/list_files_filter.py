...
class ListFilesFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListFilesFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListFilesFilter:
        """Create an instance of ListFilesFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListFilesFilter.parse_obj(obj)

        _obj = ListFilesFilter.parse_obj(
            {
