...
class CreateEnvironmentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateEnvironmentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateEnvironmentResponse:
        """Create an instance of CreateEnvironmentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateEnvironmentResponse.parse_obj(obj)

        _obj = CreateEnvironmentResponse.parse_obj(
            {
