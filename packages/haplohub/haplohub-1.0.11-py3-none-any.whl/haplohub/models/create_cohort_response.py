...
class CreateCohortResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCohortResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCohortResponse:
        """Create an instance of CreateCohortResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCohortResponse.parse_obj(obj)

        _obj = CreateCohortResponse.parse_obj(
            {
                "status": obj.get("status"),
                "result": CohortSchema.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            }
        )
        return _obj
