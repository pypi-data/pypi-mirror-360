...
class UpdateSampleRequest(BaseModel):
    ...
    __properties = ["sample_id", "patient_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateSampleRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateSampleRequest:
        """Create an instance of UpdateSampleRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateSampleRequest.parse_obj(obj)

        _obj = UpdateSampleRequest.parse_obj({"sample_id": obj.get("sample_id"), "patient_id": obj.get("patient_id")})
        return _obj
