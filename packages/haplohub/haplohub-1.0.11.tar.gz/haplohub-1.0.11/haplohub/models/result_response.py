...
class ResultResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultResponse:
        """Create an instance of ResultResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultResponse.parse_obj(obj)

        _obj = ResultResponse.parse_obj({"status": obj.get("status"), "result": obj.get("result")})
        return _obj
