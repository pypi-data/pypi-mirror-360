...
class DirSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DirSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DirSchema:
        """Create an instance of DirSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirSchema.parse_obj(obj)

        _obj = DirSchema.parse_obj({"location": obj.get("location")})
        return _obj
