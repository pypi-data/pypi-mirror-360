...
class CustomEvent(InputElement):
    ...
    **EXAMPLE:**
    ...
    '''
    @validate_types
    def __init__(self, title: str, confirmation_text: str = None, label: str = None, position: CustomEventPosition = ..., show_confirmation: bool = True, icon: str = '', **kwargs) -> None: ...
    @validate_types
...
class AssetDownloadCustomEvent(CustomEvent):
    ...
    **EXAMPLE:**
    ...
    @validate_types
    def __init__(self, title: str, asset: Asset, extension: str, label: str = None, mime_type: str | None = None) -> None: ...
    @validate_types
...
class TriggerFlowCustomEvent(CustomEvent):
    ...
    **EXAMPLE:**
    ...
    timeout: Incomplete
    @validate_types
    def __init__(self, title: str, app_name: str, confirmation_text: str = None, label: str = None, input_parameters: dict | None = None, timeout: int = 30, position: CustomEventPosition = ..., **kwargs) -> None: ...
    @validate_types
