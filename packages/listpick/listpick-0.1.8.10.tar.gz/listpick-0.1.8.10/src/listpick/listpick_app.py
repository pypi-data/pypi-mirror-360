...
class Picker:
    ...
    def initialise_variables(self, get_data: bool = False) -> None:
        ...
        if self.data_ready and self.track_entries_upon_refresh and len(self.items) > 1:
            selected_indices = []
    ...
    def fetch_data(self) -> None:
        ...
        with self.data_lock:
            ...
            if self.track_entries_upon_refresh:
                self.ids = [item[self.id_column] for i, item in enumerate(self.items) if i in get_selected_indices(self.selections)]
