...
Resources:
  ...
  FlaskApiStage:
    ...
    Properties:
      ...
      DeploymentId: !Ref FlaskApiDeployment

  FlaskApiDeployment:
    Type: AWS::ApiGateway::Deployment
    DependsOn: FlaskFunction
    Properties:
      RestApiId: !Ref FlaskApi
      Description: !Sub "Deployment for ${DeployEnvironment} environment"
...
Outputs:
  FlaskApi:
    ...
    Value: !Sub "https://${FlaskApi}.execute-api.${AWS::Region}.amazonaws.com/${DeployEnvironment}"
    Export:
