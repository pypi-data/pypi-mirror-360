...
def bwa_dedup(
    ...
    *,
    ...
    bed_file : str
        Path to the BED file for coverage analysis.
    out_path : str
        Output directory for results.
    r1 : str
        Path to the first read FASTQ file.
    r2 : str
        Path to the second read FASTQ file.
    sample_name : str
        Sample identifier for output files.
    at : str, optional
        Algorithm type for BWA indexing, by default 'bwtsw'.
    threads : int, optional
        Number of threads to use for processing, by default 40.
    remove_dups : bool, optional
        Whether to remove all duplicates, by default False.
    remove_seq_dups : bool, optional
        Whether to remove sequencing duplicates, by default False.
    use_md : bool, optional
        Whether to use MarkDuplicatesSpark, by default False.
    """
