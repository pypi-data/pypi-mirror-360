...
class S3Manager:
    ...
    def create_bucket(self, name: str, visibility: Union[Literal["private", "public"], VisibilityOptions]) -> None:
    ...
    def update_bucket_visibility(
        self, bucket: str, new_visibility: Union[Literal["private", "public"], VisibilityOptions]
    ) -> None:
