...
if USED_API == QT_API_PYQT5:
    ...
    try:
        ...
        raise QtModuleNotInstalledError(name="QtLocation", missing_package="PySide6-Addons or PySide6-QtAds")
else:
    raise ImportError("No module named 'QtLocation' in the selected Qt api ({})".format(USED_API))
