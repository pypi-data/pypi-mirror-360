...
if USED_API == QT_API_PYQT5:
    ...
    try:
        ...
        raise QtModuleNotInstalledError(name="QtPositioning", missing_package="PySide6-Addons or PySide6-QtAds")
else:
    raise ImportError("No module named 'QtPositioning' in the selected Qt api ({})".format(USED_API))
