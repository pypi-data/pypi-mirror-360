...
if USED_API == QT_API_PYQT5:
    ...
    from PySide2.QtQuick3D import *
elif USED_API == QT_API_PYSIDE6:
    try:
        from PySide6.QtQuick3D import *
    except:
        raise QtModuleNotInstalledError(name="QtQuick3D", missing_package="PySide6-Addons or PySide6-QtAds")
else:
    raise ImportError("No module named 'QtQuick3D' in the selected Qt api ({})".format(USED_API))
