...
if USED_API == QT_API_PYQT5:
    ...
    try:
        ...
        raise QtModuleNotInstalledError(name="QtSensors", missing_package="PySide6-Addons or PySide6-QtAds")
else:
    raise ImportError("No module named 'QtSensors' in the selected Qt api ({})".format(USED_API))
