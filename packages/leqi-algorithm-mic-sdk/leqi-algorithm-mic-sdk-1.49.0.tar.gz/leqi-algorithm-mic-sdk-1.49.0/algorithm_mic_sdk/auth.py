...
class AuthInfo(object):
    ...
    def __init__(self, host, user_name, password, extranet=False, gateway_cache=True, random_name=False, use_accelerate=False, **kwargs):
        """
        账号验证
        ...
        :param use_accelerate: 是否需要打开传输加速(若为True,则在文件上传到算法oss或下载将使用传输加速域名,此时文件通过外网传输)
        ...
        if self.use_accelerate:
            logging.warning('use_accelerate为True字段仅建议在海外服务器上使用')
