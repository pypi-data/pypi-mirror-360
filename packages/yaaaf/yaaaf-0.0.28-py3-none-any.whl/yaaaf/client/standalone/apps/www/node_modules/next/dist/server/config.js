...
function assignDefaults(dir, userConfig, silent) {
    ...
    if (((_result_experimental = result.experimental) == null ? void 0 : _result_experimental.ppr) && !"14.3.0-canary.43".includes('canary') && !process.env.__NEXT_TEST_MODE) {
    ...
    if (result.swcMinify === false) {
        // TODO: Remove this warning in Next.js 15
        warnOptionHasBeenDeprecated(result, 'swcMinify', 'Disabling SWC Minifier will not be an option in the next major version. Please report any issues you may be experiencing to https://github.com/vercel/next.js/issues', silent);
    }
