...
class Server {
   ...
   */ this.normalize = (pathname)=>{
        ...
        const isAppPPREnabled = this.enabledDirectories.app && (0, _ppr.checkIsAppPPREnabled)(this.nextConfig.experimental.ppr);
        this.normalizers = {
            // We should normalize the pathname from the RSC prefix only in minimal
            // mode as otherwise that route is not exposed external to the server as
            // we instead only rely on the headers.
            postponed: isAppPPREnabled && this.minimalMode ? new _postponed.PostponedPathnameNormalizer() : undefined,
            rsc: this.enabledDirectories.app && this.minimalMode ? new _rsc.RSCPathnameNormalizer() : undefined,
            prefetchRSC: isAppPPREnabled && this.minimalMode ? new _prefetchrsc.PrefetchRSCPathnameNormalizer() : undefined,
   ...
   */ async prepare() {
    ...
    async renderToResponseWithComponentsImpl({ req, res, pathname, renderOpts: opts }, { components, query }) {
        var _components_Component, _this, _this_nextConfig_i18n, _this_nextConfig_i18n1, _cacheEntry_value;
     ...
     */ const couldSupportPPR = typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule) && this.renderOpts.experimental.isAppPPREnabled;
        ...
        const isDebugPPRSkeleton = query.__nextppronly && couldSupportPPR && (this.renderOpts.dev || this.experimentalTestProxy) ? true : false;
        // This page supports PPR if it has `experimentalPPR` set to `true` in the
        // prerender manifest and this is an app page.
        const isRoutePPREnabled = couldSupportPPR && (((_this = prerenderManifest.routes[pathname] ?? prerenderManifest.dynamicRoutes[pathname]) == null ? void 0 : _this.experimentalPPR) === true || isDebugPPRSkeleton);
        ...
        const didPostpone = ((_cacheEntry_value = cacheEntry.value) == null ? void 0 : _cacheEntry_value.kind) === 'PAGE' && typeof cacheEntry.value.postponed === 'string';
