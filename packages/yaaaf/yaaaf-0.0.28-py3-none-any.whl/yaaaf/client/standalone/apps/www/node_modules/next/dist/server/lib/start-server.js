...
let startServerSpan;
async function getRequestHandlers({ dir, port, isDev, server, hostname, minimalMode, isNodeDebugging, keepAliveTimeout, experimentalHttpsServer, quiet }) {
...
async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"14.3.0-canary.43"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
