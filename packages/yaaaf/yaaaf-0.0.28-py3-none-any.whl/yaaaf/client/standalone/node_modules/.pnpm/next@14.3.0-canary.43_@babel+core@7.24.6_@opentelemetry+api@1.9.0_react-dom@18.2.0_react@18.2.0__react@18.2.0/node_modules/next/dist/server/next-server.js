    ...
    async renderHTMLImpl(req, res, pathname, query, renderOpts) {
        ...
        // the `else` branch is needed for tree-shaking
            ...
            if (this.enabledDirectories.app && renderOpts.isAppPath) {
                return (0, _modulerender.lazyRenderAppPage)(req, res, pathname, query, renderOpts);
            }
        ...
        return (req, res, parsedUrl)=>{
            ...
            if (this.renderOpts.dev) {
                ...
                const reqCallback = ()=>{
                    ...
                    const isRSC = (0, _baseserver.isRSCRequestCheck)(normalizedReq);
                    ...
                    const loggingUrl = isRSC ? (0, _url.stripNextRscUnionQuery)(requestUrl) : requestUrl;
                    writeStdoutLine(`${method} ${loggingUrl} ${color(res.statusCode.toString())} in ${reqDuration}ms`);
