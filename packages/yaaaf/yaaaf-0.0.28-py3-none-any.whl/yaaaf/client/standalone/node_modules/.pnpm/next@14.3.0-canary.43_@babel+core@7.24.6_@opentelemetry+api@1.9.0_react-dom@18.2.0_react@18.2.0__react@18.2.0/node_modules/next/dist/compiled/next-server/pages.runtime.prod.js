...
Read more: https://nextjs.org/docs/messages/invalid-getstaticpaths-value`);let ew=l.resolvedAsPath||n.url;if(S){let{isValidElementType:e}=r("./dist/compiled/react-is/index.js");if(!e(ec))throw Error(`The default export is not a React Component in page: "${a}"`);if(!e(ea))throw Error('The default export is not a React Component in page: "/_app"');if(!e(eu))throw Error('The default export is not a React Component in page: "/_document"');if((eS||ep)&&(i={...i.amp?{amp:i.amp}:{}},ew=`${a}${n.url.endsWith("/")&&"/"!==a&&!ex?"/":""}`,n.url=a),"/404"===a&&(ev||M))throw Error(`\`pages/404\` ${C.Ei}`);if(R.Er.includes(a)&&(ev||M))throw Error(`\`pages${a}\` ${C.Ei}`)}for(let e of["getStaticProps","getServerSideProps","getStaticPaths"])if(null==ec?void 0:ec[e])throw Error(`page ${a} ${e} ${C.lk}`);await H.preloadAll(),(em||M)&&!ep&&q&&(f=!1!==(h=e(n,s,q)));let eP=new eX(a,i,ew,{isFallback:ep},!!(M||ev||!eg&&!em||et),W,l.locale,l.locales,l.defaultLocale,l.domainLocales,f,ee(n,"isLocaleDomain")),e_={back(){eP.back()},forward(){eP.forward()},refresh(){eP.reload()},fastRefresh(){},push(e,t){let{scroll:r}=void 0===t?{}:t;eP.push(e,void 0,{scroll:r})},replace(e,t){let{scroll:r}=void 0===t?{}:t;eP.replace(e,void 0,{scroll:r})},prefetch(e){eP.prefetch(e)}},eC={},eE=(0,_.createStyleRegistry)(),eL={ampFirst:!0===j.amp,hasQuery:!!i.amp,hybrid:"hybrid"===j.amp},eO=function(e){let{ampFirst:t=!1,hybrid:r=!1,hasQuery:n=!1}=void 0===e?{}:e;return t||r&&n}(eL),eI=function(e){void 0===e&&(e=!1);let t=[(0,y.jsx)("meta",{charSet:"utf-8"})];return e||t.push((0,y.jsx)("meta",{name:"viewport",content:"width=device-width"})),t}(eO),eH=[],ez={};ey&&(ez.beforeInteractive=[].concat(ey()).filter(e=>"beforeInteractive"===e.props.strategy).map(e=>e.props));let eB=({children:e})=>(0,y.jsx)(eq.Provider,{value:e_,children:(0,y.jsx)(eN.Provider,{value:eP.isReady&&eP.query?new URL(eP.asPath,"http://n").searchParams:new URLSearchParams,children:(0,y.jsx)(eF,{router:eP,isAutoExport:eS,children:(0,y.jsx)(eA.Provider,{value:function(e){if(!e.isReady||!e.query)return null;let t={};for(let r of Object.keys(function(e){let{parameterizedRoute:t,groups:r}=function(e){let t=el(e).slice(1).split("/"),r={},n=1;return{parameterizedRoute:t.map(e=>{let t=U.find(t=>e.startsWith(t)),o=e.match(eM);if(t&&o){let{key:e,optional:s,repeat:a}=eD(o[1]);return r[e]={pos:n++,repeat:a,optional:s},"/"+ek(t)+"([^/]+?)"}if(!o)return"/"+ek(e);{let{key:e,repeat:t,optional:s}=eD(o[1]);return r[e]={pos:n++,repeat:t,optional:s},t?s?"(?:/(.+?))?":"/(.+?)":"/([^/]+?)"}}).join(""),groups:r}}(e);return{re:RegExp("^"+t+"(?:/)?$"),groups:r}}(e.pathname).groups))t[r]=e.query[r];return t}(eP),children:(0,y.jsx)(z.Provider,{value:eP,children:(0,y.jsx)(L.Provider,{value:eL,children:(0,y.jsx)(A.Provider,{value:{updateHead:e=>{eI=e},updateScripts:e=>{eC=e},scripts:ez,mountedInstances:new Set},children:(0,y.jsx)(O.Provider,{value:e=>eH.push(e),children:(0,y.jsx)(_.StyleRegistry,{registry:eE,children:(0,y.jsx)(ej.Provider,{value:Y,children:e})})})})})})})})})}),eU=()=>null,eG=({children:e})=>(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(eU,{}),(0,y.jsx)(eB,{children:(0,y.jsxs)(y.Fragment,{children:[S?(0,y.jsxs)(y.Fragment,{children:[e,(0,y.jsx)(eU,{})]}):e,(0,y.jsx)(eU,{})]})})]}),eK={err:b,req:eS?void 0:n,res:eS?void 0:s,pathname:a,query:i,asPath:ew,locale:l.locale,locales:l.locales,defaultLocale:l.defaultLocale,AppTree:e=>(0,y.jsx)(eG,{children:eQ(ea,ec,{...e,router:eP})}),defaultGetInitialProps:async(e,t={})=>{let{html:r,head:n}=await e.renderPage({enhanceApp:e=>t=>(0,y.jsx)(e,{...t})}),o=eE.styles({nonce:t.nonce});return eE.flush(),{html:r,head:n,styles:o}}},e0=!em&&(l.nextExport||S&&(eS||ep)),e1=()=>{let e=eE.styles();return eE.flush(),(0,y.jsx)(y.Fragment,{children:e})};if(m=await X(ea,{AppTree:eK.AppTree,Component:ec,router:eP,ctx:eK}),(em||M)&&f&&(m.__N_PREVIEW=!0),em&&(m[R.NO]=!0),em&&!ep){let e,t;try{e=await (0,en.getTracer)().trace(eo.xj.getStaticProps,{spanName:`getStaticProps ${a}`,attributes:{"next.route":a}},()=>I({...ex?{params:i}:void 0,...f?{draftMode:!0,preview:!0,previewData:h}:void 0,locales:l.locales,locale:l.locale,defaultLocale:l.defaultLocale,revalidateReason:l.isOnDemandRevalidate?"on-demand":ef?"build":"stale"}))}catch(e){throw e&&"ENOENT"===e.code&&delete e.code,e}if(null==e)throw Error(C.q6);let r=Object.keys(e).filter(e=>"revalidate"!==e&&"props"!==e&&"redirect"!==e&&"notFound"!==e);if(r.includes("unstable_revalidate"))throw Error(C.Eo);if(r.length)throw Error(eZ("getStaticProps",r));if("notFound"in e&&e.notFound){if("/404"===a)throw Error('The /404 page can not return notFound in "getStaticProps", please remove it to continue!');v.isNotFound=!0}if("redirect"in e&&e.redirect&&"object"==typeof e.redirect){if(eY(e.redirect,n,"getStaticProps"),ef)throw Error(`\`redirect\` can not be returned from getStaticProps during prerendering (${n.url})
See more info here: https://nextjs.org/docs/messages/gsp-redirect-during-prerender`);e.props={__N_REDIRECT:e.redirect.destination,__N_REDIRECT_STATUS:er(e.redirect)},void 0!==e.redirect.basePath&&(e.props.__N_REDIRECT_BASE_PATH=e.redirect.basePath),v.isRedirect=!0}if((S||ef)&&!v.isNotFound&&!N(a,"getStaticProps",e.props))throw Error("invariant: getStaticProps did not return valid props. Please report this.");if("revalidate"in e){if(e.revalidate&&"export"===l.nextConfigOutput)throw Error('ISR cannot be used with "output: export". See more info here: https://nextjs.org/docs/advanced-features/static-html-export');if("number"==typeof e.revalidate){if(Number.isInteger(e.revalidate)){if(e.revalidate<=0)throw Error(`A page's revalidate option can not be less than or equal to zero for ${n.url}. A revalidate option of zero means to revalidate after _every_ request, and implies stale data cannot be tolerated.
...
Try changing the value to '${Math.ceil(e.revalidate)}' or using \`Math.ceil()\` if you're computing the value.`)}else if(!0===e.revalidate)t=1;else if(!1===e.revalidate||void 0===e.revalidate)t=!1;else throw Error(`A page's revalidate option must be seconds expressed as a natural number. Mixed numbers and strings cannot be used. Received '${JSON.stringify(e.revalidate)}' for ${n.url}`)}else t=!1;if(m.pageProps=Object.assign({},m.pageProps,"props"in e?e.props:void 0),v.revalidate=t,v.pageData=m,v.isNotFound)return new eR(null,{metadata:v})}if(M&&(m[R.uY]=!0),M&&!ep){let e;let t=!1;try{e=await (0,en.getTracer)().trace(eo.xj.getServerSideProps,{spanName:`getServerSideProps ${a}`,attributes:{"next.route":a}},async()=>M({req:n,res:s,query:i,resolvedUrl:l.resolvedUrl,...ex?{params:F}:void 0,...!1!==h?{draftMode:!0,preview:!0,previewData:h}:void 0,locales:l.locales,locale:l.locale,defaultLocale:l.defaultLocale}))}catch(e){throw"object"==typeof e&&null!==e&&"name"in e&&"message"in e&&"ENOENT"===e.code&&delete e.code,e}if(null==e)throw Error(C.Lx);e.props instanceof Promise&&(t=!0);let r=Object.keys(e).filter(e=>"props"!==e&&"redirect"!==e&&"notFound"!==e);if(e.unstable_notFound)throw Error(`unstable_notFound has been renamed to notFound, please update the field to continue. Page: ${a}`);if(e.unstable_redirect)throw Error(`unstable_redirect has been renamed to redirect, please update the field to continue. Page: ${a}`);if(r.length)throw Error(eZ("getServerSideProps",r));if("notFound"in e&&e.notFound){if("/404"===a)throw Error('The /404 page can not return notFound in "getStaticProps", please remove it to continue!');return v.isNotFound=!0,new eR(null,{metadata:v})}if("redirect"in e&&"object"==typeof e.redirect&&(eY(e.redirect,n,"getServerSideProps"),e.props={__N_REDIRECT:e.redirect.destination,__N_REDIRECT_STATUS:er(e.redirect)},void 0!==e.redirect.basePath&&(e.props.__N_REDIRECT_BASE_PATH=e.redirect.basePath),v.isRedirect=!0),t&&(e.props=await e.props),(S||ef)&&!N(a,"getServerSideProps",e.props))throw Error("invariant: getServerSideProps did not return valid props. Please report this.");m.pageProps=Object.assign({},m.pageProps,e.props),v.pageData=m}if(D&&!em||v.isRedirect)return new eR(JSON.stringify(m),{metadata:v});if(ep&&(m.pageProps={}),V(s)&&!em)return new eR(null,{metadata:v});let e4=E;if(eS&&ex){let e;let t=(e=(function(e){let t=/^\/index(\/|$)/.test(e)&&!J(e)?"/index"+e:"/"===e?"/index":B(e);{let{posix:e}=r("path"),n=e.normalize(t);if(n!==t)throw new Q("Requested and resolved page mismatch: "+t+" "+n)}return t})(a).replace(/\\/g,"/")).startsWith("/index/")&&!J(e)?e.slice(6):"/index"!==e?e:"/";t in e4.pages&&(e4={...e4,pages:{...e4.pages,[t]:[...e4.pages[t],...e4.lowPriorityFiles.filter(e=>e.includes("_buildManifest"))]},lowPriorityFiles:e4.lowPriorityFiles.filter(e=>!e.includes("_buildManifest"))})}let e2=({children:e})=>eO?e:(0,y.jsx)("div",{id:"__next",children:e}),e3=async()=>{let e,t;async function r(e){let t=async(t={})=>{if(eK.err&&$)return e&&e(ea,ec),{html:await eV((0,y.jsx)(e2,{children:(0,y.jsx)($,{error:eK.err})})),head:eI};if(S&&(m.router||m.Component))throw Error("'router' and 'Component' can not be returned in getInitialProps from _app.js https://nextjs.org/docs/messages/cant-override-next-props");let{App:r,Component:n}="function"==typeof t?{App:ea,Component:t(ec)}:{App:t.enhanceApp?t.enhanceApp(ea):ea,Component:t.enhanceComponent?t.enhanceComponent(ec):ec},o=await e(r,n);return await o.allReady,{html:await ei(o),head:eI}},r={...eK,renderPage:t},n=await X(eu,r);if(V(s)&&!em)return null;if(!n||"string"!=typeof n.html)throw Error(`"${G(eu)}.getInitialProps()" should resolve to an object with a "html" prop set with a valid html string`);return{docProps:n,documentCtx:r}}eu[R.wU];let n=(e,t)=>{let r=e||ea,n=t||ec;return eK.err&&$?(0,y.jsx)(e2,{children:(0,y.jsx)($,{error:eK.err})}):(0,y.jsx)(e2,{children:(0,y.jsx)(eG,{children:eQ(r,n,{...m,router:eP})})})},o=async(e,t)=>{let r=n(e,t);return await function({ReactDOMServer:e,element:t,streamOptions:r}){return(0,en.getTracer)().trace(eo.k0.renderToReadableStream,async()=>e.renderToReadableStream(t,r))}({ReactDOMServer:P(),element:r})},a=!!eu.getInitialProps,[i,l]=await Promise.all([eV(e1()),(async()=>{if(a){if(null===(e=await r(o)))return null;let{docProps:t}=e;return t.html}{e={};let t=await o(ea,ec);return await t.allReady,ei(t)}})()]);if(null===l)return null;let{docProps:d}=e||{};return a?(t=d.styles,eI=d.head):(t=eE.styles(),eE.flush()),{contentHTML:i+l,documentElement:e=>(0,y.jsx)(eu,{...e,...d}),head:eI,headTags:[],styles:t}};null==(u=(0,en.getTracer)().getRootSpanAttributes())||u.set("next.route",l.page);let e8=await (0,en.getTracer)().trace(eo.xj.renderDocument,{spanName:`render route (pages) ${l.page}`,attributes:{"next.route":l.page}},async()=>e3());if(!e8)return new eR(null,{metadata:v});let e9=new Set,e6=new Set;for(let e of eH){let t=T[e];t&&(e9.add(t.id),t.files.forEach(e=>{e6.add(e)}))}let e7=eL.hybrid,{assetPrefix:e5,buildId:te,customServer:tt,defaultLocale:tr,disableOptimizedLoading:tn,domainLocales:to,locale:ts,locales:ta,runtimeConfig:ti}=l,tl={__NEXT_DATA__:{props:m,page:a,query:i,buildId:te,assetPrefix:""===e5?void 0:e5,runtimeConfig:ti,nextExport:!0===e0||void 0,autoExport:!0===eS||void 0,isFallback:ep,isExperimentalCompile:et,dynamicIds:0===e9.size?void 0:Array.from(e9),err:l.err?(p=l.err,S?(g="server",g=p[eW]||"server",{name:p.name,source:g,message:eT()(p.message),stack:p.stack,digest:p.digest}):{name:"Internal Server Error.",message:"500 - Internal Server Error.",statusCode:500}):void 0,gsp:!!I||void 0,gssp:!!M||void 0,customServer:tt,gip:!!ev||void 0,appGip:!eg||void 0,locale:ts,locales:ta,defaultLocale:tr,domainLocales:to,isPreview:!0===f||void 0,notFoundSrcPage:eh&&S?eh:void 0},strictNextHead:l.strictNextHead,buildManifest:e4,docComponentsRendered:{},dangerousAsPath:eP.asPath,canonicalBase:!l.ampPath&&ee(n,"didStripLocale")?`${l.canonicalBase||""}/${l.locale}`:l.canonicalBase,ampPath:w,inAmpMode:eO,isDevelopment:!!S,hybridAmp:e7,dynamicImports:Array.from(e6),assetPrefix:e5,unstable_runtimeJS:j.unstable_runtimeJS,unstable_JsPreload:j.unstable_JsPreload,assetQueryString:ed,scriptLoader:eC,locale:ts,disableOptimizedLoading:tn,head:e8.head,headTags:e8.headTags,styles:e8.styles,crossOrigin:l.crossOrigin,optimizeCss:l.optimizeCss,optimizeFonts:l.optimizeFonts,nextConfigOutput:l.nextConfigOutput,nextScriptWorkers:l.nextScriptWorkers,runtime:K,largePageDataBytes:l.largePageDataBytes,nextFontManifest:l.nextFontManifest},td=(0,y.jsx)(L.Provider,{value:eL,children:(0,y.jsx)(Z.Provider,{value:tl,children:e8.documentElement(tl)})}),tu=await (0,en.getTracer)().trace(eo.xj.renderToString,async()=>eV(td)),[tc,tp]=tu.split("<next-js-internal-body-render-target></next-js-internal-body-render-target>",2),th="";tu.startsWith(eJ)||(th+=eJ),th+=tc,eO&&(th+="<!-- __NEXT_DATA__ -->");let tm=th+e8.contentHTML+tp;return new eR(await o(a,tm,l,{inAmpMode:eO,hybridAmp:e7}),{metadata:v})}let e0=(e,t,r,n,o)=>eK(e,t,r,n,o,o),e1=S().createContext(null);function e4(e){let t=(0,b.useContext)(e1);t&&t(e)}class e2 extends v{constructor(e){super(e),this.components=e.components}render(e,t,r){return eK(e,t,r.page,r.query,r.renderOpts,{App:this.components.App,Document:this.components.Document})}}let e3={contexts:g},e8=e2})(),module.exports=n})();
