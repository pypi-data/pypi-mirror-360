...
if __name__ == '__main__':
    b_largefile_in_dir(r'E:\byzh_workingplace\byzh-rc-to-pypi', console_log=True)
    b_largedir_in_dir(r'E:\byzh_workingplace\byzh-rc-to-pypi', want=10, console_log=True)