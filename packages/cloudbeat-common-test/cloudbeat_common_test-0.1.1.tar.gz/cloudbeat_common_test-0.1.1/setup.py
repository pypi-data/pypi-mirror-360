...
setup(
    name=PACKAGE,
    version="0.1.1",  # Hardcoded version here
    ...
    packages=["cloudbeat_common_test"],
    package_dir={"cloudbeat_common_test": 'src'},
    install_requires=install_requires,
    py_modules=['cloudbeat', 'cloudbeat_common_test'],
    python_requires='>=3.6',
