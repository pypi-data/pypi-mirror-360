    ...
    if t_8((undefined(name='management_ssh') if l_0_management_ssh is missing else l_0_management_ssh)):
        ...
        if t_8(environment.getattr((undefined(name='management_ssh') if l_0_management_ssh is missing else l_0_management_ssh), 'vrfs')):
            ...
            for l_1_vrf in t_2(environment.getattr((undefined(name='management_ssh') if l_0_management_ssh is missing else l_0_management_ssh), 'vrfs')):
                l_1__vrf_default_ = resolve('_vrf_default_')
                ...
                if (environment.getattr(l_1_vrf, 'name') == 'default'):
                    pass
                    if not isinstance(l_1__vrf_default_, Namespace):
                        raise TemplateRuntimeError("cannot assign attribute on non-namespace object")
                    l_1__vrf_default_['enable'] = t_1(environment.getattr(l_1_vrf, 'enable'), environment.getattr((undefined(name='_vrf_default') if l_0__vrf_default is missing else l_0__vrf_default), 'enable'))
                else:
                    pass
                    ...
                    yield ' |\n'
            l_1_vrf = l_1__vrf_default_ = l_1__ipv4_acl = l_1__ipv6_acl = missing
...
blocks = {}
debug_info = '7=73&15=76&16=78&17=80&18=86&19=90&21=93&22=97&24=98&25=100&26=103&30=112&31=114&32=117&33=123&39=126&40=128&42=133&44=136&45=140&52=145&53=147&54=149&55=151&56=153&57=155&58=157&59=160&64=174'