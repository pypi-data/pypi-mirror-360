...
from cciplus_ado.vcs.ado.adapter import (
    ADOBranch,
    ADOComparison,
    ADOPullRequest,
    ADORef,
...
@pytest.fixture
@patch("cciplus_ado.vcs.ado.adapter.parse_repo_url")  # Patching the utility function
...
class TestADORepositoryInitAndProperties:
    ...
    def test_successful_initialization(self, ado_connection, mock_project_config):
        ...
        with patch("cciplus_ado.vcs.ado.adapter.parse_repo_url") as mock_parse:
    ...
    @patch("cciplus_ado.vcs.ado.adapter.parse_repo_url")
