...
from cciplus_ado.vcs.ado.adapter import ADORepository
from cciplus_ado.vcs.ado.exceptions import ADOApiNotFoundError
...
def get_ado_repo(project_config, url) -> ADORepository:
    from cciplus_ado.vcs.ado.service import VCSService, get_ado_service_for_url
...
class ADODependencyPin(base_dependency.VcsDependencyPin):
    ...
    def vcsTagResolver(self):  # -> Type["AbstractTagResolver"]:
        from cciplus_ado.vcs.ado.dependencies.ado_resolvers import (  # Circular imports
            ADOTagResolver,
        )
