...
def show_help():
    ...
    print("It's not a standalone application, but extends CumulusCI Plus's functionality.")
    print()
    print("Commands:")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="CumulusCI Plus Azure DevOps Plugin CLI",
        prog="cumulusci-ado"
    )
    parser.add_argument(
        "command",
