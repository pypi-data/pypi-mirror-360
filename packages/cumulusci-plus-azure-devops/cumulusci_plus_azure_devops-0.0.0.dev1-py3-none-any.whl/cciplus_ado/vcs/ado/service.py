...
from cciplus_ado.utils.ado import parse_repo_url

if TYPE_CHECKING:
    from cciplus_ado.vcs.ado import ADORelease, ADORepository
    from cciplus_ado.vcs.ado.dependencies.ado_dependencies import ADODynamicDependency
    from cciplus_ado.vcs.ado.generator import (
...
class AzureDevOpsService(VCSService):
    ...
    def dynamic_dependency_class(self) -> Type["ADODynamicDependency"]:
        ...
        from cciplus_ado.vcs.ado.dependencies.ado_dependencies import (
    ...
    def get_repository(self, options: dict = {}) -> Optional["ADORepository"]:
        ...
        if self._repo is None:
            from cciplus_ado.vcs.ado import ADORepository
    ...
    def release_notes_generator(self, options: dict) -> "ADOReleaseNotesGenerator":
        from cciplus_ado.vcs.ado.generator import ADOReleaseNotesGenerator
    ...
    def parent_pr_notes_generator(
        ...
        from cciplus_ado.vcs.ado.generator import ADOParentPullRequestNotesGenerator
