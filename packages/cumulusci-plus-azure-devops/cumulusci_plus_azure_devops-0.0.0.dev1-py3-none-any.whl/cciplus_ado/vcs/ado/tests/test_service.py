...
from cciplus_ado.vcs.ado import ADORepository, AzureDevOpsService
...
class TestAzureDevOpsService:
    @pytest.fixture
    @mock.patch("cciplus_ado.vcs.ado.AzureDevOpsService.get_api_connection")
    ...
    @mock.patch("cciplus_ado.vcs.ado.AzureDevOpsService._authenticate")
    @mock.patch("cciplus_ado.vcs.ado.AzureDevOpsService.validate_duplicate_service")
    ...
    @mock.patch(
        "cciplus_ado.vcs.ado.AzureDevOpsService._authenticate",
        side_effect=Exception("Auth boom!"),
    )
    @mock.patch(
        "cciplus_ado.vcs.ado.AzureDevOpsService.validate_duplicate_service",
        return_value=True,
    )
    ...
    @mock.patch("cciplus_ado.vcs.ado.ADORepository")  # Patch the ADORepository class
