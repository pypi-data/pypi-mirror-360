...
import_global("cciplus_ado.vcs.ado.service.AzureDevOpsService")

VCSSource.register(
    "azure_devops", "cciplus_ado.vcs.ado.source.azure_devops.ADOSource"
)

from cciplus_ado.vcs.ado.dependencies.ado_dependencies import VCS_ADO as dep
from cciplus_ado.vcs.ado.dependencies.ado_resolvers import VCS_ADO as res
