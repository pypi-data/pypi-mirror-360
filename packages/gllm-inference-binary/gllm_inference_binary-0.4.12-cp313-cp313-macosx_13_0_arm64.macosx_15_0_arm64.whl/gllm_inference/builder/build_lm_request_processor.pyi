...
def build_lm_request_processor(model_id: str | ModelId, credentials: str | dict[str, Any] | None = None, config: dict[str, Any] | None = None, system_template: str = '', user_template: str = '', output_parser: BaseOutputParser | None = None) -> LMRequestProcessor:
    ...
    Args:
        model_id (str | ModelId): The model id, can either be a ModelId instance or a string in the following format:
            ...
            5. For other providers: `provider/model-name`.
        ...
        user_template (str): The user prompt template. May contain placeholders enclosed in curly braces `{}`.
            Defaults to an empty string.
        output_parser (BaseOutputParser | None, optional): An optional parser to process the model\'s output.
            Defaults to None.
