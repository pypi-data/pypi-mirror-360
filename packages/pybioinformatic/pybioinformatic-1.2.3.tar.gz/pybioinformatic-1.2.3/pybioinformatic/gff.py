...
from typing import Union, List, Dict, Tuple, Generator, Any
...
# Basic method==========================================================================================================
    ...
    def to_dataframe(self) -> DataFrame:
        chunk_size = self.line_num if self.line_num < 10**6 else 500000
        filepath_or_buffer = self.name if self.name.endswith('gz') else self.__open
...
# GFF file sorted by id method==========================================================================================
    ...
    def __sort(line: str) -> tuple:
        ...
        try:
            ...
            Parent = ID
        if feature == 'gene':
            return chromosome, Parent, ID, start, end
        elif feature == 'mRNA':
            return chromosome, Parent, ID, start, end
        else:
            Parent = sub('.\d+$', '', Parent)
