...
"""Usage from the repo root folder:
    ...
    .. code-block:: python
        ...
        # for whole test
        python -m unittest tests.test_metadatas_noGeo
        # for specific
        python -m unittest tests.test_metadatas_noGeo.TestMetadatasNoGeo.test_metadatas_create
...
class TestMetadatasNoGeo(unittest.TestCase):
    ...
    def test_metadatas_update(self):
        ...
        metadata_toUpdate.geoContext = "Test geographic context"
        ...
        self.assertEqual(updated_metadata.geoContext, "Test geographic context")
