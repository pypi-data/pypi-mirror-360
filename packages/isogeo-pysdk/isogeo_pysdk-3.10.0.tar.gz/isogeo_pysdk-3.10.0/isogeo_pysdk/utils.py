...
class IsogeoUtils(object):
    ...
    def set_base_url(self, platform: str = "prod", dict_urls: dict = {}):
        ...
        if platform == "prod":
            ...
            raise ValueError(
                3,
                "Platform must be one of: {}".format(
                    " | ".join(["prod", "qa", "custom"])
                ),
            )
    ...
    def get_isogeo_version(self, component: str = "api", prot: str = "https"):
        ...
        if component == "api":
            ...
            version_url = "{}://{}/about/database".format(prot, self.api_url)
        elif component == "app":
    ...
    def get_request_base_url(
        self, route: str, prot: str = "https", lang: str = None
    ) -> str:
        ...
        return "{}://{}/{}/?_lang={}".format(prot, self.api_url, route, lang_code)
