    ...
    while line != "}\n":
        ...
        if val:
            ...
            if name and position == 0:
                ...
                enums.append(
                    (name.group("name"), enums[position - 1][0] + " + 1")
                )  # Prev. var. + 1
...
def struct_writer(infile):
    ...
    types = {
        ...
        "uns16": "ctypes.c_uint16",
        "uns64": "ctypes.c_uint64",
        "uns8": "ctypes.c_uint8",
        "int32": "ctypes.c_int32",
        "int16": "ctypes.c_int16",
        "int64": "ctypes.c_int64",
        "int8": "ctypes.c_int8",
        "long64": "ctypes.c_long",
        "char*": "ctypes.c_char_p",
        "void*": "ctypes.c_void_p",
        "flt64": "ctypes.c_float",
        "rs_bool": "ctypes.c_short",
        "char": "ctypes.c_char",
        "void": "ctypes.c_void_p",
    }
...
###############################################################################\n""".format(
    ...
    try:
        ...
        print(
            pvcam + " not found. Make sure that the PVCAM SDK is installed "
            "on this machine."
        )
        exit(-1)
