...
def catch_invalid_isea4t_id(f: Callable) -> Callable:
    """Wrapper that catches potential invalid isea4t ID.
    ...
    def safe_f(*args, **kwargs):
        try:
            ...
            message = "isea4t method raised an error. Is the isea4t ID correct?"
...
def doc_standard(column_name: str, description: str) -> Callable:
    """Wrapper to provide a standard apply-to-isea4t-id docstring"""
    ...
    def doc_decorator(f):
        ...
        doc = f"""Adds the column `{column_name}` {description}. Assumes isea4t ID.
        {parameters}
        Returns
        -------
        ...
        ------
        ValueError
            When an invalid isea4t address is encountered
        """
