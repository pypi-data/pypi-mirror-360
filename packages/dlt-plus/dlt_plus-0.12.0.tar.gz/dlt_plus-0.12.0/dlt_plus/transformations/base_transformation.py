...
from dlt_plus.transformations.const import PROCESSED_LOAD_IDS_TABLE
from dlt_plus.cache.cache import Cache


from dlt_plus.transformations.config import TransformationConfig, set_defaults_and_validate
...
class Transformation:
    ...
    def populate_state(self) -> None:
        ...
        process_loads_relation = self.state_output_pipeline.dataset()(
            f"SELECT * FROM {PROCESSED_LOAD_IDS_TABLE}", normalize_query=False
        )
