...
from frogml.core.clients.build_management.client import BuildsManagementClient
...
from frogml.sdk.frogml_client.projects.project import Project
...
class FrogMLClient:
    ...
    @lru_cache(maxsize=1)
    def _get_project_management(self) -> ProjectsManagementClient:
    ...
    @lru_cache(maxsize=1)
    def _get_build_management(self) -> BuildsManagementClient:
    ...
    def get_model(self, model_id: str) -> Optional[Model]:
        ...
        Returns:
             Optional[BaseModel]: Model by ID.

        """
        return BaseModel.from_proto(
    ...
    def list_model_metadata(self, project_id: str) -> List[ModelMetadata]:
        ...
        for metadata_source in model_metadata_from_service:
            ...
            model_metadata.model = BaseModel.from_proto(metadata_source.model)
    ...
    def build_model(
        ...
        prebuilt_frogml_model: Optional[Model] = None,
