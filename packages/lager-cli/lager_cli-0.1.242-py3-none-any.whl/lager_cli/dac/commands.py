"""
    ...
    DAC (digital/analog converter) commands
"""
...
def dac(ctx, gateway, dut, net, voltage):
    """
        Set the digital-analog convertor for a net for the DUT. Value is in volts
    """
