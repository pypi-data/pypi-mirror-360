...
class EigenSystemHReal:
    ...
    @eigenvalues.setter
    def eigenvalues(self, arg: Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')], /) -> None: ...
...
class Sorting:
    ...
    @property
    def matrix(self) -> "Eigen::PermutationMatrix<-1,-1,int>": ...

    @matrix.setter
    def matrix(self, arg: "Eigen::PermutationMatrix<-1,-1,int>", /) -> None: ...
...
class BasisBasisAtomReal(TransformationBuilderInterfaceReal):
    ...
    @overload
    def get_amplitudes(self, arg: KetAtom, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...

    @overload
    def get_amplitudes(self, arg: BasisAtomReal, /) -> scipy.sparse.csr_matrix[float]: ...

    @overload
    def get_overlaps(self, arg: KetAtom, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...

    @overload
    def get_overlaps(self, arg: BasisAtomReal, /) -> scipy.sparse.csr_matrix[float]: ...

    @overload
    def get_matrix_elements(self, arg0: KetAtom, arg1: OperatorType, arg2: int, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...
...
class BasisBasisAtomComplex(TransformationBuilderInterfaceComplex):
    ...
    @overload
    def get_amplitudes(self, arg: KetAtom, /) -> Annotated[ArrayLike, dict(dtype='complex128', shape=(None), order='C')]: ...
    ...
    @overload
    def get_matrix_elements(self, arg0: KetAtom, arg1: OperatorType, arg2: int, /) -> Annotated[ArrayLike, dict(dtype='complex128', shape=(None), order='C')]: ...
...
class BasisBasisPairReal(TransformationBuilderInterfaceReal):
    ...
    @overload
    def get_amplitudes(self, arg: KetPairReal, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...

    @overload
    def get_amplitudes(self, arg: BasisPairReal, /) -> scipy.sparse.csr_matrix[float]: ...

    @overload
    def get_overlaps(self, arg: KetPairReal, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...

    @overload
    def get_overlaps(self, arg: BasisPairReal, /) -> scipy.sparse.csr_matrix[float]: ...

    @overload
    def get_matrix_elements(self, arg0: KetPairReal, arg1: OperatorType, arg2: int, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...
...
class BasisBasisPairComplex(TransformationBuilderInterfaceComplex):
    ...
    @overload
    def get_amplitudes(self, arg: KetPairComplex, /) -> Annotated[ArrayLike, dict(dtype='complex128', shape=(None), order='C')]: ...

    @overload
    def get_amplitudes(self, arg: BasisPairComplex, /) -> scipy.sparse.csr_matrix[complex]: ...

    @overload
    def get_overlaps(self, arg: KetPairComplex, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...

    @overload
    def get_overlaps(self, arg: BasisPairComplex, /) -> scipy.sparse.csr_matrix[float]: ...

    @overload
    def get_matrix_elements(self, arg0: KetPairComplex, arg1: OperatorType, arg2: int, /) -> Annotated[ArrayLike, dict(dtype='complex128', shape=(None), order='C')]: ...
...
class BasisPairReal(BasisBasisPairReal):
    @overload
    def get_amplitudes(self, arg0: KetAtom, arg1: KetAtom, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...

    @overload
    def get_amplitudes(self, arg0: BasisAtomReal, arg1: BasisAtomReal, /) -> scipy.sparse.csr_matrix[float]: ...

    @overload
    def get_overlaps(self, arg0: KetAtom, arg1: KetAtom, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...
    ...
    @overload
    def get_matrix_elements(self, arg0: KetPairReal, arg1: OperatorType, arg2: OperatorType, arg3: int, arg4: int, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...

    @overload
    def get_matrix_elements(self, arg0: KetAtom, arg1: KetAtom, arg2: OperatorType, arg3: OperatorType, arg4: int, arg5: int, /) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...

class BasisPairComplex(BasisBasisPairComplex):
    @overload
    def get_amplitudes(self, arg0: KetAtom, arg1: KetAtom, /) -> Annotated[ArrayLike, dict(dtype='complex128', shape=(None), order='C')]: ...
    ...
    @overload
    def get_matrix_elements(self, arg0: KetPairComplex, arg1: OperatorType, arg2: OperatorType, arg3: int, arg4: int, /) -> Annotated[ArrayLike, dict(dtype='complex128', shape=(None), order='C')]: ...

    @overload
    def get_matrix_elements(self, arg0: KetAtom, arg1: KetAtom, arg2: OperatorType, arg3: OperatorType, arg4: int, arg5: int, /) -> Annotated[ArrayLike, dict(dtype='complex128', shape=(None), order='C')]: ...
...
class SystemSystemAtomReal(TransformationBuilderInterfaceReal):
    ...
    def get_eigenenergies(self) -> Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')]: ...
...
class GreenTensorReal:
    ...
    @overload
    def create_entries_from_cartesian(self, arg0: int, arg1: int, arg2: Annotated[ArrayLike, dict(dtype='float64', shape=(None, None), order='F')], /) -> None: ...

    @overload
    def create_entries_from_cartesian(self, arg0: int, arg1: int, arg2: Sequence[Annotated[ArrayLike, dict(dtype='float64', shape=(None, None), order='F')]], arg3: Sequence[float], /) -> None: ...
...
class GreenTensorComplex:
    ...
    @overload
    def create_entries_from_cartesian(self, arg0: int, arg1: int, arg2: Annotated[ArrayLike, dict(dtype='complex128', shape=(None, None), order='F')], /) -> None: ...

    @overload
    def create_entries_from_cartesian(self, arg0: int, arg1: int, arg2: Sequence[Annotated[ArrayLike, dict(dtype='complex128', shape=(None, None), order='F')]], arg3: Sequence[float], /) -> None: ...

    def get_spherical_entries(self, arg0: int, arg1: int, /) -> list[Union[ConstantEntryComplex, OmegaDependentEntryComplex]]: ...

def run_unit_tests(arg0: bool, arg1: bool, arg2: str | os.PathLike, /) -> int: ...
