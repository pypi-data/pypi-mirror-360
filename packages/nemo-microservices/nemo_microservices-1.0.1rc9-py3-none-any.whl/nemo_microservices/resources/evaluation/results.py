...
from ...types.evaluation import result_list_params, result_create_params, result_update_params
...
from ...types.evaluation.task_result_input_param import TaskResultInputParam
from ...types.evaluation.group_result_input_param import GroupResultInputParam
...
class ResultsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        groups: Dict[str, GroupResultInputParam] | NotGiven = NOT_GIVEN,
        namespace: str | NotGiven = NOT_GIVEN,
        ownership: Ownership | NotGiven = NOT_GIVEN,
        project: str | NotGiven = NOT_GIVEN,
        tasks: Dict[str, TaskResultInputParam] | NotGiven = NOT_GIVEN,
