...
from ...types.customization_config_output import CustomizationConfigOutput
from ...types.training_pod_spec_input_param import TrainingPodSpecInputParam
...
class ConfigsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        pod_spec: TrainingPodSpecInputParam | NotGiven = NOT_GIVEN,
        ...
        Args:
          ...
          chat_prompt_template: Chat Prompt Template to apply to the model to make it compatible with chat
              datasets
        ...
        return self._post(
            ...
            cast_to=CustomizationConfigOutput,
        )
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> SyncDefaultPagination[CustomizationConfigOutput]:
        """
        ...
        return self._get_api_list(
            "/v1/customization/configs",
            page=SyncDefaultPagination[CustomizationConfigOutput],
            options=make_request_options(
            ...
            model=CustomizationConfigOutput,
        )
...
class AsyncConfigsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[CustomizationConfigOutput, AsyncDefaultPagination[CustomizationConfigOutput]]:
        """
        List available customization configs.
        ...
        return self._get_api_list(
            "/v1/customization/configs",
            page=AsyncDefaultPagination[CustomizationConfigOutput],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
