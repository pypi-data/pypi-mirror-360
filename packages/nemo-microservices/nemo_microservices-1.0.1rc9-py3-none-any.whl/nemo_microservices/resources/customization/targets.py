...
from ...types.customization.customization_target_output import CustomizationTargetOutput
...
class TargetsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=CustomizationTargetOutput,
        )
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> SyncDefaultPagination[CustomizationTargetOutput]:
        """
        ...
        return self._get_api_list(
            "/v1/customization/targets",
            page=SyncDefaultPagination[CustomizationTargetOutput],
            options=make_request_options(
            ...
            model=CustomizationTargetOutput,
        )
...
class AsyncTargetsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[CustomizationTargetOutput, AsyncDefaultPagination[CustomizationTargetOutput]]:
        """
        List available customization targets.
        ...
        return self._get_api_list(
            "/v1/customization/targets",
            page=AsyncDefaultPagination[CustomizationTargetOutput],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
