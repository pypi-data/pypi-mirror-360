...
from ...types.guardrail import model_list_params
from ...types.guardrail.models_response import ModelsResponse
...
class ModelsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        Return list of models registered in the Global Config Registry in OpenAI format
        as below { "object": "list", "data": [ { "id":
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"response_model": response_model}, model_list_params.ModelListParams),
            ),
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                query=await async_maybe_transform(
                    {"response_model": response_model}, model_list_params.ModelListParams
                ),
            ),
            cast_to=ModelsResponse,
        )
