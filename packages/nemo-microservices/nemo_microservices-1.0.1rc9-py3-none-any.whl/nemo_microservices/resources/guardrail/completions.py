...
from ...types.guardrail import completion_create_params
from ...types.guardrails_data_input_param import GuardrailsDataInputParam
from ...types.guardrail.guardrail_completion_response import GuardrailCompletionResponse
from ...types.guardrail.guardrail_completion_stream_response import GuardrailCompletionStreamResponse
...
class CompletionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        guardrails: GuardrailsDataInputParam | NotGiven = NOT_GIVEN,
        ...
        prompt: Union[Iterable[int], Iterable[Iterable[int]], str, List[str]] | NotGiven = NOT_GIVEN,
    ...
    def create(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> Stream[GuardrailCompletionStreamResponse]:
        """
        Chat completion for the provided conversation.
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=GuardrailCompletionResponse,
            stream=stream or False,
            stream_cls=Stream[GuardrailCompletionStreamResponse],
        )
...
class AsyncCompletionsResource(AsyncAPIResource):
    ...
    async def create(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncStream[GuardrailCompletionStreamResponse]:
        """
        Chat completion for the provided conversation.
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            ...
            cast_to=GuardrailCompletionResponse,
            stream=stream or False,
            stream_cls=AsyncStream[GuardrailCompletionStreamResponse],
        )
