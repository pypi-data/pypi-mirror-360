...
from .customization_target_input_param import CustomizationTargetInputParam
from .customization_training_option_param import CustomizationTrainingOptionParam

__all__ = ["CustomizationConfigInputParam", "Target"]

Target: TypeAlias = Union[str, CustomizationTargetInputParam]


class CustomizationConfigInputParam(TypedDict, total=False):
