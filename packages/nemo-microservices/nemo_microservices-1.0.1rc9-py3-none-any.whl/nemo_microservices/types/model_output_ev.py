...
from .shared.guardrail_config_output import GuardrailConfigOutput
from .shared.parameter_efficient_finetuning_data import ParameterEfficientFinetuningData

__all__ = ["ModelOutputEv"]


class ModelOutputEv(BaseModel):
    ...
    base_model: Union[str, object, None] = None
    ...
    guardrails: Optional[GuardrailConfigOutput] = None
