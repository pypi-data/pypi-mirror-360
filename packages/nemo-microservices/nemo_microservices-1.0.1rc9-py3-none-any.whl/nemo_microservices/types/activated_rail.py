...
class ActivatedRail(BaseModel):
    ...
    """
    A sequence of decisions made by the rail, e.g., 'bot refuse to respond', 'stop',
    'continue'.
    """
    ...
    Some rails are applied instantly, e.g., dialog rails, so they don't have a
    duration.
    """
