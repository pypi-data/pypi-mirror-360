...
from ..task_config_output import TaskConfigOutput
from ..group_config_output import GroupConfigOutput

__all__ = ["EvaluationConfigOutput"]


class EvaluationConfigOutput(BaseModel):
    type: str
    """
    ...
    groups: Optional[Dict[str, GroupConfigOutput]] = None
    ...
    tasks: Optional[Dict[str, TaskConfigOutput]] = None
    """Evaluation tasks belonging to the evaluation."""
