...
from .training_pod_spec_output import TrainingPodSpecOutput
from .customization_training_option import CustomizationTrainingOption

__all__ = ["CustomizationConfigOutput", "Target"]

Target: TypeAlias = Union[str, CustomizationTarget]


class CustomizationConfigOutput(BaseModel):
    max_seq_length: int
    ...
    dataset_schemas: Optional[List[object]] = None
    ...
    pod_spec: Optional[TrainingPodSpecOutput] = None
    """
