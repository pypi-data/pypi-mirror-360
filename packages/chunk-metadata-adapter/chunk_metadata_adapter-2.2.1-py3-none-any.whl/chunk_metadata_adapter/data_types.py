...
class LanguageEnum(str, ComparableEnum):
    """Programming and natural languages supported by the system.
    
    Includes all 54 programming languages supported by guesslang plus additional languages.
    """
    # Special values
    UNKNOWN = "UNKNOWN"
    ...
    def is_programming_language(cls, value: Union[str, 'LanguageEnum']) -> bool:
        """Check if the given value represents a programming language."""
        if isinstance(value, str):
        ...
        # Natural languages and special values are not programming languages
