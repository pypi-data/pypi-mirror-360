...
setup(
    ...
    description="COIN-OR Cbc backend for Sage MixedIntegerLinearProgram",
    ...
    url="https://github.com/passagemath/passagemath-coin-or-cbc",
    ...
    install_requires = ['passagemath-categories'],
