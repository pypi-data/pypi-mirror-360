...
class HuggingFaceHuggingFaceRepositoryResponse(BaseModel):
    """
    A Serializer for HuggingFaceRepository.  Add any new fields if defined on HuggingFaceRepository. Similar to the example above, in HuggingFaceContentSerializer. Additional validators can be added to the parent validators list  For example::  class Meta:     validators = platform.RepositorySerializer.Meta.validators + [myValidator1, myValidator2]
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HuggingFaceHuggingFaceRepositoryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HuggingFaceHuggingFaceRepositoryResponse from a dict"""
        if obj is None:
            return None
