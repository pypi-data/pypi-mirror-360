...
class PatchedhuggingFaceHuggingFaceRemote(BaseModel):
    """
    ...
    hf_hub_url: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default='https://huggingface.co', description="Base URL for Hugging Face Hub")
    hf_token: Optional[StrictStr] = Field(default=None, description="Hugging Face authentication token for private repositories")
    __properties: ClassVar[List[str]] = ["name", "url", "ca_cert", "client_cert", "client_key", "tls_validation", "proxy_url", "proxy_username", "proxy_password", "username", "password", "pulp_labels", "download_concurrency", "max_retries", "policy", "total_timeout", "connect_timeout", "sock_connect_timeout", "sock_read_timeout", "headers", "rate_limit", "hf_hub_url", "hf_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchedhuggingFaceHuggingFaceRemote from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchedhuggingFaceHuggingFaceRemote from a dict"""
        if obj is None:
            return None
