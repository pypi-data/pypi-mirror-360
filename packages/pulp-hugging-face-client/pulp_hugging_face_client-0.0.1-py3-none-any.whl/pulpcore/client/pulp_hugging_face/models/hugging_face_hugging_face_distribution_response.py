...
class HuggingFaceHuggingFaceDistributionResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "base_path", "base_url", "content_guard", "no_content_change_since", "hidden", "pulp_labels", "name", "repository", "publication", "remote"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HuggingFaceHuggingFaceDistributionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HuggingFaceHuggingFaceDistributionResponse from a dict"""
        if obj is None:
            return None
