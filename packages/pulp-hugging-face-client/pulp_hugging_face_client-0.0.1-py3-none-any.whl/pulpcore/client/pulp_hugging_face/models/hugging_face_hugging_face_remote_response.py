...
class HuggingFaceHuggingFaceRemoteResponse(BaseModel):
    """
    ...
    hidden_fields: Optional[List[HuggingFaceHuggingFaceRemoteResponseHiddenFieldsInner]] = Field(default=None, description="List of hidden (write only) fields")
    hf_hub_url: Optional[StrictStr] = Field(default='https://huggingface.co', description="Base URL for Hugging Face Hub")
    hf_token: Optional[StrictStr] = Field(default=None, description="Hugging Face authentication token for private repositories")
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "name", "url", "ca_cert", "client_cert", "tls_validation", "proxy_url", "pulp_labels", "download_concurrency", "max_retries", "policy", "total_timeout", "connect_timeout", "sock_connect_timeout", "sock_read_timeout", "headers", "rate_limit", "hidden_fields", "hf_hub_url", "hf_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HuggingFaceHuggingFaceRemoteResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HuggingFaceHuggingFaceRemoteResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "hidden_fields": [HuggingFaceHuggingFaceRemoteResponseHiddenFieldsInner.from_dict(_item) for _item in obj["hidden_fields"]] if obj.get("hidden_fields") is not None else None,
            "hf_hub_url": obj.get("hf_hub_url") if obj.get("hf_hub_url") is not None else 'https://huggingface.co',
