...
class CodeInvite(UniversalBaseModel):
    id: str
    code: str
    ...
    files: typing.Optional[typing.List[CodeInviteFilesItem]] = None
    project_config: typing_extensions.Annotated[CodeInviteProjectConfig, FieldMetadata(alias="projectConfig")]
...
update_forward_refs(CodeInvite)
