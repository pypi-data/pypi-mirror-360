...
class QueryConditionField:
    def __init__(
        ...
        values: Union[
            ...
            None,
            SpecialValues,
            List[Union[str, int, float, date, datetime, None, SpecialValues]],
        ],
        ...
        Keyword arguments:
        field -- A internal name as string or a instance of SystemFields.
        ...
        table -- (Optional) Table internal name. If this is set, the a `<TableCondition>`
                 is created using the field parameter as `<TableColumn>`, default = None.
