...
from semantic_scholar_mcp.domain_models import Paper, Citation, Reference
    ...
    async def test_now_md_specific_issues(self):
        ...
        try:
            ...
            if "list_type" in str(e) and "publicationTypes" in str(e):
                ...
                logger.error(f"❌ get_author_papers publicationTypes: Still broken")
            else:
        ...
        try:
            ...
            try:
                ...
                if "no attribute 'citations'" in str(e) or "no attribute 'references'" in str(e):
                    results.append({"test": "get_paper_citations_references", "status": f"❌ NOT FIXED: Need to add citations/references to Paper model"})
