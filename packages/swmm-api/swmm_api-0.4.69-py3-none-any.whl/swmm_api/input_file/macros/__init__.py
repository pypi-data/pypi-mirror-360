...
try:
    ...
    from .gis import (convert_inp_to_geo_package, write_geo_package, get_subcatchment_connectors,
                      links_geo_data_frame, nodes_geo_data_frame, subcatchment_geo_data_frame, gpkg_to_swmm,
                      update_length, set_crs, update_area)
...
from .macros import (find_node, find_link, calc_slope, conduit_slopes, conduits_are_equal, update_no_duplicates,
                     increase_max_node_depth, set_times, subcatchments_data_frame, delete_sections,
                     set_absolute_file_paths, links_data_frame, nodes_data_frame, get_link_offset)
