...
from typing import Any, NamedTuple, Optional, Sequence, Type, TypeVar
...
class StringThread:
    ...
    def turns(self) -> list[StringTurn]: ...
...
class TokenizedThread:
    ...
    def turns(self) -> list[TokenizedTurn]: ...
...
class TrainingModel(InferenceModel):
    ...
    async def train_mse(self, thread: TokenizedThread, targets: Sequence[float]) -> None: ...
