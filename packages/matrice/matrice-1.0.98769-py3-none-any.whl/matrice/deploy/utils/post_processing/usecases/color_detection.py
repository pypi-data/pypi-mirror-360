...
class ColorDetectionUseCase(BaseProcessor):
    ...
    def process(
        ...
        try:
            ...
            events = self._generate_events(color_summary, alerts, config, frame_number)
            tracking_stats = self._generate_tracking_stats(color_summary, insights, summary, config, frame_number)
