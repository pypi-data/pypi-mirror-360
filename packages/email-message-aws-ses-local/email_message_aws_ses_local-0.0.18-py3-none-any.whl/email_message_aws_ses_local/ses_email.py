...
EMAIL_MESSAGE_AWS_SES_LOCAL_PYTHON_PACKAGE_COMPONENT_NAME = "email-message-aws-ses-local-python-package"
...
class EmailMessageAwsSesLocal(EmailMessage, metaclass=MetaLogger, object=logger_object):
        ...
        for recipient in recipients:
            ...
            if recipient_email is not None:
                if IS_REALLY_SEND_EMAIL:
                    ...
                    message_data_dict = {"email_message_id": email_message_id,
                                         "body": body,
                    ...
                    message_id = self.save_email_message(
