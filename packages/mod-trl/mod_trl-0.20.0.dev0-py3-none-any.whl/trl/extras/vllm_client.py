...
from trl.extras.injected_process_group import InjectedStatelessProcessGroup
...
class VLLMClient:
    ...
    def init_communicator(self):
        ...
        pg = InjectedStatelessProcessGroup.create(host=self.host, port=self.group_port, rank=self.rank,
    ...
    def update_named_param(self, name: str, weights: torch.Tensor):
        ...
        # 输出self.pynccl_comm的所有属性，以便调试
        module = inspect.getmodule(self.pynccl_comm.group.barrier)
    ...
    def update_model_params(self, model: nn.Module):
        ...
        """
        MNP = model.named_parameters()
        for name, param in MNP:
            # Update each parameter individually
            print(f'Here should show multi times.')
