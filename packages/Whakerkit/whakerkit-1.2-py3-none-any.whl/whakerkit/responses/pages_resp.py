...
class WhakerKitResponse(BaseResponseRecipe):
    ...
    def create_tree_header(self):
        """Create the body_header of the dynamic tree."""
        self._htree.body_header = WhakerKitHeaderNode(self._htree.identifier)
    ...
    def enable_unittests(self) -> None:
        ...
        if "UnitTest.js" not in serialize_head:
            self._htree.add_script_file(whakerkit.sg.whakerexa + "js/purejs-tools/UnitTest.js")
