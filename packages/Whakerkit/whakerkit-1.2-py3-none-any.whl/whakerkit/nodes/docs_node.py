...
MSG_ACTION_DETAILS = _("Details")
MSG_ACTION_DESCRIBE = _("Describe")
MSG_DOWNLOAD = _("Download")
MSG_APPLY = _("Apply")
MSG_ACTION_DELETE = _("Delete")
MSG_ACTIONS = _("Actions")
MSG_VISIBILITY = _("Column visibility")
...
class ToggleColumnsNode(HTMLNode):
    ...
    def __init__(self, parent: str):
        ...
        button = HTMLNode(self.identifier, None, "button", value=MSG_APPLY)
...
class DocumentsNode(HTMLNode):
    ...
    def reset(self):
        ...
        DocumentsNode.__add_th(tr, "actions", MSG_ACTIONS)
    ...
    def __add_actions_in_column(self, doc, td):
        ...
        self.__add_icon_button(td, f"asideManager.showDetails('{doc.folder_name}');",
                               whakerkit.sg.path + "statics/icons/info.png", MSG_ACTION_DETAILS)
        # - download
        btn = WhakerKitDownloadNode(
            td.identifier, self.__doc_manager.get_doc_relative_path(doc),
            doc.folder_name, MSG_DOWNLOAD)
        ...
        if self.__current_user == doc.author:
            self.__add_icon_button(td, f"docManager.describeDocument('{doc.folder_name}');",
                                   whakerkit.sg.path + "statics/icons/describe.png", MSG_ACTION_DESCRIBE)
            btn = self.__add_icon_button(td, f"docManager.deleteDocument('{doc.folder_name}')",
                                         whakerkit.sg.path + "statics/icons/delete.png", MSG_ACTION_DELETE)
