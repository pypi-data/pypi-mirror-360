...
MSG_HEADER_H1 = _("Login")
MSG_USERNAME = _("Username")
MSG_USERID = _("Login ID")
...
class WhakerKitLoginNode(HTMLNode):
    ...
    def reset(self):
        ...
        title = HTMLNode(self.identifier, None, "h1", value=MSG_HEADER_H1)
    ...
    def __login_form_content(form: HTMLNode):
        ...
        label_username = HTMLNode(form.identifier, "username_label", "label",
                                  value=MSG_USERNAME, attributes={"for": "username_input"})
        form.append_child(label_username)
        att = {
            "id": "username_input",
            "name": "username_input",
            "placeholder": MSG_USERID,
            "type": "text",
        ...
        label_password = HTMLNode(form.identifier, "password_label", "label",
                                  value=MSG_PASSWORD, attributes={"for": "password_input"})
        ...
        # Submit button
        btn = create_action_button(form.identifier, None, MSG_LOGIN, whakerkit.sg.path + "statics/icons/authentication.png")
