...
MSG_NAME = _("File name")
MSG_AUTHOR = _("Depositor")
MSG_TYPE = _("Type")
MSG_DATE = _("Date")
MSG_DESCRIPTION = _("Description")
MSG_DOWNLOADS = _("DLs")
...
DOC_FIELDS = {
    "filename": WhakerKitDocumentProperties(MSG_NAME, True, True, False),
    "author": WhakerKitDocumentProperties(MSG_AUTHOR, True, True, False),
    "date": WhakerKitDocumentProperties(MSG_DATE, True, True, False),
    "filetype": WhakerKitDocumentProperties(MSG_TYPE, True, True, False),
    "description": WhakerKitDocumentProperties(MSG_DESCRIPTION, False, True, True),
    "downloads": WhakerKitDocumentProperties(MSG_DOWNLOADS, False, True, True),
}
