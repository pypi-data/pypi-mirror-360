...
class WhakerKitHeadNode(HTMLHeadNode):
    ...
    def reset(self, title: str):
        ...
        self.meta({"name": "keywords",
                   "content": "WhakerKit, WhakerPy, WhintPy, Whakerexa, Brigitte, Bigi, CNRS"})
        ...
        self.script(src=whakerkit.sg.whakerexa + "js/purejs-tools/OnLoadManager.js", script_type=JS_MIME_TYPE)
        self.script(src=whakerkit.sg.whakerexa + "js/whakerpy/request.js", script_type=JS_MIME_TYPE)
        self.script(src=whakerkit.sg.whakerexa + "js/accessibility.js", script_type=JS_MIME_TYPE)
