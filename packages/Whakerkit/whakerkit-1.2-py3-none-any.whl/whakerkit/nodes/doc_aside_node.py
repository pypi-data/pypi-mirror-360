...
MSG_DETAILS = _("Information")
MSG_CLOSE = _("Close")
MSG_DOC_FILENAME = _("Name: ")
MSG_DOC_AUTHOR = _("Author: ")
MSG_DOC_FILETYPE = _("Type: ")
MSG_DOC_DATE = _("Added on: ")
MSG_DOC_DESCRIPTION = _("Description: ")
MSG_DOC_DOWNLOADS = _("Downloads: ")
MSG_DOC_DOWNLOADS_VALUE = _("0")
...
class WhakerKitDocAsideNode(HTMLNode):
    ...
    def reset(self):
        ...
        h2.set_value(MSG_DETAILS)
        self.append_child(h2)

        self.__append_p("doc_filename", value=MSG_DOC_FILENAME)
        self.__append_p("doc_author", value=MSG_DOC_AUTHOR)
        self.__append_p("doc_filetype", value=MSG_DOC_FILETYPE)
        self.__append_p("doc_date", value=MSG_DOC_DATE)
        self.__append_p("doc_description", value=MSG_DOC_DESCRIPTION)
        self.__append_p("doc_downloads", value=MSG_DOC_DOWNLOADS, span_value=MSG_DOC_DOWNLOADS_VALUE)

        button = HTMLNode(self.identifier, "button", "button",
                          attributes={"id": "close_aside_button", "onclick": "asideManager.closeDetails()",
                                      "class": "apply-button"})
        button.set_value(MSG_CLOSE)
