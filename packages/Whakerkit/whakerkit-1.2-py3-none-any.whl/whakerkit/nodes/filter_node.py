...
MSG_TITLE_FILTERS = _("Filters:")
MSG_DO_FILTER = _("Filter documents")
MSG_CLEAR_FILTER = _("Clear filters")
MSG_DOCUMENTS = _("The document")
MSG_CONDITIONS_ALL = _("meets all of the following criteria")
MSG_CONDITIONS_OR = _("meets at least one of the following criteria")
MSG_FILETYPE_IS = _("File type is")
MSG_AUTHOR_IS = _("Author is")
MSG_SELECTION_AMONG = _("among:")
MSG_DATE_AMONG = _("The deposit date is between")
MSG_NAME_OR_DESCR = _("The name or description")
MSG_STARTYEAR = _("start year")
MSG_ENDYEAR = _("end year")
MSG_THIS_THAT = _("this OR/AND that")
MSG_OR = _("OR")
MSG_AND = _("AND")
MSG_ACONTAINS = _("contains")
MSG_NOT_ACONTAINS = _("does not contain")
MSG_CONTAINS = _("contains (with diacritics)")
MSG_NOT_CONTAINS = _("does not contain (with diacritics)")
...
class WhakerKitFilterNode(HTMLNode):
    ...
    def __init__(self, parent, filetypes: list, authors: list):
        ...
        summary = HTMLNode(self.identifier, None, "summary", value=MSG_TITLE_FILTERS)
        ...
        self.__append_details(
            main, "author", MSG_AUTHOR_IS + " " + MSG_SELECTION_AMONG,
            "toggleSelectorAuthor.toggleSelection(event)", authors)

        # File type filter
        self.__append_details(
            main, "filetype", MSG_FILETYPE_IS + " " + MSG_SELECTION_AMONG,
        ...
        select_description = HTMLNode(
            ...
            attributes={"aria-label": MSG_CONTAINS,
                        "id": "description_condition", "name": "description_condition",
                        "style": "width: 100%;"})
        td_description_select.append_child(select_description)

        options_description = [
            ("acontains", MSG_ACONTAINS),
            ("not_acontains", MSG_NOT_ACONTAINS),
            ("contains", MSG_CONTAINS),
            ("not_contains", MSG_NOT_CONTAINS),
            ("astartswith", MSG_STARTSWITH),
            ("aendswith", MSG_ENDSWITH)
        ]
        ...
        input_description = HTMLNode(label_description.identifier, None, "input", attributes={
            ...
            "aria-labelledby": "description_label", "placeholder": MSG_THIS_THAT,
            "style": "width: 100%;"
        })
        ...
        or_span = HTMLNode(span.identifier, None, "span", attributes={"class": "switch-off-text"}, value=MSG_OR)
        and_span = HTMLNode(span.identifier, None, "span", attributes={"class": "switch-on-text"}, value=MSG_AND)
        ...
        td_date_label = HTMLNode(tr_date.identifier, None, "td", value=MSG_DATE_AMONG)
        ...
        input_date_min = HTMLNode(td_date_min.identifier, None, "input", attributes={
            ...
            "aria-label": MSG_STARTYEAR, "placeholder": "YYYY", "maxlength": "4",
        ...
        input_date_max = HTMLNode(td_date_max.identifier, None, "input", attributes={
            ...
            "aria-label": MSG_ENDYEAR, "aria-labelledby": "date_min_label",
    ...
    def __append_action_buttons(self, parent: HTMLNode):
        ...
        btn = create_action_button(
                ...
                MSG_DO_FILTER, whakerkit.sg.path + "statics/icons/filter.png")
        actions.append_child(btn)

        btn = create_action_button(
                actions.identifier, "docManager.resetFilters();",
                MSG_CLEAR_FILTER, whakerkit.sg.path + "statics/icons/clear.png")
        actions.append_child(btn)
