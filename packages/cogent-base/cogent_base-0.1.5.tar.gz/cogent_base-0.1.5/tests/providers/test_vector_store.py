...
from cogentbase.providers.vector_store.cogent_vector_store import CogentVectorStore
from cogentbase.providers.vector_store.weaviate_vector_store import Weaviate
...
class TestWeaviateIntegration:
    ...
    def test_weaviate_connection(self, mock_config):
        ...
        with patch("cogentbase.providers.vector_store.cogent_vector_store.get_cogent_config") as mock_get_config:
...
class TestCogentVectorStoreUnit:
    ...
    def test_initialization(self, mock_config):
        ...
        with patch("cogentbase.providers.vector_store.cogent_vector_store.get_cogent_config") as mock_get_config:
            ...
            with patch("cogentbase.providers.vector_store.weaviate_vector_store.Weaviate") as mock_weaviate_class:
...
class TestWeaviateUnit:
    ...
    def test_initialization(self, mock_weaviate_client):
        ...
        with patch("cogentbase.providers.vector_store.weaviate_vector_store.weaviate") as mock_weaviate:
