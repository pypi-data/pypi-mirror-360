...
from cogent_base.providers.embedding.litellm_embedding import LiteLLMEmbeddingModel
...
class TestIntegrationLiteLLMEmbedding:
    ...
    async def test_ollama_object_embedding(self, mock_config, test_texts):
        ...
        with patch("cogent_base.providers.embedding.litellm_embedding.get_cogent_config") as mock_get_config:
...
class TestLiteLLMEmbeddingUnit:
    ...
    async def test_mocked_litellm_embedding(self, mock_config, mock_litellm_response):
        ...
        with (
            patch("cogent_base.providers.embedding.litellm_embedding.get_cogent_config") as mock_get_config,
            patch(
                "cogent_base.providers.embedding.litellm_embedding.litellm.aembedding", new_callable=AsyncMock
            ) as mock_litellm,
        ):
    ...
    async def test_mocked_ollama_embedding(self, mock_config, mock_litellm_response):
        ...
        with (
            patch("cogent_base.providers.embedding.litellm_embedding.get_cogent_config") as mock_get_config,
            patch("cogent_base.providers.embedding.litellm_embedding.ollama.AsyncClient") as mock_ollama_client,
        ):
    ...
    async def test_mocked_error_handling(self, mock_config):
        ...
        with (
            patch("cogent_base.providers.embedding.litellm_embedding.get_cogent_config") as mock_get_config,
            patch("cogent_base.providers.embedding.litellm_embedding.litellm.aembedding") as mock_litellm,
        ):
    ...
    async def test_dimension_validation_warning(self, mock_config, mock_litellm_response):
        ...
        with (
            ...
            patch("cogent_base.providers.embedding.litellm_embedding.logger") as mock_logger,
        ):
