...
class TestIntegrationLiteLLMCompletion:
    ...
    async def test_ollama_basic_completion(self, mock_config, basic_request):
        ...
        with patch("cogent_base.providers.completion.litellm_completion.get_cogent_config") as mock_get_config:
    ...
    async def test_chat_history_completion(self, mock_config):
        ...
        from cogent_base.models.chat import ChatMessage
...
class TestLiteLLMCompletionUnit:
    ...
    async def test_ollama_detection(self, mock_config):
        ...
        with patch("cogent_base.providers.completion.litellm_completion.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent_base.providers.completion.litellm_completion.ollama") as mock_ollama:
    ...
    async def test_ollama_fallback_when_library_missing(self, mock_config):
        ...
        with patch("cogent_base.providers.completion.litellm_completion.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent_base.providers.completion.litellm_completion.initialize_ollama_model") as mock_init:
    ...
    async def test_mocked_litellm_completion(self, mock_config):
        ...
        with patch("cogent_base.providers.completion.litellm_completion.get_cogent_config") as mock_get_config:
            ...
            with patch("cogent_base.providers.completion.litellm_completion.litellm") as mock_litellm:
