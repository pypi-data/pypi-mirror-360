...
class WebhooksApi:
    ...
    def count_webhook_events(
        ...
        _param = self._count_webhook_events_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CountWebhookEvents200Response",
        }
    ...
    @validate_call
    def count_webhook_events_with_http_info(
        self,
        webhook_id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CountWebhookEvents200Response]:
        """Count webhook events
    ...
    @validate_call
    def count_webhook_events_without_preload_content(
        self,
        webhook_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _count_webhook_events_serialize(
        self,
        webhook_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webhooks/{webhookID}/events/count',
    ...
    def count_webhooks(
        ...
        _param = self._count_webhooks_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def count_webhooks_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CountWebhooks200Response]:
        """Count webhooks
    ...
    @validate_call
    def count_webhooks_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def create_webhook(
        self,
        base_webhook_endpoint: BaseWebhookEndpoint,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param base_webhook_endpoint: (required)
        :type base_webhook_endpoint: BaseWebhookEndpoint
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_webhook_serialize(
            base_webhook_endpoint=base_webhook_endpoint,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_webhook_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if base_webhook_endpoint is not None:
            _body_params = base_webhook_endpoint
    ...
    def _list_webhook_events_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webhooks/{webhookID}/events',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
