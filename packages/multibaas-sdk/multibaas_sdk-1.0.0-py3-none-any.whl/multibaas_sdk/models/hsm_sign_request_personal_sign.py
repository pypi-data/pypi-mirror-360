...
class HSMSignRequestPersonalSign(BaseModel):
    """
    ...
    chain_id: Optional[HSMSignRequestPersonalSignChainId] = Field(default=None, alias="chainId")
    __properties: ClassVar[List[str]] = ["method", "address", "data", "chainId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "chainId": HSMSignRequestPersonalSignChainId.from_dict(obj["chainId"]) if obj.get("chainId") is not None else None
        })
        return _obj
