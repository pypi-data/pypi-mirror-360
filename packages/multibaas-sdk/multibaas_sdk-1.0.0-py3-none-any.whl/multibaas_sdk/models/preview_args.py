...
class PreviewArgs(BaseModel):
    ...
    """ # noqa: E501
    inputs_only: StrictBool = Field(description="Only preview the effect of a Type Conversion on the inputs. Only applicable for write function calls, where the output is an unsigned transaction.", alias="inputsOnly")
    inputs: List[ContractABIMethodArgument] = Field(description="Type Conversion information for the function inputs. The number of inputs must match that of the actual function inputs. The parameter is a contract function argument where only the type conversion information is used.")
    outputs: List[ContractABIMethodArgument] = Field(description="Type Conversion information for the function outputs. The number of outputs must match that of the actual function outputs. The parameter is a contract function argument where only the type conversion information is used.")
    __properties: ClassVar[List[str]] = ["inputsOnly", "inputs", "outputs"]
