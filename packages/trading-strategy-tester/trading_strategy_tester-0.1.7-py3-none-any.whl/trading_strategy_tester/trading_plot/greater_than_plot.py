...
class GreaterThanPlot(TradingPlot):
    def __init__(self, series1: pd.Series, series2: pd.Series):
        """
        Initialize the GreaterThanPlot object with two time series.

        :param series1: The first time series to be plotted.
        :type series1: pd.Series
        :param series2: The second time series for comparison in greater-than detection.
    ...
    def get_plot(self, dark: bool = True) -> go.Figure:
        """
        Generate a Plotly plot comparing two series and highlighting portions where series1 is greater than series2.
        This plot also allows for dark mode styling.

        :param dark: If True, the plot will use a dark theme. Defaults to True.
        :type dark: bool
        :return: A Plotly Figure object representing the GreaterThan plot.
        :rtype: go.Figure
        """
