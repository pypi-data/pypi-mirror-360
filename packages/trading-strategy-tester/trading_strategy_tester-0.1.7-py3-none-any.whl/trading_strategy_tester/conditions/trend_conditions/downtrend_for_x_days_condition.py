...
class DowntrendForXDaysCondition(Condition):
    def __init__(self, series: TradingSeries, number_of_days: int):
        """
        Initialize the DowntrendForXDaysCondition with the given series and number of days.

        :param series: The TradingSeries object containing the data series to evaluate.
        :type series: TradingSeries
        :param number_of_days: The number of days over which the downtrend should be evaluated.
    ...
    def evaluate(self, downloader: DownloadModule, df: pd.DataFrame) -> (pd.Series, pd.Series):
        """
        Evaluate the downtrend condition over the given dataframe and return the result series and signal series.

        The condition checks whether the series has been in a downtrend for the specified number of days.
        ...
        :return: A tuple containing:
            - is_downtrend: A pandas Series where True indicates that the series has been in a downtrend for the specified number of days.
        ...
        # Apply rolling window to check for downtrend
    ...
    def get_graphs(self, downloader: DownloadModule, df: pd.DataFrame) -> [TradingPlot]:
        ...
        :type df: pd.DataFrame
        :return: A list containing the DowntrendPlot.
        :rtype: [TradingPlot]
        """
    ...
    def to_string(self) -> str:
        ...
        :return: A string representation of the DowntrendForXDaysCondition.
        :rtype: str
        """
    ...
    def to_dict(self) -> dict:
        ...
        """
        return {
            'type': 'DowntrendForXDaysCondition',
