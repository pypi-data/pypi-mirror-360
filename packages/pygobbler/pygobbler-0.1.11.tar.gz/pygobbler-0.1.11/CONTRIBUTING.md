...
Welcome to `pygobbler` contributor's guide.
...
If you experience bugs or general issues with `pygobbler`, please have a look
...
You can help improve `pygobbler` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pygobbler` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pygobbler`'s files. While this mechanism can
...
```
conda create -n pygobbler python=3 six virtualenv pytest pytest-cov
conda activate pygobbler
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pygobbler.git
   cd pygobbler
   ```
...
5. Install [pre-commit]:
   ...
   `pygobbler` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pygobbler
[issue tracker]: https://github.com/<USERNAME>/pygobbler/issues
