...
class ValidationError(Exception):
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._field_value: Any = field_value
        self._field_type: type = field_type

    def __str__(self) -> str:
        return (
            f"Field '{self._field_name}' cannot be cast to type "
            f"'{self._field_type.__name__}': {self._field_value}."
        )
